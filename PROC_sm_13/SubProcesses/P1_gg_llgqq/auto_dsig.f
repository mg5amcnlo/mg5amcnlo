...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g g > e+ e- g u u~ WEIGHTED<=7 @1
C     Process: g g > e+ e- g c c~ WEIGHTED<=7 @1
C     Process: g g > mu+ mu- g u u~ WEIGHTED<=7 @1
C     Process: g g > mu+ mu- g c c~ WEIGHTED<=7 @1
...
C      discrete sampler(imode=5) and 
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g g > e+ e- g u u~
      IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g g > e+ e- g d d~
C     ENDIF
...
C            the warp)
     ...
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! g g > e+ e- g u u~
      IF(IPROC.EQ.2) CALL DSIG2_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! g g > e+ e- g d d~
