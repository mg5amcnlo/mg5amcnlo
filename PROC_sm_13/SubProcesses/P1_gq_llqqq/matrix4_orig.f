...
C     Amplitude(s) for diagram number 4
     ...
     $ )
      CALL FFV2_3_1(W(1,5),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,17),W(1,5),W(1,9),GC_1,AMP(10))
...
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,17),W(1,5),W(1,15),GC_50,GC_58,AMP(12))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,16),W(1,5),W(1,9),GC_1,AMP(49))
...
C     Amplitude(s) for diagram number 51
      CALL FFV2_3_0(W(1,16),W(1,5),W(1,15),GC_50,GC_58,AMP(51))
