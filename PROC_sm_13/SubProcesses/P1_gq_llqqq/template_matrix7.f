...
C     
C     Process: g d > e+ e- u d u~ WEIGHTED<=7 @1
C     Process: g d > e+ e- c d c~ WEIGHTED<=7 @1
C     Process: g d > mu+ mu- u d u~ WEIGHTED<=7 @1
C     Process: g d > mu+ mu- c d c~ WEIGHTED<=7 @1
C     Process: g s > e+ e- u s u~ WEIGHTED<=7 @1
C     Process: g s > e+ e- c s c~ WEIGHTED<=7 @1
C     Process: g s > mu+ mu- u s u~ WEIGHTED<=7 @1
C     Process: g s > mu+ mu- c s c~ WEIGHTED<=7 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE   
     ...
     $     //' zero but not the total matrix-element'
      ...
      call select_color(rcol, jamp2, iconfig,7,  icol, ivec)
