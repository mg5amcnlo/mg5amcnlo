...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV1_1(W(1,5),W(1,9),GC_1,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,16),W(1,14),GC_11(IVEC),AMP(22))
      CALL FFV2_3_2(W(1,2),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,17),W(1,5),W(1,14),GC_11(IVEC),AMP(23))
      CALL FFV2_3_1(W(1,5),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
