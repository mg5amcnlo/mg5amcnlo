...
C     
C     Process: u u~ > e+ e- g g g WEIGHTED<=7 @1
C     Process: u u~ > mu+ mu- g g g WEIGHTED<=7 @1
C     Process: c c~ > e+ e- g g g WEIGHTED<=7 @1
C     Process: c c~ > mu+ mu- g g g WEIGHTED<=7 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      CALL SELECT_COLOR(RCOL, JAMP2, ICONFIG,1,  ICOL, IVEC)
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_5_2(W(1,1),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,1),W(1,16),W(1,9),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,14),W(1,10),W(1,9),GC_2,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,1),W(1,16),W(1,15),-GC_50,GC_58,AMP(11))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,1),W(1,18),W(1,9),GC_2,AMP(33))
...
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,1),W(1,18),W(1,15),-GC_50,GC_58,AMP(35))
...
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_2,AMP(97))
      CALL FFV1_0(W(1,1),W(1,6),W(1,9),GC_2,AMP(98))
      CALL FFV1_0(W(1,1),W(1,5),W(1,9),GC_2,AMP(99))
...
C     Amplitude(s) for diagram number 99
      CALL FFV2_5_0(W(1,1),W(1,7),W(1,15),-GC_50,GC_58,AMP(103))
      CALL FFV2_5_0(W(1,1),W(1,6),W(1,15),-GC_50,GC_58,AMP(104))
      CALL FFV2_5_0(W(1,1),W(1,5),W(1,15),-GC_50,GC_58,AMP(105))
