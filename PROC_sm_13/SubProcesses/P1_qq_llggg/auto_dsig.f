...
C      discrete sampler(imode=5) and 
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > e+ e- g g g
      IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! d d~ > e+ e- g g g
C     ENDIF
...
C            the warp)
     ...
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u u~ > e+ e- g g g
      IF(IPROC.EQ.2) CALL DSIG2_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d d~ > e+ e- g g g
