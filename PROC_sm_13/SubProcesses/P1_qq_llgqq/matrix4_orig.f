...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,4) .OR. NTRY(4).LE.MAXTRIES.OR.(ISUM_HEL.NE.0))
     $      THEN
            T=MATRIX4(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(4).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,4) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,4)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 4',TS(I)
     $           *NCOMB/ANS,' in event ',NTRY(4)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(4).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX4(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,2),W(1,9),GC_1,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_1(W(1,2),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,16),W(1,2),W(1,9),GC_1,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,18),W(1,2),W(1,17),GC_11(IVEC),AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,16),W(1,2),W(1,15),GC_50,GC_58,AMP(16))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 26
      ...
      CALL FFV2_3_2(W(1,1),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,20))
