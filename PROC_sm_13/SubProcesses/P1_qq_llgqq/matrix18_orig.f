...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      CALL SELECT_COLOR(RCOL, JAMP2, ICONFIG,18,  ICOL, IVEC)
...
C     Amplitude(s) for diagram number 2
     ...
     $ )
      CALL FFV2_5_1(W(1,2),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV1_1(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 23
      ...
      CALL FFV2_5_1(W(1,1),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,19),W(1,2),W(1,9),GC_2,AMP(25))
...
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,13),-GC_50,GC_58,AMP(27))
