...
C     Process: u u~ > e+ e- g c c~ WEIGHTED<=7 @1
C     Process: u u~ > mu+ mu- g c c~ WEIGHTED<=7 @1
C     Process: c c~ > e+ e- g u u~ WEIGHTED<=7 @1
C     Process: c c~ > mu+ mu- g u u~ WEIGHTED<=7 @1
...
C     Process: u c~ > e+ e- g u c~ WEIGHTED<=7 @1
C     Process: u c~ > mu+ mu- g u c~ WEIGHTED<=7 @1
C     Process: c u~ > e+ e- g c u~ WEIGHTED<=7 @1
C     Process: c u~ > mu+ mu- g c u~ WEIGHTED<=7 @1
C     Process: u d~ > e+ e- g u d~ WEIGHTED<=7 @1
C     Process: u d~ > mu+ mu- g u d~ WEIGHTED<=7 @1
C     Process: u s~ > e+ e- g u s~ WEIGHTED<=7 @1
C     Process: u s~ > mu+ mu- g u s~ WEIGHTED<=7 @1
...
C     Process: d d~ > e+ e- g s s~ WEIGHTED<=7 @1
C     Process: d d~ > mu+ mu- g s s~ WEIGHTED<=7 @1
C     Process: s s~ > e+ e- g d d~ WEIGHTED<=7 @1
C     Process: s s~ > mu+ mu- g d d~ WEIGHTED<=7 @1
C     Process: d s~ > e+ e- g d s~ WEIGHTED<=7 @1
C     Process: d s~ > mu+ mu- g d s~ WEIGHTED<=7 @1
...
C       Output weights and number of events
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(40E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        SUMPROB=0D0
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(40E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(40I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C      discrete sampler(imode=5) and 
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > e+ e- g u u
      IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u~ > e+ e- g u u~
      IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! d d > e+ e- g d d
      IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! d d~ > e+ e- g d d~
      IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u~ u~ > e+ e- g u~ u~
      IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d~ d~ > e+ e- g d~ d~
      IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u c > e+ e- g u c
      IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u d > e+ e- g u d
      IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u u~ > e+ e- g c c~
      IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u u~ > e+ e- g d d~
      IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u c~ > e+ e- g u c~
      IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u d~ > e+ e- g u d~
      IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! d s > e+ e- g d s
      IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! d u~ > e+ e- g d u~
      IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! d d~ > e+ e- g u u~
      IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! d d~ > e+ e- g s s~
      IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! d s~ > e+ e- g d s~
      IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u~ c~ > e+ e- g u~ c~
      IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u~ d~ > e+ e- g u~ d~
      IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! d~ s~ > e+ e- g d~ s~
C     ENDIF
...
C            the warp)
     ...
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u u > e+ e- g u u
      IF(IPROC.EQ.2) CALL DSIG2_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u u~ > e+ e- g u u~
      IF(IPROC.EQ.3) CALL DSIG3_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d d > e+ e- g d d
      IF(IPROC.EQ.4) CALL DSIG4_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d d~ > e+ e- g d d~
      IF(IPROC.EQ.5) CALL DSIG5_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u~ u~ > e+ e- g u~ u~
      IF(IPROC.EQ.6) CALL DSIG6_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d~ d~ > e+ e- g d~ d~
      IF(IPROC.EQ.7) CALL DSIG7_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u c > e+ e- g u c
      IF(IPROC.EQ.8) CALL DSIG8_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u d > e+ e- g u d
      IF(IPROC.EQ.9) CALL DSIG9_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u u~ > e+ e- g c c~
      IF(IPROC.EQ.10) CALL DSIG10_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u u~ > e+ e- g d d~
      IF(IPROC.EQ.11) CALL DSIG11_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u c~ > e+ e- g u c~
      IF(IPROC.EQ.12) CALL DSIG12_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u d~ > e+ e- g u d~
      IF(IPROC.EQ.13) CALL DSIG13_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d s > e+ e- g d s
      IF(IPROC.EQ.14) CALL DSIG14_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d u~ > e+ e- g d u~
      IF(IPROC.EQ.15) CALL DSIG15_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d d~ > e+ e- g u u~
      IF(IPROC.EQ.16) CALL DSIG16_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d d~ > e+ e- g s s~
      IF(IPROC.EQ.17) CALL DSIG17_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d s~ > e+ e- g d s~
      IF(IPROC.EQ.18) CALL DSIG18_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u~ c~ > e+ e- g u~ c~
      IF(IPROC.EQ.19) CALL DSIG19_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! u~ d~ > e+ e- g u~ d~
      IF(IPROC.EQ.20) CALL DSIG20_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,SYMCONF, CONFSUB,ICONF_VEC
     $ ,IMIRROR_VEC,VECSIZE_USED)  ! d~ s~ > e+ e- g d~ s~
...
C     
      ...
      CALL PRINT_ZERO_AMP3()
      CALL PRINT_ZERO_AMP4()
      CALL PRINT_ZERO_AMP5()
      CALL PRINT_ZERO_AMP6()
      CALL PRINT_ZERO_AMP7()
      CALL PRINT_ZERO_AMP8()
      CALL PRINT_ZERO_AMP9()
      CALL PRINT_ZERO_AMP10()
      CALL PRINT_ZERO_AMP11()
      CALL PRINT_ZERO_AMP12()
      CALL PRINT_ZERO_AMP13()
      CALL PRINT_ZERO_AMP14()
      CALL PRINT_ZERO_AMP15()
      CALL PRINT_ZERO_AMP16()
      CALL PRINT_ZERO_AMP17()
      CALL PRINT_ZERO_AMP18()
      CALL PRINT_ZERO_AMP19()
      CALL PRINT_ZERO_AMP20()
      RETURN
      END
...
C     all subleading color.
      ...
      ELSEIF(IPROC.EQ.3)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL3(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.4)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL4(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.5)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL5(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.6)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL6(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.7)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL7(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.8)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL8(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.9)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL9(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.10)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL10(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.11)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL11(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.12)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL12(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.13)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL13(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.14)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL14(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.15)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL15(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.16)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL16(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.17)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL17(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.18)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL18(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.19)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL19(IHEL,I)
        ENDDO
      ELSEIF(IPROC.EQ.20)THEN
        DO I=1,NEXTERNAL
          NHEL(I) = GET_NHEL20(IHEL,I)
        ENDDO
      ENDIF
