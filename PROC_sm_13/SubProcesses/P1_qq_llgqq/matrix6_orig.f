...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,6) .OR. NTRY(6).LE.MAXTRIES.OR.(ISUM_HEL.NE.0))
     $      THEN
            T=MATRIX6(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(6).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,6) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,6)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 6',TS(I)
     $           *NCOMB/ANS,' in event ',NTRY(6)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(6).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX6(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_2(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,9))
      CALL FFV1P0_3(W(1,8),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,8),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,14),W(1,13),GC_11(IVEC),AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,1),W(1,13),GC_11(IVEC),AMP(4))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_1(W(1,1),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,10),W(1,13),GC_11(IVEC),AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,3),W(1,1),W(1,13),GC_11(IVEC),AMP(8))
      CALL FFV1P0_3(W(1,7),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
      CALL FFV1_2(W(1,8),W(1,9),GC_1,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,16),W(1,2),W(1,13),GC_11(IVEC),AMP(9))
      CALL FFV1_2(W(1,8),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,17),W(1,2),W(1,9),GC_1,AMP(10))
      CALL FFV2_3_2(W(1,8),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,18),W(1,2),W(1,13),GC_11(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,17),W(1,2),W(1,15),GC_50,GC_58,AMP(12))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,1),W(1,17),GC_11(IVEC),AMP(13))
      CALL FFV1_2(W(1,8),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,16),W(1,1),W(1,9),GC_1,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,18),W(1,1),W(1,17),GC_11(IVEC),AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,16),W(1,1),W(1,15),GC_50,GC_58,AMP(16))
      CALL FFV1_1(W(1,1),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1P0_3(W(1,6),W(1,16),GC_11(IVEC),ZERO, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,7),W(1,11),W(1,20),GC_11(IVEC),AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,12),W(1,2),W(1,20),GC_11(IVEC),AMP(22))
      CALL FFV1P0_3(W(1,7),W(1,16),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
      CALL FFV1_2(W(1,6),W(1,9),GC_1,ZERO, FK_ZERO,W(1,22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,22),W(1,2),W(1,21),GC_11(IVEC),AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,6),W(1,11),W(1,21),GC_11(IVEC),AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,7),W(1,4),W(1,20),GC_11(IVEC),AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,3),W(1,2),W(1,20),GC_11(IVEC),AMP(26))
      CALL FFV2_3_2(W(1,6),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,20),W(1,2),W(1,21),GC_11(IVEC),AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,4),W(1,21),GC_11(IVEC),AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,6),W(1,19),W(1,17),GC_11(IVEC),AMP(29))
      CALL FFV1_1(W(1,16),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,6),W(1,19),W(1,9),GC_1,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,6),W(1,8),W(1,17),GC_11(IVEC),AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_3_0(W(1,6),W(1,19),W(1,15),GC_50,GC_58,AMP(32))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,19))
      CALL FFV1P0_3(W(1,6),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1P0_3(W(1,6),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,23))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,7),W(1,14),W(1,23),GC_11(IVEC),AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,12),W(1,1),W(1,23),GC_11(IVEC),AMP(38))
      CALL FFV1P0_3(W(1,7),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,24))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,22),W(1,1),W(1,24),GC_11(IVEC),AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,6),W(1,14),W(1,24),GC_11(IVEC),AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,7),W(1,10),W(1,23),GC_11(IVEC),AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,3),W(1,1),W(1,23),GC_11(IVEC),AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,20),W(1,1),W(1,24),GC_11(IVEC),AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,6),W(1,10),W(1,24),GC_11(IVEC),AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,6),W(1,21),W(1,13),GC_11(IVEC),AMP(45))
      CALL FFV1_1(W(1,19),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,6),W(1,21),W(1,9),GC_1,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,6),W(1,16),W(1,13),GC_11(IVEC),AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,6),W(1,21),W(1,15),GC_50,GC_58,AMP(48))
      CALL FFV1_2(W(1,7),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
      CALL FFV1_2(W(1,21),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,16),W(1,2),W(1,9),GC_1,AMP(49))
      CALL FFV1_2(W(1,21),W(1,9),GC_1,ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,19),W(1,2),W(1,8),GC_11(IVEC),AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_3_0(W(1,16),W(1,2),W(1,15),GC_50,GC_58,AMP(51))
      CALL FFV2_3_2(W(1,21),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_11(IVEC),AMP(52))
      CALL FFV1_2(W(1,21),W(1,18),GC_11(IVEC),ZERO, FK_ZERO,W(1,24))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,24),W(1,1),W(1,9),GC_1,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,19),W(1,1),W(1,18),GC_11(IVEC),AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_3_0(W(1,24),W(1,1),W(1,15),GC_50,GC_58,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,16),W(1,1),W(1,18),GC_11(IVEC),AMP(56))
      CALL FFV1P0_3(W(1,21),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,22),W(1,2),W(1,16),GC_11(IVEC),AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,6),W(1,11),W(1,16),GC_11(IVEC),AMP(58))
      CALL FFV1P0_3(W(1,21),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,24))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,22),W(1,1),W(1,24),GC_11(IVEC),AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,6),W(1,14),W(1,24),GC_11(IVEC),AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,20),W(1,2),W(1,16),GC_11(IVEC),AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,6),W(1,4),W(1,16),GC_11(IVEC),AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,20),W(1,1),W(1,24),GC_11(IVEC),AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,6),W(1,10),W(1,24),GC_11(IVEC),AMP(64))
      CALL VVV1P0_1(W(1,5),W(1,8),GC_10(IVEC),ZERO, FK_ZERO,W(1,24))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,7),W(1,11),W(1,24),GC_11(IVEC),AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,12),W(1,2),W(1,24),GC_11(IVEC),AMP(66))
      CALL FFV1_1(W(1,2),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,12),W(1,16),W(1,5),GC_11(IVEC),AMP(67))
      CALL FFV1_2(W(1,7),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 68
      CALL FFV1_0(W(1,21),W(1,11),W(1,5),GC_11(IVEC),AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV1_0(W(1,7),W(1,4),W(1,24),GC_11(IVEC),AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,3),W(1,2),W(1,24),GC_11(IVEC),AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,3),W(1,16),W(1,5),GC_11(IVEC),AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,21),W(1,4),W(1,5),GC_11(IVEC),AMP(72))
      CALL VVV1P0_1(W(1,5),W(1,18),GC_10(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,7),W(1,14),W(1,21),GC_11(IVEC),AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,12),W(1,1),W(1,21),GC_11(IVEC),AMP(74))
      CALL FFV1_1(W(1,1),W(1,18),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 75
      CALL FFV1_0(W(1,12),W(1,16),W(1,5),GC_11(IVEC),AMP(75))
      CALL FFV1_2(W(1,7),W(1,18),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,12),W(1,14),W(1,5),GC_11(IVEC),AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,7),W(1,10),W(1,21),GC_11(IVEC),AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,3),W(1,1),W(1,21),GC_11(IVEC),AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,3),W(1,16),W(1,5),GC_11(IVEC),AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,12),W(1,10),W(1,5),GC_11(IVEC),AMP(80))
      CALL VVV1P0_1(W(1,5),W(1,13),GC_10(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,22),W(1,2),W(1,12),GC_11(IVEC),AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,6),W(1,11),W(1,12),GC_11(IVEC),AMP(82))
      CALL FFV1_1(W(1,2),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,22),W(1,16),W(1,5),GC_11(IVEC),AMP(83))
      CALL FFV1_2(W(1,6),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,3),W(1,11),W(1,5),GC_11(IVEC),AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,20),W(1,2),W(1,12),GC_11(IVEC),AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,6),W(1,4),W(1,12),GC_11(IVEC),AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,20),W(1,16),W(1,5),GC_11(IVEC),AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_11(IVEC),AMP(88))
      CALL VVV1P0_1(W(1,5),W(1,17),GC_10(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 89
      CALL FFV1_0(W(1,22),W(1,1),W(1,3),GC_11(IVEC),AMP(89))
C     Amplitude(s) for diagram number 90
      CALL FFV1_0(W(1,6),W(1,14),W(1,3),GC_11(IVEC),AMP(90))
      CALL FFV1_1(W(1,1),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,22),W(1,4),W(1,5),GC_11(IVEC),AMP(91))
      CALL FFV1_2(W(1,6),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,22))
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,22),W(1,14),W(1,5),GC_11(IVEC),AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,20),W(1,1),W(1,3),GC_11(IVEC),AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,6),W(1,10),W(1,3),GC_11(IVEC),AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,20),W(1,4),W(1,5),GC_11(IVEC),AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,22),W(1,10),W(1,5),GC_11(IVEC),AMP(96))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(48) = AMP(92) +  AMP(96)  ! used 2 times
      TMP_JAMP(47) = AMP(91) +  AMP(95)  ! used 2 times
      TMP_JAMP(46) = AMP(85) +  AMP(86)  ! used 2 times
      TMP_JAMP(45) = AMP(83) +  AMP(87)  ! used 2 times
      TMP_JAMP(44) = AMP(81) +  AMP(82)  ! used 2 times
      TMP_JAMP(43) = AMP(77) +  AMP(78)  ! used 2 times
      TMP_JAMP(42) = AMP(76) +  AMP(80)  ! used 2 times
      TMP_JAMP(41) = AMP(73) +  AMP(74)  ! used 2 times
      TMP_JAMP(40) = AMP(31) +  AMP(32)  ! used 2 times
      TMP_JAMP(39) = AMP(29) +  AMP(30)  ! used 2 times
      TMP_JAMP(38) = AMP(27) +  AMP(28)  ! used 2 times
      TMP_JAMP(37) = AMP(25) +  AMP(26)  ! used 2 times
      TMP_JAMP(36) = AMP(23) +  AMP(24)  ! used 2 times
      TMP_JAMP(35) = AMP(21) +  AMP(22)  ! used 2 times
      TMP_JAMP(34) = AMP(19) +  AMP(20)  ! used 2 times
      TMP_JAMP(33) = AMP(17) +  AMP(18)  ! used 2 times
      TMP_JAMP(32) = AMP(15) +  AMP(16)  ! used 2 times
      TMP_JAMP(31) = AMP(13) +  AMP(14)  ! used 2 times
      TMP_JAMP(30) = AMP(11) +  AMP(12)  ! used 2 times
      TMP_JAMP(29) = AMP(9) +  AMP(10)  ! used 2 times
      TMP_JAMP(28) = AMP(7) +  AMP(8)  ! used 2 times
      TMP_JAMP(27) = AMP(5) +  AMP(6)  ! used 2 times
      TMP_JAMP(26) = AMP(3) +  AMP(4)  ! used 2 times
      TMP_JAMP(25) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(24) = AMP(93) +  AMP(94)  ! used 2 times
      TMP_JAMP(23) = AMP(89) +  AMP(90)  ! used 2 times
      TMP_JAMP(22) = AMP(75) +  AMP(79)  ! used 2 times
      TMP_JAMP(21) = AMP(69) +  AMP(70)  ! used 2 times
      TMP_JAMP(20) = AMP(67) +  AMP(71)  ! used 2 times
      TMP_JAMP(19) = AMP(65) +  AMP(66)  ! used 2 times
      TMP_JAMP(18) = AMP(63) +  AMP(64)  ! used 2 times
      TMP_JAMP(17) = AMP(61) +  AMP(62)  ! used 2 times
      TMP_JAMP(16) = AMP(59) +  AMP(60)  ! used 2 times
      TMP_JAMP(15) = AMP(57) +  AMP(58)  ! used 2 times
      TMP_JAMP(14) = AMP(55) +  AMP(56)  ! used 2 times
      TMP_JAMP(13) = AMP(53) +  AMP(54)  ! used 2 times
      TMP_JAMP(12) = AMP(51) +  AMP(52)  ! used 2 times
      TMP_JAMP(11) = AMP(49) +  AMP(50)  ! used 2 times
      TMP_JAMP(10) = AMP(84) +  AMP(88)  ! used 2 times
      TMP_JAMP(9) = AMP(68) +  AMP(72)  ! used 2 times
      TMP_JAMP(8) = AMP(47) +  AMP(48)  ! used 2 times
      TMP_JAMP(7) = AMP(45) +  AMP(46)  ! used 2 times
      TMP_JAMP(6) = AMP(43) +  AMP(44)  ! used 2 times
      TMP_JAMP(5) = AMP(41) +  AMP(42)  ! used 2 times
      TMP_JAMP(4) = AMP(39) +  AMP(40)  ! used 2 times
      TMP_JAMP(3) = AMP(37) +  AMP(38)  ! used 2 times
      TMP_JAMP(2) = AMP(35) +  AMP(36)  ! used 2 times
      TMP_JAMP(1) = AMP(33) +  AMP(34)  ! used 2 times
      TMP_JAMP(68) = TMP_JAMP(46) +  TMP_JAMP(44)  ! used 2 times
      TMP_JAMP(67) = TMP_JAMP(43) +  TMP_JAMP(41)  ! used 2 times
      TMP_JAMP(66) = TMP_JAMP(40) +  TMP_JAMP(39)  ! used 2 times
      TMP_JAMP(65) = TMP_JAMP(38) +  TMP_JAMP(36)  ! used 2 times
      TMP_JAMP(64) = TMP_JAMP(37) +  TMP_JAMP(35)  ! used 2 times
      TMP_JAMP(63) = TMP_JAMP(34) +  TMP_JAMP(33)  ! used 2 times
      TMP_JAMP(62) = TMP_JAMP(32) +  TMP_JAMP(31)  ! used 2 times
      TMP_JAMP(61) = TMP_JAMP(30) +  TMP_JAMP(29)  ! used 2 times
      TMP_JAMP(60) = TMP_JAMP(28) +  TMP_JAMP(26)  ! used 2 times
      TMP_JAMP(59) = TMP_JAMP(27) +  TMP_JAMP(25)  ! used 2 times
      TMP_JAMP(58) = TMP_JAMP(24) +  TMP_JAMP(23)  ! used 2 times
      TMP_JAMP(57) = TMP_JAMP(21) +  TMP_JAMP(19)  ! used 2 times
      TMP_JAMP(56) = TMP_JAMP(18) +  TMP_JAMP(16)  ! used 2 times
      TMP_JAMP(55) = TMP_JAMP(17) +  TMP_JAMP(15)  ! used 2 times
      TMP_JAMP(54) = TMP_JAMP(14) +  TMP_JAMP(13)  ! used 2 times
      TMP_JAMP(53) = TMP_JAMP(12) +  TMP_JAMP(11)  ! used 2 times
      ...
      TMP_JAMP(77) = TMP_JAMP(64) +  TMP_JAMP(48)  ! used 2 times
      TMP_JAMP(76) = TMP_JAMP(63) +  TMP_JAMP(42)  ! used 2 times
      TMP_JAMP(75) = TMP_JAMP(60) +  TMP_JAMP(45)  ! used 2 times
      TMP_JAMP(74) = TMP_JAMP(59) +  TMP_JAMP(47)  ! used 2 times
      TMP_JAMP(73) = TMP_JAMP(58) - TMP_JAMP(57)  ! used 2 times
      TMP_JAMP(72) = TMP_JAMP(54) +  TMP_JAMP(22)  ! used 2 times
      TMP_JAMP(71) = TMP_JAMP(53) +  TMP_JAMP(20)  ! used 2 times
      TMP_JAMP(70) = TMP_JAMP(50) +  TMP_JAMP(10)  ! used 2 times
      TMP_JAMP(69) = TMP_JAMP(49) +  TMP_JAMP(9)  ! used 2 times
      TMP_JAMP(86) = TMP_JAMP(77) +  TMP_JAMP(66)  ! used 2 times
      TMP_JAMP(85) = TMP_JAMP(76) +  TMP_JAMP(65)  ! used 2 times
      TMP_JAMP(84) = TMP_JAMP(75) +  TMP_JAMP(61)  ! used 2 times
      TMP_JAMP(83) = TMP_JAMP(74) +  TMP_JAMP(62)  ! used 2 times
     ...
     $ *TMP_JAMP(78)+(1.666666666666667D-01)*TMP_JAMP(79)
     $ +(5.000000000000000D-01)*TMP_JAMP(80)+(1.666666666666667D-01)
     $ *TMP_JAMP(81)+(5.000000000000000D-01)*TMP_JAMP(82)
      JAMP(2,1) = ((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(73)+(-5.000000000000000D-01)*TMP_JAMP(79)+(
     $ -1.666666666666667D-01)*TMP_JAMP(80)+(-5.000000000000000D-01)
     ...
     $ -1.666666666666667D-01)*TMP_JAMP(82)+(-1.666666666666667D-01)
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(84)+(5.000000000000000D-01)
