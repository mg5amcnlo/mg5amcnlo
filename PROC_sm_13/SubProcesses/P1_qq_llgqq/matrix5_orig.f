...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_5_1(W(1,1),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,17),W(1,2),W(1,9),GC_2,AMP(10))
...
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,17),W(1,2),W(1,15),-GC_50,GC_58,AMP(12))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,16),W(1,1),W(1,9),GC_2,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,18),W(1,1),W(1,17),GC_11(IVEC),AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,16),W(1,1),W(1,15),-GC_50,GC_58,AMP(16))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,16),W(1,2),W(1,9),GC_2,AMP(49))
...
C     Amplitude(s) for diagram number 51
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,15),-GC_50,GC_58,AMP(51))
