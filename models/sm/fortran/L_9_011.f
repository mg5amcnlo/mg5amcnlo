...
C     number of lorentz index :0
     ...
     $ /SM2/FORTRAN/L_9_011(C,F2,F3,M1,W1,F3)
      IMPLICIT NONE
      DOUBLE PRECISION C
      DOUBLE COMPLEX S1(3)
      DOUBLE COMPLEX F2(6)
     ...
     $ +((P1(0)**2)-(P1(1)**2)-(P1(2)**2)-(P1(3)**2))))
      S1(1)= C*DENOM*((0.000000000D0, 1.000000000D0)*(F3(3)*F2(3))
     $ +(0.000000000D0, 1.000000000D0)*(F3(4)*F2(4)))
      END
