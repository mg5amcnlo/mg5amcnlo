...
C     number of lorentz index :0
      ...
      (0,) --> 1J * ( F3_1 * S1_1 * M2 )
      (1,) --> 1J * ( F3_2 * S1_1 * M2 )
      (2,) --> ( S1_1 * ( ( F3_2 * ( -1J * P2_1 + P2_2 ) ) + ( F3_1 
     $ * ( 1J * P2_0 + -1J * P2_3 ) ) ) )
      (3,) --> ( S1_1 * ( ( F3_1 * ( -1J * P2_1 + (-1+0J) * P2_2 ) ) 
     $ + ( F3_2 * ( 1J * P2_0 + 1J * P2_3 ) ) ) )
     ...
     $ /SM2/FORTRAN/L_8_101(C,F2,F3,M2,W2,F3)
      IMPLICIT NONE
      DOUBLE PRECISION C
      DOUBLE COMPLEX S1(3)
      DOUBLE COMPLEX F2(6)
     ...
     $ +((P2(0)**2)-(P2(1)**2)-(P2(2)**2)-(P2(3)**2))))
      F2(1)= C*DENOM*(0.000000000D0, 1.000000000D0)*(F3(1)*S1(1)*M2)
      F2(2)= C*DENOM*(0.000000000D0, 1.000000000D0)*(F3(2)*S1(1)*M2)
      F2(3)= C*DENOM*(S1(1)*((F3(2)*((0.000000000D0, -1.000000000D0)
     $ *P2(1)+P2(2)))+(F3(1)*((0.000000000D0, 1.000000000D0)*P2(0)
     $ +(0.000000000D0, -1.000000000D0)*P2(3)))))
      F2(4)= C*DENOM*(S1(1)*((F3(1)*((0.000000000D0, -1.000000000D0)
