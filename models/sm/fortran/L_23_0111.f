...
C     number of lorentz index :1
     ...
     $ /SM2/FORTRAN/L_23_0111(C,V1,V2,S3,M1,W1,S4)
      IMPLICIT NONE
      DOUBLE PRECISION C
      DOUBLE COMPLEX V1(6)
      DOUBLE COMPLEX V2(6)
     ...
     $ +((P1(0)**2)-(P1(1)**2)-(P1(2)**2)-(P1(3)**2))))
      V1(1)= C*DENOM*(S3(1)*((OM1*((0.000000000D0, 1.000000000D0)
     ...
     $ -1.000000000D0)*V2(1)))*S4(1))
      V1(2)= C*DENOM*(S3(1)*((OM1*((0.000000000D0, 1.000000000D0)
     $ *(V2(1)*P1(0))+(0.000000000D0, -1.000000000D0)*(V2(2)*P1(1))
     $ +(0.000000000D0, -1.000000000D0)*(V2(3)*P1(2))+(0.000000000D0, 
     $ -1.000000000D0)*(V2(4)*P1(3)))*P1(1))+((0.000000000D0, 
     $ -1.000000000D0)*V2(2)))*S4(1))
      V1(3)= C*DENOM*(S3(1)*((OM1*((0.000000000D0, 1.000000000D0)
     $ *(V2(1)*P1(0))+(0.000000000D0, -1.000000000D0)*(V2(2)*P1(1))
     $ +(0.000000000D0, -1.000000000D0)*(V2(3)*P1(2))+(0.000000000D0, 
     $ -1.000000000D0)*(V2(4)*P1(3)))*P1(2))+((0.000000000D0, 
     $ -1.000000000D0)*V2(3)))*S4(1))
      V1(4)= C*DENOM*(S3(1)*((OM1*((0.000000000D0, 1.000000000D0)
     $ *(V2(1)*P1(0))+(0.000000000D0, -1.000000000D0)*(V2(2)*P1(1))
     $ +(0.000000000D0, -1.000000000D0)*(V2(3)*P1(2))+(0.000000000D0, 
