...
C     number of lorentz index :0
      ...
      (0,) --> ( S1_1 * ( ( F3_4 * ( 1J * P2_1 + (-1+0J) * P2_2 ) ) 
     $ + ( F3_3 * ( 1J * P2_0 + 1J * P2_3 ) ) ) )
      (1,) --> ( S1_1 * ( ( F3_3 * ( 1J * P2_1 + P2_2 ) ) + ( F3_4 
     $ * ( 1J * P2_0 + -1J * P2_3 ) ) ) )
      (2,) --> 1J * ( F3_3 * S1_1 * M2 )
      (3,) --> 1J * ( F3_4 * S1_1 * M2 )
     ...
     $ /SM2/FORTRAN/L_9_101(C,F2,F3,M2,W2,F3)
      IMPLICIT NONE
      DOUBLE PRECISION C
      DOUBLE COMPLEX S1(3)
      DOUBLE COMPLEX F2(6)
     ...
     $ +((P2(0)**2)-(P2(1)**2)-(P2(2)**2)-(P2(3)**2))))
      F2(1)= C*DENOM*(S1(1)*((F3(4)*((0.000000000D0, 1.000000000D0)
     $ *P2(1)+-P2(2)))+(F3(3)*((0.000000000D0, 1.000000000D0)*P2(0)
     $ +(0.000000000D0, 1.000000000D0)*P2(3)))))
      F2(2)= C*DENOM*(S1(1)*((F3(3)*((0.000000000D0, 1.000000000D0)
     $ *P2(1)+P2(2)))+(F3(4)*((0.000000000D0, 1.000000000D0)*P2(0)
     $ +(0.000000000D0, -1.000000000D0)*P2(3)))))
      F2(3)= C*DENOM*(0.000000000D0, 1.000000000D0)*(F3(3)*S1(1)*M2)
      F2(4)= C*DENOM*(0.000000000D0, 1.000000000D0)*(F3(4)*S1(1)*M2)
      END
