...
l_R2vexve1 = Lorentz(name = 'l_R2vexve1',
                     spins = [ 2, 2 ],
                     structure = 'P(-1,2)*Gamma(-1,2,-2)*ProjM(-2,1)')


l_R2epem2 = Lorentz(name = 'l_R2epem2',
                    spins = [ 2, 2 ],
                    structure = 'P(-1,2)*Gamma(-1,2,-2)*ProjP(-2,1)')


l_R2HH3 = Lorentz(name = 'l_R2HH3',
                  spins = [ 1, 1 ],
                  structure = 'P(-1,1)*P(-1,1)')


l_R2AA4 = Lorentz(name = 'l_R2AA4',
                  spins = [ 3, 3 ],
                  structure = 'P(1,1)*P(2,1)')


l_R2AA5 = Lorentz(name = 'l_R2AA5',
                  spins = [ 3, 3 ],
                  structure = 'Metric(1,2)*P(-1,1)*P(-1,1)')


l_R2AG0H6 = Lorentz(name = 'l_R2AG0H6',
                    spins = [ 3, 1, 1 ],
                    structure = 'P(1,2)')


l_R2AG0H7 = Lorentz(name = 'l_R2AG0H7',
                    spins = [ 3, 1, 1 ],
                    structure = 'P(1,3)')