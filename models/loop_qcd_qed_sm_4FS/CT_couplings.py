...
c_UVbxbH1EW = Coupling(name = 'c_UVbxbH1EW',
                       value = '(ee*complex(0,-0.25)*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_R + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + HWcft_UV_EW*MB + 2*bMass_UV_EW + MB*bWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVbxbH2EW = Coupling(name = 'c_UVbxbH2EW',
                       value = '(ee*complex(0,-0.25)*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_L + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + HWcft_UV_EW*MB + 2*bMass_UV_EW + MB*bWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})
...
c_UVbxbG01EW = Coupling(name = 'c_UVbxbG01EW',
                        value = '-(ee*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_R + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + G0Wcft_UV_EW*MB + 2*bMass_UV_EW + bWcft_UV_EW_L*MB))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxbG02EW = Coupling(name = 'c_UVbxbG02EW',
                        value = '(ee*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_L + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + G0Wcft_UV_EW*MB + 2*bMass_UV_EW + bWcft_UV_EW_R*MB))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVbxuGm2EW = Coupling(name = 'c_UVbxuGm2EW',
                        value = '-(ee*CKM13*(-2*MB*SWCoup_UV_EW*MW**2 + MW**2*sw*uWcft_BAR_UV_EW_L*MB + sw*(-WMass2_UV_EW*MB + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + bWcft_UV_EW_R*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVbxcGm2EW = Coupling(name = 'c_UVbxcGm2EW',
                        value = '-(ee*CKM23*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*cWcft_BAR_UV_EW_L + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + bWcft_UV_EW_R*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVbxtGm2EW = Coupling(name = 'c_UVbxtGm2EW',
                        value = '-(ee*CKM33*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*tWcft_BAR_UV_EW_L + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + bWcft_UV_EW_R*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVuxbGp1EW = Coupling(name = 'c_UVuxbGp1EW',
                        value = '(ee*complexconjugate(CKM13)*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_R + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + uWcft_UV_EW_L*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVcxbGp1EW = Coupling(name = 'c_UVcxbGp1EW',
                        value = '(ee*complexconjugate(CKM23)*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_R + sw*(-MB*WMass2_UV_EW + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + cWcft_UV_EW_L*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVtxbGp1EW = Coupling(name = 'c_UVtxbGp1EW',
                        value = '(ee*complexconjugate(CKM33)*(-2*MB*SWCoup_UV_EW*MW**2 + MB*MW**2*sw*bWcft_BAR_UV_EW_R + sw*(-WMass2_UV_EW*MB + MW**2*(2*eCoup_UV_EW*MB + GpWcft_UV_EW*MB + 2*bMass_UV_EW + tWcft_UV_EW_L*MB))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})
