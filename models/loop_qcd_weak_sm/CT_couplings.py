...
R2_GmGpboson1 = Coupling(name = 'R2_GmGpboson1',
                       value = '((MW**2*sw**2/2*(4*lhv-1)+(MZ**2 + MH**2)/8.0+MW**2/(8.0*cw**2)+((6-8*lhv)*cw**4 - 4*cw**2 + (1-4*lhv))/(8.0*cw**4)*MW**2)*(complex(0,1)*R2SS))',
                       order = {'QED':2})

R2_GmGpboson2 = Coupling(name = 'R2_GmGpboson2',
                       value = '((sw**2/6.-1./12.0-1./(24.0*cw**2))*(complex(0,1)*R2SS))',
                       order = {'QED':2})
...
c_UVHHHH1EW = Coupling(name = 'c_UVHHHH1EW',
                       value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW - 4*SWCoup_UV_EW*MH**2*MW**2 + 2*(-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + 2*(eCoup_UV_EW + HWcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.375))/(MW**4*sw**3)',
                       order = {'QED' : 4})

c_UVHHG0G01EW = Coupling(name = 'c_UVHHG0G01EW',
                         value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW + 2*(-2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + (2*eCoup_UV_EW + G0Wcft_UV_EW + HWcft_UV_EW)*MH**2)*MW**2)*sw))*complex(0,-0.125))/(MW**4*sw**3)',
                         order = {'QED' : 4})

c_UVHHGmGp1EW = Coupling(name = 'c_UVHHGmGp1EW',
                         value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW + 2*(-2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + (2*eCoup_UV_EW + GpWcft_UV_EW + HWcft_UV_EW)*MH**2)*MW**2)*sw))*complex(0,-0.125))/(MW**4*sw**3)',
                         order = {'QED' : 4})


c_UVG0G0G0G01EW = Coupling(name = 'c_UVG0G0G0G01EW',
                           value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW - 4*SWCoup_UV_EW*MH**2*MW**2 + 2*(-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + 2*(eCoup_UV_EW + G0Wcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.375))/(MW**4*sw**3)',
                           order = {'QED' : 4})


c_UVG0G0GmGp1EW = Coupling(name = 'c_UVG0G0GmGp1EW',
                           value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW + 2*(-2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + (2*eCoup_UV_EW + G0Wcft_UV_EW + GpWcft_UV_EW)*MH**2)*MW**2)*sw))*complex(0,-0.125))/(MW**4*sw**3)',
                           order = {'QED' : 4})

c_UVGmGmGpGp1EW = Coupling(name = 'c_UVGmGmGpGp1EW',
                           value = '(ee**2*(HiggsTadpole_UV_EW*ee*MW - 4*SWCoup_UV_EW*MH**2*MW**2 + 2*(-(WMass2Coup_UV_EW*MH**2) + (HMass2_UV_EW + 2*(eCoup_UV_EW + GpWcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.25))/(MW**4*sw**3)',
                           order = {'QED' : 4})

c_UVHHH1EW = Coupling(name = 'c_UVHHH1EW',
                      value = '(ee*(HiggsTadpole_UV_EW*ee*MW - 2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (2*HMass2_UV_EW + (2*eCoup_UV_EW + 3*HWcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.75))/(MW**3*sw**2)',
                      order = {'QED' : 3})

c_UVHG0G01EW = Coupling(name = 'c_UVHG0G01EW',
                        value = '(ee*(HiggsTadpole_UV_EW*ee*MW - 2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (2*HMass2_UV_EW + (2*eCoup_UV_EW + 2*G0Wcft_UV_EW + HWcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.25))/(MW**3*sw**2)',
                        order = {'QED' : 3})

c_UVGmHGp1EW = Coupling(name = 'c_UVGmHGp1EW',
                        value = '(ee*(HiggsTadpole_UV_EW*ee*MW - 2*SWCoup_UV_EW*MH**2*MW**2 + (-(WMass2Coup_UV_EW*MH**2) + (2*HMass2_UV_EW + (2*eCoup_UV_EW + 2*GpWcft_UV_EW + HWcft_UV_EW)*MH**2)*MW**2)*sw)*complex(0,-0.25))/(MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVHWpWm1EW = Coupling(name = 'c_UVHWpWm1EW',
                        value = '(ee*MW*(eCoup_UV_EW + (HWcft_UV_EW + 2*WWcft_UV_EW + WMass2Coup_UV_EW/MW**2 - (2*SWCoup_UV_EW)/sw)/2.)*complex(0,1))/sw',
                        order = {'QED' : 3})


c_UVHZZ1EW = Coupling(name = 'c_UVHZZ1EW',
                      value = '(ee*MW*(eCoup_UV_EW + (HWcft_UV_EW + 2*ZZWcft_UV_EW + WMass2Coup_UV_EW/MW**2 - (2*SWCoup_UV_EW)/sw + (4*SWCoup_UV_EW*sw)/cw**2)/2.)*complex(0,1))/(cw**2*sw)',
                      order = {'QED' : 3})
...
c_UVGmWpZ1EW = Coupling(name = 'c_UVGmWpZ1EW',
                        value = '-(ee*(2*SWCoup_UV_EW*MW**2 + cw**2*(cw*AZWcft_UV_EW*MW**2 + (WMass2Coup_UV_EW + (2*eCoup_UV_EW + GpWcft_UV_EW + WWcft_UV_EW + ZZWcft_UV_EW)*MW**2)*sw)))/(2.*cw**3*MW)',
                        order = {'QED' : 3})
...
c_UVGmWpA1EW = Coupling(name = 'c_UVGmWpA1EW',
                        value = '(ee*(cw*(WMass2Coup_UV_EW + (AAWcft_UV_EW + 2*eCoup_UV_EW + GpWcft_UV_EW + WWcft_UV_EW)*MW**2) + ZAWcft_UV_EW*MW**2*sw))/(2.*cw*MW)',
                        order = {'QED' : 3})
...
c_UVepemH1EW = Coupling(name = 'c_UVepemH1EW',
                        value = '(ee*Me*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(eWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + eWcft_UV_EW_L))))/(MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVepemH2EW = Coupling(name = 'c_UVepemH2EW',
                        value = '(ee*Me*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(eWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + eWcft_UV_EW_R))))/(MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVmpmmH1EW = Coupling(name = 'c_UVmpmmH1EW',
                        value = '(ee*MM*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(muWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + muWcft_UV_EW_L))))/(MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVmpmmH2EW = Coupling(name = 'c_UVmpmmH2EW',
                        value = '(ee*MM*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(muWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + muWcft_UV_EW_R))))/(MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVttpttmH1EW = Coupling(name = 'c_UVttpttmH1EW',
                          value = '(ee*MTA*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tauWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + tauWcft_UV_EW_L))))/(MW**3*sw**2)',
                          order = {'QED' : 3})


c_UVttpttmH2EW = Coupling(name = 'c_UVttpttmH2EW',
                          value = '(ee*MTA*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tauWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + tauWcft_UV_EW_R))))/(MW**3*sw**2)',
                          order = {'QED' : 3})


c_UVuxuH1EW = Coupling(name = 'c_UVuxuH1EW',
                       value = '(ee*MU*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + uWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVuxuH2EW = Coupling(name = 'c_UVuxuH2EW',
                       value = '(ee*MU*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + uWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})
...
c_UVcxcH1EW = Coupling(name = 'c_UVcxcH1EW',
                       value = '(ee*MC*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + cWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVcxcH2EW = Coupling(name = 'c_UVcxcH2EW',
                       value = '(ee*MC*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + cWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})
...
c_UVtxtH1EW = Coupling(name = 'c_UVtxtH1EW',
                       value = '(ee*complex(0,-0.25)*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_R) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + HWcft_UV_EW*MT + 2*tMass_UV_EW + MT*tWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVtxtH2EW = Coupling(name = 'c_UVtxtH2EW',
                       value = '(ee*complex(0,-0.25)*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_L) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + HWcft_UV_EW*MT + 2*tMass_UV_EW + MT*tWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVdxdH1EW = Coupling(name = 'c_UVdxdH1EW',
                       value = '(ee*MD*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + dWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVdxdH2EW = Coupling(name = 'c_UVdxdH2EW',
                       value = '(ee*MD*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + dWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})
...
c_UVsxsH1EW = Coupling(name = 'c_UVsxsH1EW',
                       value = '(ee*MS*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + sWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVsxsH2EW = Coupling(name = 'c_UVsxsH2EW',
                       value = '(ee*MS*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + sWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})
...
c_UVbxbH1EW = Coupling(name = 'c_UVbxbH1EW',
                       value = '(ee*MB*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + bWcft_UV_EW_L))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVbxbH2EW = Coupling(name = 'c_UVbxbH2EW',
                       value = '(ee*MB*complex(0,-0.25)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + HWcft_UV_EW + bWcft_UV_EW_R))))/(MW**3*sw**2)',
                       order = {'QED' : 3})


c_UVepemG01EW = Coupling(name = 'c_UVepemG01EW',
                         value = '-(ee*Me*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(eWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + eWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVepemG02EW = Coupling(name = 'c_UVepemG02EW',
                         value = '(ee*Me*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(eWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + eWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVmpmmG01EW = Coupling(name = 'c_UVmpmmG01EW',
                         value = '-(ee*MM*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(muWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + muWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVmpmmG02EW = Coupling(name = 'c_UVmpmmG02EW',
                         value = '(ee*MM*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(muWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + muWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVttpttmG01EW = Coupling(name = 'c_UVttpttmG01EW',
                           value = '-(ee*MTA*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tauWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + tauWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                           order = {'QED' : 3})


c_UVttpttmG02EW = Coupling(name = 'c_UVttpttmG02EW',
                           value = '(ee*MTA*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tauWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + tauWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                           order = {'QED' : 3})


c_UVuxuG01EW = Coupling(name = 'c_UVuxuG01EW',
                        value = '(ee*MU*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + uWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxuG02EW = Coupling(name = 'c_UVuxuG02EW',
                        value = '-(ee*MU*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + uWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVcxcG01EW = Coupling(name = 'c_UVcxcG01EW',
                        value = '(ee*MC*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + cWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxcG02EW = Coupling(name = 'c_UVcxcG02EW',
                        value = '-(ee*MC*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + cWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVtxtG01EW = Coupling(name = 'c_UVtxtG01EW',
                        value = '(ee*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_R) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + G0Wcft_UV_EW*MT + 2*tMass_UV_EW + MT*tWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxtG02EW = Coupling(name = 'c_UVtxtG02EW',
                        value = '-(ee*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_L) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + G0Wcft_UV_EW*MT + 2*tMass_UV_EW + MT*tWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxdG01EW = Coupling(name = 'c_UVdxdG01EW',
                        value = '-(ee*MD*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + dWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxdG02EW = Coupling(name = 'c_UVdxdG02EW',
                        value = '(ee*MD*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + dWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVsxsG01EW = Coupling(name = 'c_UVsxsG01EW',
                        value = '-(ee*MS*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + sWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxsG02EW = Coupling(name = 'c_UVsxsG02EW',
                        value = '(ee*MS*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + sWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})
...
c_UVbxbG01EW = Coupling(name = 'c_UVbxbG01EW',
                        value = '-(ee*MB*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + bWcft_UV_EW_L))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxbG02EW = Coupling(name = 'c_UVbxbG02EW',
                        value = '(ee*MB*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + G0Wcft_UV_EW + bWcft_UV_EW_R))))/(4.*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxuGm1EW = Coupling(name = 'c_UVdxuGm1EW',
                        value = '(ee*MU*CKM11*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + dWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxuGm2EW = Coupling(name = 'c_UVdxuGm2EW',
                        value = '-(ee*MD*CKM11*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + dWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxuGm1EW = Coupling(name = 'c_UVsxuGm1EW',
                        value = '(ee*MU*CKM12*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + sWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxuGm2EW = Coupling(name = 'c_UVsxuGm2EW',
                        value = '-(ee*MS*CKM12*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + sWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxuGm1EW = Coupling(name = 'c_UVbxuGm1EW',
                        value = '(ee*MU*CKM13*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + bWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxuGm2EW = Coupling(name = 'c_UVbxuGm2EW',
                        value = '-(ee*MB*CKM13*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(uWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + bWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxcGm1EW = Coupling(name = 'c_UVdxcGm1EW',
                        value = '(ee*MC*CKM21*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + dWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxcGm2EW = Coupling(name = 'c_UVdxcGm2EW',
                        value = '-(ee*MD*CKM21*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + dWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxcGm1EW = Coupling(name = 'c_UVsxcGm1EW',
                        value = '(ee*MC*CKM22*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + sWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxcGm2EW = Coupling(name = 'c_UVsxcGm2EW',
                        value = '-(ee*MS*CKM22*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + sWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxcGm1EW = Coupling(name = 'c_UVbxcGm1EW',
                        value = '(ee*MC*CKM23*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + bWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxcGm2EW = Coupling(name = 'c_UVbxcGm2EW',
                        value = '-(ee*MB*CKM23*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(cWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + bWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxtGm1EW = Coupling(name = 'c_UVdxtGm1EW',
                        value = '(ee*CKM31*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_R) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*dWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVdxtGm2EW = Coupling(name = 'c_UVdxtGm2EW',
                        value = '-(ee*MD*CKM31*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + dWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxtGm1EW = Coupling(name = 'c_UVsxtGm1EW',
                        value = '(ee*CKM32*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_R) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*sWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVsxtGm2EW = Coupling(name = 'c_UVsxtGm2EW',
                        value = '-(ee*MS*CKM32*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + sWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxtGm1EW = Coupling(name = 'c_UVbxtGm1EW',
                        value = '(ee*CKM33*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(tWcft_UV_EW_R) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*bWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVbxtGm2EW = Coupling(name = 'c_UVbxtGm2EW',
                        value = '-(ee*MB*CKM33*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + bWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxdGp1EW = Coupling(name = 'c_UVuxdGp1EW',
                        value = '(ee*MD*complexconjugate(CKM11)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + uWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxdGp2EW = Coupling(name = 'c_UVuxdGp2EW',
                        value = '-(ee*MU*complexconjugate(CKM11)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + uWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxdGp1EW = Coupling(name = 'c_UVcxdGp1EW',
                        value = '(ee*MD*complexconjugate(CKM21)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + cWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxdGp2EW = Coupling(name = 'c_UVcxdGp2EW',
                        value = '-(ee*MC*complexconjugate(CKM21)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + cWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxdGp1EW = Coupling(name = 'c_UVtxdGp1EW',
                        value = '(ee*MD*complexconjugate(CKM31)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxdGp2EW = Coupling(name = 'c_UVtxdGp2EW',
                        value = '-(ee*MT*complexconjugate(CKM31)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(dWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxsGp1EW = Coupling(name = 'c_UVuxsGp1EW',
                        value = '(ee*MS*complexconjugate(CKM12)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + uWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxsGp2EW = Coupling(name = 'c_UVuxsGp2EW',
                        value = '-(ee*MU*complexconjugate(CKM12)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + uWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxsGp1EW = Coupling(name = 'c_UVcxsGp1EW',
                        value = '(ee*MS*complexconjugate(CKM22)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + cWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxsGp2EW = Coupling(name = 'c_UVcxsGp2EW',
                        value = '-(ee*MC*complexconjugate(CKM22)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + cWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxsGp1EW = Coupling(name = 'c_UVtxsGp1EW',
                        value = '(ee*MS*complexconjugate(CKM32)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxsGp2EW = Coupling(name = 'c_UVtxsGp2EW',
                        value = '-(ee*MT*complexconjugate(CKM32)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(sWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxbGp1EW = Coupling(name = 'c_UVuxbGp1EW',
                        value = '(ee*MB*complexconjugate(CKM13)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + uWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVuxbGp2EW = Coupling(name = 'c_UVuxbGp2EW',
                        value = '-(ee*MU*complexconjugate(CKM13)*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(bWcft_UV_EW_L) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*uWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MT*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxbGp1EW = Coupling(name = 'c_UVcxbGp1EW',
                        value = '(ee*MB*complexconjugate(CKM23)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + cWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVcxbGp2EW = Coupling(name = 'c_UVcxbGp2EW',
                        value = '-(ee*MC*complexconjugate(CKM23)*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(bWcft_UV_EW_L) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*cWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MT*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxbGp1EW = Coupling(name = 'c_UVtxbGp1EW',
                        value = '(ee*MB*complexconjugate(CKM33)*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(bWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVtxbGp2EW = Coupling(name = 'c_UVtxbGp2EW',
                        value = '-(ee*complexconjugate(CKM33)*(-2*SWCoup_UV_EW*MT*MW**2 + MT*MW**2*sw*complexconjugate(bWcft_UV_EW_L) + sw*(-(WMass2Coup_UV_EW*MT) + MW**2*(2*eCoup_UV_EW*MT + GpWcft_UV_EW*MT + 2*tMass_UV_EW + MT*tWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                        order = {'QED' : 3})


c_UVepveGm1EW = Coupling(name = 'c_UVepveGm1EW',
                         value = '-(ee*Me*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(veWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + eWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVmpvmGm1EW = Coupling(name = 'c_UVmpvmGm1EW',
                         value = '-(ee*MM*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(vmWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + muWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                         order = {'QED' : 3})


c_UVttpvtGm1EW = Coupling(name = 'c_UVttpvtGm1EW',
                          value = '-(ee*MTA*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(vtWcft_UV_EW_L) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + tauWcft_UV_EW_R))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                          order = {'QED' : 3})


c_UVvexemGp1EW = Coupling(name = 'c_UVvexemGp1EW',
                          value = '(ee*Me*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(eWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + veWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                          order = {'QED' : 3})


c_UVvmxmmGp1EW = Coupling(name = 'c_UVvmxmmGp1EW',
                          value = '(ee*MM*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(muWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + vmWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                          order = {'QED' : 3})


c_UVvtxttmGp1EW = Coupling(name = 'c_UVvtxttmGp1EW',
                           value = '(ee*MTA*(-2*SWCoup_UV_EW*MW**2 + MW**2*sw*complexconjugate(tauWcft_UV_EW_R) + sw*(-WMass2Coup_UV_EW + MW**2*(2*eCoup_UV_EW + GpWcft_UV_EW + vtWcft_UV_EW_L))))/(2.*cmath.sqrt(2)*MW**3*sw**2)',
                           order = {'QED' : 3})
...
# add on coupling for R2 in weak

c_R2vexve1Weak = Coupling(name = 'c_R2vexve1Weak',
                          value = '((1 + 1/(2.*cw**2))*ee**2*lhv*complex(0,-0.03125))/(cmath.pi**2*sw**2)',
                          order = {'QED' : 2})


c_R2epem1Weak = Coupling(name = 'c_R2epem1Weak',
                         value = '((-1 + 2*cw**2)*ee**2*lhv*Me*complex(0,-0.0625))/(cw**2*cmath.pi**2)',
                         order = {'QED' : 2})


c_R2epem3Weak = Coupling(name = 'c_R2epem3Weak',
                         value = '(ee**2*lhv*(-1 + cw**2*(-2 + 4*sw**2))*complex(0,0.015625))/(cw**2*cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2epem4Weak = Coupling(name = 'c_R2epem4Weak',
                         value = '((-1 + cw**2)*ee**2*lhv*complex(0,0.0625))/(cw**2*cmath.pi**2)',
                         order = {'QED' : 2})


c_R2mpmm1Weak = Coupling(name = 'c_R2mpmm1Weak',
                         value = '((-1 + 2*cw**2)*ee**2*lhv*MM*complex(0,-0.0625))/(cw**2*cmath.pi**2)',
                         order = {'QED' : 2})


c_R2ttpttm1Weak = Coupling(name = 'c_R2ttpttm1Weak',
                           value = '((-1 + 2*cw**2)*ee**2*lhv*MTA*complex(0,-0.0625))/(cw**2*cmath.pi**2)',
                           order = {'QED' : 2})


c_R2uxu1Weak = Coupling(name = 'c_R2uxu1Weak',
                        value = '((-1 + 4*cw**2)*ee**2*lhv*MU*complex(0,-0.013888888888888888))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2uxu3Weak = Coupling(name = 'c_R2uxu3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 16*cw**2*sw**2 - 18*cw**2*CKM11*complexconjugate(CKM11) - 18*cw**2*CKM12*complexconjugate(CKM12) - 18*cw**2*CKM13*complexconjugate(CKM13)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2uxu4Weak = Coupling(name = 'c_R2uxu4Weak',
                        value = '((-1 + cw**2)*ee**2*lhv*complex(0,0.027777777777777776))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2cxc1Weak = Coupling(name = 'c_R2cxc1Weak',
                        value = '((-1 + 4*cw**2)*ee**2*lhv*MC*complex(0,-0.013888888888888888))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2cxc3Weak = Coupling(name = 'c_R2cxc3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 16*cw**2*sw**2 - 18*cw**2*CKM21*complexconjugate(CKM21) - 18*cw**2*CKM22*complexconjugate(CKM22) - 18*cw**2*CKM23*complexconjugate(CKM23)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2txt1Weak = Coupling(name = 'c_R2txt1Weak',
                        value = '((-1 + 4*cw**2)*ee**2*lhv*MT*complex(0,-0.013888888888888888))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2txt3Weak = Coupling(name = 'c_R2txt3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 16*cw**2*sw**2 - 18*cw**2*CKM31*complexconjugate(CKM31) - 18*cw**2*CKM32*complexconjugate(CKM32) - 18*cw**2*CKM33*complexconjugate(CKM33)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2dxd1Weak = Coupling(name = 'c_R2dxd1Weak',
                        value = '((1 + 2*cw**2)*ee**2*lhv*MD*complex(0,-0.006944444444444444))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2dxd3Weak = Coupling(name = 'c_R2dxd3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 4*cw**2*sw**2 - 18*cw**2*CKM11*complexconjugate(CKM11) - 18*cw**2*CKM21*complexconjugate(CKM21) - 18*cw**2*CKM31*complexconjugate(CKM31)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2dxd4Weak = Coupling(name = 'c_R2dxd4Weak',
                        value = '((-1 + cw**2)*ee**2*lhv*complex(0,0.006944444444444444))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2sxs1Weak = Coupling(name = 'c_R2sxs1Weak',
                        value = '((1 + 2*cw**2)*ee**2*lhv*MS*complex(0,-0.006944444444444444))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2sxs3Weak = Coupling(name = 'c_R2sxs3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 4*cw**2*sw**2 - 18*cw**2*CKM12*complexconjugate(CKM12) - 18*cw**2*CKM22*complexconjugate(CKM22) - 18*cw**2*CKM32*complexconjugate(CKM32)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2bxb1Weak = Coupling(name = 'c_R2bxb1Weak',
                        value = '((1 + 2*cw**2)*ee**2*lhv*MB*complex(0,-0.006944444444444444))/(cw**2*cmath.pi**2)',
                        order = {'QED' : 2})


c_R2bxb3Weak = Coupling(name = 'c_R2bxb3Weak',
                        value = '(ee**2*lhv*complex(0,0.001736111111111111)*(-9 + 8*sw**2 + 4*cw**2*sw**2 - 18*cw**2*CKM13*complexconjugate(CKM13) - 18*cw**2*CKM23*complexconjugate(CKM23) - 18*cw**2*CKM33*complexconjugate(CKM33)))/(cw**2*cmath.pi**2*sw**2)',
                        order = {'QED' : 2})


c_R2HH1Weak = Coupling(name = 'c_R2HH1Weak',
                       value = '(ee**2*((1 - 6*lhv)*MW**4 + 2*cw**4*(2*Me**4 + 2*MM**4 + 2*MTA**4 + MW**4 - 6*lhv*MW**4 + 2*MB**4*Ncol + 2*MC**4*Ncol + 2*MD**4*Ncol + 2*MS**4*Ncol + 2*MT**4*Ncol + 2*MU**4*Ncol))*complex(0,0.015625))/(cw**4*MW**2*cmath.pi**2*sw**2)',
                       order = {'QED' : 2})


c_R2HH2Weak = Coupling(name = 'c_R2HH2Weak',
                       value = '(ee**2*(MW**2 + 2*cw**2*(2*Me**2 + 2*MM**2 + 2*MTA**2 + MW**2 + 2*MB**2*Ncol + 2*MC**2*Ncol + 2*MD**2*Ncol + 2*MS**2*Ncol + 2*MT**2*Ncol + 2*MU**2*Ncol))*complex(0,-0.0026041666666666665))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                       order = {'QED' : 2})


c_R2G0G01Weak = Coupling(name = 'c_R2G0G01Weak',
                         value = '(ee**2*(cw**2*MH**2*MW**2 - 4*lhv*MW**4 + cw**4*(8*Me**4 + 8*MM**4 + 8*MTA**4 + 6*MW**4 - 8*lhv*MW**4 + 8*MB**4*Ncol + 8*MC**4*Ncol + 8*MD**4*Ncol + 8*MS**4*Ncol + 8*MT**4*Ncol + 8*MU**4*Ncol))*complex(0,0.0078125))/(cw**4*MW**2*cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2GmGp1Weak = Coupling(name = 'c_R2GmGp1Weak',
                         value = '(ee**2*complex(0,0.0078125)*(4*cw**4*Me**4 + 4*cw**4*MM**4 + 4*cw**4*MTA**4 + cw**4*MH**2*MW**2 + MW**4 - 2*cw**2*MW**4 + 6*cw**4*MW**4 - 4*lhv*MW**4 - 8*cw**4*lhv*MW**4 - 4*cw**4*MW**4*sw**2 + 16*cw**4*lhv*MW**4*sw**2 + 4*cw**4*(MD**2 + MU**2)**2*Ncol*CKM11*complexconjugate(CKM11) + 4*cw**4*(MS**2 + MU**2)**2*Ncol*CKM12*complexconjugate(CKM12) + 4*cw**4*MB**4*Ncol*CKM13*complexconjugate(CKM13) + 8*cw**4*MB**2*MU**2*Ncol*CKM13*complexconjugate(CKM13) + 4*cw**4*MU**4*Ncol*CKM13*complexconjugate(CKM13) + 4*cw**4*MC**4*Ncol*CKM21*complexconjugate(CKM21) + 8*cw**4*MC**2*MD**2*Ncol*CKM21*complexconjugate(CKM21) + 4*cw**4*MD**4*Ncol*CKM21*complexconjugate(CKM21) + 4*cw**4*MC**4*Ncol*CKM22*complexconjugate(CKM22) + 8*cw**4*MC**2*MS**2*Ncol*CKM22*complexconjugate(CKM22) + 4*cw**4*MS**4*Ncol*CKM22*complexconjugate(CKM22) + 4*cw**4*MB**4*Ncol*CKM23*complexconjugate(CKM23) + 8*cw**4*MB**2*MC**2*Ncol*CKM23*complexconjugate(CKM23) + 4*cw**4*MC**4*Ncol*CKM23*complexconjugate(CKM23) + 4*cw**4*MD**4*Ncol*CKM31*complexconjugate(CKM31) + 8*cw**4*MD**2*MT**2*Ncol*CKM31*complexconjugate(CKM31) + 4*cw**4*MT**4*Ncol*CKM31*complexconjugate(CKM31) + 4*cw**4*MS**4*Ncol*CKM32*complexconjugate(CKM32) + 8*cw**4*MS**2*MT**2*Ncol*CKM32*complexconjugate(CKM32) + 4*cw**4*MT**4*Ncol*CKM32*complexconjugate(CKM32) + 4*cw**4*MB**4*Ncol*CKM33*complexconjugate(CKM33) + 8*cw**4*MB**2*MT**2*Ncol*CKM33*complexconjugate(CKM33) + 4*cw**4*MT**4*Ncol*CKM33*complexconjugate(CKM33)))/(cw**4*MW**2*cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2GmGp2Weak = Coupling(name = 'c_R2GmGp2Weak',
                         value = '(ee**2*complex(0,-0.0026041666666666665)*(4*cw**2*Me**2 + 4*cw**2*MM**2 + 4*cw**2*MTA**2 + MW**2 + 2*cw**2*MW**2 - 4*cw**2*MW**2*sw**2 + 4*cw**2*(MD**2 + MU**2)*Ncol*CKM11*complexconjugate(CKM11) + 4*cw**2*(MS**2 + MU**2)*Ncol*CKM12*complexconjugate(CKM12) + 4*cw**2*MB**2*Ncol*CKM13*complexconjugate(CKM13) + 4*cw**2*MU**2*Ncol*CKM13*complexconjugate(CKM13) + 4*cw**2*MC**2*Ncol*CKM21*complexconjugate(CKM21) + 4*cw**2*MD**2*Ncol*CKM21*complexconjugate(CKM21) + 4*cw**2*MC**2*Ncol*CKM22*complexconjugate(CKM22) + 4*cw**2*MS**2*Ncol*CKM22*complexconjugate(CKM22) + 4*cw**2*MB**2*Ncol*CKM23*complexconjugate(CKM23) + 4*cw**2*MC**2*Ncol*CKM23*complexconjugate(CKM23) + 4*cw**2*MD**2*Ncol*CKM31*complexconjugate(CKM31) + 4*cw**2*MT**2*Ncol*CKM31*complexconjugate(CKM31) + 4*cw**2*MS**2*Ncol*CKM32*complexconjugate(CKM32) + 4*cw**2*MT**2*Ncol*CKM32*complexconjugate(CKM32) + 4*cw**2*MB**2*Ncol*CKM33*complexconjugate(CKM33) + 4*cw**2*MT**2*Ncol*CKM33*complexconjugate(CKM33)))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2AA1Weak = Coupling(name = 'c_R2AA1Weak',
                       value = '(ee**2*lhv*complex(0,-0.041666666666666664))/cmath.pi**2',
                       order = {'QED' : 2})


c_R2AA2Weak = Coupling(name = 'c_R2AA2Weak',
                       value = '(ee**2*(18*Me**2 + 18*MM**2 + 18*MTA**2 + 9*MW**2 + 2*MB**2*Ncol + 8*MC**2*Ncol + 2*MD**2*Ncol + 2*MS**2*Ncol + 8*MT**2*Ncol + 8*MU**2*Ncol)*complex(0,-0.013888888888888888))/cmath.pi**2',
                       order = {'QED' : 2})


c_R2AA3Weak = Coupling(name = 'c_R2AA3Weak',
                       value = '(ee**2*(21 + 6*lhv + 10*Ncol)*complex(0,0.006944444444444444))/cmath.pi**2',
                       order = {'QED' : 2})


c_R2AZ1Weak = Coupling(name = 'c_R2AZ1Weak',
                       value = '(cw*ee**2*lhv*complex(0,-0.041666666666666664))/(cmath.pi**2*sw)',
                       order = {'QED' : 2})


c_R2AZ2Weak = Coupling(name = 'c_R2AZ2Weak',
                       value = '(ee**2*(-9*MTA**2 - 18*cw**2*MW**2 - 3*MB**2*Ncol - 6*MC**2*Ncol - 3*MD**2*Ncol - 3*MS**2*Ncol - 6*MT**2*Ncol - 6*MU**2*Ncol + 36*MTA**2*sw**2 + 4*MB**2*Ncol*sw**2 + 16*MC**2*Ncol*sw**2 + 4*MD**2*Ncol*sw**2 + 4*MS**2*Ncol*sw**2 + 16*MT**2*Ncol*sw**2 + 16*MU**2*Ncol*sw**2 + 9*Me**2*(-1 + 4*sw**2) + 9*MM**2*(-1 + 4*sw**2))*complex(0,0.006944444444444444))/(cw*cmath.pi**2*sw)',
                       order = {'QED' : 2})


c_R2AZ3Weak = Coupling(name = 'c_R2AZ3Weak',
                       value = '(ee**2*(9 + 6*cw**2*(1 + 2*lhv) - 36*sw**2 + Ncol*(9 - 20*sw**2))*complex(0,0.003472222222222222))/(cw*cmath.pi**2*sw)',
                       order = {'QED' : 2})


c_R2ZZ1Weak = Coupling(name = 'c_R2ZZ1Weak',
                       value = '(cw**2*ee**2*lhv*complex(0,-0.041666666666666664))/(cmath.pi**2*sw**2)',
                       order = {'QED' : 2})


c_R2ZZ2Weak = Coupling(name = 'c_R2ZZ2Weak',
                       value = '(ee**2*(9*MTA**2 + 36*cw**4*MW**2 + 9*MB**2*Ncol + 9*MC**2*Ncol + 9*MD**2*Ncol + 9*MS**2*Ncol + 9*MT**2*Ncol + 9*MU**2*Ncol - 36*MTA**2*sw**2 - 12*MB**2*Ncol*sw**2 - 24*MC**2*Ncol*sw**2 - 12*MD**2*Ncol*sw**2 - 12*MS**2*Ncol*sw**2 - 24*MT**2*Ncol*sw**2 - 24*MU**2*Ncol*sw**2 + 72*MTA**2*sw**4 + 8*MB**2*Ncol*sw**4 + 32*MC**2*Ncol*sw**4 + 8*MD**2*Ncol*sw**4 + 8*MS**2*Ncol*sw**4 + 32*MT**2*Ncol*sw**4 + 32*MU**2*Ncol*sw**4 + 9*Me**2*(1 - 4*sw**2 + 8*sw**4) + 9*MM**2*(1 - 4*sw**2 + 8*sw**4))*complex(0,-0.003472222222222222))/(cw**2*cmath.pi**2*sw**2)',
                       order = {'QED' : 2})


c_R2ZZ3Weak = Coupling(name = 'c_R2ZZ3Weak',
                       value = '(ee**2*(6*cw**4*(1 + 2*lhv) + 9*(1 - 2*sw**2 + 4*sw**4) + Ncol*(9 - 18*sw**2 + 20*sw**4))*complex(0,0.003472222222222222))/(cw**2*cmath.pi**2*sw**2)',
                       order = {'QED' : 2})


c_R2WmWp1Weak = Coupling(name = 'c_R2WmWp1Weak',
                         value = '(ee**2*lhv*(-1 + sw**2)*complex(0,0.041666666666666664))/(cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2WmWp2Weak = Coupling(name = 'c_R2WmWp2Weak',
                         value = '(ee**2*complex(0,-0.03125)*(Me**2 + MM**2 + MTA**2 + 4*MW**2 - 2*MW**2*sw**2 - 4*lhv*MW**2*sw**2 + (MD**2 + MU**2)*Ncol*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*Ncol*CKM12*complexconjugate(CKM12) + MB**2*Ncol*CKM13*complexconjugate(CKM13) + MU**2*Ncol*CKM13*complexconjugate(CKM13) + MC**2*Ncol*CKM21*complexconjugate(CKM21) + MD**2*Ncol*CKM21*complexconjugate(CKM21) + MC**2*Ncol*CKM22*complexconjugate(CKM22) + MS**2*Ncol*CKM22*complexconjugate(CKM22) + MB**2*Ncol*CKM23*complexconjugate(CKM23) + MC**2*Ncol*CKM23*complexconjugate(CKM23) + MD**2*Ncol*CKM31*complexconjugate(CKM31) + MT**2*Ncol*CKM31*complexconjugate(CKM31) + MS**2*Ncol*CKM32*complexconjugate(CKM32) + MT**2*Ncol*CKM32*complexconjugate(CKM32) + MB**2*Ncol*CKM33*complexconjugate(CKM33) + MT**2*Ncol*CKM33*complexconjugate(CKM33)))/(cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2WmWp3Weak = Coupling(name = 'c_R2WmWp3Weak',
                         value = '(ee**2*complex(0,-0.010416666666666666)*(-5 - 4*lhv + 2*sw**2 + 4*lhv*sw**2 - Ncol*CKM11*complexconjugate(CKM11) - Ncol*CKM12*complexconjugate(CKM12) - Ncol*CKM13*complexconjugate(CKM13) - Ncol*CKM21*complexconjugate(CKM21) - Ncol*CKM22*complexconjugate(CKM22) - Ncol*CKM23*complexconjugate(CKM23) - Ncol*CKM31*complexconjugate(CKM31) - Ncol*CKM32*complexconjugate(CKM32) - Ncol*CKM33*complexconjugate(CKM33)))/(cmath.pi**2*sw**2)',
                         order = {'QED' : 2})


c_R2vexveA1Weak = Coupling(name = 'c_R2vexveA1Weak',
                           value = '(ee**3*Me**2*complex(0,0.015625))/(MW**2*cmath.pi**2*sw**2)',
                           order = {'QED' : 3})


c_R2vexveZ1Weak = Coupling(name = 'c_R2vexveZ1Weak',
                           value = '(ee**3*(2*cw**2*Me**2*sw**2 + (1 + lhv)*MW**2*(1 + 4*cw**4 + cw**2*(-2 + 4*sw**2)))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2epveGm1Weak = Coupling(name = 'c_R2epveGm1Weak',
                           value = '0',
                           order = {'QED' : 0})


c_R2epveGm2Weak = Coupling(name = 'c_R2epveGm2Weak',
                           value = '(ee**3*Me*((9 + 8*lhv)*sw**2 + cw**2*(3 - 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2epveWm1Weak = Coupling(name = 'c_R2epveWm1Weak',
                           value = '(ee**3*(1 + lhv)*(1 - 2*sw**2 + 4*cw**2*(-1 + sw**2))*complex(0,0.015625))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2mpveGm2Weak = Coupling(name = 'c_R2mpveGm2Weak',
                           value = '(ee**3*MM*((9 + 8*lhv)*sw**2 + cw**2*(3 - 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2ttpveGm2Weak = Coupling(name = 'c_R2ttpveGm2Weak',
                            value = '(ee**3*MTA*((9 + 8*lhv)*sw**2 + cw**2*(3 - 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                            order = {'QED' : 3})


c_R2vmxvmA1Weak = Coupling(name = 'c_R2vmxvmA1Weak',
                           value = '(ee**3*MM**2*complex(0,0.015625))/(MW**2*cmath.pi**2*sw**2)',
                           order = {'QED' : 3})


c_R2vmxvmZ1Weak = Coupling(name = 'c_R2vmxvmZ1Weak',
                           value = '(ee**3*(2*cw**2*MM**2*sw**2 + (1 + lhv)*MW**2*(1 + 4*cw**4 + cw**2*(-2 + 4*sw**2)))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2vtxvtA1Weak = Coupling(name = 'c_R2vtxvtA1Weak',
                           value = '(ee**3*MTA**2*complex(0,0.015625))/(MW**2*cmath.pi**2*sw**2)',
                           order = {'QED' : 3})


c_R2vtxvtZ1Weak = Coupling(name = 'c_R2vtxvtZ1Weak',
                           value = '(ee**3*(2*cw**2*MTA**2*sw**2 + (1 + lhv)*MW**2*(1 + 4*cw**4 + cw**2*(-2 + 4*sw**2)))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2vexemGp1Weak = Coupling(name = 'c_R2vexemGp1Weak',
                            value = '(ee**3*Me*(-((9 + 8*lhv)*sw**2) + cw**2*(-3 + 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                            order = {'QED' : 3})


c_R2epemH1Weak = Coupling(name = 'c_R2epemH1Weak',
                          value = '(ee**3*Me*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2))*complex(0,-0.00390625))/(cw**2*MW*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2epemG01Weak = Coupling(name = 'c_R2epemG01Weak',
                           value = '-(ee**3*Me*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2epemG02Weak = Coupling(name = 'c_R2epemG02Weak',
                           value = '(ee**3*Me*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2epemA1Weak = Coupling(name = 'c_R2epemA1Weak',
                          value = '(ee**3*((1 + lhv)*MW**2 + cw**2*(Me**2 - 2*(1 + lhv)*MW**2*(-1 + 2*sw**2)))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                          order = {'QED' : 3})


c_R2epemA2Weak = Coupling(name = 'c_R2epemA2Weak',
                          value = '(ee**3*(4*(1 + lhv)*MW**2*sw**2 + cw**2*(Me**2 - 4*(1 + lhv)*MW**2*sw**2))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                          order = {'QED' : 3})


c_R2epemZ1Weak = Coupling(name = 'c_R2epemZ1Weak',
                          value = '(ee**3*(2*cw**2*Me**2*sw**2 + (1 - 2*cw**2 + 4*cw**4)*(1 + lhv)*MW**2*(-1 + 2*sw**2))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2epemZ2Weak = Coupling(name = 'c_R2epemZ2Weak',
                          value = '(ee**3*(4*cw**4*(1 + lhv)*MW**2 + cw**2*(Me**2 - 4*(1 + lhv)*MW**2) + 4*(1 + lhv)*MW**2*sw**2)*complex(0,-0.015625))/(cw**3*MW**2*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2vexmmGp1Weak = Coupling(name = 'c_R2vexmmGp1Weak',
                            value = '(ee**3*MM*(-((9 + 8*lhv)*sw**2) + cw**2*(-3 + 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                            order = {'QED' : 3})


c_R2mpmmH1Weak = Coupling(name = 'c_R2mpmmH1Weak',
                          value = '(ee**3*MM*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2))*complex(0,-0.00390625))/(cw**2*MW*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2mpmmG01Weak = Coupling(name = 'c_R2mpmmG01Weak',
                           value = '-(ee**3*MM*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2mpmmG02Weak = Coupling(name = 'c_R2mpmmG02Weak',
                           value = '(ee**3*MM*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2mpmmA1Weak = Coupling(name = 'c_R2mpmmA1Weak',
                          value = '(ee**3*((1 + lhv)*MW**2 + cw**2*(MM**2 - 2*(1 + lhv)*MW**2*(-1 + 2*sw**2)))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                          order = {'QED' : 3})


c_R2mpmmA2Weak = Coupling(name = 'c_R2mpmmA2Weak',
                          value = '(ee**3*(4*(1 + lhv)*MW**2*sw**2 + cw**2*(MM**2 - 4*(1 + lhv)*MW**2*sw**2))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                          order = {'QED' : 3})


c_R2mpmmZ1Weak = Coupling(name = 'c_R2mpmmZ1Weak',
                          value = '(ee**3*(2*cw**2*MM**2*sw**2 + (1 - 2*cw**2 + 4*cw**4)*(1 + lhv)*MW**2*(-1 + 2*sw**2))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2mpmmZ2Weak = Coupling(name = 'c_R2mpmmZ2Weak',
                          value = '(ee**3*(4*cw**4*(1 + lhv)*MW**2 + cw**2*(MM**2 - 4*(1 + lhv)*MW**2) + 4*(1 + lhv)*MW**2*sw**2)*complex(0,-0.015625))/(cw**3*MW**2*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2vexttmGp1Weak = Coupling(name = 'c_R2vexttmGp1Weak',
                             value = '(ee**3*MTA*(-((9 + 8*lhv)*sw**2) + cw**2*(-3 + 4*sw**2)))/(128.*cmath.sqrt(2)*cw**2*MW*cmath.pi**2*sw**3)',
                             order = {'QED' : 3})


c_R2ttpttmH1Weak = Coupling(name = 'c_R2ttpttmH1Weak',
                            value = '(ee**3*MTA*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2))*complex(0,-0.00390625))/(cw**2*MW*cmath.pi**2*sw**3)',
                            order = {'QED' : 3})


c_R2ttpttmG01Weak = Coupling(name = 'c_R2ttpttmG01Weak',
                             value = '-(ee**3*MTA*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                             order = {'QED' : 3})


c_R2ttpttmG02Weak = Coupling(name = 'c_R2ttpttmG02Weak',
                             value = '(ee**3*MTA*(-1 - 8*(1 + lhv)*sw**2 + 2*cw**2*(-1 + 8*(1 + lhv)*sw**2)))/(256.*cw**2*MW*cmath.pi**2*sw**3)',
                             order = {'QED' : 3})


c_R2ttpttmA1Weak = Coupling(name = 'c_R2ttpttmA1Weak',
                            value = '(ee**3*((1 + lhv)*MW**2 + cw**2*(MTA**2 - 2*(1 + lhv)*MW**2*(-1 + 2*sw**2)))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                            order = {'QED' : 3})


c_R2ttpttmA2Weak = Coupling(name = 'c_R2ttpttmA2Weak',
                            value = '(ee**3*(4*(1 + lhv)*MW**2*sw**2 + cw**2*(MTA**2 - 4*(1 + lhv)*MW**2*sw**2))*complex(0,0.015625))/(cw**2*MW**2*cmath.pi**2*sw**2)',
                            order = {'QED' : 3})


c_R2ttpttmZ1Weak = Coupling(name = 'c_R2ttpttmZ1Weak',
                            value = '(ee**3*(2*cw**2*MTA**2*sw**2 + (1 - 2*cw**2 + 4*cw**4)*(1 + lhv)*MW**2*(-1 + 2*sw**2))*complex(0,-0.0078125))/(cw**3*MW**2*cmath.pi**2*sw**3)',
                            order = {'QED' : 3})


c_R2ttpttmZ2Weak = Coupling(name = 'c_R2ttpttmZ2Weak',
                            value = '(ee**3*(4*cw**4*(1 + lhv)*MW**2 + cw**2*(MTA**2 - 4*(1 + lhv)*MW**2) + 4*(1 + lhv)*MW**2*sw**2)*complex(0,-0.015625))/(cw**3*MW**2*cmath.pi**2*sw)',
                            order = {'QED' : 3})


c_R2uxuH1Weak = Coupling(name = 'c_R2uxuH1Weak',
                         value = '(ee**3*MU*complex(0,-0.00043402777777777775)*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MS**2 + MW**2)*CKM12*complexconjugate(CKM12) - 18*cw**2*MB**2*CKM13*complexconjugate(CKM13) - 18*cw**2*MW**2*CKM13*complexconjugate(CKM13)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2uxuG01Weak = Coupling(name = 'c_R2uxuG01Weak',
                          value = '(ee**3*MU*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MS**2 + MW**2)*CKM12*complexconjugate(CKM12) - 18*cw**2*MB**2*CKM13*complexconjugate(CKM13) - 18*cw**2*MW**2*CKM13*complexconjugate(CKM13)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxuG02Weak = Coupling(name = 'c_R2uxuG02Weak',
                          value = '-(ee**3*MU*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MS**2 + MW**2)*CKM12*complexconjugate(CKM12) - 18*cw**2*MB**2*CKM13*complexconjugate(CKM13) - 18*cw**2*MW**2*CKM13*complexconjugate(CKM13)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxuA1Weak = Coupling(name = 'c_R2uxuA1Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*((2*MU**2)/MW**2 + 4*(1 + lhv)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)) - (MD**2*CKM11*complexconjugate(CKM11) + MS**2*CKM12*complexconjugate(CKM12) + MB**2*CKM13*complexconjugate(CKM13))/MW**2))/(2.*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2uxuA2Weak = Coupling(name = 'c_R2uxuA2Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) - 27*((2*(1 + lhv))/(27.*cw**2) - (MU**2*(-2 + CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)))/(48.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2uxuZ1Weak = Coupling(name = 'c_R2uxuZ1Weak',
                         value = '(ee**3*complex(0,0.004629629629629629)*(((-1 + 4*cw**2)*(1 + lhv))/sw + ((-27*(1 + lhv))/cw**2 + (108*(1 + lhv)*sw**2)/cw**2 + (64*(1 + lhv)*sw**4)/cw**2 - (48*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 18*sw**2*(((1 + lhv)*(-3 + 6*cw**2 + 2*sw**2)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)))/sw**2 + (-2*MU**2 + MD**2*CKM11*complexconjugate(CKM11) + MS**2*CKM12*complexconjugate(CKM12) + MB**2*CKM13*complexconjugate(CKM13))/MW**2))/(16.*sw**3)))/(cw*cmath.pi**2)',
                         order = {'QED' : 3})


c_R2uxuZ2Weak = Coupling(name = 'c_R2uxuZ2Weak',
                         value = '(ee**3*complex(0,0.00028935185185185184)*(64*(-1 + cw**2)*(1 + lhv)*sw**2 + (64*(1 + lhv)*sw**4)/cw**2 + (9*MU**2*(-3 + 4*sw**2))/MW**2 - (9*MU**2*(-3 + 2*sw**2)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)))/MW**2))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2uxuG1Weak = Coupling(name = 'c_R2uxuG1Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) + ((-16*(1 + lhv))/cw**2 - (9*MU**2)/(MW**2*sw**2) + (3*(1 + lhv)*(-3 + 8*sw**2))/(cw**2*sw**2) - (18*(1 + lhv)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)))/sw**2 - (9*(MD**2*CKM11*complexconjugate(CKM11) + MS**2*CKM12*complexconjugate(CKM12) + MB**2*CKM13*complexconjugate(CKM13)))/(MW**2*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2uxuG2Weak = Coupling(name = 'c_R2uxuG2Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) - 9*((2*(1 + lhv))/(9.*cw**2) + MU**2/(8.*MW**2*sw**2) + (MU**2*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13)))/(8.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2dxuGm1Weak = Coupling(name = 'c_R2dxuGm1Weak',
                          value = '-(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM11)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxuGm2Weak = Coupling(name = 'c_R2dxuGm2Weak',
                          value = '(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM11)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxuWm1Weak = Coupling(name = 'c_R2dxuWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM11*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxuGm1Weak = Coupling(name = 'c_R2sxuGm1Weak',
                          value = '-(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM12)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxuGm2Weak = Coupling(name = 'c_R2sxuGm2Weak',
                          value = '(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM12)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxuWm1Weak = Coupling(name = 'c_R2sxuWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM12*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxuGm1Weak = Coupling(name = 'c_R2bxuGm1Weak',
                          value = '-(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM13)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxuGm2Weak = Coupling(name = 'c_R2bxuGm2Weak',
                          value = '(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM13)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxuWm1Weak = Coupling(name = 'c_R2bxuWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM13*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxcH1Weak = Coupling(name = 'c_R2cxcH1Weak',
                         value = '(ee**3*MC*complex(0,-0.00043402777777777775)*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*(MS**2 + MW**2)*CKM22*complexconjugate(CKM22) - 18*cw**2*MB**2*CKM23*complexconjugate(CKM23) - 18*cw**2*MW**2*CKM23*complexconjugate(CKM23)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2cxcG01Weak = Coupling(name = 'c_R2cxcG01Weak',
                          value = '(ee**3*MC*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*(MS**2 + MW**2)*CKM22*complexconjugate(CKM22) - 18*cw**2*MB**2*CKM23*complexconjugate(CKM23) - 18*cw**2*MW**2*CKM23*complexconjugate(CKM23)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxcG02Weak = Coupling(name = 'c_R2cxcG02Weak',
                          value = '-(ee**3*MC*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*(MS**2 + MW**2)*CKM22*complexconjugate(CKM22) - 18*cw**2*MB**2*CKM23*complexconjugate(CKM23) - 18*cw**2*MW**2*CKM23*complexconjugate(CKM23)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxcA1Weak = Coupling(name = 'c_R2cxcA1Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*((2*MC**2)/MW**2 + 4*(1 + lhv)*(CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)) - (MD**2*CKM21*complexconjugate(CKM21) + MS**2*CKM22*complexconjugate(CKM22) + MB**2*CKM23*complexconjugate(CKM23))/MW**2))/(2.*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2cxcA2Weak = Coupling(name = 'c_R2cxcA2Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) - 27*((2*(1 + lhv))/(27.*cw**2) - (MC**2*(-2 + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)))/(48.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2cxcZ1Weak = Coupling(name = 'c_R2cxcZ1Weak',
                         value = '(ee**3*complex(0,0.004629629629629629)*(((-1 + 4*cw**2)*(1 + lhv))/sw + ((-27*(1 + lhv))/cw**2 + (108*(1 + lhv)*sw**2)/cw**2 + (64*(1 + lhv)*sw**4)/cw**2 - (48*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 18*sw**2*(((1 + lhv)*(-3 + 6*cw**2 + 2*sw**2)*(CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)))/sw**2 + (-2*MC**2 + MD**2*CKM21*complexconjugate(CKM21) + MS**2*CKM22*complexconjugate(CKM22) + MB**2*CKM23*complexconjugate(CKM23))/MW**2))/(16.*sw**3)))/(cw*cmath.pi**2)',
                         order = {'QED' : 3})


c_R2cxcZ2Weak = Coupling(name = 'c_R2cxcZ2Weak',
                         value = '(ee**3*complex(0,0.00028935185185185184)*(64*(-1 + cw**2)*(1 + lhv)*sw**2 + (64*(1 + lhv)*sw**4)/cw**2 + (9*MC**2*(-3 + 4*sw**2))/MW**2 - (9*MC**2*(-3 + 2*sw**2)*(CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)))/MW**2))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2cxcG1Weak = Coupling(name = 'c_R2cxcG1Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) + ((-16*(1 + lhv))/cw**2 - (9*MC**2)/(MW**2*sw**2) + (3*(1 + lhv)*(-3 + 8*sw**2))/(cw**2*sw**2) - (18*(1 + lhv)*(CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)))/sw**2 - (9*(MD**2*CKM21*complexconjugate(CKM21) + MS**2*CKM22*complexconjugate(CKM22) + MB**2*CKM23*complexconjugate(CKM23)))/(MW**2*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2cxcG2Weak = Coupling(name = 'c_R2cxcG2Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) - 9*((2*(1 + lhv))/(9.*cw**2) + MC**2/(8.*MW**2*sw**2) + (MC**2*(CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23)))/(8.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2dxcGm1Weak = Coupling(name = 'c_R2dxcGm1Weak',
                          value = '-(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM21)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxcGm2Weak = Coupling(name = 'c_R2dxcGm2Weak',
                          value = '(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM21)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxcWm1Weak = Coupling(name = 'c_R2dxcWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM21*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxcGm1Weak = Coupling(name = 'c_R2sxcGm1Weak',
                          value = '-(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM22)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxcGm2Weak = Coupling(name = 'c_R2sxcGm2Weak',
                          value = '(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM22)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxcWm1Weak = Coupling(name = 'c_R2sxcWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM22*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxcGm1Weak = Coupling(name = 'c_R2bxcGm1Weak',
                          value = '-(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM23)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxcGm2Weak = Coupling(name = 'c_R2bxcGm2Weak',
                          value = '(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM23)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxcWm1Weak = Coupling(name = 'c_R2bxcWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM23*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txtH1Weak = Coupling(name = 'c_R2txtH1Weak',
                         value = '(ee**3*MT*complex(0,-0.00043402777777777775)*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM31*complexconjugate(CKM31) - 18*cw**2*(MS**2 + MW**2)*CKM32*complexconjugate(CKM32) - 18*cw**2*MB**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2txtG01Weak = Coupling(name = 'c_R2txtG01Weak',
                          value = '(ee**3*MT*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM31*complexconjugate(CKM31) - 18*cw**2*(MS**2 + MW**2)*CKM32*complexconjugate(CKM32) - 18*cw**2*MB**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txtG02Weak = Coupling(name = 'c_R2txtG02Weak',
                          value = '-(ee**3*MT*(-9*MW**2 - 16*MW**2*sw**2 + 64*cw**2*MW**2*sw**2 - 16*lhv*MW**2*sw**2 + 64*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MD**2 + MW**2)*CKM31*complexconjugate(CKM31) - 18*cw**2*(MS**2 + MW**2)*CKM32*complexconjugate(CKM32) - 18*cw**2*MB**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txtA1Weak = Coupling(name = 'c_R2txtA1Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*((2*MT**2)/MW**2 + 4*(1 + lhv)*(CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)) - (MD**2*CKM31*complexconjugate(CKM31) + MS**2*CKM32*complexconjugate(CKM32) + MB**2*CKM33*complexconjugate(CKM33))/MW**2))/(2.*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2txtA2Weak = Coupling(name = 'c_R2txtA2Weak',
                         value = '(ee**3*complex(0,0.009259259259259259)*(2*(1 + lhv) - 27*((2*(1 + lhv))/(27.*cw**2) - (MT**2*(-2 + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/(48.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2txtZ1Weak = Coupling(name = 'c_R2txtZ1Weak',
                         value = '(ee**3*complex(0,0.004629629629629629)*(((-1 + 4*cw**2)*(1 + lhv))/sw + ((-27*(1 + lhv))/cw**2 + (108*(1 + lhv)*sw**2)/cw**2 + (64*(1 + lhv)*sw**4)/cw**2 - (48*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 18*sw**2*(((1 + lhv)*(-3 + 6*cw**2 + 2*sw**2)*(CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/sw**2 + (-2*MT**2 + MD**2*CKM31*complexconjugate(CKM31) + MS**2*CKM32*complexconjugate(CKM32) + MB**2*CKM33*complexconjugate(CKM33))/MW**2))/(16.*sw**3)))/(cw*cmath.pi**2)',
                         order = {'QED' : 3})


c_R2txtZ2Weak = Coupling(name = 'c_R2txtZ2Weak',
                         value = '(ee**3*complex(0,0.00028935185185185184)*(64*(-1 + cw**2)*(1 + lhv)*sw**2 + (64*(1 + lhv)*sw**4)/cw**2 + (9*MT**2*(-3 + 4*sw**2))/MW**2 - (9*MT**2*(-3 + 2*sw**2)*(CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/MW**2))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2txtG1Weak = Coupling(name = 'c_R2txtG1Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) + ((-16*(1 + lhv))/cw**2 - (9*MT**2)/(MW**2*sw**2) + (3*(1 + lhv)*(-3 + 8*sw**2))/(cw**2*sw**2) - (18*(1 + lhv)*(CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/sw**2 - (9*(MD**2*CKM31*complexconjugate(CKM31) + MS**2*CKM32*complexconjugate(CKM32) + MB**2*CKM33*complexconjugate(CKM33)))/(MW**2*sw**2))/8.))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2txtG2Weak = Coupling(name = 'c_R2txtG2Weak',
                         value = '(ee**2*G*complex(0,0.013888888888888888)*(2*(1 + lhv) - 9*((2*(1 + lhv))/(9.*cw**2) + MT**2/(8.*MW**2*sw**2) + (MT**2*(CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/(8.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2dxtGm1Weak = Coupling(name = 'c_R2dxtGm1Weak',
                          value = '-(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM31)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxtGm2Weak = Coupling(name = 'c_R2dxtGm2Weak',
                          value = '(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM31)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxtWm1Weak = Coupling(name = 'c_R2dxtWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM31*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxtGm1Weak = Coupling(name = 'c_R2sxtGm1Weak',
                          value = '-(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM32)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxtGm2Weak = Coupling(name = 'c_R2sxtGm2Weak',
                          value = '(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM32)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxtWm1Weak = Coupling(name = 'c_R2sxtWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM32*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxtGm1Weak = Coupling(name = 'c_R2bxtGm1Weak',
                          value = '-(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM33)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxtGm2Weak = Coupling(name = 'c_R2bxtGm2Weak',
                          value = '(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*CKM33)/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxtWm1Weak = Coupling(name = 'c_R2bxtWm1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*CKM33*complex(0,0.001736111111111111))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxdGp1Weak = Coupling(name = 'c_R2uxdGp1Weak',
                          value = '-(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM11))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxdGp2Weak = Coupling(name = 'c_R2uxdGp2Weak',
                          value = '(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM11))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxdWp1Weak = Coupling(name = 'c_R2uxdWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM11))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxdGp1Weak = Coupling(name = 'c_R2cxdGp1Weak',
                          value = '-(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM21))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxdGp2Weak = Coupling(name = 'c_R2cxdGp2Weak',
                          value = '(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM21))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxdWp1Weak = Coupling(name = 'c_R2cxdWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM21))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txdGp1Weak = Coupling(name = 'c_R2txdGp1Weak',
                          value = '-(ee**3*MD*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM31))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txdGp2Weak = Coupling(name = 'c_R2txdGp2Weak',
                          value = '(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MD**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM31))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txdWp1Weak = Coupling(name = 'c_R2txdWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM31))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxdH1Weak = Coupling(name = 'c_R2dxdH1Weak',
                         value = '(ee**3*MD*complex(0,-0.00043402777777777775)*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MC**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*MT**2*CKM31*complexconjugate(CKM31) - 18*cw**2*MW**2*CKM31*complexconjugate(CKM31)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2dxdG01Weak = Coupling(name = 'c_R2dxdG01Weak',
                          value = '-(ee**3*MD*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MC**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*MT**2*CKM31*complexconjugate(CKM31) - 18*cw**2*MW**2*CKM31*complexconjugate(CKM31)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxdG02Weak = Coupling(name = 'c_R2dxdG02Weak',
                          value = '(ee**3*MD*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MC**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*MT**2*CKM31*complexconjugate(CKM31) - 18*cw**2*MW**2*CKM31*complexconjugate(CKM31)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2dxdA1Weak = Coupling(name = 'c_R2dxdA1Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*(MD**2/MW**2 + 2*(1 + lhv)*(CKM11*complexconjugate(CKM11) + CKM21*complexconjugate(CKM21) + CKM31*complexconjugate(CKM31)) - (2*(MU**2*CKM11*complexconjugate(CKM11) + MC**2*CKM21*complexconjugate(CKM21) + MT**2*CKM31*complexconjugate(CKM31)))/MW**2))/sw**2)/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2dxdA2Weak = Coupling(name = 'c_R2dxdA2Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((-4*(1 + lhv))/cw**2 + (9*MD**2*(-1 + 2*CKM11*complexconjugate(CKM11) + 2*CKM21*complexconjugate(CKM21) + 2*CKM31*complexconjugate(CKM31)))/(MW**2*sw**2))/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2dxdZ1Weak = Coupling(name = 'c_R2dxdZ1Weak',
                         value = '(ee**3*complex(0,-0.00028935185185185184)*((-27*(1 + lhv))/cw**2 + (54*(1 + lhv)*sw**2)/cw**2 + 4*(1 + 2*cw**2)*(1 + lhv)*sw**2 + (8*(1 + lhv)*sw**4)/cw**2 - (12*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 54*sw**2*(2*(1 + lhv)*(0.6666666666666666 + (-0.5 + cw**2)/sw**2)*(CKM11*complexconjugate(CKM11) + CKM21*complexconjugate(CKM21) + CKM31*complexconjugate(CKM31)) + (-MD**2 + 2*MU**2*CKM11*complexconjugate(CKM11) + 2*MC**2*CKM21*complexconjugate(CKM21) + 2*MT**2*CKM31*complexconjugate(CKM31))/(3.*MW**2))))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2dxdZ2Weak = Coupling(name = 'c_R2dxdZ2Weak',
                         value = '(ee**3*complex(0,-0.0005787037037037037)*(4*(-1 + cw**2)*(1 + lhv) + (4*(1 + lhv)*sw**2)/cw**2 + (9*MD**2*(-3 + 2*sw**2))/(2.*MW**2*sw**2) - (9*MD**2*(-3 + 4*sw**2)*(CKM11*complexconjugate(CKM11) + CKM21*complexconjugate(CKM21) + CKM31*complexconjugate(CKM31)))/(2.*MW**2*sw**2)))/(cw*cmath.pi**2*sw)',
                         order = {'QED' : 3})


c_R2dxdG1Weak = Coupling(name = 'c_R2dxdG1Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + ((1 + lhv)*(-0.3333333333333333 + 1/(4.*sw**2)))/cw**2 + ((1 + lhv)*(CKM11*complexconjugate(CKM11) + CKM21*complexconjugate(CKM21) + CKM31*complexconjugate(CKM31)))/(2.*sw**2) + (MD**2 + MU**2*CKM11*complexconjugate(CKM11) + MC**2*CKM21*complexconjugate(CKM21) + MT**2*CKM31*complexconjugate(CKM31))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2dxdG2Weak = Coupling(name = 'c_R2dxdG2Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + (MD**2*(1 + CKM11*complexconjugate(CKM11) + CKM21*complexconjugate(CKM21) + CKM31*complexconjugate(CKM31)))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2uxsGp1Weak = Coupling(name = 'c_R2uxsGp1Weak',
                          value = '-(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM12))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxsGp2Weak = Coupling(name = 'c_R2uxsGp2Weak',
                          value = '(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM12))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxsWp1Weak = Coupling(name = 'c_R2uxsWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM12))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxsGp1Weak = Coupling(name = 'c_R2cxsGp1Weak',
                          value = '-(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM22))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxsGp2Weak = Coupling(name = 'c_R2cxsGp2Weak',
                          value = '(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM22))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxsWp1Weak = Coupling(name = 'c_R2cxsWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM22))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txsGp1Weak = Coupling(name = 'c_R2txsGp1Weak',
                          value = '-(ee**3*MS*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM32))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txsGp2Weak = Coupling(name = 'c_R2txsGp2Weak',
                          value = '(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MS**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM32))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txsWp1Weak = Coupling(name = 'c_R2txsWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM32))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxsH1Weak = Coupling(name = 'c_R2sxsH1Weak',
                         value = '(ee**3*MS*complex(0,-0.00043402777777777775)*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM11*complexconjugate(CKM11) - 18*cw**2*(MC**2 + MW**2)*CKM21*complexconjugate(CKM21) - 18*cw**2*MT**2*CKM31*complexconjugate(CKM31) - 18*cw**2*MW**2*CKM31*complexconjugate(CKM31)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2sxsG01Weak = Coupling(name = 'c_R2sxsG01Weak',
                          value = '-(ee**3*MS*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM12*complexconjugate(CKM12) - 18*cw**2*(MC**2 + MW**2)*CKM22*complexconjugate(CKM22) - 18*cw**2*MT**2*CKM32*complexconjugate(CKM32) - 18*cw**2*MW**2*CKM32*complexconjugate(CKM32)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxsG02Weak = Coupling(name = 'c_R2sxsG02Weak',
                          value = '(ee**3*MS*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM12*complexconjugate(CKM12) - 18*cw**2*(MC**2 + MW**2)*CKM22*complexconjugate(CKM22) - 18*cw**2*MT**2*CKM32*complexconjugate(CKM32) - 18*cw**2*MW**2*CKM32*complexconjugate(CKM32)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2sxsA1Weak = Coupling(name = 'c_R2sxsA1Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*(MS**2/MW**2 + 2*(1 + lhv)*(CKM12*complexconjugate(CKM12) + CKM22*complexconjugate(CKM22) + CKM32*complexconjugate(CKM32)) - (2*(MU**2*CKM12*complexconjugate(CKM12) + MC**2*CKM22*complexconjugate(CKM22) + MT**2*CKM32*complexconjugate(CKM32)))/MW**2))/sw**2)/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2sxsA2Weak = Coupling(name = 'c_R2sxsA2Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((-4*(1 + lhv))/cw**2 + (9*MS**2*(-1 + 2*CKM12*complexconjugate(CKM12) + 2*CKM22*complexconjugate(CKM22) + 2*CKM32*complexconjugate(CKM32)))/(MW**2*sw**2))/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2sxsZ1Weak = Coupling(name = 'c_R2sxsZ1Weak',
                         value = '(ee**3*complex(0,-0.00028935185185185184)*((-27*(1 + lhv))/cw**2 + (54*(1 + lhv)*sw**2)/cw**2 + 4*(1 + 2*cw**2)*(1 + lhv)*sw**2 + (8*(1 + lhv)*sw**4)/cw**2 - (12*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 54*sw**2*(2*(1 + lhv)*(0.6666666666666666 + (-0.5 + cw**2)/sw**2)*(CKM12*complexconjugate(CKM12) + CKM22*complexconjugate(CKM22) + CKM32*complexconjugate(CKM32)) + (-MS**2 + 2*MU**2*CKM12*complexconjugate(CKM12) + 2*MC**2*CKM22*complexconjugate(CKM22) + 2*MT**2*CKM32*complexconjugate(CKM32))/(3.*MW**2))))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2sxsZ2Weak = Coupling(name = 'c_R2sxsZ2Weak',
                         value = '(ee**3*complex(0,-0.0005787037037037037)*(4*(-1 + cw**2)*(1 + lhv) + (4*(1 + lhv)*sw**2)/cw**2 + (9*MS**2*(-3 + 2*sw**2))/(2.*MW**2*sw**2) - (9*MS**2*(-3 + 4*sw**2)*(CKM12*complexconjugate(CKM12) + CKM22*complexconjugate(CKM22) + CKM32*complexconjugate(CKM32)))/(2.*MW**2*sw**2)))/(cw*cmath.pi**2*sw)',
                         order = {'QED' : 3})


c_R2sxsG1Weak = Coupling(name = 'c_R2sxsG1Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + ((1 + lhv)*(-0.3333333333333333 + 1/(4.*sw**2)))/cw**2 + ((1 + lhv)*(CKM12*complexconjugate(CKM12) + CKM22*complexconjugate(CKM22) + CKM32*complexconjugate(CKM32)))/(2.*sw**2) + (MS**2 + MU**2*CKM12*complexconjugate(CKM12) + MC**2*CKM22*complexconjugate(CKM22) + MT**2*CKM32*complexconjugate(CKM32))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2sxsG2Weak = Coupling(name = 'c_R2sxsG2Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + (MS**2*(1 + CKM12*complexconjugate(CKM12) + CKM22*complexconjugate(CKM22) + CKM32*complexconjugate(CKM32)))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2uxbGp1Weak = Coupling(name = 'c_R2uxbGp1Weak',
                          value = '-(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MU**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM13))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxbGp2Weak = Coupling(name = 'c_R2uxbGp2Weak',
                          value = '(ee**3*MU*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM13))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2uxbWp1Weak = Coupling(name = 'c_R2uxbWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM13))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxbGp1Weak = Coupling(name = 'c_R2cxbGp1Weak',
                          value = '-(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MC**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM23))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxbGp2Weak = Coupling(name = 'c_R2cxbGp2Weak',
                          value = '(ee**3*MC*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM23))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2cxbWp1Weak = Coupling(name = 'c_R2cxbWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM23))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txbGp1Weak = Coupling(name = 'c_R2txbGp1Weak',
                          value = '-(ee**3*MB*((1 - 8*lhv)*MW**2*sw**2 + cw**2*(18*MT**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM33))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txbGp2Weak = Coupling(name = 'c_R2txbGp2Weak',
                          value = '(ee**3*MT*((25 + 16*lhv)*MW**2*sw**2 + cw**2*(18*MB**2 + MW**2*(27 + 4*(-1 + 8*lhv)*sw**2)))*complexconjugate(CKM33))/(1152.*cmath.sqrt(2)*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2txbWp1Weak = Coupling(name = 'c_R2txbWp1Weak',
                          value = '(ee**3*(1 + lhv)*(9 - 10*sw**2 + 4*cw**2*(-9 + 7*sw**2))*complex(0,0.001736111111111111)*complexconjugate(CKM33))/(cmath.sqrt(2)*cw**2*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxbH1Weak = Coupling(name = 'c_R2bxbH1Weak',
                         value = '(ee**3*MB*complex(0,-0.00043402777777777775)*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM13*complexconjugate(CKM13) - 18*cw**2*(MC**2 + MW**2)*CKM23*complexconjugate(CKM23) - 18*cw**2*MT**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(cw**2*MW**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2bxbG01Weak = Coupling(name = 'c_R2bxbG01Weak',
                          value = '-(ee**3*MB*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM13*complexconjugate(CKM13) - 18*cw**2*(MC**2 + MW**2)*CKM23*complexconjugate(CKM23) - 18*cw**2*MT**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxbG02Weak = Coupling(name = 'c_R2bxbG02Weak',
                          value = '(ee**3*MB*(-9*MW**2 + 8*MW**2*sw**2 + 16*cw**2*MW**2*sw**2 + 8*lhv*MW**2*sw**2 + 16*cw**2*lhv*MW**2*sw**2 - 18*cw**2*(MU**2 + MW**2)*CKM13*complexconjugate(CKM13) - 18*cw**2*(MC**2 + MW**2)*CKM23*complexconjugate(CKM23) - 18*cw**2*MT**2*CKM33*complexconjugate(CKM33) - 18*cw**2*MW**2*CKM33*complexconjugate(CKM33)))/(2304.*cw**2*MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2bxbA1Weak = Coupling(name = 'c_R2bxbA1Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((8*(1 + lhv))/cw**2 - (9*(1 + lhv))/(cw**2*sw**2) - (9*(MB**2/MW**2 + 2*(1 + lhv)*(CKM13*complexconjugate(CKM13) + CKM23*complexconjugate(CKM23) + CKM33*complexconjugate(CKM33)) - (2*(MU**2*CKM13*complexconjugate(CKM13) + MC**2*CKM23*complexconjugate(CKM23) + MT**2*CKM33*complexconjugate(CKM33)))/MW**2))/sw**2)/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2bxbA2Weak = Coupling(name = 'c_R2bxbA2Weak',
                         value = '(ee**3*complex(0,-0.0023148148148148147)*(1 + lhv + ((-4*(1 + lhv))/cw**2 + (9*MB**2*(-1 + 2*CKM13*complexconjugate(CKM13) + 2*CKM23*complexconjugate(CKM23) + 2*CKM33*complexconjugate(CKM33)))/(MW**2*sw**2))/4.))/cmath.pi**2',
                         order = {'QED' : 3})


c_R2bxbZ1Weak = Coupling(name = 'c_R2bxbZ1Weak',
                         value = '(ee**3*complex(0,-0.00028935185185185184)*((-27*(1 + lhv))/cw**2 + (54*(1 + lhv)*sw**2)/cw**2 + 4*(1 + 2*cw**2)*(1 + lhv)*sw**2 + (8*(1 + lhv)*sw**4)/cw**2 - (12*(1 + lhv)*sw**2*(1 + 2*sw**2))/cw**2 - 54*sw**2*(2*(1 + lhv)*(0.6666666666666666 + (-0.5 + cw**2)/sw**2)*(CKM13*complexconjugate(CKM13) + CKM23*complexconjugate(CKM23) + CKM33*complexconjugate(CKM33)) + (-MB**2 + 2*MU**2*CKM13*complexconjugate(CKM13) + 2*MC**2*CKM23*complexconjugate(CKM23) + 2*MT**2*CKM33*complexconjugate(CKM33))/(3.*MW**2))))/(cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2bxbZ2Weak = Coupling(name = 'c_R2bxbZ2Weak',
                         value = '(ee**3*complex(0,-0.0005787037037037037)*(4*(-1 + cw**2)*(1 + lhv) + (4*(1 + lhv)*sw**2)/cw**2 + (9*MB**2*(-3 + 2*sw**2))/(2.*MW**2*sw**2) - (9*MB**2*(-3 + 4*sw**2)*(CKM13*complexconjugate(CKM13) + CKM23*complexconjugate(CKM23) + CKM33*complexconjugate(CKM33)))/(2.*MW**2*sw**2)))/(cw*cmath.pi**2*sw)',
                         order = {'QED' : 3})


c_R2bxbG1Weak = Coupling(name = 'c_R2bxbG1Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + ((1 + lhv)*(-0.3333333333333333 + 1/(4.*sw**2)))/cw**2 + ((1 + lhv)*(CKM13*complexconjugate(CKM13) + CKM23*complexconjugate(CKM23) + CKM33*complexconjugate(CKM33)))/(2.*sw**2) + (MB**2 + MU**2*CKM13*complexconjugate(CKM13) + MC**2*CKM23*complexconjugate(CKM23) + MT**2*CKM33*complexconjugate(CKM33))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2bxbG2Weak = Coupling(name = 'c_R2bxbG2Weak',
                         value = '(ee**2*G*complex(0,0.006944444444444444)*(1 + lhv - 9*((1 + lhv)/(9.*cw**2) + (MB**2*(1 + CKM13*complexconjugate(CKM13) + CKM23*complexconjugate(CKM23) + CKM33*complexconjugate(CKM33)))/(4.*MW**2*sw**2))))/cmath.pi**2',
                         order = {'QED' : 2, 'QCD' : 1})


c_R2HHH1Weak = Coupling(name = 'c_R2HHH1Weak',
                        value = '(ee**3*(((1 + 1/(2.*cw**2))*MH**2)/MW + 2*(1 - 4*lhv)*MW + (MW - 4*lhv*MW)/cw**4 + (4*(Me**4 + MM**4 + MTA**4 + (MB**4 + MC**4 + MD**4 + MS**4 + MT**4 + MU**4)*Ncol))/MW**3)*complex(0,0.0234375))/(cmath.pi**2*sw**3)',
                        order = {'QED' : 3})


c_R2HG0G01Weak = Coupling(name = 'c_R2HG0G01Weak',
                          value = '(ee**3*((1 + 1/(2.*cw**2))*MH**2*MW**2 + 2*(1 - 4*lhv)*MW**4 + ((1 - 4*lhv)*MW**4)/cw**4 + 4*(Me**4 + MM**4 + MTA**4 + (MB**4 + MC**4 + MD**4 + MS**4 + MT**4 + MU**4)*Ncol))*complex(0,0.0078125))/(MW**3*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2HGmGp1Weak = Coupling(name = 'c_R2HGmGp1Weak',
                          value = '(ee**3*complex(0,0.015625)*(-(((MH**2 + 2*(1 - 4*lhv)*MW**2)*sw**2)/MW) + 2*(((1 + 2*cw**2)*MH**2)/(8.*cw**2*MW) + (3*(1 - 4*lhv)*MW)/4. + ((1 + cw**2)*(1 - 4*lhv)*MW*sw**2)/(4.*cw**4) + (Me**4 + MM**4 + MTA**4 + Ncol*((MD**4 + MU**4)*CKM11*complexconjugate(CKM11) + (MS**4 + MU**4)*CKM12*complexconjugate(CKM12) + (MB**4 + MU**4)*CKM13*complexconjugate(CKM13) + (MC**4 + MD**4)*CKM21*complexconjugate(CKM21) + (MC**4 + MS**4)*CKM22*complexconjugate(CKM22) + (MB**4 + MC**4)*CKM23*complexconjugate(CKM23) + (MD**4 + MT**4)*CKM31*complexconjugate(CKM31) + (MS**4 + MT**4)*CKM32*complexconjugate(CKM32) + (MB**4 + MT**4)*CKM33*complexconjugate(CKM33)))/MW**3)))/(cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2HAA1Weak = Coupling(name = 'c_R2HAA1Weak',
                        value = '(ee**3*(MW/2. + (Me**2 + MM**2 + MTA**2 + ((MB**2 + MD**2 + MS**2 + 4*(MC**2 + MT**2 + MU**2))*Ncol)/9.)/MW)*complex(0,-0.125))/(cmath.pi**2*sw)',
                        order = {'QED' : 3})


c_R2HAZ1Weak = Coupling(name = 'c_R2HAZ1Weak',
                        value = '(ee**3*((MW + 2*cw**2*MW)/(4.*sw**2) + ((Me**2 + MM**2 + MTA**2)*(-1 + 1/(4.*sw**2)) + Ncol*((2*(MC**2 + MT**2 + MU**2)*(-0.6666666666666666 + 1/(4.*sw**2)))/3. - ((MB**2 + MD**2 + MS**2)*(-3 + 4*sw**2))/(36.*sw**2)))/MW)*complex(0,-0.125))/(cw*cmath.pi**2)',
                        order = {'QED' : 3})


c_R2HZZ1Weak = Coupling(name = 'c_R2HZZ1Weak',
                        value = '(ee**3*(18*MW**2*(-2 + sw**2) - (9*(Me**2 + MM**2 + MTA**2)*(1 - 2*sw**2 + 4*sw**4) + Ncol*((MB**2 + MD**2 + MS**2)*(9 - 6*sw**2 + 4*sw**4) + (MC**2 + MT**2 + MU**2)*(9 - 12*sw**2 + 16*sw**4)))/cw**2)*complex(0,0.003472222222222222))/(MW*cmath.pi**2*sw**3)',
                        order = {'QED' : 3})


c_R2HWpWm1Weak = Coupling(name = 'c_R2HWpWm1Weak',
                          value = '(ee**3*complex(0,0.03125)*((3 + 4*lhv)*MW*sw**2 - 4*(MW + (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/(4.*MW))))/(cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2GmAWp1Weak = Coupling(name = 'c_R2GmAWp1Weak',
                          value = '(ee**3*(-MW - (MW + (Ncol*((2*MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (2*MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (2*MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + 2*MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + 2*MS**2)*CKM22*complexconjugate(CKM22) + (2*MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (2*MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (2*MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (2*MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/(3.*MW))/sw**2))/(32.*cmath.pi**2)',
                          order = {'QED' : 3})


c_R2GmZWp1Weak = Coupling(name = 'c_R2GmZWp1Weak',
                          value = '(ee**3*(MW - (1 + cw**2)*MW + (Ncol*((2*MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (2*MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (2*MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + 2*MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + 2*MS**2)*CKM22*complexconjugate(CKM22) + (2*MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (2*MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (2*MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (2*MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/(3.*MW)))/(32.*cw*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2GpAWm1Weak = Coupling(name = 'c_R2GpAWm1Weak',
                          value = '(ee**3*(MW + (MW + (Ncol*((2*MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (2*MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (2*MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + 2*MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + 2*MS**2)*CKM22*complexconjugate(CKM22) + (2*MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (2*MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (2*MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (2*MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/(3.*MW))/sw**2))/(32.*cmath.pi**2)',
                          order = {'QED' : 3})


c_R2GpZWm1Weak = Coupling(name = 'c_R2GpZWm1Weak',
                          value = '(ee**3*(-MW + (1 + cw**2)*MW - (Ncol*((2*MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (2*MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (2*MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + 2*MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + 2*MS**2)*CKM22*complexconjugate(CKM22) + (2*MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (2*MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (2*MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (2*MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/(3.*MW)))/(32.*cw*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2AG0H1Weak = Coupling(name = 'c_R2AG0H1Weak',
                         value = '(5*ee**3)/(192.*cmath.pi**2*sw**2)',
                         order = {'QED' : 3})


c_R2AG0H2Weak = Coupling(name = 'c_R2AG0H2Weak',
                         value = '(-5*ee**3)/(192.*cmath.pi**2*sw**2)',
                         order = {'QED' : 3})


c_R2AGpGm1Weak = Coupling(name = 'c_R2AGpGm1Weak',
                          value = '(ee**3*complex(0,0.010416666666666666)*(1 - (2*((12 + cw**(-2))/8. + (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/MW**2))/sw**2))/cmath.pi**2',
                          order = {'QED' : 3})


c_R2AGpGm2Weak = Coupling(name = 'c_R2AGpGm2Weak',
                          value = '(ee**3*complex(0,-0.010416666666666666)*(1 - (2*((12 + cw**(-2))/8. + (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/MW**2))/sw**2))/cmath.pi**2',
                          order = {'QED' : 3})


c_R2AWpWm1Weak = Coupling(name = 'c_R2AWpWm1Weak',
                          value = '(ee**3*complex(0,0.010416666666666666)*(7 + 4*lhv - (7 + 4*lhv + 2*(3 + Ncol*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33))))/sw**2))/cmath.pi**2',
                          order = {'QED' : 3})


c_R2ZG0H1Weak = Coupling(name = 'c_R2ZG0H1Weak',
                         value = '(ee**3*(2 + cw**(-2) + 20*cw**2 + (8*(Me**2 + MM**2 + MTA**2 + MB**2*Ncol + MC**2*Ncol + MD**2*Ncol + MS**2*Ncol + MT**2*Ncol + MU**2*Ncol))/MW**2))/(768.*cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2ZG0H2Weak = Coupling(name = 'c_R2ZG0H2Weak',
                         value = '-(ee**3*(2 + cw**(-2) + 20*cw**2 + (8*(Me**2 + MM**2 + MTA**2 + MB**2*Ncol + MC**2*Ncol + MD**2*Ncol + MS**2*Ncol + MT**2*Ncol + MU**2*Ncol))/MW**2))/(768.*cw*cmath.pi**2*sw**3)',
                         order = {'QED' : 3})


c_R2ZGpGm1Weak = Coupling(name = 'c_R2ZGpGm1Weak',
                          value = '(ee**3*complex(0,0.005208333333333333)*(-1 + 2*cw**2 + (cw**(-2) - 24*cw**2 + (8*(-1 + 2*sw**2)*(Me**2 + MM**2 + MTA**2 + (MD**2 + MU**2)*Ncol*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*Ncol*CKM12*complexconjugate(CKM12) + MB**2*Ncol*CKM13*complexconjugate(CKM13) + MU**2*Ncol*CKM13*complexconjugate(CKM13) + MC**2*Ncol*CKM21*complexconjugate(CKM21) + MD**2*Ncol*CKM21*complexconjugate(CKM21) + MC**2*Ncol*CKM22*complexconjugate(CKM22) + MS**2*Ncol*CKM22*complexconjugate(CKM22) + MB**2*Ncol*CKM23*complexconjugate(CKM23) + MC**2*Ncol*CKM23*complexconjugate(CKM23) + MD**2*Ncol*CKM31*complexconjugate(CKM31) + MT**2*Ncol*CKM31*complexconjugate(CKM31) + MS**2*Ncol*CKM32*complexconjugate(CKM32) + MT**2*Ncol*CKM32*complexconjugate(CKM32) + MB**2*Ncol*CKM33*complexconjugate(CKM33) + MT**2*Ncol*CKM33*complexconjugate(CKM33)))/MW**2)/(4.*sw**2)))/(cw*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2ZGpGm2Weak = Coupling(name = 'c_R2ZGpGm2Weak',
                          value = '(ee**3*complex(0,-0.005208333333333333)*(-1 + 2*cw**2 + (cw**(-2) - 24*cw**2 + (8*(-1 + 2*sw**2)*(Me**2 + MM**2 + MTA**2 + (MD**2 + MU**2)*Ncol*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*Ncol*CKM12*complexconjugate(CKM12) + MB**2*Ncol*CKM13*complexconjugate(CKM13) + MU**2*Ncol*CKM13*complexconjugate(CKM13) + MC**2*Ncol*CKM21*complexconjugate(CKM21) + MD**2*Ncol*CKM21*complexconjugate(CKM21) + MC**2*Ncol*CKM22*complexconjugate(CKM22) + MS**2*Ncol*CKM22*complexconjugate(CKM22) + MB**2*Ncol*CKM23*complexconjugate(CKM23) + MC**2*Ncol*CKM23*complexconjugate(CKM23) + MD**2*Ncol*CKM31*complexconjugate(CKM31) + MT**2*Ncol*CKM31*complexconjugate(CKM31) + MS**2*Ncol*CKM32*complexconjugate(CKM32) + MT**2*Ncol*CKM32*complexconjugate(CKM32) + MB**2*Ncol*CKM33*complexconjugate(CKM33) + MT**2*Ncol*CKM33*complexconjugate(CKM33)))/MW**2)/(4.*sw**2)))/(cw*cmath.pi**2*sw)',
                          order = {'QED' : 3})


c_R2ZWpWm1Weak = Coupling(name = 'c_R2ZWpWm1Weak',
                          value = '(cw*ee**3*complex(0,0.010416666666666666)*(-13 - 4*lhv + 7*sw**2 + 4*lhv*sw**2 - 2*Ncol*CKM11*complexconjugate(CKM11) - 2*Ncol*CKM12*complexconjugate(CKM12) - 2*Ncol*CKM13*complexconjugate(CKM13) - 2*Ncol*CKM21*complexconjugate(CKM21) - 2*Ncol*CKM22*complexconjugate(CKM22) - 2*Ncol*CKM23*complexconjugate(CKM23) - 2*Ncol*CKM31*complexconjugate(CKM31) - 2*Ncol*CKM32*complexconjugate(CKM32) - 2*Ncol*CKM33*complexconjugate(CKM33)))/(cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2WmGpH1Weak = Coupling(name = 'c_R2WmGpH1Weak',
                          value = '(ee**3*((22 + cw**(-2))/8. - 3*sw**2 + (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/MW**2))/(96.*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2WmGpH2Weak = Coupling(name = 'c_R2WmGpH2Weak',
                          value = '(ee**3*(-2.75 - 1/(8.*cw**2) + 3*sw**2 - (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/MW**2))/(96.*cmath.pi**2*sw**3)',
                          order = {'QED' : 3})


c_R2WmGpG01Weak = Coupling(name = 'c_R2WmGpG01Weak',
                           value = '(ee**3*complex(0,-0.010416666666666666)*(3*sw**2 + (-22 - cw**(-2) - (8*(Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33))))/MW**2)/8.))/(cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2WmGpG02Weak = Coupling(name = 'c_R2WmGpG02Weak',
                           value = '(ee**3*complex(0,0.010416666666666666)*(3*sw**2 + (-22 - cw**(-2) - (8*(Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33))))/MW**2)/8.))/(cmath.pi**2*sw**3)',
                           order = {'QED' : 3})


c_R2HHHH1Weak = Coupling(name = 'c_R2HHHH1Weak',
                         value = '(ee**4*(((1 + 1/(2.*cw**4))*(1 - 12*lhv))/2. + ((3*(1 + 1/(2.*cw**2))*MH**2)/2. + (5*(Me**4 + MM**4 + MTA**4 + (MB**4 + MC**4 + MD**4 + MS**4 + MT**4 + MU**4)*Ncol))/MW**2)/MW**2)*complex(0,0.015625))/(cmath.pi**2*sw**4)',
                         order = {'QED' : 4})


c_R2HHG0G01Weak = Coupling(name = 'c_R2HHG0G01Weak',
                           value = '(ee**4*(((1 + 1/(2.*cw**4))*(1 - 12*lhv))/2. + ((3*(1 + 1/(2.*cw**2))*MH**2)/2. + (5*(Me**4 + MM**4 + MTA**4 + (MB**4 + MC**4 + MD**4 + MS**4 + MT**4 + MU**4)*Ncol))/MW**2)/MW**2)*complex(0,0.005208333333333333))/(cmath.pi**2*sw**4)',
                           order = {'QED' : 4})


c_R2HHGmGp1Weak = Coupling(name = 'c_R2HHGmGp1Weak',
                           value = '(ee**4*complex(0,0.0026041666666666665)*(((-3*MH**2 + 2*(-1 + 12*lhv)*MW**2)*sw**2)/MW**2 + 6*(((1 - 12*lhv)*(1 + ((1 + cw**2)*sw**2)/(3.*cw**4)))/4. + (((1 + 1/(2.*cw**2))*MH**2)/2. + (5*(Me**4 + MM**4 + MTA**4 + Ncol*((MD**4 + MU**4)*CKM11*complexconjugate(CKM11) + (MS**4 + MU**4)*CKM12*complexconjugate(CKM12) + (MB**4 + MU**4)*CKM13*complexconjugate(CKM13) + (MC**4 + MD**4)*CKM21*complexconjugate(CKM21) + (MC**4 + MS**4)*CKM22*complexconjugate(CKM22) + (MB**4 + MC**4)*CKM23*complexconjugate(CKM23) + (MD**4 + MT**4)*CKM31*complexconjugate(CKM31) + (MS**4 + MT**4)*CKM32*complexconjugate(CKM32) + (MB**4 + MT**4)*CKM33*complexconjugate(CKM33))))/(3.*MW**2))/MW**2)))/(cmath.pi**2*sw**4)',
                           order = {'QED' : 4})


c_R2HHAA1Weak = Coupling(name = 'c_R2HHAA1Weak',
                         value = '(ee**4*(0.08333333333333333 - (Me**2 + MM**2 + MTA**2 + ((MB**2 + MD**2 + MS**2)*Ncol)/9. + (4*(MC**2 + MT**2 + MU**2)*Ncol)/9.)/MW**2)*complex(0,0.0625))/(cmath.pi**2*sw**2)',
                         order = {'QED' : 4})


c_R2HHAZ1Weak = Coupling(name = 'c_R2HHAZ1Weak',
                         value = '(ee**4*(1 + (12*((Me**2 + MM**2 + MTA**2)*(-1 + 1/(4.*sw**2)) + (2*(MC**2 + MT**2 + MU**2)*Ncol*(-0.6666666666666666 + 1/(4.*sw**2)))/3. + ((MB**2 + MD**2 + MS**2)*Ncol*(-0.3333333333333333 + 1/(4.*sw**2)))/3.))/MW**2 + 4/sw**2)*complex(0,-0.005208333333333333))/(cw*cmath.pi**2*sw)',
                         order = {'QED' : 4})


c_R2HHZZ1Weak = Coupling(name = 'c_R2HHZZ1Weak',
                         value = '(ee**4*((1 + 2*cw**2 + 40*cw**4 - 4*cw**6)/(48.*cw**2*sw**4) + ((Me**2 + MM**2 + MTA**2)*(1 + 1/(3.*sw**4) - 1/(2.*sw**2)) + ((MB**2 + MD**2 + MS**2)*Ncol*(6 - 3*sw**2 + 2*sw**4))/(18.*sw**4) + ((MC**2 + MT**2 + MU**2)*Ncol*(3 - 3*sw**2 + 4*sw**4))/(9.*sw**4))/MW**2)*complex(0,-0.0625))/(cw**2*cmath.pi**2)',
                         order = {'QED' : 4})


c_R2HHWmWp1Weak = Coupling(name = 'c_R2HHWmWp1Weak',
                           value = '(ee**4*complex(0,0.0026041666666666665)*(3*(5 + 8*lhv)*sw**2 - 8*((38 + cw**(-2))/16. + (Me**2 + MM**2 + MTA**2 + Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/MW**2)))/(cmath.pi**2*sw**4)',
                           order = {'QED' : 4})


c_R2HGmWpA1Weak = Coupling(name = 'c_R2HGmWpA1Weak',
                           value = '(ee**4*(9*sw**2 + (-22 - cw**(-2) - (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2)/2.))/(384.*cmath.pi**2*sw**3)',
                           order = {'QED' : 4})


c_R2HGmWpZ1Weak = Coupling(name = 'c_R2HGmWpZ1Weak',
                           value = '(ee**4*(-2 + cw**(-2) + 18*cw**2 + (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2))/(768.*cw*cmath.pi**2*sw**2)',
                           order = {'QED' : 4})


c_R2G0GmWpA1Weak = Coupling(name = 'c_R2G0GmWpA1Weak',
                            value = '(ee**4*complex(0,-0.0026041666666666665)*(9*sw**2 + (-22 - cw**(-2) - (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2)/2.))/(cmath.pi**2*sw**3)',
                            order = {'QED' : 4})


c_R2G0GmWpZ1Weak = Coupling(name = 'c_R2G0GmWpZ1Weak',
                            value = '(ee**4*complex(0,-0.0013020833333333333)*(-2 + cw**(-2) + 18*cw**2 + (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2))/(cw*cmath.pi**2*sw**2)',
                            order = {'QED' : 4})


c_R2GpHAWm1Weak = Coupling(name = 'c_R2GpHAWm1Weak',
                           value = '(ee**4*(-9*sw**2 + (22 + cw**(-2) + (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2)/2.))/(384.*cmath.pi**2*sw**3)',
                           order = {'QED' : 4})


c_R2GpHZWm1Weak = Coupling(name = 'c_R2GpHZWm1Weak',
                           value = '(ee**4*(2 - cw**(-2) - 18*cw**2 - (4*(Me**2 + MM**2 + MTA**2 + Ncol*((3*MD**2 + 2*MU**2)*CKM11*complexconjugate(CKM11) + (3*MS**2 + 2*MU**2)*CKM12*complexconjugate(CKM12) + (3*MB**2 + 2*MU**2)*CKM13*complexconjugate(CKM13) + (2*MC**2 + 3*MD**2)*CKM21*complexconjugate(CKM21) + (2*MC**2 + 3*MS**2)*CKM22*complexconjugate(CKM22) + (3*MB**2 + 2*MC**2)*CKM23*complexconjugate(CKM23) + (3*MD**2 + 2*MT**2)*CKM31*complexconjugate(CKM31) + (3*MS**2 + 2*MT**2)*CKM32*complexconjugate(CKM32) + (3*MB**2 + 2*MT**2)*CKM33*complexconjugate(CKM33))))/MW**2))/(768.*cw*cmath.pi**2*sw**2)',
                           order = {'QED' : 4})


c_R2GmGpGmGp1Weak = Coupling(name = 'c_R2GmGpGmGp1Weak',
                             value = '(ee**4*complex(0,0.010416666666666666)*(((2*(-1 + 12*lhv)*MW**2 + 4*cw**4*(-1 + 12*lhv)*MW**2 + cw**2*(-3*MH**2 + 4*(1 - 12*lhv)*MW**2))*sw**2)/(cw**2*MW**2) + 3*(-((-1 + 12*lhv)*(4*cw**2*sw**6 + sw**8 + cw**4*(3 + 2*sw**2 + 3*sw**4)))/(12.*cw**4) + (((1 + 1/(2.*cw**2))*MH**2)/2. + (5*(Me**4 + MM**4 + MTA**4 + Ncol*((MD**4 + MU**4)*CKM11**2*complexconjugate(CKM11)**2 + 2*(MD**2*MS**2 + MU**4)*CKM11*CKM12*complexconjugate(CKM11)*complexconjugate(CKM12) + (MS**4 + MU**4)*CKM12**2*complexconjugate(CKM12)**2 + 2*(MB**2*MD**2 + MU**4)*CKM11*CKM13*complexconjugate(CKM11)*complexconjugate(CKM13) + 2*(MB**2*MS**2 + MU**4)*CKM12*CKM13*complexconjugate(CKM12)*complexconjugate(CKM13) + (MB**4 + MU**4)*CKM13**2*complexconjugate(CKM13)**2 + 2*(MD**4 + MC**2*MU**2)*CKM11*CKM21*complexconjugate(CKM11)*complexconjugate(CKM21) + 2*(MD**2*MS**2 + MC**2*MU**2)*CKM11*CKM22*complexconjugate(CKM12)*complexconjugate(CKM21) + 2*(MB**2*MD**2 + MC**2*MU**2)*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) + (MC**4 + MD**4)*CKM21**2*complexconjugate(CKM21)**2 + 2*(MD**2*MS**2 + MC**2*MU**2)*CKM12*CKM21*complexconjugate(CKM11)*complexconjugate(CKM22) + 2*(MS**4 + MC**2*MU**2)*CKM12*CKM22*complexconjugate(CKM12)*complexconjugate(CKM22) + 2*(MB**2*MS**2 + MC**2*MU**2)*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) + 2*(MC**4 + MD**2*MS**2)*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) + (MC**4 + MS**4)*CKM22**2*complexconjugate(CKM22)**2 + 2*(MB**2*MD**2 + MC**2*MU**2)*CKM13*CKM21*complexconjugate(CKM11)*complexconjugate(CKM23) + 2*(MB**2*MS**2 + MC**2*MU**2)*CKM13*CKM22*complexconjugate(CKM12)*complexconjugate(CKM23) + 2*(MB**4 + MC**2*MU**2)*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) + 2*(MC**4 + MB**2*MD**2)*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) + 2*(MC**4 + MB**2*MS**2)*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) + (MB**4 + MC**4)*CKM23**2*complexconjugate(CKM23)**2 + 2*(MD**4 + MT**2*MU**2)*CKM11*CKM31*complexconjugate(CKM11)*complexconjugate(CKM31) + 2*(MD**2*MS**2 + MT**2*MU**2)*CKM11*CKM32*complexconjugate(CKM12)*complexconjugate(CKM31) + 2*(MB**2*MD**2 + MT**2*MU**2)*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) + 2*(MD**4 + MC**2*MT**2)*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) + 2*(MD**2*MS**2 + MC**2*MT**2)*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) + 2*(MB**2*MD**2 + MC**2*MT**2)*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) + (MD**4 + MT**4)*CKM31**2*complexconjugate(CKM31)**2 + 2*(MD**2*MS**2 + MT**2*MU**2)*CKM12*CKM31*complexconjugate(CKM11)*complexconjugate(CKM32) + 2*(MS**4 + MT**2*MU**2)*CKM12*CKM32*complexconjugate(CKM12)*complexconjugate(CKM32) + 2*(MB**2*MS**2 + MT**2*MU**2)*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) + 2*(MD**2*MS**2 + MC**2*MT**2)*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) + 2*(MS**4 + MC**2*MT**2)*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) + 2*(MB**2*MS**2 + MC**2*MT**2)*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) + 2*(MD**2*MS**2 + MT**4)*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) + (MS**4 + MT**4)*CKM32**2*complexconjugate(CKM32)**2 + 2*(MB**2*MD**2 + MT**2*MU**2)*CKM13*CKM31*complexconjugate(CKM11)*complexconjugate(CKM33) + 2*(MB**2*MS**2 + MT**2*MU**2)*CKM13*CKM32*complexconjugate(CKM12)*complexconjugate(CKM33) + 2*(MB**4 + MT**2*MU**2)*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) + 2*(MB**2*MD**2 + MC**2*MT**2)*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) + 2*(MB**2*MS**2 + MC**2*MT**2)*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) + 2*(MB**4 + MC**2*MT**2)*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) + 2*(MB**2*MD**2 + MT**4)*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) + 2*(MB**2*MS**2 + MT**4)*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) + (MB**4 + MT**4)*CKM33**2*complexconjugate(CKM33)**2)))/(3.*MW**2))/MW**2)))/(cmath.pi**2*sw**4)',
                             order = {'QED' : 4})


c_R2GmGpAA1Weak = Coupling(name = 'c_R2GmGpAA1Weak',
                           value = '(ee**4*complex(0,0.020833333333333332)*(1 - (4*((21 + cw**(-2))/16. + (Me**2 + MM**2 + MTA**2 + (5*Ncol*((MD**2 + MU**2)*CKM11*complexconjugate(CKM11) + (MS**2 + MU**2)*CKM12*complexconjugate(CKM12) + (MB**2 + MU**2)*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2)*CKM21*complexconjugate(CKM21) + (MC**2 + MS**2)*CKM22*complexconjugate(CKM22) + (MB**2 + MC**2)*CKM23*complexconjugate(CKM23) + (MD**2 + MT**2)*CKM31*complexconjugate(CKM31) + (MS**2 + MT**2)*CKM32*complexconjugate(CKM32) + (MB**2 + MT**2)*CKM33*complexconjugate(CKM33)))/6.)/MW**2))/sw**2))/cmath.pi**2',
                           order = {'QED' : 4})


c_R2GmGpAZ1Weak = Coupling(name = 'c_R2GmGpAZ1Weak',
                           value = '(ee**4*complex(0,0.010416666666666666)*(-1 + 2*cw**2 - 8*(-(1 + 10*cw**2 - 42*cw**4)/(32.*cw**2*sw**2) - ((Me**2 + MM**2 + MTA**2)*(1 - 5/(16.*sw**2)) + Ncol*((MD**2*(0.8333333333333334 - 7/(16.*sw**2)) + MU**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM11*complexconjugate(CKM11) + (MS**2*(0.8333333333333334 - 7/(16.*sw**2)) + MU**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM12*complexconjugate(CKM12) + (MB**2*(0.8333333333333334 - 7/(16.*sw**2)) + MU**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM13*complexconjugate(CKM13) + (MD**2*(0.8333333333333334 - 7/(16.*sw**2)) + MC**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM21*complexconjugate(CKM21) + (MS**2*(0.8333333333333334 - 7/(16.*sw**2)) + MC**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM22*complexconjugate(CKM22) + (MB**2*(0.8333333333333334 - 7/(16.*sw**2)) + MC**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM23*complexconjugate(CKM23) + (MD**2*(0.8333333333333334 - 7/(16.*sw**2)) + MT**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM31*complexconjugate(CKM31) + (MS**2*(0.8333333333333334 - 7/(16.*sw**2)) + MT**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM32*complexconjugate(CKM32) + (MB**2*(0.8333333333333334 - 7/(16.*sw**2)) + MT**2*(0.8333333333333334 - 3/(8.*sw**2)))*CKM33*complexconjugate(CKM33)))/MW**2)))/(cw*cmath.pi**2*sw)',
                           order = {'QED' : 4})


c_R2GmGpZZ1Weak = Coupling(name = 'c_R2GmGpZZ1Weak',
                           value = '(ee**4*complex(0,0.005208333333333333)*((1 - 2*cw**2)**2/sw**2 + 16*((-1 + 2*cw**2 + 44*cw**4 - 84*cw**6)/(64.*cw**2*sw**4) - ((Me**2 + MM**2 + MTA**2)*(1 + 1/(4.*sw**4) - 5/(8.*sw**2)) + (Ncol*((2*MU**2*(3 - 9*sw**2 + 10*sw**4) + MD**2*(6 - 21*sw**2 + 20*sw**4))*CKM11*complexconjugate(CKM11) + (2*MU**2*(3 - 9*sw**2 + 10*sw**4) + MS**2*(6 - 21*sw**2 + 20*sw**4))*CKM12*complexconjugate(CKM12) + (2*MU**2*(3 - 9*sw**2 + 10*sw**4) + MB**2*(6 - 21*sw**2 + 20*sw**4))*CKM13*complexconjugate(CKM13) + (2*MC**2*(3 - 9*sw**2 + 10*sw**4) + MD**2*(6 - 21*sw**2 + 20*sw**4))*CKM21*complexconjugate(CKM21) + (2*MC**2*(3 - 9*sw**2 + 10*sw**4) + MS**2*(6 - 21*sw**2 + 20*sw**4))*CKM22*complexconjugate(CKM22) + (2*MC**2*(3 - 9*sw**2 + 10*sw**4) + MB**2*(6 - 21*sw**2 + 20*sw**4))*CKM23*complexconjugate(CKM23) + (2*MT**2*(3 - 9*sw**2 + 10*sw**4) + MD**2*(6 - 21*sw**2 + 20*sw**4))*CKM31*complexconjugate(CKM31) + (2*MT**2*(3 - 9*sw**2 + 10*sw**4) + MS**2*(6 - 21*sw**2 + 20*sw**4))*CKM32*complexconjugate(CKM32) + (2*MT**2*(3 - 9*sw**2 + 10*sw**4) + MB**2*(6 - 21*sw**2 + 20*sw**4))*CKM33*complexconjugate(CKM33)))/(24.*sw**4))/MW**2)))/(cw**2*cmath.pi**2)',
                           order = {'QED' : 4})


c_R2GmGpWmWp1Weak = Coupling(name = 'c_R2GmGpWmWp1Weak',
                             value = '(ee**4*complex(0,0.0013020833333333333)*(-16*cw**2*Me**2 - 16*cw**2*MM**2 - 16*cw**2*MTA**2 - MW**2 - 38*cw**2*MW**2 - 14*cw**2*MW**2*sw**2 + 72*cw**4*MW**2*sw**2 + 48*cw**2*lhv*MW**2*sw**2 - 16*cw**2*(MD**2 + MU**2)*Ncol*CKM11**2*complexconjugate(CKM11)**2 - 16*cw**2*(MS**2 + MU**2)*Ncol*CKM12**2*complexconjugate(CKM12)**2 - 16*cw**2*MB**2*Ncol*CKM13**2*complexconjugate(CKM13)**2 - 16*cw**2*MU**2*Ncol*CKM13**2*complexconjugate(CKM13)**2 - 16*cw**2*MB**2*Ncol*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) - 16*cw**2*MC**2*Ncol*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) - 16*cw**2*MD**2*Ncol*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) - 16*cw**2*MU**2*Ncol*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) - 16*cw**2*MC**2*Ncol*CKM21**2*complexconjugate(CKM21)**2 - 16*cw**2*MD**2*Ncol*CKM21**2*complexconjugate(CKM21)**2 - 16*cw**2*MB**2*Ncol*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) - 16*cw**2*MC**2*Ncol*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) - 16*cw**2*MS**2*Ncol*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) - 16*cw**2*MU**2*Ncol*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) - 32*cw**2*MC**2*Ncol*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) - 16*cw**2*MD**2*Ncol*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) - 16*cw**2*MS**2*Ncol*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) - 16*cw**2*MC**2*Ncol*CKM22**2*complexconjugate(CKM22)**2 - 16*cw**2*MS**2*Ncol*CKM22**2*complexconjugate(CKM22)**2 - 32*cw**2*MB**2*Ncol*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) - 16*cw**2*MC**2*Ncol*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) - 16*cw**2*MU**2*Ncol*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) - 16*cw**2*MB**2*Ncol*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) - 32*cw**2*MC**2*Ncol*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) - 16*cw**2*MD**2*Ncol*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) - 16*cw**2*MB**2*Ncol*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) - 32*cw**2*MC**2*Ncol*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) - 16*cw**2*MS**2*Ncol*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) - 16*cw**2*MB**2*Ncol*CKM23**2*complexconjugate(CKM23)**2 - 16*cw**2*MC**2*Ncol*CKM23**2*complexconjugate(CKM23)**2 - 16*cw**2*MB**2*Ncol*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) - 16*cw**2*MD**2*Ncol*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) - 16*cw**2*MT**2*Ncol*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) - 16*cw**2*MU**2*Ncol*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) - 16*cw**2*MC**2*Ncol*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) - 32*cw**2*MD**2*Ncol*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) - 16*cw**2*MT**2*Ncol*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) - 16*cw**2*MC**2*Ncol*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) - 16*cw**2*MD**2*Ncol*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) - 16*cw**2*MS**2*Ncol*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) - 16*cw**2*MT**2*Ncol*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) - 16*cw**2*MB**2*Ncol*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) - 16*cw**2*MC**2*Ncol*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) - 16*cw**2*MD**2*Ncol*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) - 16*cw**2*MT**2*Ncol*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) - 16*cw**2*MD**2*Ncol*CKM31**2*complexconjugate(CKM31)**2 - 16*cw**2*MT**2*Ncol*CKM31**2*complexconjugate(CKM31)**2 - 16*cw**2*MB**2*Ncol*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) - 16*cw**2*MS**2*Ncol*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) - 16*cw**2*MT**2*Ncol*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) - 16*cw**2*MU**2*Ncol*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) - 16*cw**2*MC**2*Ncol*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) - 16*cw**2*MD**2*Ncol*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) - 16*cw**2*MS**2*Ncol*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) - 16*cw**2*MT**2*Ncol*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) - 16*cw**2*MC**2*Ncol*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) - 32*cw**2*MS**2*Ncol*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) - 16*cw**2*MT**2*Ncol*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) - 16*cw**2*MB**2*Ncol*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) - 16*cw**2*MC**2*Ncol*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) - 16*cw**2*MS**2*Ncol*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) - 16*cw**2*MT**2*Ncol*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) - 16*cw**2*MD**2*Ncol*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) - 16*cw**2*MS**2*Ncol*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) - 32*cw**2*MT**2*Ncol*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) - 16*cw**2*MS**2*Ncol*CKM32**2*complexconjugate(CKM32)**2 - 16*cw**2*MT**2*Ncol*CKM32**2*complexconjugate(CKM32)**2 - 32*cw**2*MB**2*Ncol*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) - 16*cw**2*MT**2*Ncol*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) - 16*cw**2*MU**2*Ncol*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) - 16*cw**2*MB**2*Ncol*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) - 16*cw**2*MC**2*Ncol*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) - 16*cw**2*MD**2*Ncol*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) - 16*cw**2*MT**2*Ncol*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) - 16*cw**2*MB**2*Ncol*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) - 16*cw**2*MC**2*Ncol*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) - 16*cw**2*MS**2*Ncol*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) - 16*cw**2*MT**2*Ncol*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) - 32*cw**2*MB**2*Ncol*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) - 16*cw**2*MC**2*Ncol*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) - 16*cw**2*MT**2*Ncol*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) - 16*cw**2*MB**2*Ncol*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) - 16*cw**2*MD**2*Ncol*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) - 32*cw**2*MT**2*Ncol*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) - 16*cw**2*MB**2*Ncol*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) - 16*cw**2*MS**2*Ncol*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) - 32*cw**2*MT**2*Ncol*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) - 16*cw**2*MB**2*Ncol*CKM33**2*complexconjugate(CKM33)**2 - 16*cw**2*MT**2*Ncol*CKM33**2*complexconjugate(CKM33)**2 - 16*cw**2*Ncol*complexconjugate(CKM11)*((MD**2 + MS**2 + 2*MU**2)*CKM11*CKM12*complexconjugate(CKM12) + (MB**2 + MD**2 + 2*MU**2)*CKM11*CKM13*complexconjugate(CKM13) + MC**2*CKM11*CKM21*complexconjugate(CKM21) + 2*MD**2*CKM11*CKM21*complexconjugate(CKM21) + MU**2*CKM11*CKM21*complexconjugate(CKM21) + MC**2*CKM12*CKM21*complexconjugate(CKM22) + MD**2*CKM12*CKM21*complexconjugate(CKM22) + MS**2*CKM12*CKM21*complexconjugate(CKM22) + MU**2*CKM12*CKM21*complexconjugate(CKM22) + MB**2*CKM13*CKM21*complexconjugate(CKM23) + MC**2*CKM13*CKM21*complexconjugate(CKM23) + MD**2*CKM13*CKM21*complexconjugate(CKM23) + MU**2*CKM13*CKM21*complexconjugate(CKM23) + 2*MD**2*CKM11*CKM31*complexconjugate(CKM31) + MT**2*CKM11*CKM31*complexconjugate(CKM31) + MU**2*CKM11*CKM31*complexconjugate(CKM31) + MD**2*CKM12*CKM31*complexconjugate(CKM32) + MS**2*CKM12*CKM31*complexconjugate(CKM32) + MT**2*CKM12*CKM31*complexconjugate(CKM32) + MU**2*CKM12*CKM31*complexconjugate(CKM32) + MB**2*CKM13*CKM31*complexconjugate(CKM33) + MD**2*CKM13*CKM31*complexconjugate(CKM33) + MT**2*CKM13*CKM31*complexconjugate(CKM33) + MU**2*CKM13*CKM31*complexconjugate(CKM33)) - 16*cw**2*Ncol*complexconjugate(CKM12)*((MB**2 + MS**2 + 2*MU**2)*CKM12*CKM13*complexconjugate(CKM13) + (MC**2 + MD**2 + MS**2 + MU**2)*CKM11*CKM22*complexconjugate(CKM21) + MC**2*CKM12*CKM22*complexconjugate(CKM22) + 2*MS**2*CKM12*CKM22*complexconjugate(CKM22) + MU**2*CKM12*CKM22*complexconjugate(CKM22) + MB**2*CKM13*CKM22*complexconjugate(CKM23) + MC**2*CKM13*CKM22*complexconjugate(CKM23) + MS**2*CKM13*CKM22*complexconjugate(CKM23) + MU**2*CKM13*CKM22*complexconjugate(CKM23) + MD**2*CKM11*CKM32*complexconjugate(CKM31) + MS**2*CKM11*CKM32*complexconjugate(CKM31) + MT**2*CKM11*CKM32*complexconjugate(CKM31) + MU**2*CKM11*CKM32*complexconjugate(CKM31) + 2*MS**2*CKM12*CKM32*complexconjugate(CKM32) + MT**2*CKM12*CKM32*complexconjugate(CKM32) + MU**2*CKM12*CKM32*complexconjugate(CKM32) + MB**2*CKM13*CKM32*complexconjugate(CKM33) + MS**2*CKM13*CKM32*complexconjugate(CKM33) + MT**2*CKM13*CKM32*complexconjugate(CKM33) + MU**2*CKM13*CKM32*complexconjugate(CKM33))))/(cw**2*MW**2*cmath.pi**2*sw**4)',
                             order = {'QED' : 4})


c_R2AAAA1Weak = Coupling(name = 'c_R2AAAA1Weak',
                         value = '(ee**4*(54 + 17*Ncol)*complex(0,0.0030864197530864196))/cmath.pi**2',
                         order = {'QED' : 4})


c_R2AAAZ1Weak = Coupling(name = 'c_R2AAAZ1Weak',
                         value = '(ee**4*(-81 + 108*cw**2 - 27*Ncol + 324*sw**2 + 68*Ncol*sw**2)*complex(0,-0.0007716049382716049))/(cw*cmath.pi**2*sw)',
                         order = {'QED' : 4})


c_R2AAZZ1Weak = Coupling(name = 'c_R2AAZZ1Weak',
                         value = '(ee**4*(216*cw**4 + Ncol*(-45 + 108*sw**2 - 136*sw**4) - 81*(1 - 4*sw**2 + 8*sw**4))*complex(0,-0.00038580246913580245))/(cw**2*cmath.pi**2*sw**2)',
                         order = {'QED' : 4})


c_R2AAWmWp1Weak = Coupling(name = 'c_R2AAWmWp1Weak',
                           value = '(ee**4*complex(0,0.010416666666666666)*(11 + 4*lhv - (6*(1 + (7 + 2*lhv)/3. + (11*Ncol*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/27.))/sw**2))/cmath.pi**2',
                           order = {'QED' : 4})


c_R2AAWmWp3Weak = Coupling(name = 'c_R2AAWmWp3Weak',
                           value = '(ee**4*complex(0,-0.020833333333333332)*(4*(1 + lhv) - (3*(3 + (2*(5 + 2*lhv))/3. + (25*Ncol*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/27.))/sw**2))/cmath.pi**2',
                           order = {'QED' : 4})


c_R2AZZZ1Weak = Coupling(name = 'c_R2AZZZ1Weak',
                         value = '(ee**4*(432*cw**6 + 81*(-1 + 6*sw**2 - 12*sw**4 + 16*sw**6) + Ncol*(-81 + 270*sw**2 - 324*sw**4 + 272*sw**6))*complex(0,-0.00019290123456790122))/(cw**3*cmath.pi**2*sw**3)',
                         order = {'QED' : 4})


c_R2AZWmWp1Weak = Coupling(name = 'c_R2AZWmWp1Weak',
                           value = '(ee**4*complex(0,0.010416666666666666)*(cw**2*(11 + 4*lhv) - 6*(-1 + 5/(4.*sw**2) + (cw**2*(7 + 2*lhv))/(3.*sw**2) + Ncol*(-0.4074074074074074 + 5/(12.*sw**2))*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))))/(cw*cmath.pi**2*sw)',
                           order = {'QED' : 4})


c_R2AZWmWp3Weak = Coupling(name = 'c_R2AZWmWp3Weak',
                           value = '(ee**4*complex(0,-0.020833333333333332)*(4*cw**2*(1 + lhv) + 3*(3 - 11/(4.*sw**2) - (2*cw**2*(5 + 2*lhv))/(3.*sw**2) + Ncol*(0.9259259259259259 - 11/(12.*sw**2))*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))))/(cw*cmath.pi**2*sw)',
                           order = {'QED' : 4})


c_R2ZZZZ1Weak = Coupling(name = 'c_R2ZZZZ1Weak',
                         value = '(ee**4*(432*cw**8 - 81*(1 - 2*sw**2 + 4*sw**4)**2 + Ncol*(-81 + 324*sw**2 - 540*sw**4 + 432*sw**6 - 272*sw**8))*complex(0,-0.00019290123456790122))/(cw**4*cmath.pi**2*sw**4)',
                         order = {'QED' : 4})


c_R2ZZWmWp1Weak = Coupling(name = 'c_R2ZZWmWp1Weak',
                           value = '(ee**4*complex(0,-0.010416666666666666)*((cw**2*(11 + 4*lhv))/(-1 + cw**2) + (2*((3*(4 + 5/sw**4 - 10/sw**2))/4. + (cw**4*(7 + 2*lhv))/sw**4 + (Ncol*(45 - 90*sw**2 + 44*sw**4)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/(36.*sw**4)))/cw**2))/cmath.pi**2',
                           order = {'QED' : 4})


c_R2ZZWmWp3Weak = Coupling(name = 'c_R2ZZWmWp3Weak',
                           value = '(ee**4*complex(0,0.08333333333333333)*((cw**2*(1 + lhv))/(-1 + cw**2) + (9 + 33/(4.*sw**4) + (2*cw**4*(5 + 2*lhv))/sw**4 - 33/(2.*sw**2) + (Ncol*(99 - 198*sw**2 + 100*sw**4)*(CKM11*complexconjugate(CKM11) + CKM12*complexconjugate(CKM12) + CKM13*complexconjugate(CKM13) + CKM21*complexconjugate(CKM21) + CKM22*complexconjugate(CKM22) + CKM23*complexconjugate(CKM23) + CKM31*complexconjugate(CKM31) + CKM32*complexconjugate(CKM32) + CKM33*complexconjugate(CKM33)))/(36.*sw**4))/(4.*cw**2)))/cmath.pi**2',
                           order = {'QED' : 4})


c_R2WmWpWmWp1Weak = Coupling(name = 'c_R2WmWpWmWp1Weak',
                             value = '(ee**4*complex(0,0.010416666666666666)*(15 + 4*lhv - 6*sw**2 + 6*cw**2*sw**2 - 16*lhv*sw**2 + 8*cw**2*lhv*sw**2 + 3*Ncol*CKM11**2*complexconjugate(CKM11)**2 + 3*Ncol*CKM12**2*complexconjugate(CKM12)**2 + 3*Ncol*CKM13**2*complexconjugate(CKM13)**2 + 6*Ncol*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) + 3*Ncol*CKM21**2*complexconjugate(CKM21)**2 + 6*Ncol*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) + 6*Ncol*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) + 3*Ncol*CKM22**2*complexconjugate(CKM22)**2 + 6*Ncol*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) + 6*Ncol*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) + 6*Ncol*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) + 3*Ncol*CKM23**2*complexconjugate(CKM23)**2 + 6*Ncol*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) + 6*Ncol*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) + 6*Ncol*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) + 6*Ncol*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) + 3*Ncol*CKM31**2*complexconjugate(CKM31)**2 + 6*Ncol*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) + 6*Ncol*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) + 6*Ncol*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) + 6*Ncol*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) + 6*Ncol*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) + 3*Ncol*CKM32**2*complexconjugate(CKM32)**2 + 6*Ncol*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) + 6*Ncol*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) + 6*Ncol*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) + 6*Ncol*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) + 6*Ncol*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) + 6*Ncol*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) + 3*Ncol*CKM33**2*complexconjugate(CKM33)**2 + 6*Ncol*complexconjugate(CKM11)*(CKM11*CKM12*complexconjugate(CKM12) + CKM11*CKM13*complexconjugate(CKM13) + CKM11*CKM21*complexconjugate(CKM21) + CKM12*CKM21*complexconjugate(CKM22) + CKM13*CKM21*complexconjugate(CKM23) + CKM11*CKM31*complexconjugate(CKM31) + CKM12*CKM31*complexconjugate(CKM32) + CKM13*CKM31*complexconjugate(CKM33)) + 6*Ncol*complexconjugate(CKM12)*(CKM12*CKM13*complexconjugate(CKM13) + CKM11*CKM22*complexconjugate(CKM21) + CKM12*CKM22*complexconjugate(CKM22) + CKM13*CKM22*complexconjugate(CKM23) + CKM11*CKM32*complexconjugate(CKM31) + CKM12*CKM32*complexconjugate(CKM32) + CKM13*CKM32*complexconjugate(CKM33))))/(cmath.pi**2*sw**4)',
                             order = {'QED' : 4})


c_R2WmWpWmWp2Weak = Coupling(name = 'c_R2WmWpWmWp2Weak',
                             value = '(ee**4*complex(0,0.041666666666666664)*((7 - 4*lhv + cw**2*(7 + 8*lhv))*sw**2 - 3*(1.25 + (7 + 2*lhv)/3. + (5*Ncol*(CKM11**2*complexconjugate(CKM11)**2 + 2*CKM11*CKM12*complexconjugate(CKM11)*complexconjugate(CKM12) + CKM12**2*complexconjugate(CKM12)**2 + 2*CKM11*CKM13*complexconjugate(CKM11)*complexconjugate(CKM13) + 2*CKM12*CKM13*complexconjugate(CKM12)*complexconjugate(CKM13) + CKM13**2*complexconjugate(CKM13)**2 + 2*CKM11*CKM21*complexconjugate(CKM11)*complexconjugate(CKM21) + 2*CKM11*CKM22*complexconjugate(CKM12)*complexconjugate(CKM21) + 2*CKM11*CKM23*complexconjugate(CKM13)*complexconjugate(CKM21) + CKM21**2*complexconjugate(CKM21)**2 + 2*CKM12*CKM21*complexconjugate(CKM11)*complexconjugate(CKM22) + 2*CKM12*CKM22*complexconjugate(CKM12)*complexconjugate(CKM22) + 2*CKM12*CKM23*complexconjugate(CKM13)*complexconjugate(CKM22) + 2*CKM21*CKM22*complexconjugate(CKM21)*complexconjugate(CKM22) + CKM22**2*complexconjugate(CKM22)**2 + 2*CKM13*CKM21*complexconjugate(CKM11)*complexconjugate(CKM23) + 2*CKM13*CKM22*complexconjugate(CKM12)*complexconjugate(CKM23) + 2*CKM13*CKM23*complexconjugate(CKM13)*complexconjugate(CKM23) + 2*CKM21*CKM23*complexconjugate(CKM21)*complexconjugate(CKM23) + 2*CKM22*CKM23*complexconjugate(CKM22)*complexconjugate(CKM23) + CKM23**2*complexconjugate(CKM23)**2 + 2*CKM11*CKM31*complexconjugate(CKM11)*complexconjugate(CKM31) + 2*CKM11*CKM32*complexconjugate(CKM12)*complexconjugate(CKM31) + 2*CKM11*CKM33*complexconjugate(CKM13)*complexconjugate(CKM31) + 2*CKM21*CKM31*complexconjugate(CKM21)*complexconjugate(CKM31) + 2*CKM21*CKM32*complexconjugate(CKM22)*complexconjugate(CKM31) + 2*CKM21*CKM33*complexconjugate(CKM23)*complexconjugate(CKM31) + CKM31**2*complexconjugate(CKM31)**2 + 2*CKM12*CKM31*complexconjugate(CKM11)*complexconjugate(CKM32) + 2*CKM12*CKM32*complexconjugate(CKM12)*complexconjugate(CKM32) + 2*CKM12*CKM33*complexconjugate(CKM13)*complexconjugate(CKM32) + 2*CKM22*CKM31*complexconjugate(CKM21)*complexconjugate(CKM32) + 2*CKM22*CKM32*complexconjugate(CKM22)*complexconjugate(CKM32) + 2*CKM22*CKM33*complexconjugate(CKM23)*complexconjugate(CKM32) + 2*CKM31*CKM32*complexconjugate(CKM31)*complexconjugate(CKM32) + CKM32**2*complexconjugate(CKM32)**2 + 2*CKM13*CKM31*complexconjugate(CKM11)*complexconjugate(CKM33) + 2*CKM13*CKM32*complexconjugate(CKM12)*complexconjugate(CKM33) + 2*CKM13*CKM33*complexconjugate(CKM13)*complexconjugate(CKM33) + 2*CKM23*CKM31*complexconjugate(CKM21)*complexconjugate(CKM33) + 2*CKM23*CKM32*complexconjugate(CKM22)*complexconjugate(CKM33) + 2*CKM23*CKM33*complexconjugate(CKM23)*complexconjugate(CKM33) + 2*CKM31*CKM33*complexconjugate(CKM31)*complexconjugate(CKM33) + 2*CKM32*CKM33*complexconjugate(CKM32)*complexconjugate(CKM33) + CKM33**2*complexconjugate(CKM33)**2))/12.)))/(cmath.pi**2*sw**4)',
                             order = {'QED' : 4})
