...
FFV6 = Lorentz(name = 'FFV6',
               spins = [ 2, 2, 3 ],
               structure = 'P(3,3)*ProjM(2,1) - P(\'m1\',3)*Gamma(3,2,\'s2\')*Gamma(\'m1\',\'s2\',\'s1\')*ProjM(\'s1\',1) + P(3,3)*ProjP(2,1) - P(\'m1\',3)*Gamma(3,2,\'s2\')*Gamma(\'m1\',\'s2\',\'s1\')*ProjP(\'s1\',1)')
...
FFVV1 = Lorentz(name = 'FFVV1',
                spins = [ 2, 2, 3, 3 ],
                structure = 'Metric(3,4)*ProjM(2,1) - Gamma(3,2,\'s2\')*Gamma(4,\'s2\',\'s1\')*ProjM(\'s1\',1)')

FFVV2 = Lorentz(name = 'FFVV2',
                spins = [ 2, 2, 3, 3 ],
                structure = 'Metric(3,4)*ProjP(2,1) - Gamma(3,2,\'s2\')*Gamma(4,\'s2\',\'s1\')*ProjP(\'s1\',1)')
...
FFVVS1 = Lorentz(name = 'FFVVS1',
                 spins = [ 2, 2, 3, 3, 1 ],
                 structure = 'Metric(3,4)*ProjM(2,1) - Gamma(3,2,\'s1\')*Gamma(4,\'s1\',\'s2\')*ProjM(\'s2\',1)')
