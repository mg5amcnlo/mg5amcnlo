...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      l=(i-1)*8
         ...
         call HwU_book(l+ 5,'m t-tx        ',20,log10(0.1d0),log10(4000d0))
         call HwU_book(l+ 6,'pt t          ',20,log10(0.1d0),log10(1000d0))
         call HwU_book(l+ 7,'pt tx         ',20,log10(0.1d0),log10(1000d0))
         call HwU_book(l+ 8,'pt t-tx       ',20,log10(0.1d0),log10(1000d0))
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &        /'only for process "p p > t t~ [QCD]"'
      ...
      i=1 
         ...
         if (pt_t .gt. 0d0) call HwU_fill(l+6,dlog10(pt_t),wgts)
         if (pt_tx .gt. 0d0) call HwU_fill(l+7,dlog10(pt_tx),wgts)
