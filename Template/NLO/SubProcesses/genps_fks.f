...
C dressed lepton stuff
      ...
      integer nmax_ee
      parameter (nmax_ee=4)
      double precision q2ref_ee, vol_ee, x1_ee, x2_ee
...
c Generate the rapditity of the Born system
           ...
           if (one_body) then
             ...
             xjac0 = xjac0 * vol_ee
             x1_ee=eepdf_fraction(x(ndim-4), Q2ref_ee, n_ee, idbmup(1), idbmup(1))
             x2_ee=eepdf_fraction(x(ndim-3), Q2ref_ee, n_ee, idbmup(2), idbmup(2))
