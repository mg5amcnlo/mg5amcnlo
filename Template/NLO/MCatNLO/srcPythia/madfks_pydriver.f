...
C QQIN IS THE EVENT FILE
      ...
      REAL*8 TMPLAM,GAMT0
      CHARACTER * 70 LHAPDF
      LOGICAL LHACRTL,OLDFORM,S_LHAPDF,PI_STABLE,W_STABLE,Z_STABLE
      ...
      COMMON/CIPROC/JPR
      COMMON/CPDFINFO/S_LHAPDF,AUTPDF,MODPDF,IPDF
     ...
     &WRITE(*,*)'Underlying event WILL NOT be generated'
      ...
      ELSEIF(IPDF.EQ.1)THEN
         DO I=1,2
            ...
            READ(*,*)MODPDF(I)
         ENDDO
         IF(AUTPDF(1).EQ.'LHAPDF')S_LHAPDF=.TRUE.
         IF(S_LHAPDF)THEN
...
C$$$C---SET LHACRTL TO FALSE IF LHAPDF DEFAULTS FOR 16, 18, AND 19 ARE OK
C$$$         IF(LHACRTL.AND.
C$$$     #      (AUTPDF(1).EQ.'LHAPDF'.OR.AUTPDF(1).EQ.'LHAEXT'))THEN
C$$$            LHAPDF='FREEZE'
C$$$            IF(AUTPDF(1).EQ.'LHAEXT')LHAPDF='EXTRAPOLATE'
C$$$            CALL SETLHACBLK(LHAPDF)
C$$$         ENDIF
C$$$      ENDIF
