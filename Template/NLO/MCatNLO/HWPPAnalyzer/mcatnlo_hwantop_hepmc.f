...
c
      call inihist
      k=0
      call mbook(k+ 1,'tt pt',2.e0,0.e0,100.e0)
      call mbook(k+ 2,'tt log[pt]',0.05e0,0.1e0,5.e0)
      call mbook(k+ 3,'tt inv m',10.e0,300.e0,1000.e0)
      call mbook(k+ 4,'tt azimt',pi/20.e0,0.e0,pi)
      call mbook(k+ 5,'tt del R',pi/20.e0,0.e0,3*pi)
      call mbook(k+ 6,'tb pt',5.e0,0.e0,500.e0)
      call mbook(k+ 7,'tb log[pt]',0.05e0,0.1e0,5.e0)
      call mbook(k+ 8,'t pt',5.e0,0.e0,500.e0)
      call mbook(k+ 9,'t log[pt]',0.05e0,0.1e0,5.e0)
      call mbook(k+10,'tt delta eta',0.2e0,-4.e0,4.e0)
      call mbook(k+11,'y_tt',0.1e0,-4.e0,4.e0)
      call mbook(k+12,'delta y',0.2e0,-4.e0,4.e0)
      call mbook(k+13,'tt azimt',pi/60.e0,2*pi/3,pi)
      call mbook(k+14,'tt del R',pi/60.e0,2*pi/3,4*pi/3)
      call mbook(k+15,'y_tb',0.1e0,-4.e0,4.e0)
      call mbook(k+16,'y_t',0.1e0,-4.e0,4.e0)
      call mbook(k+17,'tt log[pi-azimt]',0.05e0,-4.e0,0.1e0)
      call mbook(k+18,'tt pt',20.e0,80.e0,2000.e0)
      call mbook(k+19,'tb pt',20.e0,400.e0,2400.e0)
      call mbook(k+20,'t pt',20.e0,400.e0,2400.e0)
      END
...
C     
      ...
      if(azinorm.gt.0)call mfill(17,sngl(log10(azinorm)),sngl(WWW0))
