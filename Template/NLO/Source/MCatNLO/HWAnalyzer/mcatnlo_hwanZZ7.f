...
c
      IFOUNDPAIRS=0
      IF( ABS(XM_LL(1)-RMASS(200)).LE.PAIRWIDTH .AND.
     #    ABS(XM_LL(2)-RMASS(200)).LE.PAIRWIDTH )
     #  IFOUNDPAIRS=1
      IF( ABS(XM_LL(3)-RMASS(200)).LE.PAIRWIDTH .AND.
     #    ABS(XM_LL(4)-RMASS(200)).LE.PAIRWIDTH )
