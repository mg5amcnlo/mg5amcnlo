...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      integer i,l
      character*6 cc(4)
c      character*12 cc(16)
      data cc/'|T@NLO','|T@LO ','|T@SD0','|T@SD1'/
...
c      do i=1,16
         ...
         if ((i.le.2.or.i.gt.4).and.ibody.ge.10) cycle ! do not fill sudakov corrections here
         if (i.eq.3.and.(ibody.ne.10.and.ibody.ne.3)) cycle ! fill sudakov/0+born for i=3
         if (i.eq.4.and.(ibody.ne.11.and.ibody.ne.3)) cycle ! fill sudakov/1+born for i=4

c         How to tag orders (QCD+QED*100)
c
c         if (i.eq. 5.and.orders_tag_plot.ne.4) cycle
c         if (i.eq. 6.and.orders_tag_plot.ne.202) cycle
c         if (i.eq. 7.and.orders_tag_plot.ne.400) cycle
c         if (i.eq. 8.and.orders_tag_plot.ne.6) cycle
c         if (i.eq. 9.and.orders_tag_plot.ne.204) cycle
c         if (i.eq.10.and.orders_tag_plot.ne.402) cycle
c         if (i.eq.11.and.orders_tag_plot.ne.600) cycle
c         if (i.eq.12.and.orders_tag_plot.ne.8) cycle
c         if (i.eq.13.and.orders_tag_plot.ne.206) cycle
c         if (i.eq.14.and.orders_tag_plot.ne.404) cycle
c         if (i.eq.15.and.orders_tag_plot.ne.602) cycle
c         if (i.eq.16.and.orders_tag_plot.ne.800) cycle
