...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      l=(kk-1)*48+(j-1)*24
      call rbook(l+ 1,'t pt        '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+ 2,'t log pt    '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+ 3,'t y         '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+ 4,'t eta       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call rbook(l+ 5,'j1 pt       '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+ 6,'j1 log pt   '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+ 7,'j1 y        '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+ 8,'j1 eta      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call rbook(l+ 9,'j2 pt       '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+10,'j2 log pt   '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+11,'j2 y        '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+12,'j2 eta      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call rbook(l+13,'bj1 pt      '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+14,'bj1 log pt  '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+15,'bj1 y       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+16,'bj1 eta     '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call rbook(l+17,'bj2 pt      '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+18,'bj2 log pt  '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+19,'bj2 y       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+20,'bj2 eta     '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call rbook(l+21,'syst pt     '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call rbook(l+22,'syst log pt '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call rbook(l+23,'syst y      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call rbook(l+24,'syst eta    '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      enddo
      enddo
