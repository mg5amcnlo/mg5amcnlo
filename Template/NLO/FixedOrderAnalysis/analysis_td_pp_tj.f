...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &     ,5d0,0d0,200d0)
      call bookup(l+ 2,'t log pt    '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+ 3,'t y         '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+ 4,'t eta       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call bookup(l+ 5,'j1 pt       '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call bookup(l+ 6,'j1 log pt   '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+ 7,'j1 y        '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+ 8,'j1 eta      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call bookup(l+ 9,'j2 pt       '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call bookup(l+10,'j2 log pt   '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+11,'j2 y        '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+12,'j2 eta      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call bookup(l+13,'bj1 pt      '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call bookup(l+14,'bj1 log pt  '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+15,'bj1 y       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+16,'bj1 eta     '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call bookup(l+17,'bj2 pt      '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call bookup(l+18,'bj2 log pt  '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+19,'bj2 y       '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+20,'bj2 eta     '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      call bookup(l+21,'syst pt     '//weights_info(kk)//cc(j)
     &     ,5d0,0d0,200d0)
      call bookup(l+22,'syst log pt '//weights_info(kk)//cc(j)
     &     ,0.05d0,0d0,5d0)
      call bookup(l+23,'syst y      '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
      call bookup(l+24,'syst eta    '//weights_info(kk)//cc(j)
     &     ,0.25d0,-6d0,6d0)
c
      enddo
      enddo
