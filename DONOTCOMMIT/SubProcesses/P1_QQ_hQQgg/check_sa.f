...
c
     ...
     .dsqrt(dabs(DOT(p(0,i),p(0,i))))
      ...
      write (*,*) "-----------------------------------------------------------------------------"
              ...
              FLAVOR(:,:) =1
        PDG_FOR_FLAVOR(1,1) = 1
        PDG_FOR_FLAVOR(2,1) = 1
        PDG_FOR_FLAVOR(3,1) = 25
        PDG_FOR_FLAVOR(4,1) = 1
        PDG_FOR_FLAVOR(5,1) = 1
        PDG_FOR_FLAVOR(6,1) = 21
        PDG_FOR_FLAVOR(7,1) = 21
        PDG_FOR_FLAVOR(1,2) = 1
        FLAVOR(2,2) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(2,2) = 2
        PDG_FOR_FLAVOR(3,2) = 25
        PDG_FOR_FLAVOR(4,2) = 1
        FLAVOR(5,2) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(5,2) = 2
        PDG_FOR_FLAVOR(6,2) = 21
        PDG_FOR_FLAVOR(7,2) = 21
        PDG_FOR_FLAVOR(1,3) = 1
        FLAVOR(2,3) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(2,3) = 3
        PDG_FOR_FLAVOR(3,3) = 25
        PDG_FOR_FLAVOR(4,3) = 1
        FLAVOR(5,3) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(5,3) = 3
        PDG_FOR_FLAVOR(6,3) = 21
        PDG_FOR_FLAVOR(7,3) = 21
        PDG_FOR_FLAVOR(1,4) = 1
        FLAVOR(2,4) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(2,4) = 4
        PDG_FOR_FLAVOR(3,4) = 25
        PDG_FOR_FLAVOR(4,4) = 1
        FLAVOR(5,4) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(5,4) = 4
        PDG_FOR_FLAVOR(6,4) = 21
        PDG_FOR_FLAVOR(7,4) = 21
        PDG_FOR_FLAVOR(1,5) = 1
        FLAVOR(2,5) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(2,5) = 4
        PDG_FOR_FLAVOR(3,5) = 25
        FLAVOR(4,5) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(4,5) = 2
        FLAVOR(5,5) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(5,5) = 3
        PDG_FOR_FLAVOR(6,5) = 21
        PDG_FOR_FLAVOR(7,5) = 21
        FLAVOR(1,6) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(1,6) = 2
        FLAVOR(2,6) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(2,6) = 2
        PDG_FOR_FLAVOR(3,6) = 25
        FLAVOR(4,6) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(4,6) = 2
        FLAVOR(5,6) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(5,6) = 2
        PDG_FOR_FLAVOR(6,6) = 21
        PDG_FOR_FLAVOR(7,6) = 21
        FLAVOR(1,7) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(1,7) = 2
        FLAVOR(2,7) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(2,7) = 3
        PDG_FOR_FLAVOR(3,7) = 25
        PDG_FOR_FLAVOR(4,7) = 1
        FLAVOR(5,7) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(5,7) = 4
        PDG_FOR_FLAVOR(6,7) = 21
        PDG_FOR_FLAVOR(7,7) = 21
        FLAVOR(1,8) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(1,8) = 2
        FLAVOR(2,8) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(2,8) = 3
        PDG_FOR_FLAVOR(3,8) = 25
        FLAVOR(4,8) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(4,8) = 2
        FLAVOR(5,8) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(5,8) = 3
        PDG_FOR_FLAVOR(6,8) = 21
        PDG_FOR_FLAVOR(7,8) = 21
        FLAVOR(1,9) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(1,9) = 2
        FLAVOR(2,9) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(2,9) = 4
        PDG_FOR_FLAVOR(3,9) = 25
        FLAVOR(4,9) = 2 ! PDG = 2
        PDG_FOR_FLAVOR(4,9) = 2
        FLAVOR(5,9) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(5,9) = 4
        PDG_FOR_FLAVOR(6,9) = 21
        PDG_FOR_FLAVOR(7,9) = 21
        FLAVOR(1,10) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(1,10) = 3
        FLAVOR(2,10) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(2,10) = 4
        PDG_FOR_FLAVOR(3,10) = 25
        FLAVOR(4,10) = 3 ! PDG = 3
        PDG_FOR_FLAVOR(4,10) = 3
        FLAVOR(5,10) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(5,10) = 4
        PDG_FOR_FLAVOR(6,10) = 21
        PDG_FOR_FLAVOR(7,10) = 21
        FLAVOR(1,11) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(1,11) = 4
        FLAVOR(2,11) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(2,11) = 4
        PDG_FOR_FLAVOR(3,11) = 25
        FLAVOR(4,11) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(4,11) = 4
        FLAVOR(5,11) = 4 ! PDG = 4
        PDG_FOR_FLAVOR(5,11) = 4
        PDG_FOR_FLAVOR(6,11) = 21
        PDG_FOR_FLAVOR(7,11) = 21
c     
