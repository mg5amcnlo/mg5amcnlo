...
#ifndef PY8MEs_R6_P1_sm_gg_ttxqq_H
#define PY8MEs_R6_P1_sm_gg_ttxqq_H
...
// Process: g g > t t~ u u~ WEIGHTED<=4 @6
// Process: g g > t t~ c c~ WEIGHTED<=4 @6
// Process: g g > t t~ d d~ WEIGHTED<=4 @6
// Process: g g > t t~ s s~ WEIGHTED<=4 @6
//--------------------------------------------------------------------------
...
class PY8MEs_R6_P1_sm_gg_ttxqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P1_sm_gg_ttxqq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R6_P1_sm_gg_ttxqq(); 
    ...
    virtual string name() const {return "gg_ttxqq (sm)";}

    virtual int code() const {return 10601;}
...
#endif  // PY8MEs_R6_P1_sm_gg_ttxqq_H
