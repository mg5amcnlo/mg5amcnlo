...
#ifndef PY8MEs_R3_P6_sm_gg_zqq_H
#define PY8MEs_R3_P6_sm_gg_zqq_H
...
class PY8MEs_R3_P6_sm_gg_zqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P6_sm_gg_zqq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R3_P6_sm_gg_zqq(); 
  ...
  private:
    ...
    double matrix_3_gg_zuux(); 
    double matrix_3_gg_zddx(); 
...
#endif  // PY8MEs_R3_P6_sm_gg_zqq_H
