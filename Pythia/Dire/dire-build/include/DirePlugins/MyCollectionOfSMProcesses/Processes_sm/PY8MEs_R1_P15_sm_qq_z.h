...
#ifndef PY8MEs_R1_P15_sm_qq_z_H
#define PY8MEs_R1_P15_sm_qq_z_H
...
class PY8MEs_R1_P15_sm_qq_z : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P15_sm_qq_z(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R1_P15_sm_qq_z(); 
    ...
    virtual string name() const {return "qq_z (sm)";}

    virtual int code() const {return 10115;}
  ...
  private:
    ...
    double matrix_1_uux_z(); 
    double matrix_1_ddx_z(); 
