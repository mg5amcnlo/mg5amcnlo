...
#ifndef PY8MEs_R3_P7_sm_gq_zgq_H
#define PY8MEs_R3_P7_sm_gq_zgq_H
...
class PY8MEs_R3_P7_sm_gq_zgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P7_sm_gq_zgq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R3_P7_sm_gq_zgq(); 
  ...
  private:
    ...
    double matrix_3_gu_zgu(); 
    double matrix_3_gd_zgd(); 
    double matrix_3_gux_zgux(); 
    double matrix_3_gdx_zgdx(); 
...
#endif  // PY8MEs_R3_P7_sm_gq_zgq_H
