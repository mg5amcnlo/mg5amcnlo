...
#ifndef PY8MEs_R6_P5_sm_qq_ttxqq_H
#define PY8MEs_R6_P5_sm_qq_ttxqq_H
...
class PY8MEs_R6_P5_sm_qq_ttxqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P5_sm_qq_ttxqq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R6_P5_sm_qq_ttxqq(); 
    ...
    virtual string name() const {return "qq_ttxqq (sm)";}

    virtual int code() const {return 10605;}
  ...
  private:
    ...
    static const int nwavefuncs = 51; 
    std::complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 65; 
    std::complex<double> amp[namplitudes]; 
    double matrix_6_uu_ttxuu(); 
    double matrix_6_uux_ttxuux(); 
    double matrix_6_uxux_ttxuxux(); 
    double matrix_6_uc_ttxuc(); 
    double matrix_6_uux_ttxccx(); 
    double matrix_6_ucx_ttxucx(); 
    double matrix_6_uxcx_ttxuxcx(); 

    // Constants for array limits
    static const int nexternal = 6; 
    static const int ninitial = 2; 
    static const int nprocesses = 7; 
...
#endif  // PY8MEs_R6_P5_sm_qq_ttxqq_H
