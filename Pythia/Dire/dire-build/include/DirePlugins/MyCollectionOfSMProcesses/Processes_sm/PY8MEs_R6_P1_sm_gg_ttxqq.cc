...
#include "PY8MEs_R6_P1_sm_gg_ttxqq.h"
...
// Exception class
class PY8MEs_R6_P1_sm_gg_ttxqqException : public exception
{
  virtual const char * what() const throw()
  {
    return "Exception in class 'PY8MEs_R6_P1_sm_gg_ttxqq'."; 
  }
}
PY8MEs_R6_P1_sm_gg_ttxqq_exception; 

// Required s-channel initialization
//int PY8MEs_R6_P1_sm_gg_ttxqq::req_s_channels[nreq_s_channels] = {}; 

int PY8MEs_R6_P1_sm_gg_ttxqq::helicities[ncomb][nexternal] = {{-1, -1, -1, -1,
...
vector < vec_int > PY8MEs_R6_P1_sm_gg_ttxqq::getHelicityConfigs(vector<int>
    permutation)
{
...
vector < vec_int > PY8MEs_R6_P1_sm_gg_ttxqq::getColorConfigs(int
...
vector<int> PY8MEs_R6_P1_sm_gg_ttxqq::getHelicityConfigForID(int hel_ID,
    vector<int> permutation)
{
  if (hel_ID < 0 || hel_ID >= ncomb)
  {
    cout <<  "Error in function 'getHelicityConfigForID' of class" << 
    " 'PY8MEs_R6_P1_sm_gg_ttxqq': Specified helicity ID '" << 
    hel_ID <<  "' cannot be found." << endl; 
    throw PY8MEs_R6_P1_sm_gg_ttxqq_exception; 
  }
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  {
...
int PY8MEs_R6_P1_sm_gg_ttxqq::getHelicityIDForConfig(vector<int> hel_config,
    vector<int> permutation)
{
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  ...
  if (hel_config.size() > 0)
  {
    ...
    if (user_ihel == -1)
    {
      ...
      " 'PY8MEs_R6_P1_sm_gg_ttxqq': Specified helicity" << 
...
vector<int> PY8MEs_R6_P1_sm_gg_ttxqq::getColorConfigForID(int color_ID, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_ID < 0 || color_ID >= int(color_configs[chosenProcID].size()))
  {
    ...
    " 'PY8MEs_R6_P1_sm_gg_ttxqq': Specified color ID '" << 
...
int PY8MEs_R6_P1_sm_gg_ttxqq::getColorIDForConfig(vector<int> color_config, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_config.size() > 0)
  {
      ...
      for (int j = 0; j < (nexternal * 2); j++ )
      {
        ...
        else
        {
          ...
          if (color_linked_pos == -1)
          {
            ...
            " 'PY8MEs_R6_P1_sm_gg_ttxqq': A color line could " << 
            " not be closed." << endl;
            return -2; 
            //throw PY8MEs_R6_P1_sm_gg_ttxqq_exception; 
          }
    ...
    {
      cout <<  "Error in function 'getColorIDForConfig' of class" << 
      " 'PY8MEs_R6_P1_sm_gg_ttxqq': Specified color" << 
      " configuration cannot be found." << endl; 
      return -2;
      //throw PY8MEs_R6_P1_sm_gg_ttxqq_exception; 
    }
...
vector < vec_double > PY8MEs_R6_P1_sm_gg_ttxqq::getAllResults(int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
double PY8MEs_R6_P1_sm_gg_ttxqq::getResult(int helicity_ID, int color_ID, int
    specify_proc_ID)
{
...
pair < vector<int> , int > PY8MEs_R6_P1_sm_gg_ttxqq::static_getPY8ME(vector<int> initial_pdgs, vector<int> final_pdgs, set<int> schannels) 
{
  ...
  const int in_pdgs[nprocs][ninitial] = {{21, 21}, {21, 21}, {21, 21}, {21,
      21}};
  const int out_pdgs[nprocs][nexternal - ninitial] = {{6, -6, 2, -2}, {6, -6,
      4, -4}, {6, -6, 1, -1}, {6, -6, 3, -3}};
...
//--------------------------------------------------------------------------
// Set momenta
void PY8MEs_R6_P1_sm_gg_ttxqq::setMomenta(vector < vec_double > momenta_picked)
{
  if (momenta_picked.size() != nexternal)
  {
    cout <<  "Error in function 'setMomenta' of class" << 
    " 'PY8MEs_R6_P1_sm_gg_ttxqq': Incorrect number of" << 
  ...
  for(int i = 0; i < nexternal; i++ )
  {
    ...
    {
      cout <<  "Error in function 'setMomenta' of class" << 
      " 'PY8MEs_R6_P1_sm_gg_ttxqq': A momentum was specified" << 
...
void PY8MEs_R6_P1_sm_gg_ttxqq::setColors(vector<int> colors_picked)
{
  ...
  if (colors_picked.size() != (2 * nexternal))
  {
    ...
    " 'PY8MEs_R6_P1_sm_gg_ttxqq': Incorrect number" << 
...
void PY8MEs_R6_P1_sm_gg_ttxqq::setHelicities(vector<int> helicities_picked) 
{
...
void PY8MEs_R6_P1_sm_gg_ttxqq::setPermutation(vector<int> perm_picked) 
{
...
void PY8MEs_R6_P1_sm_gg_ttxqq::setProcID(int procID_picked) 
{
...
void PY8MEs_R6_P1_sm_gg_ttxqq::initProc() 
{
  // Initialize vectors.
...
double PY8MEs_R6_P1_sm_gg_ttxqq::sigmaKin() 
{
...
void PY8MEs_R6_P1_sm_gg_ttxqq::calculate_wavefunctions(const int hel[])
{
  ...
  FFV1_1(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1P0_3(w[5], w[23], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_1(w[23], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
...
double PY8MEs_R6_P1_sm_gg_ttxqq::matrix_6_gg_ttxuux() 
{
  int i, j; 
  // Local variables
  ...
  double cf[ncolor][ncolor] = {{48, 16, 16, 6, 0, 16, -2, 0, -6, -2, -2, 6},
      {16, 48, 6, 16, 16, 0, 0, -2, -2, -6, 6, -2}, {16, 6, 48, 16, -2, 0, 0,
      16, -2, 6, -6, -2}, {6, 16, 16, 48, 0, -2, 16, 0, 6, -2, -2, -6}, {0, 16,
      -2, 0, 48, 16, 16, 6, 0, -2, 16, 0}, {16, 0, 0, -2, 16, 48, 6, 16, -2, 0,
      0, 16}, {-2, 0, 0, 16, 16, 6, 48, 16, 16, 0, 0, -2}, {0, -2, 16, 0, 6,
      16, 16, 48, 0, 16, -2, 0}, {-6, -2, -2, 6, 0, -2, 16, 0, 48, 16, 16, 6},
      {-2, -6, 6, -2, -2, 0, 0, 16, 16, 48, 6, 16}, {-2, 6, -6, -2, 16, 0, 0,
      -2, 16, 6, 48, 16}, {6, -2, -2, -6, 0, 16, -2, 0, 6, 16, 16, 48}};
