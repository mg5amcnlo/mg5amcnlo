...
#ifndef PY8MEs_R6_P0_sm_gg_ttxgg_H
#define PY8MEs_R6_P0_sm_gg_ttxgg_H
...
class PY8MEs_R6_P0_sm_gg_ttxgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P0_sm_gg_ttxgg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R6_P0_sm_gg_ttxgg(); 
    ...
    virtual string name() const {return "gg_ttxgg (sm)";}

    virtual int code() const {return 10606;}
...
#endif  // PY8MEs_R6_P0_sm_gg_ttxgg_H
