...
#ifndef PY8MEs_R5_P10_sm_gq_ttxq_H
#define PY8MEs_R5_P10_sm_gq_ttxq_H
...
class PY8MEs_R5_P10_sm_gq_ttxq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P10_sm_gq_ttxq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R5_P10_sm_gq_ttxq(); 
    ...
    virtual string name() const {return "gq_ttxq (sm)";}
  ...
  private:
    ...
    double matrix_5_gu_ttxu(); 
    double matrix_5_gux_ttxux(); 
...
#endif  // PY8MEs_R5_P10_sm_gq_ttxq_H
