...
#ifndef PY8MEs_R3_P9_sm_qq_zgg_H
#define PY8MEs_R3_P9_sm_qq_zgg_H
...
class PY8MEs_R3_P9_sm_qq_zgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P9_sm_qq_zgg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R3_P9_sm_qq_zgg(); 
    ...
    virtual int code() const {return 10309;}
  ...
  private:
    ...
    double matrix_3_uux_zgg(); 
    double matrix_3_ddx_zgg(); 
...
#endif  // PY8MEs_R3_P9_sm_qq_zgg_H
