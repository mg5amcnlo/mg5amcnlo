...
#ifndef PY8MEs_R4_P16_sm_qq_ttx_H
#define PY8MEs_R4_P16_sm_qq_ttx_H
...
class PY8MEs_R4_P16_sm_qq_ttx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P16_sm_qq_ttx(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R4_P16_sm_qq_ttx(); 
    ...
    virtual string name() const {return "qq_ttx (sm)";}

    virtual int code() const {return 10416;}
...
#endif  // PY8MEs_R4_P16_sm_qq_ttx_H
