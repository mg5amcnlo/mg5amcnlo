...
#ifndef PY8MEs_R2_P1_sm_qq_zg_H
#define PY8MEs_R2_P1_sm_qq_zg_H
...
class PY8MEs_R2_P1_sm_qq_zg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P1_sm_qq_zg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R2_P1_sm_qq_zg(); 
