...
#ifndef PY8MEs_R1_P2_sm_qq_z_H
#define PY8MEs_R1_P2_sm_qq_z_H
...
class PY8MEs_R1_P2_sm_qq_z : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P2_sm_qq_z(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R1_P2_sm_qq_z(); 
