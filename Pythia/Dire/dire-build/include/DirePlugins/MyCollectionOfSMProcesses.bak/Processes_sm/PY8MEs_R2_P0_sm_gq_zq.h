...
#ifndef PY8MEs_R2_P0_sm_gq_zq_H
#define PY8MEs_R2_P0_sm_gq_zq_H
...
class PY8MEs_R2_P0_sm_gq_zq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P0_sm_gq_zq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R2_P0_sm_gq_zq(); 
    ...
    virtual string name() const {return "gq_zq (sm)";}
  ...
  private:
    ...
    double matrix_2_gu_zu(); 
    double matrix_2_gd_zd(); 
    double matrix_2_gux_zux(); 
    double matrix_2_gdx_zdx(); 
    ...
    static const int nreq_s_channels = 1; // Note: Not correct. Only to avoid compiler warnings for DIRE 2.000 
