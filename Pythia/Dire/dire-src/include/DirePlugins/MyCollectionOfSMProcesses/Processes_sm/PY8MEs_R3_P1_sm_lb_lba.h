...
#ifndef PY8MEs_R3_P1_sm_lb_lba_H
#define PY8MEs_R3_P1_sm_lb_lba_H
...
class PY8MEs_R3_P1_sm_lb_lba : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P1_sm_lb_lba(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R3_P1_sm_lb_lba(); 
    ...
    virtual string name() const {return "lb_lba (sm)";}

    virtual int code() const {return 10301;}
  ...
  private:
    ...
    static const int namplitudes = 40; 
    std::complex<double> amp[namplitudes]; 
    double matrix_3_emb_emba(); 
    double matrix_3_embx_embxa(); 
    double matrix_3_epb_epba(); 
    double matrix_3_epbx_epbxa(); 
    double matrix_3_veb_veba(); 
    double matrix_3_vebx_vebxa(); 
    double matrix_3_vexb_vexba(); 
    double matrix_3_vexbx_vexbxa(); 
...
#endif  // PY8MEs_R3_P1_sm_lb_lba_H
