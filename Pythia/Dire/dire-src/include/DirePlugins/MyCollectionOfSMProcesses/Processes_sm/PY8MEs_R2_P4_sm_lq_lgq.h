...
#ifndef PY8MEs_R2_P4_sm_lq_lgq_H
#define PY8MEs_R2_P4_sm_lq_lgq_H
...
class PY8MEs_R2_P4_sm_lq_lgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P4_sm_lq_lgq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P4_sm_lq_lgq(); 
    ...
    virtual string name() const {return "lq_lgq (sm)";}
  ...
  private:
    ...
    static const int namplitudes = 56; 
    std::complex<double> amp[namplitudes]; 
    double matrix_2_emu_emgu(); 
    double matrix_2_emd_emgd(); 
    double matrix_2_emux_emgux(); 
    double matrix_2_emdx_emgdx(); 
    double matrix_2_epu_epgu(); 
    double matrix_2_epd_epgd(); 
    double matrix_2_epux_epgux(); 
    double matrix_2_epdx_epgdx(); 
    double matrix_2_emu_vegd(); 
    double matrix_2_emdx_vegux(); 
    double matrix_2_veu_vegu(); 
    double matrix_2_ved_vegd(); 
    double matrix_2_veux_vegux(); 
    double matrix_2_vedx_vegdx(); 
    double matrix_2_epd_vexgu(); 
    double matrix_2_epux_vexgdx(); 
    double matrix_2_vexu_vexgu(); 
    double matrix_2_vexd_vexgd(); 
    double matrix_2_vexux_vexgux(); 
    double matrix_2_vexdx_vexgdx(); 
...
#endif  // PY8MEs_R2_P4_sm_lq_lgq_H
