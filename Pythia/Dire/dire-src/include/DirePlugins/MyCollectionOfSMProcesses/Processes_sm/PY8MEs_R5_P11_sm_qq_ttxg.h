...
#ifndef PY8MEs_R5_P11_sm_qq_ttxg_H
#define PY8MEs_R5_P11_sm_qq_ttxg_H
...
class PY8MEs_R5_P11_sm_qq_ttxg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P11_sm_qq_ttxg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R5_P11_sm_qq_ttxg(); 
    ...
    virtual string name() const {return "qq_ttxg (sm)";}
...
#endif  // PY8MEs_R5_P11_sm_qq_ttxg_H
