...
#ifndef PY8MEs_R2_P5_sm_lb_lgb_H
#define PY8MEs_R2_P5_sm_lb_lgb_H
...
class PY8MEs_R2_P5_sm_lb_lgb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P5_sm_lb_lgb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P5_sm_lb_lgb(); 
    ...
    virtual string name() const {return "lb_lgb (sm)";}
  ...
  private:
    ...
    double matrix_2_emb_emgb(); 
    double matrix_2_embx_emgbx(); 
    double matrix_2_epb_epgb(); 
    double matrix_2_epbx_epgbx(); 
    double matrix_2_veb_vegb(); 
    double matrix_2_vebx_vegbx(); 
    double matrix_2_vexb_vexgb(); 
    double matrix_2_vexbx_vexgbx(); 
...
#endif  // PY8MEs_R2_P5_sm_lb_lgb_H
