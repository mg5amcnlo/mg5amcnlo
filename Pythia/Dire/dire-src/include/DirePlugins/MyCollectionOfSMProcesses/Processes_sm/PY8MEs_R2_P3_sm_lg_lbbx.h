...
#ifndef PY8MEs_R2_P3_sm_lg_lbbx_H
#define PY8MEs_R2_P3_sm_lg_lbbx_H
...
class PY8MEs_R2_P3_sm_lg_lbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P3_sm_lg_lbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P3_sm_lg_lbbx(); 
    ...
    virtual string name() const {return "lg_lbbx (sm)";}
  ...
  private:
    ...
    double matrix_2_emg_embbx(); 
    double matrix_2_epg_epbbx(); 
    double matrix_2_veg_vebbx(); 
    double matrix_2_vexg_vexbbx(); 
...
#endif  // PY8MEs_R2_P3_sm_lg_lbbx_H
