...
#ifndef PY8MEs_R2_P13_sm_gq_zq_H
#define PY8MEs_R2_P13_sm_gq_zq_H
...
class PY8MEs_R2_P13_sm_gq_zq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P13_sm_gq_zq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R2_P13_sm_gq_zq(); 
    ...
    virtual int code() const {return 10213;}
...
#endif  // PY8MEs_R2_P13_sm_gq_zq_H
