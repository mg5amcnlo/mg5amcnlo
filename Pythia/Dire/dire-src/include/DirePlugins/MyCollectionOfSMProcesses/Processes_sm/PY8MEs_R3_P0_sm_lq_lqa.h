...
#ifndef PY8MEs_R3_P0_sm_lq_lqa_H
#define PY8MEs_R3_P0_sm_lq_lqa_H
...
class PY8MEs_R3_P0_sm_lq_lqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P0_sm_lq_lqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R3_P0_sm_lq_lqa(); 
    ...
    virtual string name() const {return "lq_lqa (sm)";}
  ...
  private:
    ...
    static const int namplitudes = 112; 
    std::complex<double> amp[namplitudes]; 
    double matrix_3_emu_emua(); 
    double matrix_3_emd_emda(); 
    double matrix_3_emux_emuxa(); 
    double matrix_3_emdx_emdxa(); 
    double matrix_3_epu_epua(); 
    double matrix_3_epd_epda(); 
    double matrix_3_epux_epuxa(); 
    double matrix_3_epdx_epdxa(); 
    double matrix_3_emu_veda(); 
    double matrix_3_emdx_veuxa(); 
    double matrix_3_ved_emua(); 
    double matrix_3_veux_emdxa(); 
    double matrix_3_epd_vexua(); 
    double matrix_3_epux_vexdxa(); 
    double matrix_3_vexu_epda(); 
    double matrix_3_vexdx_epuxa(); 
    double matrix_3_veu_veua(); 
    double matrix_3_ved_veda(); 
    double matrix_3_veux_veuxa(); 
    double matrix_3_vedx_vedxa(); 
    double matrix_3_vexu_vexua(); 
    double matrix_3_vexd_vexda(); 
    double matrix_3_vexux_vexuxa(); 
    double matrix_3_vexdx_vexdxa(); 
...
#endif  // PY8MEs_R3_P0_sm_lq_lqa_H
