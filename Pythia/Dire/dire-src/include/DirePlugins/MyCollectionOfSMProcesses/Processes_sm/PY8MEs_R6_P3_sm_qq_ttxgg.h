...
#ifndef PY8MEs_R6_P3_sm_qq_ttxgg_H
#define PY8MEs_R6_P3_sm_qq_ttxgg_H
...
class PY8MEs_R6_P3_sm_qq_ttxgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P3_sm_qq_ttxgg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R6_P3_sm_qq_ttxgg(); 
    ...
    virtual string name() const {return "qq_ttxgg (sm)";}

    virtual int code() const {return 10603;}
...
#endif  // PY8MEs_R6_P3_sm_qq_ttxgg_H
