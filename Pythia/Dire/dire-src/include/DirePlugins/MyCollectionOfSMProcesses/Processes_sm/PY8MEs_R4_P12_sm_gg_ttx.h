...
#ifndef PY8MEs_R4_P12_sm_gg_ttx_H
#define PY8MEs_R4_P12_sm_gg_ttx_H
...
class PY8MEs_R4_P12_sm_gg_ttx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P12_sm_gg_ttx(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R4_P12_sm_gg_ttx(); 
...
#endif  // PY8MEs_R4_P12_sm_gg_ttx_H
