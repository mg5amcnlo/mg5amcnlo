...
#ifndef PY8MEs_R6_P2_sm_gq_ttxgq_H
#define PY8MEs_R6_P2_sm_gq_ttxgq_H
...
class PY8MEs_R6_P2_sm_gq_ttxgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P2_sm_gq_ttxgq(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R6_P2_sm_gq_ttxgq(); 
    ...
    virtual string name() const {return "gq_ttxgq (sm)";}

    virtual int code() const {return 10602;}
  ...
  private:
    ...
    double matrix_6_gu_ttxgu(); 
    double matrix_6_gux_ttxgux(); 
...
#endif  // PY8MEs_R6_P2_sm_gq_ttxgq_H
