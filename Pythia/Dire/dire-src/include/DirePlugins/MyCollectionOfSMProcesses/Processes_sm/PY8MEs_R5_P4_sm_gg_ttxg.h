...
#ifndef PY8MEs_R5_P4_sm_gg_ttxg_H
#define PY8MEs_R5_P4_sm_gg_ttxg_H
...
class PY8MEs_R5_P4_sm_gg_ttxg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P4_sm_gg_ttxg(Parameters_sm * model) {pars = model; initProc();}

    // Destructor.
    ~PY8MEs_R5_P4_sm_gg_ttxg(); 
    ...
    virtual string name() const {return "gg_ttxg (sm)";}
...
#endif  // PY8MEs_R5_P4_sm_gg_ttxg_H
