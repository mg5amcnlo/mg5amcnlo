...
void Sigma2Process::store2Kin( double x1in, double x2in, double sHin,
  ...
  //double mu2 = 2.*sH*tH*uH / ( pow2(sH) + pow2(tH) + pow2(uH) );
  //double mu2 = -1./ (1/sH + 1/tH + 1/uH) / sqrt(2);
...
if(settingsPtr->flag("HardQCD:all") ) Q2RenSave = renormMultFac*mu2;
...
if(settingsPtr->flag("HardQCD:all") ) Q2FacSave = factorMultFac*mu2;
