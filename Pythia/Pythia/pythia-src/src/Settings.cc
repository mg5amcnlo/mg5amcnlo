...
//  // Read full string, strip leading and trailing whitespace
//  getline(splitLine, valueString);
//  while(std::isspace(*valueString.begin()))
//    valueString.erase(valueString.begin());
//  while(std::isspace(*valueString.rbegin()))
