...
#ifndef PY8MEs_R221_P27_sm_ckm_qq_bq_H
#define PY8MEs_R221_P27_sm_ckm_qq_bq_H
...
class PY8MEs_R221_P27_sm_ckm_qq_bq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P27_sm_ckm_qq_bq(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P27_sm_ckm_qq_bq(); 
    ...
    virtual string name() const {return "qq_bq (sm_ckm)";}

    virtual int code() const {return 32127;}
  ...
  private:
    ...
    double matrix_221_ud_bu(); 
    double matrix_221_ud_bc(); 
    double matrix_221_us_bu(); 
    double matrix_221_uux_bdx(); 
    double matrix_221_uux_bsx(); 
    double matrix_221_ucx_bdx(); 
    double matrix_221_cd_bu(); 
    double matrix_221_cd_bc(); 
    double matrix_221_cs_bu(); 
    double matrix_221_cux_bdx(); 
    double matrix_221_cux_bsx(); 
    double matrix_221_ccx_bdx(); 
    double matrix_221_dux_bux(); 
    double matrix_221_dux_bcx(); 
    double matrix_221_dcx_bux(); 
    double matrix_221_dcx_bcx(); 
    double matrix_221_sux_bux(); 
    double matrix_221_sux_bcx(); 
    double matrix_221_uux_bxd(); 
    double matrix_221_uux_bxs(); 
    double matrix_221_ucx_bxd(); 
    double matrix_221_ucx_bxs(); 
    double matrix_221_udx_bxu(); 
    double matrix_221_udx_bxc(); 
    double matrix_221_usx_bxu(); 
    double matrix_221_usx_bxc(); 
    double matrix_221_cux_bxd(); 
    double matrix_221_ccx_bxd(); 
    double matrix_221_cdx_bxu(); 
    double matrix_221_cdx_bxc(); 
    double matrix_221_uxdx_bxux(); 
    double matrix_221_uxdx_bxcx(); 
    double matrix_221_uxsx_bxux(); 
    double matrix_221_cxdx_bxux(); 
    double matrix_221_cxdx_bxcx(); 
    double matrix_221_cxsx_bxux(); 
...
#endif  // PY8MEs_R221_P27_sm_ckm_qq_bq_H
