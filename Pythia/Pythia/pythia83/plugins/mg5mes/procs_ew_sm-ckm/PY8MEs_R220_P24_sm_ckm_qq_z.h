...
#ifndef PY8MEs_R220_P24_sm_ckm_qq_z_H
#define PY8MEs_R220_P24_sm_ckm_qq_z_H
...
// Process: u u~ > z WEIGHTED<=2 @220
// Process: c c~ > z WEIGHTED<=2 @220
// Process: d d~ > z WEIGHTED<=2 @220
// Process: s s~ > z WEIGHTED<=2 @220
//--------------------------------------------------------------------------
...
class PY8MEs_R220_P24_sm_ckm_qq_z : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R220_P24_sm_ckm_qq_z(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R220_P24_sm_ckm_qq_z(); 
    ...
    virtual string name() const {return "qq_z (sm_ckm)";}

    virtual int code() const {return 32024;}
  ...
  private:
    ...
    double matrix_22uux_z(); 
    double matrix_22ddx_z(); 
...
#endif  // PY8MEs_R220_P24_sm_ckm_qq_z_H
