...
#ifndef PY8MEs_R121_P12_sm_ckm_ll_bbx_H
#define PY8MEs_R121_P12_sm_ckm_ll_bbx_H
...
class PY8MEs_R121_P12_sm_ckm_ll_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R121_P12_sm_ckm_ll_bbx(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R121_P12_sm_ckm_ll_bbx(); 
    ...
    virtual string name() const {return "ll_bbx (sm_ckm)";}

    virtual int code() const {return 22112;}
...
#endif  // PY8MEs_R121_P12_sm_ckm_ll_bbx_H
