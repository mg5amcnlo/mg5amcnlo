...
#ifndef PY8MEs_R220_P25_sm_ckm_qq_wp_H
#define PY8MEs_R220_P25_sm_ckm_qq_wp_H
...
// Process: u d~ > w+ WEIGHTED<=2 @220
// Process: c s~ > w+ WEIGHTED<=2 @220
// Process: u s~ > w+ WEIGHTED<=2 @220
// Process: c d~ > w+ WEIGHTED<=2 @220
// Process: d u~ > w- WEIGHTED<=2 @220
// Process: s c~ > w- WEIGHTED<=2 @220
// Process: d c~ > w- WEIGHTED<=2 @220
// Process: s u~ > w- WEIGHTED<=2 @220
//--------------------------------------------------------------------------
...
class PY8MEs_R220_P25_sm_ckm_qq_wp : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R220_P25_sm_ckm_qq_wp(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R220_P25_sm_ckm_qq_wp(); 
    ...
    virtual string name() const {return "qq_wp (sm_ckm)";}

    virtual int code() const {return 32025;}
  ...
  private:
    ...
    double matrix_22udx_wp(); 
    double matrix_22usx_wp(); 
    double matrix_22cdx_wp(); 
    double matrix_22dux_wm(); 
    double matrix_22dcx_wm(); 
    double matrix_22sux_wm(); 
...
#endif  // PY8MEs_R220_P25_sm_ckm_qq_wp_H
