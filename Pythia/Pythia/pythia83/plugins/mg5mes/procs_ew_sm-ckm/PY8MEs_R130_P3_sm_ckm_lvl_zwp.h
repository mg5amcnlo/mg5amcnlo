...
#ifndef PY8MEs_R130_P3_sm_ckm_lvl_zwp_H
#define PY8MEs_R130_P3_sm_ckm_lvl_zwp_H
...
class PY8MEs_R130_P3_sm_ckm_lvl_zwp : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P3_sm_ckm_lvl_zwp(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R130_P3_sm_ckm_lvl_zwp(); 
    ...
    virtual string name() const {return "lvl_zwp (sm_ckm)";}
  ...
  private:
    ...
    double matrix_13epve_zwp(); 
    double matrix_13vexem_zwm(); 
...
#endif  // PY8MEs_R130_P3_sm_ckm_lvl_zwp_H
