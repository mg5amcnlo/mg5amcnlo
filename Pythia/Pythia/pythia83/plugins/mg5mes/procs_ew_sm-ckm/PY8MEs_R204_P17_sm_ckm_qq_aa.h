...
#ifndef PY8MEs_R204_P17_sm_ckm_qq_aa_H
#define PY8MEs_R204_P17_sm_ckm_qq_aa_H
...
// Process: u u~ > a a WEIGHTED<=4 @204
// Process: c c~ > a a WEIGHTED<=4 @204
// Process: d d~ > a a WEIGHTED<=4 @204
// Process: s s~ > a a WEIGHTED<=4 @204
//--------------------------------------------------------------------------
...
class PY8MEs_R204_P17_sm_ckm_qq_aa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R204_P17_sm_ckm_qq_aa(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R204_P17_sm_ckm_qq_aa(); 
    ...
    virtual string name() const {return "qq_aa (sm_ckm)";}

    virtual int code() const {return 30417;}
  ...
  private:
    ...
    double matrix_204_uux_aa(); 
    double matrix_204_ddx_aa(); 
...
#endif  // PY8MEs_R204_P17_sm_ckm_qq_aa_H
