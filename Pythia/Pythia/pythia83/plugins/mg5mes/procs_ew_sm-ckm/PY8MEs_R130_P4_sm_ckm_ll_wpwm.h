...
#ifndef PY8MEs_R130_P4_sm_ckm_ll_wpwm_H
#define PY8MEs_R130_P4_sm_ckm_ll_wpwm_H
...
// Process: e+ e- > w+ w- WEIGHTED<=4 @130
// Process: mu+ mu- > w+ w- WEIGHTED<=4 @130
//--------------------------------------------------------------------------
...
class PY8MEs_R130_P4_sm_ckm_ll_wpwm : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P4_sm_ckm_ll_wpwm(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R130_P4_sm_ckm_ll_wpwm(); 
    ...
    virtual string name() const {return "ll_wpwm (sm_ckm)";}

    virtual int code() const {return 23004;}
...
#endif  // PY8MEs_R130_P4_sm_ckm_ll_wpwm_H
