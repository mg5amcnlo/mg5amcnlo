...
#ifndef PY8MEs_R221_P5_sm_ckm_qq_bbx_H
#define PY8MEs_R221_P5_sm_ckm_qq_bbx_H
...
class PY8MEs_R221_P5_sm_ckm_qq_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P5_sm_ckm_qq_bbx(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P5_sm_ckm_qq_bbx(); 
    ...
    virtual string name() const {return "qq_bbx (sm_ckm)";}

    virtual int code() const {return 32105;}
  ...
  private:
    ...
    double matrix_221_uux_bbx(); 
    double matrix_221_ccx_bbx(); 
    double matrix_221_ddx_bbx(); 
    double matrix_221_ucx_bbx(); 
    double matrix_221_cux_bbx(); 

    // Constants for array limits
    static const int nexternal = 4; 
    static const int ninitial = 2; 
    static const int nprocesses = 5; 
...
#endif  // PY8MEs_R221_P5_sm_ckm_qq_bbx_H
