...
#ifndef PY8MEs_R230_P20_sm_ckm_qq_zz_H
#define PY8MEs_R230_P20_sm_ckm_qq_zz_H
...
class PY8MEs_R230_P20_sm_ckm_qq_zz : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R230_P20_sm_ckm_qq_zz(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R230_P20_sm_ckm_qq_zz(); 
    ...
    virtual string name() const {return "qq_zz (sm_ckm)";}

    virtual int code() const {return 33020;}
  ...
  private:
    ...
    double matrix_23uux_zz(); 
    double matrix_23ddx_zz(); 
...
#endif  // PY8MEs_R230_P20_sm_ckm_qq_zz_H
