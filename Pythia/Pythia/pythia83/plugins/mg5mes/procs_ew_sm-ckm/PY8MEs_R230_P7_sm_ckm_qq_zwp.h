...
#ifndef PY8MEs_R230_P7_sm_ckm_qq_zwp_H
#define PY8MEs_R230_P7_sm_ckm_qq_zwp_H
...
// Process: u d~ > z w+ WEIGHTED<=4 @230
// Process: c s~ > z w+ WEIGHTED<=4 @230
// Process: u s~ > z w+ WEIGHTED<=4 @230
// Process: c d~ > z w+ WEIGHTED<=4 @230
// Process: d u~ > z w- WEIGHTED<=4 @230
// Process: s c~ > z w- WEIGHTED<=4 @230
// Process: d c~ > z w- WEIGHTED<=4 @230
// Process: s u~ > z w- WEIGHTED<=4 @230
//--------------------------------------------------------------------------
...
class PY8MEs_R230_P7_sm_ckm_qq_zwp : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R230_P7_sm_ckm_qq_zwp(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R230_P7_sm_ckm_qq_zwp(); 
    ...
    virtual string name() const {return "qq_zwp (sm_ckm)";}

    virtual int code() const {return 33007;}
  ...
  private:
    ...
    double matrix_23udx_zwp(); 
    double matrix_23usx_zwp(); 
    double matrix_23cdx_zwp(); 
    double matrix_23dux_zwm(); 
    double matrix_23dcx_zwm(); 
    double matrix_23sux_zwm(); 
...
#endif  // PY8MEs_R230_P7_sm_ckm_qq_zwp_H
