...
#ifndef PY8MEs_R221_P19_sm_ckm_qq_tamtap_H
#define PY8MEs_R221_P19_sm_ckm_qq_tamtap_H
...
// Process: u u~ > ta- ta+ WEIGHTED<=4 @221
// Process: c c~ > ta- ta+ WEIGHTED<=4 @221
// Process: d d~ > ta- ta+ WEIGHTED<=4 @221
// Process: s s~ > ta- ta+ WEIGHTED<=4 @221
//--------------------------------------------------------------------------
...
class PY8MEs_R221_P19_sm_ckm_qq_tamtap : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P19_sm_ckm_qq_tamtap(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P19_sm_ckm_qq_tamtap(); 
    ...
    virtual string name() const {return "qq_tamtap (sm_ckm)";}

    virtual int code() const {return 32119;}
  ...
  private:
    ...
    double matrix_221_uux_tamtap(); 
    double matrix_221_ddx_tamtap(); 
...
#endif  // PY8MEs_R221_P19_sm_ckm_qq_tamtap_H
