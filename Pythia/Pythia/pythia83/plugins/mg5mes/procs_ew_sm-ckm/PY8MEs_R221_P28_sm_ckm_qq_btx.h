...
#ifndef PY8MEs_R221_P28_sm_ckm_qq_btx_H
#define PY8MEs_R221_P28_sm_ckm_qq_btx_H
...
// Process: d u~ > b t~ QCD=0 @221
// Process: s c~ > b t~ QCD=0 @221
// Process: d c~ > b t~ QCD=0 @221
// Process: s u~ > b t~ QCD=0 @221
//--------------------------------------------------------------------------
...
class PY8MEs_R221_P28_sm_ckm_qq_btx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P28_sm_ckm_qq_btx(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P28_sm_ckm_qq_btx(); 
    ...
    virtual string name() const {return "qq_btx (sm_ckm)";}

    virtual int code() const {return 32128;}
  ...
  private:
    ...
    double matrix_221_dux_btx(); 
    double matrix_221_dcx_btx(); 
    double matrix_221_sux_btx(); 
...
#endif  // PY8MEs_R221_P28_sm_ckm_qq_btx_H
