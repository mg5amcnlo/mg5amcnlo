...
#ifndef PY8MEs_R221_P18_sm_ckm_qq_ll_H
#define PY8MEs_R221_P18_sm_ckm_qq_ll_H
...
// Process: u u~ > e- e+ WEIGHTED<=4 @221
// Process: u u~ > mu- mu+ WEIGHTED<=4 @221
// Process: c c~ > e- e+ WEIGHTED<=4 @221
// Process: c c~ > mu- mu+ WEIGHTED<=4 @221
// Process: d d~ > e- e+ WEIGHTED<=4 @221
// Process: d d~ > mu- mu+ WEIGHTED<=4 @221
// Process: s s~ > e- e+ WEIGHTED<=4 @221
// Process: s s~ > mu- mu+ WEIGHTED<=4 @221
// Process: u u~ > ve ve~ WEIGHTED<=4 @221
// Process: u u~ > vm vm~ WEIGHTED<=4 @221
// Process: u u~ > vt vt~ WEIGHTED<=4 @221
// Process: c c~ > ve ve~ WEIGHTED<=4 @221
// Process: c c~ > vm vm~ WEIGHTED<=4 @221
// Process: c c~ > vt vt~ WEIGHTED<=4 @221
// Process: d d~ > ve ve~ WEIGHTED<=4 @221
// Process: d d~ > vm vm~ WEIGHTED<=4 @221
// Process: d d~ > vt vt~ WEIGHTED<=4 @221
// Process: s s~ > ve ve~ WEIGHTED<=4 @221
// Process: s s~ > vm vm~ WEIGHTED<=4 @221
// Process: s s~ > vt vt~ WEIGHTED<=4 @221
// Process: d u~ > e- ve~ WEIGHTED<=4 @221
// Process: d u~ > mu- vm~ WEIGHTED<=4 @221
// Process: s c~ > e- ve~ WEIGHTED<=4 @221
// Process: s c~ > mu- vm~ WEIGHTED<=4 @221
// Process: d c~ > e- ve~ WEIGHTED<=4 @221
// Process: d c~ > mu- vm~ WEIGHTED<=4 @221
// Process: s u~ > e- ve~ WEIGHTED<=4 @221
// Process: s u~ > mu- vm~ WEIGHTED<=4 @221
// Process: u d~ > e+ ve WEIGHTED<=4 @221
// Process: u d~ > mu+ vm WEIGHTED<=4 @221
// Process: c s~ > e+ ve WEIGHTED<=4 @221
// Process: c s~ > mu+ vm WEIGHTED<=4 @221
// Process: u s~ > e+ ve WEIGHTED<=4 @221
// Process: u s~ > mu+ vm WEIGHTED<=4 @221
// Process: c d~ > e+ ve WEIGHTED<=4 @221
// Process: c d~ > mu+ vm WEIGHTED<=4 @221
//--------------------------------------------------------------------------
...
class PY8MEs_R221_P18_sm_ckm_qq_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P18_sm_ckm_qq_ll(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P18_sm_ckm_qq_ll(); 
    ...
    virtual string name() const {return "qq_ll (sm_ckm)";}

    virtual int code() const {return 32118;}
  ...
  private:
    ...
    double matrix_221_uux_emep(); 
    double matrix_221_ddx_emep(); 
    double matrix_221_uux_vevex(); 
    double matrix_221_ddx_vevex(); 
    double matrix_221_dux_emvex(); 
    double matrix_221_dcx_emvex(); 
    double matrix_221_sux_emvex(); 
    double matrix_221_udx_epve(); 
    double matrix_221_usx_epve(); 
    double matrix_221_cdx_epve(); 
...
#endif  // PY8MEs_R221_P18_sm_ckm_qq_ll_H
