...
#ifndef PY8MEs_R121_P10_sm_ckm_ll_tamtap_H
#define PY8MEs_R121_P10_sm_ckm_ll_tamtap_H
...
// Process: e+ e- > ta- ta+ WEIGHTED<=4 @121
// Process: mu+ mu- > ta- ta+ WEIGHTED<=4 @121
//--------------------------------------------------------------------------
...
class PY8MEs_R121_P10_sm_ckm_ll_tamtap : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R121_P10_sm_ckm_ll_tamtap(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R121_P10_sm_ckm_ll_tamtap(); 
    ...
    virtual string name() const {return "ll_tamtap (sm_ckm)";}

    virtual int code() const {return 22110;}
...
#endif  // PY8MEs_R121_P10_sm_ckm_ll_tamtap_H
