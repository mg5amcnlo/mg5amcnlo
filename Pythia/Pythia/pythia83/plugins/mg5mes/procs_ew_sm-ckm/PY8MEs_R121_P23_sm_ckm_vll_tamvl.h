...
#ifndef PY8MEs_R121_P23_sm_ckm_vll_tamvl_H
#define PY8MEs_R121_P23_sm_ckm_vll_tamvl_H
...
// Process: ve~ e- > ta- vt~ WEIGHTED<=4 @121
// Process: vm~ mu- > ta- vt~ WEIGHTED<=4 @121
// Process: e+ ve > ta+ vt WEIGHTED<=4 @121
// Process: mu+ vm > ta+ vt WEIGHTED<=4 @121
//--------------------------------------------------------------------------
...
class PY8MEs_R121_P23_sm_ckm_vll_tamvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R121_P23_sm_ckm_vll_tamvl(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R121_P23_sm_ckm_vll_tamvl(); 
    ...
    virtual string name() const {return "vll_tamvl (sm_ckm)";}

    virtual int code() const {return 22123;}
  ...
  private:
    ...
    double matrix_121_vexem_tamvtx(); 
    double matrix_121_epve_tapvt(); 
...
#endif  // PY8MEs_R121_P23_sm_ckm_vll_tamvl_H
