...
#ifndef PY8MEs_R221_P26_sm_ckm_qq_tamvl_H
#define PY8MEs_R221_P26_sm_ckm_qq_tamvl_H
...
class PY8MEs_R221_P26_sm_ckm_qq_tamvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R221_P26_sm_ckm_qq_tamvl(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R221_P26_sm_ckm_qq_tamvl(); 
    ...
    virtual string name() const {return "qq_tamvl (sm_ckm)";}

    virtual int code() const {return 32126;}
  ...
  private:
    ...
    double matrix_221_dux_tamvtx(); 
    double matrix_221_dcx_tamvtx(); 
    double matrix_221_sux_tamvtx(); 
    double matrix_221_udx_tapvt(); 
    double matrix_221_usx_tapvt(); 
    double matrix_221_cdx_tapvt(); 

    // Constants for array limits
    static const int nexternal = 4; 
    static const int ninitial = 2; 
    static const int nprocesses = 6; 
...
#endif  // PY8MEs_R221_P26_sm_ckm_qq_tamvl_H
