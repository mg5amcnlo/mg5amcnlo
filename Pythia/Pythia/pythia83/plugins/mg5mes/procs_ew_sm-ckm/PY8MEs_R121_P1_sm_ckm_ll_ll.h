...
#ifndef PY8MEs_R121_P1_sm_ckm_ll_ll_H
#define PY8MEs_R121_P1_sm_ckm_ll_ll_H
...
// Process: e+ e- > e- e+ WEIGHTED<=4 @121
// Process: mu+ mu- > mu- mu+ WEIGHTED<=4 @121
// Process: e+ e- > mu- mu+ WEIGHTED<=4 @121
// Process: mu+ mu- > e- e+ WEIGHTED<=4 @121
// Process: e+ mu- > mu- e+ WEIGHTED<=4 @121
// Process: mu+ e- > e- mu+ WEIGHTED<=4 @121
// Process: e+ e- > ve ve~ WEIGHTED<=4 @121
// Process: mu+ mu- > vm vm~ WEIGHTED<=4 @121
// Process: ve~ e- > e- ve~ WEIGHTED<=4 @121
// Process: vm~ mu- > mu- vm~ WEIGHTED<=4 @121
// Process: e+ ve > e+ ve WEIGHTED<=4 @121
// Process: mu+ vm > mu+ vm WEIGHTED<=4 @121
// Process: e+ e- > vm vm~ WEIGHTED<=4 @121
// Process: e+ e- > vt vt~ WEIGHTED<=4 @121
// Process: mu+ mu- > ve ve~ WEIGHTED<=4 @121
// Process: mu+ mu- > vt vt~ WEIGHTED<=4 @121
// Process: e+ mu- > vm ve~ WEIGHTED<=4 @121
// Process: mu+ e- > ve vm~ WEIGHTED<=4 @121
// Process: ve~ e- > mu- vm~ WEIGHTED<=4 @121
// Process: vm~ mu- > e- ve~ WEIGHTED<=4 @121
// Process: ve~ mu- > mu- ve~ WEIGHTED<=4 @121
// Process: vm~ e- > e- vm~ WEIGHTED<=4 @121
// Process: vt~ e- > e- vt~ WEIGHTED<=4 @121
// Process: vt~ mu- > mu- vt~ WEIGHTED<=4 @121
// Process: e+ ve > mu+ vm WEIGHTED<=4 @121
// Process: mu+ vm > e+ ve WEIGHTED<=4 @121
// Process: e+ vm > e+ vm WEIGHTED<=4 @121
// Process: e+ vt > e+ vt WEIGHTED<=4 @121
// Process: mu+ ve > mu+ ve WEIGHTED<=4 @121
// Process: mu+ vt > mu+ vt WEIGHTED<=4 @121
//--------------------------------------------------------------------------
...
class PY8MEs_R121_P1_sm_ckm_ll_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R121_P1_sm_ckm_ll_ll(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R121_P1_sm_ckm_ll_ll(); 
    ...
    virtual string name() const {return "ll_ll (sm_ckm)";}

    virtual int code() const {return 22101;}
  ...
  private:
    ...
    double matrix_121_epem_emep(); 
    double matrix_121_epem_mummup(); 
    double matrix_121_epmum_mumep(); 
    double matrix_121_epem_vevex(); 
    double matrix_121_vexem_emvex(); 
    double matrix_121_epve_epve(); 
    double matrix_121_epem_vmvmx(); 
    double matrix_121_epmum_vmvex(); 
    double matrix_121_vexem_mumvmx(); 
    double matrix_121_vexmum_mumvex(); 
    double matrix_121_epve_mupvm(); 
    double matrix_121_epvm_epvm(); 
...
#endif  // PY8MEs_R121_P1_sm_ckm_ll_ll_H
