...
#ifndef PY8MEs_R110_P8_sm_ckm_ll_aa_H
#define PY8MEs_R110_P8_sm_ckm_ll_aa_H
...
class PY8MEs_R110_P8_sm_ckm_ll_aa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R110_P8_sm_ckm_ll_aa(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R110_P8_sm_ckm_ll_aa(); 
    ...
    virtual string name() const {return "ll_aa (sm_ckm)";}

    virtual int code() const {return 21008;}
...
#endif  // PY8MEs_R110_P8_sm_ckm_ll_aa_H
