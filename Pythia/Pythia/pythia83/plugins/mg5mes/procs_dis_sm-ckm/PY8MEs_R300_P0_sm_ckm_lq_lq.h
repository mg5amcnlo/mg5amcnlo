...
#ifndef PY8MEs_R300_P0_sm_ckm_lq_lq_H
#define PY8MEs_R300_P0_sm_ckm_lq_lq_H
...
// Process: e- u > e- u WEIGHTED<=4 @300
// Process: e- c > e- c WEIGHTED<=4 @300
// Process: mu- u > mu- u WEIGHTED<=4 @300
// Process: mu- c > mu- c WEIGHTED<=4 @300
// Process: e- d > e- d WEIGHTED<=4 @300
// Process: e- s > e- s WEIGHTED<=4 @300
// Process: mu- d > mu- d WEIGHTED<=4 @300
// Process: mu- s > mu- s WEIGHTED<=4 @300
// Process: e- u~ > e- u~ WEIGHTED<=4 @300
// Process: e- c~ > e- c~ WEIGHTED<=4 @300
// Process: mu- u~ > mu- u~ WEIGHTED<=4 @300
// Process: mu- c~ > mu- c~ WEIGHTED<=4 @300
...
// Process: mu+ d~ > mu+ d~ WEIGHTED<=4 @300
// Process: mu+ s~ > mu+ s~ WEIGHTED<=4 @300
// Process: ve u > ve u WEIGHTED<=4 @300
// Process: ve c > ve c WEIGHTED<=4 @300
// Process: vm u > vm u WEIGHTED<=4 @300
// Process: vm c > vm c WEIGHTED<=4 @300
// Process: vt u > vt u WEIGHTED<=4 @300
// Process: vt c > vt c WEIGHTED<=4 @300
// Process: ve d > ve d WEIGHTED<=4 @300
// Process: ve s > ve s WEIGHTED<=4 @300
// Process: vm d > vm d WEIGHTED<=4 @300
// Process: vm s > vm s WEIGHTED<=4 @300
// Process: vt d > vt d WEIGHTED<=4 @300
// Process: vt s > vt s WEIGHTED<=4 @300
// Process: ve u~ > ve u~ WEIGHTED<=4 @300
// Process: ve c~ > ve c~ WEIGHTED<=4 @300
// Process: vm u~ > vm u~ WEIGHTED<=4 @300
// Process: vm c~ > vm c~ WEIGHTED<=4 @300
...
// Process: vt~ d~ > vt~ d~ WEIGHTED<=4 @300
// Process: vt~ s~ > vt~ s~ WEIGHTED<=4 @300
// Process: e- u > ve d WEIGHTED<=4 @300
// Process: e- c > ve s WEIGHTED<=4 @300
// Process: mu- u > vm d WEIGHTED<=4 @300
// Process: mu- c > vm s WEIGHTED<=4 @300
// Process: ve d > e- u WEIGHTED<=4 @300
// Process: ve s > e- c WEIGHTED<=4 @300
// Process: vm d > mu- u WEIGHTED<=4 @300
// Process: vm s > mu- c WEIGHTED<=4 @300
// Process: e- u > ve s WEIGHTED<=4 @300
// Process: mu- u > vm s WEIGHTED<=4 @300
// Process: ve s > e- u WEIGHTED<=4 @300
// Process: vm s > mu- u WEIGHTED<=4 @300
// Process: e- c > ve d WEIGHTED<=4 @300
// Process: mu- c > vm d WEIGHTED<=4 @300
// Process: ve d > e- c WEIGHTED<=4 @300
// Process: vm d > mu- c WEIGHTED<=4 @300
// Process: e- d~ > ve u~ WEIGHTED<=4 @300
// Process: e- s~ > ve c~ WEIGHTED<=4 @300
// Process: mu- d~ > vm u~ WEIGHTED<=4 @300
// Process: mu- s~ > vm c~ WEIGHTED<=4 @300
// Process: ve u~ > e- d~ WEIGHTED<=4 @300
// Process: ve c~ > e- s~ WEIGHTED<=4 @300
// Process: vm u~ > mu- d~ WEIGHTED<=4 @300
// Process: vm c~ > mu- s~ WEIGHTED<=4 @300
// Process: e- d~ > ve c~ WEIGHTED<=4 @300
// Process: mu- d~ > vm c~ WEIGHTED<=4 @300
// Process: ve c~ > e- d~ WEIGHTED<=4 @300
// Process: vm c~ > mu- d~ WEIGHTED<=4 @300
// Process: e- s~ > ve u~ WEIGHTED<=4 @300
// Process: mu- s~ > vm u~ WEIGHTED<=4 @300
// Process: ve u~ > e- s~ WEIGHTED<=4 @300
// Process: vm u~ > mu- s~ WEIGHTED<=4 @300
// Process: e+ d > ve~ u WEIGHTED<=4 @300
// Process: e+ s > ve~ c WEIGHTED<=4 @300
// Process: mu+ d > vm~ u WEIGHTED<=4 @300
// Process: mu+ s > vm~ c WEIGHTED<=4 @300
...
class PY8MEs_R300_P0_sm_ckm_lq_lq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R300_P0_sm_ckm_lq_lq(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R300_P0_sm_ckm_lq_lq(); 
    ...
    virtual string name() const {return "lq_lq (sm_ckm)";}

    virtual int code() const {return 40300;}
  ...
  private:
    ...
    double matrix_30emu_emu(); 
    double matrix_30emd_emd(); 
    double matrix_30emux_emux(); 
    double matrix_30emdx_emdx(); 
    double matrix_30epu_epu(); 
    double matrix_30epd_epd(); 
    double matrix_30epux_epux(); 
    double matrix_30epdx_epdx(); 
    double matrix_30veu_veu(); 
    double matrix_30ved_ved(); 
    double matrix_30veux_veux(); 
    double matrix_30vedx_vedx(); 
    double matrix_30vexu_vexu(); 
    double matrix_30vexd_vexd(); 
    double matrix_30vexux_vexux(); 
    double matrix_30vexdx_vexdx(); 
    double matrix_30emu_ved(); 
    double matrix_30emu_ves(); 
    double matrix_30emc_ved(); 
    double matrix_30emdx_veux(); 
    double matrix_30emdx_vecx(); 
    double matrix_30emsx_veux(); 
    double matrix_30epd_vexu(); 
    double matrix_30epd_vexc(); 
    double matrix_30eps_vexu(); 
    double matrix_30epux_vexdx(); 
    double matrix_30epux_vexsx(); 
    double matrix_30epcx_vexdx(); 

    // Constants for array limits
    static const int nexternal = 4; 
    static const int ninitial = 2; 
    static const int nprocesses = 28; 
...
#endif  // PY8MEs_R300_P0_sm_ckm_lq_lq_H
