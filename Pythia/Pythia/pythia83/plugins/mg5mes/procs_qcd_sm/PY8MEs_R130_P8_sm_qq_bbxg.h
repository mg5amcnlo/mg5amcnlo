...
#ifndef PY8MEs_R130_P8_sm_qq_bbxg_H
#define PY8MEs_R130_P8_sm_qq_bbxg_H
...
// Process: u u~ > b b~ g WEIGHTED<=3 @130
// Process: c c~ > b b~ g WEIGHTED<=3 @130
// Process: d d~ > b b~ g WEIGHTED<=3 @130
// Process: s s~ > b b~ g WEIGHTED<=3 @130
//--------------------------------------------------------------------------
...
class PY8MEs_R130_P8_sm_qq_bbxg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P8_sm_qq_bbxg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P8_sm_qq_bbxg(); 
    ...
    virtual string name() const {return "qq_bbxg (sm)";}

    virtual int code() const {return 23008;}
...
#endif  // PY8MEs_R130_P8_sm_qq_bbxg_H
