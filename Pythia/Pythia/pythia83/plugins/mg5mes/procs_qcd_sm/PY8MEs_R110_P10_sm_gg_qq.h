...
#ifndef PY8MEs_R110_P10_sm_gg_qq_H
#define PY8MEs_R110_P10_sm_gg_qq_H
...
// Process: g g > u u~ WEIGHTED<=2 @110
// Process: g g > c c~ WEIGHTED<=2 @110
// Process: g g > d d~ WEIGHTED<=2 @110
// Process: g g > s s~ WEIGHTED<=2 @110
//--------------------------------------------------------------------------
...
class PY8MEs_R110_P10_sm_gg_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R110_P10_sm_gg_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R110_P10_sm_gg_qq(); 
    ...
    virtual string name() const {return "gg_qq (sm)";}

    virtual int code() const {return 21010;}
...
#endif  // PY8MEs_R110_P10_sm_gg_qq_H
