...
#ifndef PY8MEs_R130_P6_sm_qq_gqq_H
#define PY8MEs_R130_P6_sm_qq_gqq_H
...
class PY8MEs_R130_P6_sm_qq_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P6_sm_qq_gqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P6_sm_qq_gqq(); 
    ...
    virtual string name() const {return "qq_gqq (sm)";}

    virtual int code() const {return 23006;}
  ...
  private:
    ...
    static const int namplitudes = 50; 
    Complex<double> amp[namplitudes]; 
    double matrix_13uu_guu(); 
    double matrix_13uux_guux(); 
    double matrix_13uxux_guxux(); 
    double matrix_13uc_guc(); 
    double matrix_13uux_gccx(); 
    double matrix_13ucx_gucx(); 
    double matrix_13uxcx_guxcx(); 
...
#endif  // PY8MEs_R130_P6_sm_qq_gqq_H
