...
#ifndef PY8MEs_R110_P11_sm_gq_gq_H
#define PY8MEs_R110_P11_sm_gq_gq_H
...
// Process: g u > g u WEIGHTED<=2 @110
// Process: g c > g c WEIGHTED<=2 @110
// Process: g d > g d WEIGHTED<=2 @110
// Process: g s > g s WEIGHTED<=2 @110
// Process: g u~ > g u~ WEIGHTED<=2 @110
// Process: g c~ > g c~ WEIGHTED<=2 @110
// Process: g d~ > g d~ WEIGHTED<=2 @110
// Process: g s~ > g s~ WEIGHTED<=2 @110
...
class PY8MEs_R110_P11_sm_gq_gq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R110_P11_sm_gq_gq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R110_P11_sm_gq_gq(); 
    ...
    virtual int code() const {return 21011;}
  ...
  private:
    ...
    double matrix_11gu_gu(); 
    double matrix_11gux_gux(); 
...
#endif  // PY8MEs_R110_P11_sm_gq_gq_H
