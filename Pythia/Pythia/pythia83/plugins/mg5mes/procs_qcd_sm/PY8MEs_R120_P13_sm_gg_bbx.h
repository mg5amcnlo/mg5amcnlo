...
#ifndef PY8MEs_R120_P13_sm_gg_bbx_H
#define PY8MEs_R120_P13_sm_gg_bbx_H
...
// Process: g g > b b~ WEIGHTED<=2 @120
//--------------------------------------------------------------------------
...
class PY8MEs_R120_P13_sm_gg_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R120_P13_sm_gg_bbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R120_P13_sm_gg_bbx(); 
    ...
    virtual string name() const {return "gg_bbx (sm)";}

    virtual int code() const {return 22013;}
...
#endif  // PY8MEs_R120_P13_sm_gg_bbx_H
