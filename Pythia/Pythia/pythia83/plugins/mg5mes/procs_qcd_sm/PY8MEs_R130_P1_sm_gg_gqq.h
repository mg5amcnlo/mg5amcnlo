...
#ifndef PY8MEs_R130_P1_sm_gg_gqq_H
#define PY8MEs_R130_P1_sm_gg_gqq_H
...
class PY8MEs_R130_P1_sm_gg_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P1_sm_gg_gqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P1_sm_gg_gqq(); 
    ...
    virtual string name() const {return "gg_gqq (sm)";}

    virtual int code() const {return 23001;}
...
#endif  // PY8MEs_R130_P1_sm_gg_gqq_H
