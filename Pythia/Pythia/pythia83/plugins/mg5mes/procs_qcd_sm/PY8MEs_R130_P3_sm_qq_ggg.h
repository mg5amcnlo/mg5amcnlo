...
#ifndef PY8MEs_R130_P3_sm_qq_ggg_H
#define PY8MEs_R130_P3_sm_qq_ggg_H
...
class PY8MEs_R130_P3_sm_qq_ggg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P3_sm_qq_ggg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P3_sm_qq_ggg(); 
    ...
    virtual string name() const {return "qq_ggg (sm)";}

    virtual int code() const {return 23003;}
...
#endif  // PY8MEs_R130_P3_sm_qq_ggg_H
