...
#ifndef PY8MEs_R110_P12_sm_qq_gg_H
#define PY8MEs_R110_P12_sm_qq_gg_H
...
// Process: u u~ > g g WEIGHTED<=2 @110
// Process: c c~ > g g WEIGHTED<=2 @110
// Process: d d~ > g g WEIGHTED<=2 @110
// Process: s s~ > g g WEIGHTED<=2 @110
//--------------------------------------------------------------------------
...
class PY8MEs_R110_P12_sm_qq_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R110_P12_sm_qq_gg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R110_P12_sm_qq_gg(); 
    ...
    virtual string name() const {return "qq_gg (sm)";}

    virtual int code() const {return 21012;}
...
#endif  // PY8MEs_R110_P12_sm_qq_gg_H
