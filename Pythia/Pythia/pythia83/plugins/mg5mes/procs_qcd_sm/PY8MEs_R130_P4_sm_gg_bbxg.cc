...
#include "PY8MEs_R130_P4_sm_gg_bbxg.h"
...
// Exception class
class PY8MEs_R130_P4_sm_gg_bbxgException : public exception
{
  virtual const char * what() const throw()
  {
    return "Exception in class 'PY8MEs_R130_P4_sm_gg_bbxg'."; 
  }
}
PY8MEs_R130_P4_sm_gg_bbxg_exception; 

std::set<int> PY8MEs_R130_P4_sm_gg_bbxg::s_channel_proc = std::set<int>
    (createset<int> ());

int PY8MEs_R130_P4_sm_gg_bbxg::helicities[ncomb][nexternal] = {{-1, -1, -1, -1,
...
int PY8MEs_R130_P4_sm_gg_bbxg::denom_colors[nprocesses] = {64}; 
int PY8MEs_R130_P4_sm_gg_bbxg::denom_hels[nprocesses] = {4}; 
int PY8MEs_R130_P4_sm_gg_bbxg::denom_iden[nprocesses] = {1}; 

//--------------------------------------------------------------------------
// Color config initialization
void PY8MEs_R130_P4_sm_gg_bbxg::initColorConfigs() 
{
  color_configs = vector < vec_vec_int > (); 
  jamp_nc_relative_power = vector < vec_int > (); 

  // Color flows of process Process: g g > b b~ g WEIGHTED<=3 @130
...
//--------------------------------------------------------------------------
// Destructor.
PY8MEs_R130_P4_sm_gg_bbxg::~PY8MEs_R130_P4_sm_gg_bbxg() 
{
...
vector<int> PY8MEs_R130_P4_sm_gg_bbxg::invert_mapping(vector<int> mapping) 
{
...
vector < vec_int > PY8MEs_R130_P4_sm_gg_bbxg::getHelicityConfigs(vector<int>
    permutation)
{
...
vector < vec_int > PY8MEs_R130_P4_sm_gg_bbxg::getColorConfigs(int
...
int PY8MEs_R130_P4_sm_gg_bbxg::getColorFlowRelativeNCPower(int color_flow_ID,
    int specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
vector<int> PY8MEs_R130_P4_sm_gg_bbxg::getHelicityConfigForID(int hel_ID,
    vector<int> permutation)
{
  if (hel_ID < 0 || hel_ID >= ncomb)
  {
    ...
    " 'PY8MEs_R130_P4_sm_gg_bbxg': Specified helicity ID '" << 
    hel_ID <<  "' cannot be found." << endl; 
    #endif
    throw PY8MEs_R130_P4_sm_gg_bbxg_exception; 
  }
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  {
...
int PY8MEs_R130_P4_sm_gg_bbxg::getHelicityIDForConfig(vector<int> hel_config,
    vector<int> permutation)
{
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  ...
  if (hel_config.size() > 0)
  {
    ...
    if (user_ihel == -1)
    {
      ...
      " 'PY8MEs_R130_P4_sm_gg_bbxg': Specified helicity" << 
...
vector<int> PY8MEs_R130_P4_sm_gg_bbxg::getColorConfigForID(int color_ID, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_ID < 0 || color_ID >= int(color_configs[chosenProcID].size()))
  {
    ...
    " 'PY8MEs_R130_P4_sm_gg_bbxg': Specified color ID '" << 
...
int PY8MEs_R130_P4_sm_gg_bbxg::getColorIDForConfig(vector<int> color_config,
    int specify_proc_ID, vector<int> permutation)
{
  ...
  if (color_config.size() > 0)
  {
      ...
      for (unsigned int j = 0; j < (nexternal * 2); j++ )
      {
        ...
        else
        {
          ...
          if (color_linked_pos == -1)
          {
            ...
            " 'PY8MEs_R130_P4_sm_gg_bbxg': A color line could " << 
            " not be closed." << endl; 
            #endif
            throw PY8MEs_R130_P4_sm_gg_bbxg_exception; 
          }
    ...
    if (user_icol == -1)
    {
      #ifdef DEBUG
      cerr <<  "Error in function 'getColorIDForConfig' of class" << 
      " 'PY8MEs_R130_P4_sm_gg_bbxg': Specified color" << 
      " configuration cannot be found." << endl; 
      #endif
      throw PY8MEs_R130_P4_sm_gg_bbxg_exception; 
    }
...
vector < vec_double > PY8MEs_R130_P4_sm_gg_bbxg::getAllResults(int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
double PY8MEs_R130_P4_sm_gg_bbxg::getResult(int helicity_ID, int color_ID, int
    specify_proc_ID)
{
...
pair < vector<int> , int > PY8MEs_R130_P4_sm_gg_bbxg::static_getPY8ME(vector<int> initial_pdgs, vector<int> final_pdgs, set<int> schannels) 
{
  ...
  const int out_pdgs[nprocs][nexternal - ninitial] = {{5, -5, 21}}; 
...
//--------------------------------------------------------------------------
// Set momenta
void PY8MEs_R130_P4_sm_gg_bbxg::setMomenta(vector < vec_double > momenta_picked)
{
  if (momenta_picked.size() != nexternal)
  {
    #ifdef DEBUG
    cerr <<  "Error in function 'setMomenta' of class" << 
    " 'PY8MEs_R130_P4_sm_gg_bbxg': Incorrect number of" << 
  ...
  for(unsigned int i = 0; i < nexternal; i++ )
  {
    ...
    if (momenta_picked[i][0] < 0.0)
    {
      #ifdef DEBUG
      cerr <<  "Error in function 'setMomenta' of class" << 
      " 'PY8MEs_R130_P4_sm_gg_bbxg': A momentum was specified" << 
...
void PY8MEs_R130_P4_sm_gg_bbxg::setColors(vector<int> colors_picked)
{
  ...
  if (colors_picked.size() != (2 * nexternal))
  {
    ...
    " 'PY8MEs_R130_P4_sm_gg_bbxg': Incorrect number" << 
...
void PY8MEs_R130_P4_sm_gg_bbxg::setHelicities(vector<int> helicities_picked) 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::setPermutation(vector<int> perm_picked) 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::setProcID(int procID_picked) 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::initProc() 
{
...
// parameters
void PY8MEs_R130_P4_sm_gg_bbxg::syncProcModelParams() 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::setMasses(vec_double external_masses) 
{
...
vector<double> PY8MEs_R130_P4_sm_gg_bbxg::getMasses() 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::setExternalMassesMode(int mode) 
{
  if (mode != 0 && mode != 1 && mode != 2)
  {
    #ifdef DEBUG
    cerr <<  "Error in function 'setExternalMassesMode' of class" << 
    " 'PY8MEs_R130_P4_sm_gg_bbxg': Incorrect mode selected :" << mode << 
...
double PY8MEs_R130_P4_sm_gg_bbxg::sigmaKin() 
{
...
void PY8MEs_R130_P4_sm_gg_bbxg::calculate_wavefunctions(const int hel[])
{
  ...
  FFV1_1(w[2], w[4], pars->GC_11, pars->mdl_MB, pars->ZERO, w[7]); 
  FFV1_2(w[3], w[4], pars->GC_11, pars->mdl_MB, pars->ZERO, w[8]); 
  FFV1_1(w[2], w[0], pars->GC_11, pars->mdl_MB, pars->ZERO, w[9]); 
  FFV1_2(w[3], w[1], pars->GC_11, pars->mdl_MB, pars->ZERO, w[10]); 
  VVV1P0_1(w[1], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[3], w[0], pars->GC_11, pars->mdl_MB, pars->ZERO, w[12]); 
  FFV1_1(w[2], w[1], pars->GC_11, pars->mdl_MB, pars->ZERO, w[13]); 
...
double PY8MEs_R130_P4_sm_gg_bbxg::matrix_13gg_bbxg() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = -amp[0] + Complex<double> (0, 1) * amp[2] + Complex<double> (0, 1)
      * amp[4] - amp[5] + amp[14] - amp[17] + amp[15];
  jamp[1] = -amp[3] - Complex<double> (0, 1) * amp[4] + Complex<double> (0, 1)
      * amp[10] + amp[11] - amp[14] - amp[16] - amp[15];
  jamp[2] = +amp[0] - Complex<double> (0, 1) * amp[2] + Complex<double> (0, 1)
      * amp[9] - amp[11] - amp[12] + amp[17] + amp[16];
  jamp[3] = -amp[6] + Complex<double> (0, 1) * amp[7] - Complex<double> (0, 1)
      * amp[9] + amp[11] - amp[14] - amp[16] - amp[15];
  jamp[4] = +amp[0] + Complex<double> (0, 1) * amp[1] - Complex<double> (0, 1)
      * amp[10] - amp[11] - amp[13] + amp[17] + amp[16];
  jamp[5] = -amp[0] - Complex<double> (0, 1) * amp[1] - Complex<double> (0, 1)
      * amp[7] - amp[8] + amp[14] - amp[17] + amp[15];
