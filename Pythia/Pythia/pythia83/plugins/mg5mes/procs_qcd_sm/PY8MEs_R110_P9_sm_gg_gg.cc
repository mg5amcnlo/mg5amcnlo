...
#include "PY8MEs_R110_P9_sm_gg_gg.h"
...
// Process: g g > g g WEIGHTED<=2 @110

// Exception class
class PY8MEs_R110_P9_sm_gg_ggException : public exception
{
  virtual const char * what() const throw()
  {
    return "Exception in class 'PY8MEs_R110_P9_sm_gg_gg'."; 
  }
}
PY8MEs_R110_P9_sm_gg_gg_exception; 

std::set<int> PY8MEs_R110_P9_sm_gg_gg::s_channel_proc = std::set<int>
    (createset<int> ());

int PY8MEs_R110_P9_sm_gg_gg::helicities[ncomb][nexternal] = {{-1, -1, -1, -1},
...
int PY8MEs_R110_P9_sm_gg_gg::denom_colors[nprocesses] = {64}; 
int PY8MEs_R110_P9_sm_gg_gg::denom_hels[nprocesses] = {4}; 
int PY8MEs_R110_P9_sm_gg_gg::denom_iden[nprocesses] = {2}; 

//--------------------------------------------------------------------------
// Color config initialization
void PY8MEs_R110_P9_sm_gg_gg::initColorConfigs() 
{
  color_configs = vector < vec_vec_int > (); 
  jamp_nc_relative_power = vector < vec_int > (); 

  // Color flows of process Process: g g > g g WEIGHTED<=2 @110
...
//--------------------------------------------------------------------------
// Destructor.
PY8MEs_R110_P9_sm_gg_gg::~PY8MEs_R110_P9_sm_gg_gg() 
{
...
vector<int> PY8MEs_R110_P9_sm_gg_gg::invert_mapping(vector<int> mapping) 
{
...
vector < vec_int > PY8MEs_R110_P9_sm_gg_gg::getHelicityConfigs(vector<int>
    permutation)
{
...
vector < vec_int > PY8MEs_R110_P9_sm_gg_gg::getColorConfigs(int
...
int PY8MEs_R110_P9_sm_gg_gg::getColorFlowRelativeNCPower(int color_flow_ID, int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
vector<int> PY8MEs_R110_P9_sm_gg_gg::getHelicityConfigForID(int hel_ID,
    vector<int> permutation)
{
  if (hel_ID < 0 || hel_ID >= ncomb)
  {
    ...
    " 'PY8MEs_R110_P9_sm_gg_gg': Specified helicity ID '" << 
    hel_ID <<  "' cannot be found." << endl; 
    #endif
    throw PY8MEs_R110_P9_sm_gg_gg_exception; 
  }
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  {
...
int PY8MEs_R110_P9_sm_gg_gg::getHelicityIDForConfig(vector<int> hel_config,
    vector<int> permutation)
{
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  ...
  if (hel_config.size() > 0)
  {
    ...
    if (user_ihel == -1)
    {
      ...
      " 'PY8MEs_R110_P9_sm_gg_gg': Specified helicity" << 
...
vector<int> PY8MEs_R110_P9_sm_gg_gg::getColorConfigForID(int color_ID, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_ID < 0 || color_ID >= int(color_configs[chosenProcID].size()))
  {
    ...
    " 'PY8MEs_R110_P9_sm_gg_gg': Specified color ID '" << 
...
int PY8MEs_R110_P9_sm_gg_gg::getColorIDForConfig(vector<int> color_config, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_config.size() > 0)
  {
      ...
      for (unsigned int j = 0; j < (nexternal * 2); j++ )
      {
        ...
        else
        {
          ...
          if (color_linked_pos == -1)
          {
            ...
            " 'PY8MEs_R110_P9_sm_gg_gg': A color line could " << 
            " not be closed." << endl; 
            #endif
            throw PY8MEs_R110_P9_sm_gg_gg_exception; 
          }
    ...
    if (user_icol == -1)
    {
      #ifdef DEBUG
      cerr <<  "Error in function 'getColorIDForConfig' of class" << 
      " 'PY8MEs_R110_P9_sm_gg_gg': Specified color" << 
      " configuration cannot be found." << endl; 
      #endif
      throw PY8MEs_R110_P9_sm_gg_gg_exception; 
    }
...
vector < vec_double > PY8MEs_R110_P9_sm_gg_gg::getAllResults(int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
double PY8MEs_R110_P9_sm_gg_gg::getResult(int helicity_ID, int color_ID, int
    specify_proc_ID)
{
...
pair < vector<int> , int > PY8MEs_R110_P9_sm_gg_gg::static_getPY8ME(vector<int>
...
//--------------------------------------------------------------------------
// Set momenta
void PY8MEs_R110_P9_sm_gg_gg::setMomenta(vector < vec_double > momenta_picked)
{
  if (momenta_picked.size() != nexternal)
  {
    #ifdef DEBUG
    cerr <<  "Error in function 'setMomenta' of class" << 
    " 'PY8MEs_R110_P9_sm_gg_gg': Incorrect number of" << 
  ...
  for(unsigned int i = 0; i < nexternal; i++ )
  {
    ...
    if (momenta_picked[i][0] < 0.0)
    {
      #ifdef DEBUG
      cerr <<  "Error in function 'setMomenta' of class" << 
      " 'PY8MEs_R110_P9_sm_gg_gg': A momentum was specified" << 
...
void PY8MEs_R110_P9_sm_gg_gg::setColors(vector<int> colors_picked)
{
  ...
  if (colors_picked.size() != (2 * nexternal))
  {
    ...
    " 'PY8MEs_R110_P9_sm_gg_gg': Incorrect number" << 
...
void PY8MEs_R110_P9_sm_gg_gg::setHelicities(vector<int> helicities_picked) 
{
...
void PY8MEs_R110_P9_sm_gg_gg::setPermutation(vector<int> perm_picked) 
{
...
void PY8MEs_R110_P9_sm_gg_gg::setProcID(int procID_picked) 
{
...
void PY8MEs_R110_P9_sm_gg_gg::initProc() 
{
...
// parameters
void PY8MEs_R110_P9_sm_gg_gg::syncProcModelParams() 
{
...
void PY8MEs_R110_P9_sm_gg_gg::setMasses(vec_double external_masses) 
{
...
vector<double> PY8MEs_R110_P9_sm_gg_gg::getMasses() 
{
...
void PY8MEs_R110_P9_sm_gg_gg::setExternalMassesMode(int mode) 
{
  if (mode != 0 && mode != 1 && mode != 2)
  {
    #ifdef DEBUG
    cerr <<  "Error in function 'setExternalMassesMode' of class" << 
    " 'PY8MEs_R110_P9_sm_gg_gg': Incorrect mode selected :" << mode << 
...
double PY8MEs_R110_P9_sm_gg_gg::sigmaKin() 
{
...
void PY8MEs_R110_P9_sm_gg_gg::calculate_wavefunctions(const int hel[])
{
...
double PY8MEs_R110_P9_sm_gg_gg::matrix_11gg_gg() 
{
  int i, j; 
  // Local variables
  // const int ngraphs = 6;
