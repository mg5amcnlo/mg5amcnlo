...
#ifndef PY8MEs_R130_P2_sm_gq_ggq_H
#define PY8MEs_R130_P2_sm_gq_ggq_H
...
// Process: g u > g g u WEIGHTED<=3 @130
// Process: g c > g g c WEIGHTED<=3 @130
// Process: g d > g g d WEIGHTED<=3 @130
// Process: g s > g g s WEIGHTED<=3 @130
// Process: g u~ > g g u~ WEIGHTED<=3 @130
// Process: g c~ > g g c~ WEIGHTED<=3 @130
// Process: g d~ > g g d~ WEIGHTED<=3 @130
// Process: g s~ > g g s~ WEIGHTED<=3 @130
...
class PY8MEs_R130_P2_sm_gq_ggq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P2_sm_gq_ggq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P2_sm_gq_ggq(); 
    ...
    virtual string name() const {return "gq_ggq (sm)";}

    virtual int code() const {return 23002;}
  ...
  private:
    ...
    static const int namplitudes = 36; 
    Complex<double> amp[namplitudes]; 
    double matrix_13gu_ggu(); 
    double matrix_13gux_ggux(); 
...
#endif  // PY8MEs_R130_P2_sm_gq_ggq_H
