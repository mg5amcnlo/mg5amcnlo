...
#ifndef PY8MEs_R130_P5_sm_gq_qqq_H
#define PY8MEs_R130_P5_sm_gq_qqq_H
...
class PY8MEs_R130_P5_sm_gq_qqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P5_sm_gq_qqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P5_sm_gq_qqq(); 
    ...
    virtual int code() const {return 23005;}
  ...
  private:
    ...
    double matrix_13gu_uuux(); 
    double matrix_13gux_uuxux(); 
    double matrix_13gu_uccx(); 
    double matrix_13gux_cuxcx(); 
...
#endif  // PY8MEs_R130_P5_sm_gq_qqq_H
