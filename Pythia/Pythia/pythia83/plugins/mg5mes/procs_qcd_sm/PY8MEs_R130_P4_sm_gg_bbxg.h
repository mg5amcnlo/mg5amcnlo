...
#ifndef PY8MEs_R130_P4_sm_gg_bbxg_H
#define PY8MEs_R130_P4_sm_gg_bbxg_H
...
// Process: g g > b b~ g WEIGHTED<=3 @130
//--------------------------------------------------------------------------
...
class PY8MEs_R130_P4_sm_gg_bbxg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R130_P4_sm_gg_bbxg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R130_P4_sm_gg_bbxg(); 
    ...
    virtual string name() const {return "gg_bbxg (sm)";}
...
#endif  // PY8MEs_R130_P4_sm_gg_bbxg_H
