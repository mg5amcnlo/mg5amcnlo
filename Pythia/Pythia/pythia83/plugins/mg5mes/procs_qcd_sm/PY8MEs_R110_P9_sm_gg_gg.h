...
#ifndef PY8MEs_R110_P9_sm_gg_gg_H
#define PY8MEs_R110_P9_sm_gg_gg_H
...
class PY8MEs_R110_P9_sm_gg_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R110_P9_sm_gg_gg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R110_P9_sm_gg_gg(); 
    ...
    virtual string name() const {return "gg_gg (sm)";}

    virtual int code() const {return 21009;}
...
#endif  // PY8MEs_R110_P9_sm_gg_gg_H
