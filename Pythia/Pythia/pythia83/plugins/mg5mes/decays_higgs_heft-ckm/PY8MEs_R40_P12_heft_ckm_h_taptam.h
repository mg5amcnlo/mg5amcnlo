...
#ifndef PY8MEs_R40_P12_heft_ckm_h_taptam_H
#define PY8MEs_R40_P12_heft_ckm_h_taptam_H
...
class PY8MEs_R40_P12_heft_ckm_h_taptam : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R40_P12_heft_ckm_h_taptam(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R40_P12_heft_ckm_h_taptam(); 
    ...
    virtual string name() const {return "h_taptam (heft_ckm)";}

    virtual int code() const {return 14012;}
...
#endif  // PY8MEs_R40_P12_heft_ckm_h_taptam_H
