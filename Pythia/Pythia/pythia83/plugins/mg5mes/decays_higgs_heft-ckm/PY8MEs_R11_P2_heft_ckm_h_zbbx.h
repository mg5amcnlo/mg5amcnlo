...
#ifndef PY8MEs_R11_P2_heft_ckm_h_zbbx_H
#define PY8MEs_R11_P2_heft_ckm_h_zbbx_H
...
// Process: h > z b b~ HIG<=1 HIW<=1 QCD=0 @11
//--------------------------------------------------------------------------
...
class PY8MEs_R11_P2_heft_ckm_h_zbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R11_P2_heft_ckm_h_zbbx(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R11_P2_heft_ckm_h_zbbx(); 
    ...
    virtual string name() const {return "h_zbbx (heft_ckm)";}

    virtual int code() const {return 11102;}
...
#endif  // PY8MEs_R11_P2_heft_ckm_h_zbbx_H
