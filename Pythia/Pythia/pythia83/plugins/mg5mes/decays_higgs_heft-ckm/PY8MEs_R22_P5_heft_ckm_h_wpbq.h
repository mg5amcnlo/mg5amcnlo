...
#ifndef PY8MEs_R22_P5_heft_ckm_h_wpbq_H
#define PY8MEs_R22_P5_heft_ckm_h_wpbq_H
...
class PY8MEs_R22_P5_heft_ckm_h_wpbq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R22_P5_heft_ckm_h_wpbq(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R22_P5_heft_ckm_h_wpbq(); 
    ...
    virtual string name() const {return "h_wpbq (heft_ckm)";}

    virtual int code() const {return 12205;}
  ...
  private:
    ...
    double matrix_22_h_wpbux(); 
    double matrix_22_h_wpbcx(); 
    double matrix_22_h_wmbxu(); 
    double matrix_22_h_wmbxc(); 
...
#endif  // PY8MEs_R22_P5_heft_ckm_h_wpbq_H
