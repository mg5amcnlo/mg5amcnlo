...
#ifndef PY8MEs_R21_P11_heft_ckm_h_wpqq_H
#define PY8MEs_R21_P11_heft_ckm_h_wpqq_H
...
// Process: h > w+ d u~ HIG<=1 HIW<=1 @21
// Process: h > w+ s c~ HIG<=1 HIW<=1 @21
// Process: h > w+ d c~ HIG<=1 HIW<=1 @21
// Process: h > w+ s u~ HIG<=1 HIW<=1 @21
// Process: h > w- u d~ HIG<=1 HIW<=1 @21
// Process: h > w- c s~ HIG<=1 HIW<=1 @21
// Process: h > w- u s~ HIG<=1 HIW<=1 @21
// Process: h > w- c d~ HIG<=1 HIW<=1 @21
//--------------------------------------------------------------------------
...
class PY8MEs_R21_P11_heft_ckm_h_wpqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R21_P11_heft_ckm_h_wpqq(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R21_P11_heft_ckm_h_wpqq(); 
    ...
    virtual string name() const {return "h_wpqq (heft_ckm)";}

    virtual int code() const {return 12111;}
  ...
  private:
    ...
    double matrix_21_h_wpdux(); 
    double matrix_21_h_wpdcx(); 
    double matrix_21_h_wpsux(); 
    double matrix_21_h_wmudx(); 
    double matrix_21_h_wmusx(); 
    double matrix_21_h_wmcdx(); 
...
#endif  // PY8MEs_R21_P11_heft_ckm_h_wpqq_H
