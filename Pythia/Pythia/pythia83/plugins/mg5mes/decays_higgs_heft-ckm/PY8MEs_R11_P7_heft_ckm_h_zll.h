...
#ifndef PY8MEs_R11_P7_heft_ckm_h_zll_H
#define PY8MEs_R11_P7_heft_ckm_h_zll_H
...
class PY8MEs_R11_P7_heft_ckm_h_zll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R11_P7_heft_ckm_h_zll(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R11_P7_heft_ckm_h_zll(); 
    ...
    virtual string name() const {return "h_zll (heft_ckm)";}

    virtual int code() const {return 11107;}
  ...
  private:
    ...
    double matrix_11_h_zepem(); 
    double matrix_11_h_zvevex(); 
...
#endif  // PY8MEs_R11_P7_heft_ckm_h_zll_H
