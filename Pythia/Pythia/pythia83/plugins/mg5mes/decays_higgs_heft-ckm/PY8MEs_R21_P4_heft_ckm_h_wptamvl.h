...
#ifndef PY8MEs_R21_P4_heft_ckm_h_wptamvl_H
#define PY8MEs_R21_P4_heft_ckm_h_wptamvl_H
...
class PY8MEs_R21_P4_heft_ckm_h_wptamvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R21_P4_heft_ckm_h_wptamvl(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R21_P4_heft_ckm_h_wptamvl(); 
    ...
    virtual string name() const {return "h_wptamvl (heft_ckm)";}

    virtual int code() const {return 12104;}
  ...
  private:
    ...
    double matrix_21_h_wptamvtx(); 
    double matrix_21_h_wmtapvt(); 
...
#endif  // PY8MEs_R21_P4_heft_ckm_h_wptamvl_H
