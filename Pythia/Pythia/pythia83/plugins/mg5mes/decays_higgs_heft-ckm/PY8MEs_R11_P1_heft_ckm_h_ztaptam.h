...
#ifndef PY8MEs_R11_P1_heft_ckm_h_ztaptam_H
#define PY8MEs_R11_P1_heft_ckm_h_ztaptam_H
...
class PY8MEs_R11_P1_heft_ckm_h_ztaptam : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R11_P1_heft_ckm_h_ztaptam(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R11_P1_heft_ckm_h_ztaptam(); 
    ...
    virtual string name() const {return "h_ztaptam (heft_ckm)";}

    virtual int code() const {return 11101;}
...
#endif  // PY8MEs_R11_P1_heft_ckm_h_ztaptam_H
