...
#ifndef PY8MEs_R21_P10_heft_ckm_h_wplvl_H
#define PY8MEs_R21_P10_heft_ckm_h_wplvl_H
...
// Process: h > w+ e- ve~ HIG<=1 HIW<=1 @21
// Process: h > w+ mu- vm~ HIG<=1 HIW<=1 @21
// Process: h > w- e+ ve HIG<=1 HIW<=1 @21
// Process: h > w- mu+ vm HIG<=1 HIW<=1 @21
//--------------------------------------------------------------------------
...
class PY8MEs_R21_P10_heft_ckm_h_wplvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R21_P10_heft_ckm_h_wplvl(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R21_P10_heft_ckm_h_wplvl(); 
    ...
    virtual string name() const {return "h_wplvl (heft_ckm)";}

    virtual int code() const {return 12110;}
  ...
  private:
    ...
    double matrix_21_h_wpemvex(); 
    double matrix_21_h_wmepve(); 
...
#endif  // PY8MEs_R21_P10_heft_ckm_h_wplvl_H
