...
#ifndef PY8MEs_R701_P15_heft_ckm_h_gqq_H
#define PY8MEs_R701_P15_heft_ckm_h_gqq_H
...
// Process: h > g u u~ HIG<=1 HIW<=1 @701
// Process: h > g c c~ HIG<=1 HIW<=1 @701
// Process: h > g d d~ HIG<=1 HIW<=1 @701
// Process: h > g s s~ HIG<=1 HIW<=1 @701
//--------------------------------------------------------------------------
...
class PY8MEs_R701_P15_heft_ckm_h_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R701_P15_heft_ckm_h_gqq(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R701_P15_heft_ckm_h_gqq(); 
    ...
    virtual string name() const {return "h_gqq (heft_ckm)";}

    virtual int code() const {return 80115;}
...
#endif  // PY8MEs_R701_P15_heft_ckm_h_gqq_H
