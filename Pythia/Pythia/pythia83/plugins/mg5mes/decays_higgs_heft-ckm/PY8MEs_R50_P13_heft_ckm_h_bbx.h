...
#ifndef PY8MEs_R50_P13_heft_ckm_h_bbx_H
#define PY8MEs_R50_P13_heft_ckm_h_bbx_H
...
class PY8MEs_R50_P13_heft_ckm_h_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R50_P13_heft_ckm_h_bbx(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R50_P13_heft_ckm_h_bbx(); 
    ...
    virtual string name() const {return "h_bbx (heft_ckm)";}

    virtual int code() const {return 15013;}
...
#endif  // PY8MEs_R50_P13_heft_ckm_h_bbx_H
