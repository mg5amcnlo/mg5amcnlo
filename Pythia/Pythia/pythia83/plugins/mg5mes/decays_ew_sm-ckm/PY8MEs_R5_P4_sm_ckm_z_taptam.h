...
#ifndef PY8MEs_R5_P4_sm_ckm_z_taptam_H
#define PY8MEs_R5_P4_sm_ckm_z_taptam_H
...
class PY8MEs_R5_P4_sm_ckm_z_taptam : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P4_sm_ckm_z_taptam(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R5_P4_sm_ckm_z_taptam(); 
    ...
    virtual string name() const {return "z_taptam (sm_ckm)";}

    virtual int code() const {return 10504;}
...
#endif  // PY8MEs_R5_P4_sm_ckm_z_taptam_H
