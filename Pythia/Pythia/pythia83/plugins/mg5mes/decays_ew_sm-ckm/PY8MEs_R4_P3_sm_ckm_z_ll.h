...
#ifndef PY8MEs_R4_P3_sm_ckm_z_ll_H
#define PY8MEs_R4_P3_sm_ckm_z_ll_H
...
class PY8MEs_R4_P3_sm_ckm_z_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P3_sm_ckm_z_ll(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R4_P3_sm_ckm_z_ll(); 
    ...
    virtual string name() const {return "z_ll (sm_ckm)";}

    virtual int code() const {return 10403;}
  ...
  private:
    ...
    double matrix_4_z_epem(); 
    double matrix_4_z_vevex(); 
...
#endif  // PY8MEs_R4_P3_sm_ckm_z_ll_H
