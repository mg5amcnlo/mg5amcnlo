...
#ifndef PY8MEs_R2_P1_sm_ckm_z_bbx_H
#define PY8MEs_R2_P1_sm_ckm_z_bbx_H
...
class PY8MEs_R2_P1_sm_ckm_z_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P1_sm_ckm_z_bbx(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R2_P1_sm_ckm_z_bbx(); 
    ...
    virtual string name() const {return "z_bbx (sm_ckm)";}
...
#endif  // PY8MEs_R2_P1_sm_ckm_z_bbx_H
