...
#ifndef PY8MEs_R10_P2_sm_ckm_tx_bxqq_H
#define PY8MEs_R10_P2_sm_ckm_tx_bxqq_H
...
class PY8MEs_R10_P2_sm_ckm_tx_bxqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R10_P2_sm_ckm_tx_bxqq(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R10_P2_sm_ckm_tx_bxqq(); 
    ...
    virtual string name() const {return "tx_bxqq (sm_ckm)";}

    virtual int code() const {return 11002;}
  ...
  private:
    ...
    double matrix_1tx_bxdux(); 
    double matrix_1tx_bxdcx(); 
    double matrix_1tx_bxsux(); 
...
#endif  // PY8MEs_R10_P2_sm_ckm_tx_bxqq_H
