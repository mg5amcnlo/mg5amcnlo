...
#ifndef PY8MEs_R15_P7_sm_ckm_tx_bxtamvl_H
#define PY8MEs_R15_P7_sm_ckm_tx_bxtamvl_H
...
class PY8MEs_R15_P7_sm_ckm_tx_bxtamvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R15_P7_sm_ckm_tx_bxtamvl(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R15_P7_sm_ckm_tx_bxtamvl(); 
    ...
    virtual string name() const {return "tx_bxtamvl (sm_ckm)";}

    virtual int code() const {return 11507;}
...
#endif  // PY8MEs_R15_P7_sm_ckm_tx_bxtamvl_H
