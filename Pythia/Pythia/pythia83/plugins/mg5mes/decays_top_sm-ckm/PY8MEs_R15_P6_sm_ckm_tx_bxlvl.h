...
#ifndef PY8MEs_R15_P6_sm_ckm_tx_bxlvl_H
#define PY8MEs_R15_P6_sm_ckm_tx_bxlvl_H
...
class PY8MEs_R15_P6_sm_ckm_tx_bxlvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R15_P6_sm_ckm_tx_bxlvl(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R15_P6_sm_ckm_tx_bxlvl(); 
    ...
    virtual string name() const {return "tx_bxlvl (sm_ckm)";}

    virtual int code() const {return 11506;}
...
#endif  // PY8MEs_R15_P6_sm_ckm_tx_bxlvl_H
