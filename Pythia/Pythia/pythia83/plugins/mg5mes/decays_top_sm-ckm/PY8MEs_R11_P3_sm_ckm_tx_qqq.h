...
#ifndef PY8MEs_R11_P3_sm_ckm_tx_qqq_H
#define PY8MEs_R11_P3_sm_ckm_tx_qqq_H
...
class PY8MEs_R11_P3_sm_ckm_tx_qqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R11_P3_sm_ckm_tx_qqq(Parameters_sm_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R11_P3_sm_ckm_tx_qqq(); 
    ...
    virtual string name() const {return "tx_qqq (sm_ckm)";}

    virtual int code() const {return 11103;}
  ...
  private:
    ...
    double matrix_11_tx_duxdx(); 
    double matrix_11_tx_duxsx(); 
    double matrix_11_tx_dcxdx(); 
    double matrix_11_tx_dcxsx(); 
    double matrix_11_tx_suxdx(); 
    double matrix_11_tx_suxsx(); 
...
#endif  // PY8MEs_R11_P3_sm_ckm_tx_qqq_H
