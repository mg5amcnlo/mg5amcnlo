...
#ifndef PY8MEs_R990_P12_heft_ckm_taptam_h_H
#define PY8MEs_R990_P12_heft_ckm_taptam_h_H
...
// Process: ta+ ta- > h HIG<=1 HIW<=1 WEIGHTED<=2 @990
//--------------------------------------------------------------------------
...
class PY8MEs_R990_P12_heft_ckm_taptam_h : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R990_P12_heft_ckm_taptam_h(Parameters_heft_ckm * model) :
        pars(model)
    {
      initProc(); 
    }
    ...
    // Destructor.
    ~PY8MEs_R990_P12_heft_ckm_taptam_h(); 
    ...
    virtual string name() const {return "taptam_h (heft_ckm)";}

    virtual int code() const {return 109012;}
...
#endif  // PY8MEs_R990_P12_heft_ckm_taptam_h_H
