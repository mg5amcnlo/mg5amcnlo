...
#ifndef PY8MEs_R906_P11_heft_ckm_qq_hbq_H
#define PY8MEs_R906_P11_heft_ckm_qq_hbq_H
...
class PY8MEs_R906_P11_heft_ckm_qq_hbq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R906_P11_heft_ckm_qq_hbq(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R906_P11_heft_ckm_qq_hbq(); 
    ...
    virtual string name() const {return "qq_hbq (heft_ckm)";}

    virtual int code() const {return 100611;}
  ...
  private:
    ...
    static const int nwavefuncs = 31; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 36; 
    Complex<double> amp[namplitudes]; 
    double matrix_906_ud_hbu_no_b(); 
    double matrix_906_ud_hbc_no_b(); 
    double matrix_906_us_hbu_no_b(); 
    double matrix_906_uux_hbdx_no_b(); 
    double matrix_906_uux_hbsx_no_b(); 
    double matrix_906_ucx_hbdx_no_b(); 
    double matrix_906_cd_hbu_no_b(); 
    double matrix_906_cd_hbc_no_b(); 
    double matrix_906_cs_hbu_no_b(); 
    double matrix_906_cux_hbdx_no_b(); 
    double matrix_906_cux_hbsx_no_b(); 
    double matrix_906_ccx_hbdx_no_b(); 
    double matrix_906_dux_hbux_no_b(); 
    double matrix_906_dux_hbcx_no_b(); 
    double matrix_906_dcx_hbux_no_b(); 
    double matrix_906_dcx_hbcx_no_b(); 
    double matrix_906_sux_hbux_no_b(); 
    double matrix_906_sux_hbcx_no_b(); 
    double matrix_906_uux_hbxd_no_b(); 
    double matrix_906_uux_hbxs_no_b(); 
    double matrix_906_ucx_hbxd_no_b(); 
    double matrix_906_ucx_hbxs_no_b(); 
    double matrix_906_udx_hbxu_no_b(); 
    double matrix_906_udx_hbxc_no_b(); 
    double matrix_906_usx_hbxu_no_b(); 
    double matrix_906_usx_hbxc_no_b(); 
    double matrix_906_cux_hbxd_no_b(); 
    double matrix_906_ccx_hbxd_no_b(); 
    double matrix_906_cdx_hbxu_no_b(); 
    double matrix_906_cdx_hbxc_no_b(); 
    double matrix_906_uxdx_hbxux_no_b(); 
    double matrix_906_uxdx_hbxcx_no_b(); 
    double matrix_906_uxsx_hbxux_no_b(); 
    double matrix_906_cxdx_hbxux_no_b(); 
    double matrix_906_cxdx_hbxcx_no_b(); 
    double matrix_906_cxsx_hbxux_no_b(); 

    // Constants for array limits
    static const int nexternal = 5; 
    static const int ninitial = 2; 
    static const int nprocesses = 36; 
...
#endif  // PY8MEs_R906_P11_heft_ckm_qq_hbq_H
