...
#ifndef PY8MEs_R912_P2_heft_ckm_ll_hbbx_H
#define PY8MEs_R912_P2_heft_ckm_ll_hbbx_H
...
class PY8MEs_R912_P2_heft_ckm_ll_hbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R912_P2_heft_ckm_ll_hbbx(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R912_P2_heft_ckm_ll_hbbx(); 
    ...
    virtual string name() const {return "ll_hbbx (heft_ckm)";}

    virtual int code() const {return 101202;}
...
#endif  // PY8MEs_R912_P2_heft_ckm_ll_hbbx_H
