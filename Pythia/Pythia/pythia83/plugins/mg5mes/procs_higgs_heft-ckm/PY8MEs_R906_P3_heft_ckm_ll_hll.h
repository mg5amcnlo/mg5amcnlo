...
#ifndef PY8MEs_R906_P3_heft_ckm_ll_hll_H
#define PY8MEs_R906_P3_heft_ckm_ll_hll_H
...
// Process: e+ e- > h e+ e- HIG<=1 HIW<=1 WEIGHTED<=6 @906
// Process: e+ e- > h mu+ mu- HIG<=1 HIW<=1 WEIGHTED<=6 @906
// Process: e+ e- > h ve ve~ HIG<=1 HIW<=1 WEIGHTED<=6 @906
// Process: e+ e- > h vm vm~ HIG<=1 HIW<=1 WEIGHTED<=6 @906
// Process: e+ e- > h vt vt~ HIG<=1 HIW<=1 WEIGHTED<=6 @906
//--------------------------------------------------------------------------
...
class PY8MEs_R906_P3_heft_ckm_ll_hll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R906_P3_heft_ckm_ll_hll(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R906_P3_heft_ckm_ll_hll(); 
    ...
    virtual string name() const {return "ll_hll (heft_ckm)";}

    virtual int code() const {return 100603;}
  ...
  private:
    ...
    double matrix_906_epem_hepem(); 
    double matrix_906_epem_hmupmum(); 
    double matrix_906_epem_hvevex(); 
    double matrix_906_epem_hvmvmx(); 
...
#endif  // PY8MEs_R906_P3_heft_ckm_ll_hll_H
