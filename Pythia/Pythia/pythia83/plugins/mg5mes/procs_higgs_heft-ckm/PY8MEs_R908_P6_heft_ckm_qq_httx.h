...
#ifndef PY8MEs_R908_P6_heft_ckm_qq_httx_H
#define PY8MEs_R908_P6_heft_ckm_qq_httx_H
...
class PY8MEs_R908_P6_heft_ckm_qq_httx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R908_P6_heft_ckm_qq_httx(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R908_P6_heft_ckm_qq_httx(); 
    ...
    virtual string name() const {return "qq_httx (heft_ckm)";}

    virtual int code() const {return 100806;}
...
#endif  // PY8MEs_R908_P6_heft_ckm_qq_httx_H
