...
#ifndef PY8MEs_R908_P1_heft_ckm_ll_httx_H
#define PY8MEs_R908_P1_heft_ckm_ll_httx_H
...
class PY8MEs_R908_P1_heft_ckm_ll_httx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R908_P1_heft_ckm_ll_httx(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R908_P1_heft_ckm_ll_httx(); 
    ...
    virtual string name() const {return "ll_httx (heft_ckm)";}

    virtual int code() const {return 100801;}
...
#endif  // PY8MEs_R908_P1_heft_ckm_ll_httx_H
