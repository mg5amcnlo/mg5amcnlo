...
#ifndef PY8MEs_R905_P9_heft_ckm_qq_hwp_H
#define PY8MEs_R905_P9_heft_ckm_qq_hwp_H
...
class PY8MEs_R905_P9_heft_ckm_qq_hwp : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R905_P9_heft_ckm_qq_hwp(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R905_P9_heft_ckm_qq_hwp(); 
    ...
    virtual string name() const {return "qq_hwp (heft_ckm)";}

    virtual int code() const {return 100509;}
  ...
  private:
    ...
    double matrix_905_udx_hwp(); 
    double matrix_905_usx_hwp(); 
    double matrix_905_cdx_hwp(); 
    double matrix_905_dux_hwm(); 
    double matrix_905_dcx_hwm(); 
    double matrix_905_sux_hwm(); 
...
#endif  // PY8MEs_R905_P9_heft_ckm_qq_hwp_H
