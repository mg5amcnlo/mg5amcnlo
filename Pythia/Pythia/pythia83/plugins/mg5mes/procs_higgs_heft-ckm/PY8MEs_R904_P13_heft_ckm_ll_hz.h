...
#ifndef PY8MEs_R904_P13_heft_ckm_ll_hz_H
#define PY8MEs_R904_P13_heft_ckm_ll_hz_H
...
// Process: e+ e- > h z HIG<=1 HIW<=1 WEIGHTED<=4 @904
//--------------------------------------------------------------------------
...
class PY8MEs_R904_P13_heft_ckm_ll_hz : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R904_P13_heft_ckm_ll_hz(Parameters_heft_ckm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R904_P13_heft_ckm_ll_hz(); 
    ...
    virtual string name() const {return "ll_hz (heft_ckm)";}

    virtual int code() const {return 100413;}
...
#endif  // PY8MEs_R904_P13_heft_ckm_ll_hz_H
