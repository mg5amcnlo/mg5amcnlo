// test024.cc is a part of the PYTHIA event generator.
...
// All input is specified in the test022.cmnd file.
...
int main() {
  ...
  pythia.stat();
  ofstream cmp("test024.dat");
  epCons.table(cmp);
  nFinal.table(cmp);
  dnparticledy.table(cmp);
