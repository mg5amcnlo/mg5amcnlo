// test007.cc is a part of the PYTHIA event generator.
...
// In the accompanying test029.cmnd file the decay channels of this
// blob can be set up. Furthermore, only gamma, e+-, p/pbar and
// neutrinos are stable, everything else is set to decay.
// (The "single-particle gun" of test021.cc offers another possible
...
int main() {
  ...
  // After the program has run, type "python test007plot.py" (without the " ")
  // in a terminal window, and open "out07plot.pdf" in a PDF viewer.
  HistPlot hpl("test007plot");
