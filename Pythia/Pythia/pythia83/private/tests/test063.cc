// test063.cc is a part of the PYTHIA event generator.
// Copyright (C) 2021 Torbjorn Sjostrand.
// PYTHIA is licenced under the GNU GPL v2 or later, see COPYING for details.
// Please respect the MCnet Guidelines, see GUIDELINES for details.

// Tests rare emission rates, in this case q -> q gamma.  To
// concentrate on the photons from the showers, MPI and hadronization
...
int main() {
  ...
  ofstream write("test063.dat");
  gamNoEnh.table(write, true);
  gamWithEnh.table(write, true);
  write.close();
