// test015.cc is a part of the PYTHIA event generator.
...
int main() {
  ...
  pythia.stat();
  ofstream cmp("test015.dat");
  nBperEvent.table(cmp);
  nSameEvent.table(cmp);
  oppSignMass.table(cmp);
  sameSignMass.table(cmp);
