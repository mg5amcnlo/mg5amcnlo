// test068.cc is a part of the PYTHIA event generator.
...
int main() {
  ...
  // Histograms.
  ofstream cmp("test068.dat");
  xP1.table(cmp, true);
  xP2.table(cmp, true);
  tP1.table(cmp, true);
  tP2.table(cmp, true);
  nJets0.table(cmp, true);
  nJets1.table(cmp, true);
  nJets2.table(cmp, true);
  eTjets0.table(cmp, true);
  eTjets1.table(cmp, true);
  eTjets2.table(cmp, true);
  etaJets0.table(cmp, true);
  etaJets1.table(cmp, true);
  etaJets2.table(cmp, true);
  phiJets0.table(cmp, true);
  phiJets1.table(cmp, true);
  phiJets2.table(cmp, true);
