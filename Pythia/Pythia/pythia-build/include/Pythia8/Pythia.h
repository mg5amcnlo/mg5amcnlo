...
#define PYTHIA_VERSION 8.225
#define PYTHIA_VERSION_INTEGER 8225
...
public:
  ...
  // Possibility to pass in pointer for external beam remnants.
  bool setRemnantsPtr( BeamRemnants* remnantsPtrIn)
    { remnantsPtr = remnantsPtrIn; return true; }
...
private:
  ...
  // Pointers to beamn remnants.
  BeamRemnants* remnantsPtr;
  bool useNewRemnants;
