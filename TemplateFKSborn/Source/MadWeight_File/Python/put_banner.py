...
import os,re,sys
sys.path+=['../'*i+'./Source/MadWeight_File/Python' for i in range(1,6)]
import MW_param
...
class Banner:
    ...
    def __init__(self):
        ...
        self.card_info={'MGProcCard':'./Cards/proc_card.dat',
...
class MW_Banner(Banner):
    ...
    def __init__(self,event_file):
        ...
        self.header_file='./Source/MadWeight_File/MWP_template/MW_banner_header.txt'

        #adding information for version
        self.version_info['MW version']='./Source/MadWeight_File/MW_TemplateVersion.txt'
        self.version_info['Transfer_Function version']='./Source/MadWeight_File/Transfer_Fct/Transfer_FctVersion.txt'
