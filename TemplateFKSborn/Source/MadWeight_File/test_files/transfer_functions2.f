...
C+-----------------------------------------------------------------------+
        ...
        c_point(4,1,2)=width_THETA_all(p_exp(0,4),tag_lhco(4))
        c_point(4,2,2)=width_PHI_all(p_exp(0,4),tag_lhco(4))
        c_point(4,3,2)=width_E_all(p_exp(0,4),tag_lhco(4))
        ...
        c_point(6,1,2)=width_THETA_all(p_exp(0,6),tag_lhco(6))
        c_point(6,2,2)=width_PHI_all(p_exp(0,6),tag_lhco(6))
        c_point(6,3,2)=width_E_all(p_exp(0,6),tag_lhco(6))

        c_point(7,1,1)=theta(p_exp(0,7))
        c_point(7,2,1)=phi(p_exp(0,7))
        c_point(7,3,1)=rho(p_exp(0,7))
        c_point(7,1,2)=width_THETA_all(p_exp(0,7),tag_lhco(7))
        c_point(7,2,2)=width_PHI_all(p_exp(0,7),tag_lhco(7))
        c_point(7,3,2)=width_E_all(p_exp(0,7),tag_lhco(7))

        c_point(8,1,1)=theta(p_exp(0,8))
        c_point(8,2,1)=phi(p_exp(0,8))
        c_point(8,3,1)=rho(p_exp(0,8))
        c_point(8,1,2)=width_THETA_all(p_exp(0,8),tag_lhco(8))
        c_point(8,2,2)=width_PHI_all(p_exp(0,8),tag_lhco(8))
        c_point(8,3,2)=width_E_all(p_exp(0,8),tag_lhco(8))
...
c                
      ...
      integer n_lhco
        ...
        n_lhco=tag_lhco(4)
        call tf_E_all(pexp(0,4),p(0,4),n_lhco,weight)
        call tf_THETA_all(pexp(0,4),p(0,4),n_lhco,weight)
        call tf_PHI_all(pexp(0,4),p(0,4),n_lhco,weight)
        ...
        n_lhco=tag_lhco(6)
        call tf_E_all(pexp(0,6),p(0,6),n_lhco,weight)
        call tf_THETA_all(pexp(0,6),p(0,6),n_lhco,weight)
        call tf_PHI_all(pexp(0,6),p(0,6),n_lhco,weight)

        n_lhco=tag_lhco(7)
        call tf_E_all(pexp(0,7),p(0,7),n_lhco,weight)
        call tf_THETA_all(pexp(0,7),p(0,7),n_lhco,weight)
        call tf_PHI_all(pexp(0,7),p(0,7),n_lhco,weight)

        n_lhco=tag_lhco(8)
        call tf_E_all(pexp(0,8),p(0,8),n_lhco,weight)
        call tf_THETA_all(pexp(0,8),p(0,8),n_lhco,weight)
        call tf_PHI_all(pexp(0,8),p(0,8),n_lhco,weight)
...
c
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(4)
        call tf_E_all(pexp(0,4),momenta(0,4),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(6)
        call tf_E_all(pexp(0,6),momenta(0,6),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(7)
        call tf_E_all(pexp(0,7),momenta(0,7),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(8)
        call tf_E_all(pexp(0,8),momenta(0,8),n_lhco,tf_E_for_part)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_4=1d0
        n_lhco=tag_lhco(4)
        call tf_E_all(pexp(0,4),momenta(0,4),n_lhco,tf_E_for_4)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_6=1d0
        n_lhco=tag_lhco(6)
        call tf_E_all(pexp(0,6),momenta(0,6),n_lhco,tf_E_for_6)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_7=1d0
        n_lhco=tag_lhco(7)
        call tf_E_all(pexp(0,7),momenta(0,7),n_lhco,tf_E_for_7)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_8=1d0
        n_lhco=tag_lhco(8)
        call tf_E_all(pexp(0,8),momenta(0,8),n_lhco,tf_E_for_8)
