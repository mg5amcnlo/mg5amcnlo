...
!
  ...
  public :: olo_xkind
!
  integer ,parameter :: olo_xkind=kind(1d0) !XKIND_SETPAR
!  
end module
...
!
  include 'cts_dpr.h'
   ,parameter :: R0P0=0._kindr2
  include 'cts_dpr.h'
   ,parameter :: R1P0=1._kindr2
  include 'cts_dpr.h'
   ,parameter :: R5M1=0.5_kindr2
!                                  1 2345678901234567890123456789012 
  include 'cts_dpr.h'
   ,parameter :: TWOPI=6.2831853071795864769252867665590_kindr2
  include 'cts_dpr.h'
   ,parameter :: SQRT2=1.4142135623730950488016887242097_kindr2
  include 'cts_dpc.h'
   ,parameter :: C0P0 = (0._kindr2,0._kindr2)
  include 'cts_dpc.h'
   ,parameter :: C1P0 = (1._kindr2,0._kindr2)
  include 'cts_dpc.h'
   ,parameter :: CiP0 = (0._kindr2,1._kindr2)
!  
end module
...
!*******************************************************************
   ...
   integer :: ir,ik
   include 'cts_dpc.h'
    ,parameter :: two=2*C1P0,four=4*C1P0
   dd = sqrt(qq*qq-four)
   rr = qq+dd
   r2 = qq-dd
   aa = abs(rr)
...
module avh_olo_tri
  ...
  include 'cts_dpc.h'
   ,parameter :: oieps=C1P0+CiP0*epsilon(R1P0)**2
...
!*******************************************************************
   ...
   include 'cts_dpr.h'
    ,intent(in)  :: rmu2
   include 'cts_dpc.h'
    ,parameter :: const=C1P0*TWOPI*TWOPI/96
   include 'cts_dpc.h'
    ,parameter :: half=C1P0/2
...
!*******************************************************************
   ...
   include 'cts_dpr.h'
    :: pp(3),rp1,rp2,rp3
   include 'cts_dpc.h'
    ,parameter :: const=C1P0*TWOPI*TWOPI/48
   include 'cts_dpc.h'
    :: log2,log3
...
!*******************************************************************
   ...
   include 'cts_dpc.h'
    ,parameter :: const=C1P0*TWOPI*TWOPI/32
!
...
!*******************************************************************
   ...
   include 'cts_dpc.h'
    ,parameter :: const=(C1P0*TWOPI*TWOPI*7)/48
!
...
!*******************************************************************
   ...
   include 'cts_dpr.h'
    :: rmu2
   include 'cts_dpc.h'
    ,parameter :: const=C1P0*TWOPI*TWOPI/16
!
...
!*******************************************************************
   ...
   include 'cts_dpc.h'
    :: r13,r14,r24,logm,log12,log23,log4,li423 &
                     ,z2,z1,z0,cc
   include 'cts_dpc.h'
    ,parameter :: const=(C1P0*TWOPI*TWOPI*13)/96
!
...
!*******************************************************************
   ...
   include 'cts_dpc.h'
    ,parameter :: const=C1P0*TWOPI*TWOPI/12
!
...
!*******************************************************************
   ...
   integer ,parameter :: base(4)=(/8,4,2,1/)
   include 'cts_dpc.h'
    ,parameter :: pi2=C1P0*TWOPI*TWOPI/4
!
   rmu2 = rmu*rmu
   ff = api(5)*api(6)
   gg = api(2)*api(4)
...
!*******************************************************************
   ...
   include 'cts_dpr.h'
    ,parameter :: small=epsilon(R1P0)**2
!
...
!
  ...
  include 'cts_dpr.h'
   :: onshellthrs = R0P0 ! corrected in subroutine hello
...
!
  include 'cts_dpc.h'
   :: ss,r1,r2
  include 'cts_dpr.h'
   :: app,am1,am2,thrs,mulocal,mulocal2
  character(25+99) ,parameter :: warning=&
