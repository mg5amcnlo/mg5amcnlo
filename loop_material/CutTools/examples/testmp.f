...
!
      ...
      limitvalue= 1.d-20 ! limit of precision below which 
...
!---------------------------------------------------------------------
!
!      call ctsxcut(rootsvalue,muscale,number_propagators,test,mpfortest,
...
!
        forcemp=.false. 
        call ctsxcut(rootsvalue,muscale,number_propagators,test,
     & mpfortest,rnk,pp,m2,amp,ar1,stable,forcemp)
!        print*,'               '
!        print*,'  iter= ',iter
!        print*,'               '
!        print*,'               '
