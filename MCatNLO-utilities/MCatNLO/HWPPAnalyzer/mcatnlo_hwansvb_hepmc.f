...
C----------------------------------------------------------------------
      ...
      call mbook(k+ 2,'W log pt'//cc(j),0.05e0,0.e0,5.e0)
      call mbook(k+ 3,'W y'//cc(j),0.25e0,-9.e0,9.e0)
      call mbook(k+ 4,'W eta'//cc(j),0.25e0,-9.e0,9.e0)
      call mbook(k+ 5,'mW'//cc(j),sngl(bin),xmi,xms)
...
C
      do j=1,1
        kk=30+(j-1)*5
          ...
          if(ptv.gt.0)call mfill(kk+2,sngl(log10(ptv)),sngl(WWW0))
          call mfill(kk+3,sngl(yv),sngl(WWW0))
          call mfill(kk+4,sngl(etav),sngl(WWW0))
          call mfill(kk+5,sngl(xmv),sngl(WWW0))
      enddo
C
 999  END
