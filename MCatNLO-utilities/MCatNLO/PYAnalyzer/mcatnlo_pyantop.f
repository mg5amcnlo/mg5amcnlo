...
c-------------------------------------------------------------
      ...
      if(ptq2.gt.0) call mfill(7,sngl(log10(ptq2)),sngl(WWW0))
      call mfill(15,sngl(yq2),sngl(WWW0))
      call mfill(8,sngl(ptq1),sngl(WWW0))
      call mfill(20,sngl(ptq1),sngl(WWW0))
      if(ptq1.gt.0) call mfill(9,sngl(log10(ptq1)),sngl(WWW0))
...
c
     ...
     #    call mfill(kk+17,sngl(log10(azinorm)),sngl(WWW0))
      ...
      if(abs(yq2).lt.ycut)then
        ...
        if(ptq2.gt.0) call mfill(kk+7,sngl(log10(ptq2)),sngl(WWW0))
      endif
      ...
      if(abs(yq1).lt.ycut)then
        ...
        if(ptq1.gt.0) call mfill(kk+9,sngl(log10(ptq1)),sngl(WWW0))
      endif
