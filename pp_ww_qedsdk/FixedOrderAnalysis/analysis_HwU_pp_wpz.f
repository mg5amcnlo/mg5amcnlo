...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      do i=1,4
         ...
         call HwU_book(l+ 2,'wp rap         '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 3,'wm rap        '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 4,'wp-wm pair rap '//cc(i), 60,-3d0,3d0)
         call HwU_book(l+ 5,'log10 m wp-wm        '//cc(i),40,1d0,4d0)
         call HwU_book(l+ 6,'log10 pt wp          '//cc(i),40,1d0,4d0)
         call HwU_book(l+ 7,'log10 pt wm         '//cc(i),40,1d0,4d0)
         call HwU_book(l+ 8,'log10 pt wp wm       '//cc(i),40,1d0,4d0)
      enddo
      return
      end
