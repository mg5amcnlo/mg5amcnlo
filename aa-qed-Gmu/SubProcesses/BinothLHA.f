...
c======================================================================
c If one employs a model in the Gmu scheme and there are tagged photon
c in the process, then they must be accounted for
...
c weight, screwing up the complete integration afterward.
     ...
     $     .and. ret_code/100.eq.1) then
      ...
      implicit none
      ! at the moment, just hardcode the number
      get_n_tagged_photons = 2
      return
      end
