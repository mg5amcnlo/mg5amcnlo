...
class TestMod_file(unittest.TestCase):
    ...
    def test_mw_cuts(self):
        ...
        file_to_mod ='./SubProcesses/cuts.bk'
        rule= './Source/MadWeight_File/mod_file/mod_cuts'
...
class TestMWBuilder(unittest.TestCase):
    ...
    def oneSetUp(self):
        ...
        os.system('rm ./Cards/proc_card.dat')
        os.system('ln -s ../Source/MadWeight_File/test_files/proc_card.dat ./Cards')
    ...
    def checkSetUp(self):
        return filecmp.cmp('./Source/MadWeight_File/test_files/proc_card.dat','./Cards/proc_card.dat', False)
    ...
    def test_autofiles(self):
        ...
        for MWdir in self.MWparam.MW_listdir:
            for filename in ['main_code%s.f', 'data%s.inc','d_choices%s.f','d_choices%s.inc','info_part%s.dat','multi_channel%s.f','transfer_functions%s.f']:
                text = 'diff ./SubProcesses/%s/' + filename + ' ./Source/MadWeight_File/test_files/'+ filename
                os.system(text % (MWdir, '', MWdir[4]))
                self.assertTrue(filecmp.cmp(os.path.join('./SubProcesses/',MWdir, filename % ''), './Source/MadWeight_File/test_files/' + filename % MWdir[4], False),
