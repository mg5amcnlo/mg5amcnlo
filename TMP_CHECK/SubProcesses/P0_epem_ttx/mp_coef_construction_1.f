...
C     Coefficient construction for loop diagram with ID 3
      CALL MP_FFV1L1P0_3(PL(0,0),W(3),GC_5,ZERO,ZERO,PL(0,1),COEFS)
      CALL MP_ML5_0_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,1))
      CALL MP_FFV1L3_2(PL(0,1),W(4),GC_5,MDL_MT,MDL_WT,PL(0,2),COEFS)
      CALL MP_ML5_0_UPDATE_WL_0_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL MP_FFV1L1_2(PL(0,2),W(5),GC_2,MDL_MT,MDL_WT,PL(0,3),COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,3),2,4,1,1,1,7,H)
C     Coefficient construction for loop diagram with ID 4
      CALL MP_FFV2_5L1_2(PL(0,2),W(6),GC_22,GC_23,MDL_MT,MDL_WT,PL(0,4)
     $ ,COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,4))
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,4),2,4,1,1,1,8,H)
