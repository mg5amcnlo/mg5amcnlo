...
C     Amplitude(s) for UVCT diagram with ID 40
      CALL MP_FFV1_0(W(5),W(4),W(3),GC_5,AMPL(2,76))
      AMPL(2,76)=AMPL(2,76)*(4.0D0*UVWFCT_G_1_1EPS)
C     Amplitude(s) for UVCT diagram with ID 41
      CALL MP_FFV1_0(W(5),W(4),W(3),GC_5,AMPL(1,77))
      AMPL(1,77)=AMPL(1,77)*(2.0D0*UVWFCT_G_1+2.0D0*UVWFCT_G_2)
C     Amplitude(s) for UVCT diagram with ID 42
      CALL MP_FFV1_0(W(2),W(4),W(6),GC_5,AMPL(2,78))
      AMPL(2,78)=AMPL(2,78)*(4.0D0*UVWFCT_G_1_1EPS)
C     Amplitude(s) for UVCT diagram with ID 43
      CALL MP_FFV1_0(W(2),W(4),W(6),GC_5,AMPL(1,79))
      AMPL(1,79)=AMPL(1,79)*(2.0D0*UVWFCT_G_1+2.0D0*UVWFCT_G_2)
C     Amplitude(s) for UVCT diagram with ID 44
      CALL MP_FFV1_0(W(2),W(7),W(3),GC_5,AMPL(2,80))
      AMPL(2,80)=AMPL(2,80)*(4.0D0*UVWFCT_G_1_1EPS)
C     Amplitude(s) for UVCT diagram with ID 45
      CALL MP_FFV1_0(W(2),W(7),W(3),GC_5,AMPL(1,81))
