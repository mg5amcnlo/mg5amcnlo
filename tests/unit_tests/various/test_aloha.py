...
R2(1)= COUP*denom*(S3(1)*( (P2(0)*( (0, -1)*R1(1)+(0, 1)*R1(6)-R1(10)+(0, 1)*R1(13)))+( (P2(3)*( (0, -1)*R1(1)+(0, 1)*R1(6)-R1(10)+(0, 1)*R1(13)))+( (P2(1)*( (0, -1)*R1(2)+(0, 1)*R1(5)+R1(9)+(0, -1)*R1(14)))+(P2(2)*( R1(2)-R1(5)+(0, 1)*R1(9)+R1(14)))))))
R2(2)= COUP*denom*(S3(1)*( (P2(1)*( (0, -1)*R1(1)+(0, 1)*R1(6)-R1(10)+(0, 1)*R1(13)))+( (P2(2)*( -R1(1)+R1(6)+(0, 1)*R1(10)+R1(13)))+( (P2(0)*( (0, -1)*R1(2)+(0, 1)*R1(5)+R1(9)+(0, -1)*R1(14)))+(P2(3)*( (0, 1)*R1(2)+(0, -1)*R1(5)-R1(9)+(0, 1)*R1(14)))))))
R2(3)= COUP*denom*(M2*( (0, 1)*R1(6)-R1(10)+(0, -1)*R1(1)+(0, 1)*R1(13))*S3(1))
R2(4)= COUP*denom*(M2*( (0, -1)*R1(2)+(0, -1)*R1(14)+(0, 1)*R1(5)+R1(9))*S3(1))
end
...
def FFV13C1_0(F2,F1,V3,COUP):
    ...
    P3 = [complex(V3[4]).real, \\
             ...
             complex(V3[5]).imag, \\
             complex(V3[4]).imag]
    vertex = COUP*( (F2[1]*( (F1[3]*( (P2[1]*( (P3[1]*( -V3[0]+V3[3]))+( (V3[1]*( P3[0]-P3[3]))+( (P3[2]*( -1j*V3[3]+1j*V3[0]))+(V3[2]*( -1j*P3[0]+1j*P3[3]))))))+( (P2[2]*( (P3[2]*( -V3[0]+V3[3]))+( (V3[2]*( P3[0]-P3[3]))+( (P3[1]*( 1j*V3[3]-1j*V3[0]))+(V3[1]*( 1j*P3[0]-1j*P3[3]))))))+( (P2[3]*( -(P3[3]*V3[0])+(P3[0]*V3[3])-1j*(V3[2]*P3[1])+1j*(V3[1]*P3[2])))+(P2[0]*( -(P3[0]*V3[3])+(P3[3]*V3[0])+1j*(V3[2]*P3[1])-1j*(V3[1]*P3[2])))))))+(F1[2]*( (P2[3]*( (P3[3]*( -V3[1]+1j*V3[2]))+( (V3[3]*( P3[1]-1j*P3[2]))+( (P3[0]*( -1j*V3[2]+V3[1]))+(V3[0]*( -P3[1]+1j*P3[2]))))))+( (P2[0]*( (P3[0]*( V3[1]-1j*V3[2]))+( (V3[0]*( -P3[1]+1j*P3[2]))+( (V3[3]*( P3[1]-1j*P3[2]))+(P3[3]*( 1j*V3[2]-V3[1]))))))+( (P2[2]*( -(P3[2]*V3[1])+(P3[1]*V3[2])+1j*(V3[3]*P3[0])-1j*(V3[0]*P3[3])))+(P2[1]*( 1j*(P3[1]*V3[2])-1j*(P3[2]*V3[1])-(V3[3]*P3[0])+(V3[0]*P3[3])))))))))+( (F2[0]*( (F1[2]*( (P2[1]*( (P3[1]*( -V3[0]-V3[3]))+( (V3[1]*( P3[0]+P3[3]))+( (P3[2]*( -1j*V3[3]-1j*V3[0]))+(V3[2]*( 1j*P3[0]+1j*P3[3]))))))+( (P2[2]*( (P3[2]*( -V3[0]-V3[3]))+( (V3[2]*( P3[0]+P3[3]))+( (P3[1]*( 1j*V3[3]+1j*V3[0]))+(V3[1]*( -1j*P3[0]-1j*P3[3]))))))+( (P2[3]*( -(P3[3]*V3[0])+(P3[0]*V3[3])-1j*(V3[2]*P3[1])+1j*(V3[1]*P3[2])))+(P2[0]*( (P3[0]*V3[3])-(P3[3]*V3[0])-1j*(V3[2]*P3[1])+1j*(V3[1]*P3[2])))))))+(F1[3]*( (P2[3]*( (P3[3]*( -V3[1]-1j*V3[2]))+( (V3[3]*( P3[1]+1j*P3[2]))+( (P3[0]*( -1j*V3[2]-V3[1]))+(V3[0]*( P3[1]+1j*P3[2]))))))+( (P2[0]*( (P3[0]*( V3[1]+(-0+1j)*V3[2]))+( (V3[0]*( -P3[1]-1j*P3[2]))+( (V3[3]*( -P3[1]-1j*P3[2]))+(P3[3]*( 1j*V3[2]+V3[1]))))))+( (P2[2]*( -(P3[2]*V3[1])+(P3[1]*V3[2])+1j*(V3[3]*P3[0])-1j*(V3[0]*P3[3])))+(P2[1]*( -1j*(P3[1]*V3[2])+1j*(P3[2]*V3[1])+(V3[3]*P3[0])-(V3[0]*P3[3])))))))))+( (F2[3]*( (F1[1]*( (P2[1]*( (P3[1]*( -V3[0]-V3[3]))+( (V3[1]*( P3[0]+P3[3]))+( (P3[2]*( 1j*V3[3]+1j*V3[0]))+(V3[2]*( -1j*P3[0]-1j*P3[3]))))))+( (P2[2]*( (P3[2]*( -V3[0]-V3[3]))+( (V3[2]*( P3[0]+P3[3]))+( (P3[1]*( -1j*V3[3]-1j*V3[0]))+(V3[1]*( 1j*P3[0]+1j*P3[3]))))))+( (P2[3]*( -(P3[3]*V3[0])+(P3[0]*V3[3])+1j*(V3[2]*P3[1])-1j*(V3[1]*P3[2])))+(P2[0]*( (P3[0]*V3[3])-(P3[3]*V3[0])+1j*(V3[2]*P3[1])-1j*(V3[1]*P3[2])))))))+(F1[0]*( (P2[3]*( (P3[3]*( V3[1]-1j*V3[2]))+( (V3[3]*( -P3[1]+1j*P3[2]))+( (P3[0]*( -1j*V3[2]+V3[1]))+(V3[0]*( -P3[1]+1j*P3[2]))))))+( (P2[0]*( (P3[0]*( -V3[1]+(-0+1j)*V3[2]))+( (V3[0]*( P3[1]-1j*P3[2]))+( (V3[3]*( P3[1]-1j*P3[2]))+(P3[3]*( 1j*V3[2]-V3[1]))))))+( (P2[2]*( (P3[2]*V3[1])-(P3[1]*V3[2])+1j*(V3[3]*P3[0])-1j*(V3[0]*P3[3])))+(P2[1]*( -1j*(P3[1]*V3[2])+1j*(P3[2]*V3[1])-(V3[3]*P3[0])+(V3[0]*P3[3])))))))))+(F2[2]*( (F1[0]*( (P2[1]*( (P3[1]*( -V3[0]+V3[3]))+( (V3[1]*( P3[0]-P3[3]))+( (P3[2]*( 1j*V3[3]-1j*V3[0]))+(V3[2]*( 1j*P3[0]-1j*P3[3]))))))+( (P2[2]*( (P3[2]*( -V3[0]+V3[3]))+( (V3[2]*( P3[0]-P3[3]))+( (P3[1]*( -1j*V3[3]+1j*V3[0]))+(V3[1]*( -1j*P3[0]+1j*P3[3]))))))+( (P2[3]*( -(P3[3]*V3[0])+(P3[0]*V3[3])+1j*(V3[2]*P3[1])-1j*(V3[1]*P3[2])))+(P2[0]*( -(P3[0]*V3[3])+(P3[3]*V3[0])-1j*(V3[2]*P3[1])+1j*(V3[1]*P3[2])))))))+(F1[1]*( (P2[3]*( (P3[3]*( V3[1]+1j*V3[2]))+( (V3[3]*( -P3[1]-1j*P3[2]))+( (P3[0]*( -1j*V3[2]-V3[1]))+(V3[0]*( P3[1]+1j*P3[2]))))))+( (P2[0]*( (P3[0]*( -V3[1]-1j*V3[2]))+( (V3[0]*( P3[1]+1j*P3[2]))+( (V3[3]*( -P3[1]-1j*P3[2]))+(P3[3]*( 1j*V3[2]+V3[1]))))))+( (P2[2]*( (P3[2]*V3[1])-(P3[1]*V3[2])+1j*(V3[3]*P3[0])-1j*(V3[0]*P3[3])))+(P2[1]*( 1j*(P3[1]*V3[2])-1j*(P3[2]*V3[1])+(V3[3]*P3[0])-(V3[0]*P3[3]))))))))))))
    return vertex
