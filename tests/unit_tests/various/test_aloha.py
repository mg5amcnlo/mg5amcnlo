...
def RFSC1_2(F2,S3,COUP,M1,W1):
    ...
    denom = COUP/(P1[0]**2-P1[1]**2-P1[2]**2-P1[3]**2 - M1 * (M1 -1j* W1))
    R1[2]= denom*-0.333333333333j * M1*S3[2]*(OM1*(P1[0]*(F2[4]*(M1*M1*OM1*(P1[3]-P1[0])+(+2*(P1[0])-P1[3]))+F2[5]*(M1*M1*OM1*(P1[1]-1j*(P1[2]))+(+1j*(P1[2])-P1[1])))-F2[4]*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]))-F2[4])
    R1[6]= denom*0.333333333333j * M1*S3[2]*(OM1*(P1[1]*(F2[4]*(M1*M1*OM1*(P1[0]-P1[3])+(P1[3]-P1[0]))+F2[5]*(M1*M1*OM1*(+1j*(P1[2])-P1[1])+(+2*(P1[1])-1j*(P1[2]))))+F2[5]*(P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0]))+F2[5])
    R1[10]= denom*(0.333333333333-0j) * M1*S3[2]*(OM1*(P1[2]*(F2[4]*(M1*M1*OM1*(-1j*(P1[3])+1j*(P1[0]))+(-1j*(P1[0])+1j*(P1[3])))+F2[5]*(M1*-M1*OM1*(P1[2]+1j*(P1[1]))+(+2*(P1[2])+1j*(P1[1]))))+F2[5]*(P1[1]*P1[1]+P1[3]*P1[3]-P1[0]*P1[0]))+F2[5])
    R1[14]= denom*0.333333333333j * M1*S3[2]*(OM1*(P1[3]*(F2[4]*(M1*M1*OM1*(P1[0]-P1[3])+(+2*(P1[3])-P1[0]))+F2[5]*(M1*M1*OM1*(+1j*(P1[2])-P1[1])+(P1[1]-1j*(P1[2]))))+F2[4]*(P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0]))+F2[4])
    R1[3]= denom*-0.333333333333j * M1*S3[2]*(OM1*(P1[0]*(F2[4]*(M1*M1*OM1*(P1[1]+1j*(P1[2]))+(-1j*(P1[2])-P1[1]))+F2[5]*(M1*-M1*OM1*(P1[0]+P1[3])+(P1[3]+2*(P1[0]))))-F2[5]*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]))-F2[5])
    R1[7]= denom*0.333333333333j * M1*S3[2]*(OM1*(P1[1]*(F2[4]*(M1*-M1*OM1*(P1[1]+1j*(P1[2]))+(+2*(P1[1])+1j*(P1[2])))+F2[5]*(M1*M1*OM1*(P1[0]+P1[3])+(-P1[0]-P1[3])))+F2[4]*(P1[3]*P1[3]+P1[2]*P1[2]-P1[0]*P1[0]))+F2[4])
    R1[11]= denom*(-0.333333333333+0j) * M1*S3[2]*(OM1*(P1[2]*(F2[4]*(M1*M1*OM1*(+1j*(P1[1])-P1[2])+(-1j*(P1[1])+2*(P1[2])))+F2[5]*(M1*-M1*OM1*(+1j*(P1[0]+P1[3]))+(+1j*(P1[0]+P1[3]))))+F2[4]*(P1[3]*P1[3]+P1[1]*P1[1]-P1[0]*P1[0]))+F2[4])
    R1[15]= denom*-0.333333333333j * M1*S3[2]*(OM1*(P1[3]*(F2[4]*(M1*M1*OM1*(P1[1]+1j*(P1[2]))+(-1j*(P1[2])-P1[1]))+F2[5]*(M1*-M1*OM1*(P1[0]+P1[3])+(P1[0]+2*(P1[3]))))+F2[5]*(P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0]))+F2[5])
    R1[4]= denom*-1j * S3[2]*(F2[4]*(OM1*(P1[0]*(M1*M1*(OM1*-0.333333333333*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0]))+(0.333333333333-0j)*(P1[3]*M1*M1))+(+(2.33333333333-0j)*(P1[0])+(-0.333333333333-0j)*(P1[3])))+F2[5]*(M1*0.333333333333 * M1*OM1*(P1[1]-1j*(P1[2]))+(+(-0.333333333333-0j)*(P1[1])+0.333333333333j*(P1[2]))))
    R1[8]= denom*-1j * S3[2]*(F2[4]*(OM1*(P1[1]*(M1*M1*(OM1*-0.333333333333*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0]))-0.333333333333j*(P1[2]*M1*M1))+(+(2.33333333333+0j)*(P1[1])+0.333333333333j*(P1[2])))+F2[5]*(M1*0.333333333333 * M1*OM1*(P1[0]+P1[3])+(+(-0.333333333333+0j)*(P1[0]+P1[3]))))
    R1[12]= denom*(-0.333333333333+0j) * S3[2]*(F2[4]*(OM1*(P1[2]*(M1*M1*(OM1*-1*(-1j*(P1[0]*P1[0])+1j*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]))+ -5j)+(+3j*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2])-3j*(P1[0]*P1[0])))-P1[1]*M1*M1)+(P1[1]+7j*(P1[2])))+F2[5]*(M1*M1*OM1*(P1[0]+P1[3])+(-P1[0]-P1[3])))
    R1[16]= denom*-1j * S3[2]*(F2[4]*(OM1*(P1[3]*(M1*M1*(OM1*-0.333333333333*(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[3]*P1[3]+P1[1]*P1[1]+P1[2]*P1[2]-P1[0]*P1[0]))+(0.333333333333+0j)*(P1[0]*M1*M1))+(+(2.33333333333+0j)*(P1[3])+(-0.333333333333+0j)*(P1[0])))+F2[5]*(M1*0.333333333333 * M1*OM1*(+1j*(P1[2])-P1[1])+(-0.333333333333j*(P1[2])+(0.333333333333+0j)*(P1[1]))))
    R1[5]= denom*-1j * S3[2]*(F2[5]*(OM1*(P1[0]*(M1*M1*(OM1*-0.333333333333*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0]))+(-0.333333333333-0j)*(P1[3]*M1*M1))+(+(2.33333333333-0j)*(P1[0])+(0.333333333333-0j)*(P1[3])))+F2[4]*(M1*0.333333333333 * M1*OM1*(P1[1]+1j*(P1[2]))+(-0.333333333333j*(P1[2])+(-0.333333333333-0j)*(P1[1]))))
    R1[9]= denom*-1j * S3[2]*(F2[5]*(OM1*(P1[1]*(M1*M1*(OM1*-0.333333333333*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0]))+0.333333333333j*(P1[2]*M1*M1))+(-0.333333333333j*(P1[2])+(2.33333333333+0j)*(P1[1])))+F2[4]*(M1*0.333333333333 * M1*OM1*(P1[0]-P1[3])+(+(-0.333333333333+0j)*(P1[0])+(0.333333333333+0j)*(P1[3]))))
    R1[13]= denom*(0.333333333333+0j) * S3[2]*(F2[5]*(OM1*(P1[2]*(M1*M1*(OM1*(-1j*(P1[0]*P1[0])+1j*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]))+ 5j)+(+3j*(P1[0]*P1[0])-3j*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3])))-P1[1]*M1*M1)+(P1[1]-7j*(P1[2])))+F2[4]*(M1*M1*OM1*(P1[0]-P1[3])+(P1[3]-P1[0])))
    R1[17]= denom*-1j * S3[2]*(F2[5]*(OM1*(P1[3]*(M1*M1*(OM1*-0.333333333333*(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0])+ (-1.66666666667+0j))+(P1[1]*P1[1]+P1[2]*P1[2]+P1[3]*P1[3]-P1[0]*P1[0]))+(-0.333333333333-0j)*(P1[0]*M1*M1))+(+(2.33333333333-0j)*(P1[3])+(0.333333333333-0j)*(P1[0])))+F2[4]*(M1*0.333333333333 * M1*OM1*(P1[1]+1j*(P1[2]))+(-0.333333333333j*(P1[2])+(-0.333333333333-0j)*(P1[1]))))
    return R1
