...
DECAY 6 0.000000e+00 #  wt
      9.900000e-01 5 24 #  branching ratio
      1.000000e-02 3 24 #  branching ratio
...
DECAY 6 1.561950e+00 #  top decays
      ...
      0.000000e+00 2 2000006 1000022 #  br(t -> ~t_2 ~chi_10)
      0.000000e+00 2 2000006 1000023 #  br(t -> ~t_2 ~chi_20)
      0.000000e+00 2 2000006 1000025 #  br(t -> ~t_2 ~chi_30)
      0.000000e+00 2 2000006 1000035 #  br(t -> ~t_2 ~chi_40)
...
DECAY 1000021 5.506754e+00 #  gluino decays
      2.084542e-02 2 1000001 -1 #  br(~g -> ~d_l  db)
      2.084542e-02 2 -1000001 1 #  br(~g -> ~d_l* d )
      5.070753e-02 2 2000001 -1 #  br(~g -> ~d_r  db)
      5.070753e-02 2 -2000001 1 #  br(~g -> ~d_r* d )
      2.897878e-02 2 1000002 -2 #  br(~g -> ~u_l  ub)
      2.897878e-02 2 -1000002 2 #  br(~g -> ~u_l* u )
      4.468728e-02 2 2000002 -2 #  br(~g -> ~u_r  ub)
      4.468728e-02 2 -2000002 2 #  br(~g -> ~u_r* u )
      2.084542e-02 2 1000003 -3 #  br(~g -> ~s_l  sb)
      2.084542e-02 2 -1000003 3 #  br(~g -> ~s_l* s )
      5.070753e-02 2 2000003 -3 #  br(~g -> ~s_r  sb)
      5.070753e-02 2 -2000003 3 #  br(~g -> ~s_r* s )
      2.897878e-02 2 1000004 -4 #  br(~g -> ~c_l  cb)
      2.897878e-02 2 -1000004 4 #  br(~g -> ~c_l* c )
      4.468728e-02 2 2000004 -4 #  br(~g -> ~c_r  cb)
      4.468728e-02 2 -2000004 4 #  br(~g -> ~c_r* c )
      1.058402e-01 2 1000005 -5 #  br(~g -> ~b_1  bb)
      1.058402e-01 2 -1000005 5 #  br(~g -> ~b_1* b )
      5.565748e-02 2 2000005 -5 #  br(~g -> ~b_2  bb)
      5.565748e-02 2 -2000005 5 #  br(~g -> ~b_2* b )
      4.806428e-02 2 1000006 -6 #  br(~g -> ~t_1  tb)
      4.806428e-02 2 -1000006 6 #  br(~g -> ~t_1* t )
      0.000000e+00 2 2000006 -6 #  br(~g -> ~t_2  tb)
      0.000000e+00 2 -2000006 6 #  br(~g -> ~t_2* t )

DECAY 1000006 2.021596e+00 #  stop1 decays
      1.929476e-01 2 1000022 6 #  br(~t_1 -> ~chi_10 t )
      1.174692e-01 2 1000023 6 #  br(~t_1 -> ~chi_20 t )
      0.000000e+00 2 1000025 6 #  br(~t_1 -> ~chi_30 t )
      0.000000e+00 2 1000035 6 #  br(~t_1 -> ~chi_40 t )
      6.757477e-01 2 1000024 5 #  br(~t_1 -> ~chi_1+ b )
      1.383548e-02 2 1000037 5 #  br(~t_1 -> ~chi_2+ b )
      0.000000e+00 2 1000021 6 #  br(~t_1 -> ~g      t )
      0.000000e+00 2 1000005 37 #  br(~t_1 -> ~b_1    h+)
      0.000000e+00 2 2000005 37 #  br(~t_1 -> ~b_2    h+)
      0.000000e+00 2 1000005 24 #  br(~t_1 -> ~b_1    w+)
      0.000000e+00 2 2000005 24 #  br(~t_1 -> ~b_2    w+)

DECAY 2000006 7.373133e+00 #  stop2 decays
      2.968256e-02 2 1000022 6 #  br(~t_2 -> ~chi_10 t )
      8.680354e-02 2 1000023 6 #  br(~t_2 -> ~chi_20 t )
      4.184084e-02 2 1000025 6 #  br(~t_2 -> ~chi_30 t )
      1.932816e-01 2 1000035 6 #  br(~t_2 -> ~chi_40 t )
      2.196324e-01 2 1000024 5 #  br(~t_2 -> ~chi_1+ b )
      2.022061e-01 2 1000037 5 #  br(~t_2 -> ~chi_2+ b )
      0.000000e+00 2 1000021 6 #  br(~t_2 -> ~g      t )
      3.663977e-02 2 1000006 25 #  br(~t_2 -> ~t_1    h )
      0.000000e+00 2 1000006 35 #  br(~t_2 -> ~t_1    h )
      0.000000e+00 2 1000006 36 #  br(~t_2 -> ~t_1    a )
      0.000000e+00 2 1000005 37 #  br(~t_2 -> ~b_1    h+)
      0.000000e+00 2 2000005 37 #  br(~t_2 -> ~b_2    h+)
      1.899131e-01 2 1000006 23 #  br(~t_2 -> ~t_1    z )
      0.000000e+00 2 1000005 24 #  br(~t_2 -> ~b_1    w+)
      0.000000e+00 2 2000005 24 #  br(~t_2 -> ~b_2    w+)

DECAY 1000005 3.736276e+00 #  sbottom1 decays
      4.433071e-02 2 1000022 5 #  br(~b_1 -> ~chi_10 b )
      3.563199e-01 2 1000023 5 #  br(~b_1 -> ~chi_20 b )
      5.160838e-03 2 1000025 5 #  br(~b_1 -> ~chi_30 b )
      1.041051e-02 2 1000035 5 #  br(~b_1 -> ~chi_40 b )
      4.458301e-01 2 -1000024 6 #  br(~b_1 -> ~chi_1- t )
      0.000000e+00 2 -1000037 6 #  br(~b_1 -> ~chi_2- t )
      0.000000e+00 2 1000021 5 #  br(~b_1 -> ~g      b )
      0.000000e+00 2 1000006 -37 #  br(~b_1 -> ~t_1    h-)
      0.000000e+00 2 2000006 -37 #  br(~b_1 -> ~t_2    h-)
      1.379480e-01 2 1000006 -24 #  br(~b_1 -> ~t_1    w-)
      0.000000e+00 2 2000006 -24 #  br(~b_1 -> ~t_2    w-)

DECAY 2000005 8.015663e-01 #  sbottom2 decays
      2.862006e-01 2 1000022 5 #  br(~b_2 -> ~chi_10 b )
      1.403159e-01 2 1000023 5 #  br(~b_2 -> ~chi_20 b )
      5.326356e-02 2 1000025 5 #  br(~b_2 -> ~chi_30 b )
      7.487481e-02 2 1000035 5 #  br(~b_2 -> ~chi_40 b )
      1.797343e-01 2 -1000024 6 #  br(~b_2 -> ~chi_1- t )
      0.000000e+00 2 -1000037 6 #  br(~b_2 -> ~chi_2- t )
      0.000000e+00 2 1000021 5 #  br(~b_2 -> ~g      b )
      0.000000e+00 2 1000005 25 #  br(~b_2 -> ~b_1    h )
      0.000000e+00 2 1000005 35 #  br(~b_2 -> ~b_1    h )
      0.000000e+00 2 1000005 36 #  br(~b_2 -> ~b_1    a )
      0.000000e+00 2 1000006 -37 #  br(~b_2 -> ~t_1    h-)
      0.000000e+00 2 2000006 -37 #  br(~b_2 -> ~t_2    h-)
      0.000000e+00 2 1000005 23 #  br(~b_2 -> ~b_1    z )
      2.656108e-01 2 1000006 -24 #  br(~b_2 -> ~t_1    w-)
      0.000000e+00 2 2000006 -24 #  br(~b_2 -> ~t_2    w-)

DECAY 1000002 5.477195e+00 #  sup_l decays
      6.652410e-03 2 1000022 2 #  br(~u_l -> ~chi_10 u)
      3.190515e-01 2 1000023 2 #  br(~u_l -> ~chi_20 u)
      8.449291e-04 2 1000025 2 #  br(~u_l -> ~chi_30 u)
      1.034852e-02 2 1000035 2 #  br(~u_l -> ~chi_40 u)
      6.494995e-01 2 1000024 1 #  br(~u_l -> ~chi_1+ d)
      1.360317e-02 2 1000037 1 #  br(~u_l -> ~chi_2+ d)
      0.000000e+00 2 1000021 2 #  br(~u_l -> ~g      u)

DECAY 2000002 1.152973e+00 #  sup_r decays
      9.863774e-01 2 1000022 2 #  br(~u_r -> ~chi_10 u)
      8.466406e-03 2 1000023 2 #  br(~u_r -> ~chi_20 u)
      1.238947e-03 2 1000025 2 #  br(~u_r -> ~chi_30 u)
      3.917226e-03 2 1000035 2 #  br(~u_r -> ~chi_40 u)
      0.000000e+00 2 1000024 1 #  br(~u_r -> ~chi_1+ d)
      0.000000e+00 2 1000037 1 #  br(~u_r -> ~chi_2+ d)
      0.000000e+00 2 1000021 2 #  br(~u_r -> ~g      u)

DECAY 1000001 5.312788e+00 #  sdown_l decays
      2.323180e-02 2 1000022 1 #  br(~d_l -> ~chi_10 d)
      3.102351e-01 2 1000023 1 #  br(~d_l -> ~chi_20 d)
      1.523348e-03 2 1000025 1 #  br(~d_l -> ~chi_30 d)
      1.488498e-02 2 1000035 1 #  br(~d_l -> ~chi_40 d)
      6.064525e-01 2 -1000024 2 #  br(~d_l -> ~chi_1- u)
      4.367232e-02 2 -1000037 2 #  br(~d_l -> ~chi_2- u)
      0.000000e+00 2 1000021 1 #  br(~d_l -> ~g      d)

DECAY 2000001 2.858123e-01 #  sdown_r decays
      9.865296e-01 2 1000022 1 #  br(~d_r -> ~chi_10 d)
      8.445104e-03 2 1000023 1 #  br(~d_r -> ~chi_20 d)
      1.211721e-03 2 1000025 1 #  br(~d_r -> ~chi_30 d)
      3.813561e-03 2 1000035 1 #  br(~d_r -> ~chi_40 d)
      0.000000e+00 2 -1000024 2 #  br(~d_r -> ~chi_1- u)
      0.000000e+00 2 -1000037 2 #  br(~d_r -> ~chi_2- u)
      0.000000e+00 2 1000021 1 #  br(~d_r -> ~g      d)

DECAY 1000004 5.477195e+00 #  scharm_l decays
      6.652410e-03 2 1000022 4 #  br(~c_l -> ~chi_10 c)
      3.190515e-01 2 1000023 4 #  br(~c_l -> ~chi_20 c)
      8.449291e-04 2 1000025 4 #  br(~c_l -> ~chi_30 c)
      1.034852e-02 2 1000035 4 #  br(~c_l -> ~chi_40 c)
      6.494995e-01 2 1000024 3 #  br(~c_l -> ~chi_1+ s)
      1.360317e-02 2 1000037 3 #  br(~c_l -> ~chi_2+ s)
      0.000000e+00 2 1000021 4 #  br(~c_l -> ~g      c)

DECAY 2000004 1.152973e+00 #  scharm_r decays
      9.863774e-01 2 1000022 4 #  br(~c_r -> ~chi_10 c)
      8.466406e-03 2 1000023 4 #  br(~c_r -> ~chi_20 c)
      1.238947e-03 2 1000025 4 #  br(~c_r -> ~chi_30 c)
      3.917226e-03 2 1000035 4 #  br(~c_r -> ~chi_40 c)
      0.000000e+00 2 1000024 3 #  br(~c_r -> ~chi_1+ s)
      0.000000e+00 2 1000037 3 #  br(~c_r -> ~chi_2+ s)
      0.000000e+00 2 1000021 4 #  br(~c_r -> ~g      c)

DECAY 1000003 5.312788e+00 #  sstrange_l decays
      2.323180e-02 2 1000022 3 #  br(~s_l -> ~chi_10 s)
      3.102351e-01 2 1000023 3 #  br(~s_l -> ~chi_20 s)
      1.523348e-03 2 1000025 3 #  br(~s_l -> ~chi_30 s)
      1.488498e-02 2 1000035 3 #  br(~s_l -> ~chi_40 s)
      6.064525e-01 2 -1000024 4 #  br(~s_l -> ~chi_1- c)
      4.367232e-02 2 -1000037 4 #  br(~s_l -> ~chi_2- c)
      0.000000e+00 2 1000021 3 #  br(~s_l -> ~g      s)

DECAY 2000003 2.858123e-01 #  sstrange_r decays
      9.865296e-01 2 1000022 3 #  br(~s_r -> ~chi_10 s)
      8.445104e-03 2 1000023 3 #  br(~s_r -> ~chi_20 s)
      1.211721e-03 2 1000025 3 #  br(~s_r -> ~chi_30 s)
      3.813561e-03 2 1000035 3 #  br(~s_r -> ~chi_40 s)
      0.000000e+00 2 -1000024 4 #  br(~s_r -> ~chi_1- c)
      0.000000e+00 2 -1000037 4 #  br(~s_r -> ~chi_2- c)
      0.000000e+00 2 1000021 3 #  br(~s_r -> ~g      s)

DECAY 1000011 2.136822e-01 #  selectron_l decays
      5.731554e-01 2 1000022 11 #  br(~e_l -> ~chi_10 e-)
      1.645226e-01 2 1000023 11 #  br(~e_l -> ~chi_20 e-)
      0.000000e+00 2 1000025 11 #  br(~e_l -> ~chi_30 e-)
      0.000000e+00 2 1000035 11 #  br(~e_l -> ~chi_40 e-)
...
DECAY 2000011 2.161216e-01 #  selectron_r decays
      1.000000e+00 2 1000022 11 #  br(~e_r -> ~chi_10 e-)
      0.000000e+00 2 1000023 11 #  br(~e_r -> ~chi_20 e-)
      0.000000e+00 2 1000025 11 #  br(~e_r -> ~chi_30 e-)
      0.000000e+00 2 1000035 11 #  br(~e_r -> ~chi_40 e-)
...
DECAY 1000013 2.136822e-01 #  smuon_l decays
      5.731554e-01 2 1000022 13 #  br(~mu_l -> ~chi_10 mu-)
      1.645226e-01 2 1000023 13 #  br(~mu_l -> ~chi_20 mu-)
      0.000000e+00 2 1000025 13 #  br(~mu_l -> ~chi_30 mu-)
      0.000000e+00 2 1000035 13 #  br(~mu_l -> ~chi_40 mu-)
...
DECAY 2000013 2.161216e-01 #  smuon_r decays
      1.000000e+00 2 1000022 13 #  br(~mu_r -> ~chi_10 mu-)
      0.000000e+00 2 1000023 13 #  br(~mu_r -> ~chi_20 mu-)
      0.000000e+00 2 1000025 13 #  br(~mu_r -> ~chi_30 mu-)
      0.000000e+00 2 1000035 13 #  br(~mu_r -> ~chi_40 mu-)
...
DECAY 1000015 1.483273e-01 #  stau_1 decays
      1.000000e+00 2 1000022 15 #  br(~tau_1 -> ~chi_10  tau-)
      0.000000e+00 2 1000023 15 #  br(~tau_1 -> ~chi_20  tau-)
      0.000000e+00 2 1000025 15 #  br(~tau_1 -> ~chi_30  tau-)
      0.000000e+00 2 1000035 15 #  br(~tau_1 -> ~chi_40  tau-)
      0.000000e+00 2 -1000024 16 #  br(~tau_1 -> ~chi_1-  nu_tau)
      0.000000e+00 2 -1000037 16 #  br(~tau_1 -> ~chi_2-  nu_tau)
      0.000000e+00 2 1000016 -37 #  br(~tau_1 -> ~nu_taul h-)
      0.000000e+00 2 1000016 -24 #  br(~tau_1 -> ~nu_taul w-)

DECAY 2000015 2.699061e-01 #  stau_2 decays
      5.966530e-01 2 1000022 15 #  br(~tau_2 -> ~chi_10  tau-)
      1.545368e-01 2 1000023 15 #  br(~tau_2 -> ~chi_20  tau-)
      0.000000e+00 2 1000025 15 #  br(~tau_2 -> ~chi_30  tau-)
      0.000000e+00 2 1000035 15 #  br(~tau_2 -> ~chi_40  tau-)
      2.488102e-01 2 -1000024 16 #  br(~tau_2 -> ~chi_1-  nu_tau)
      0.000000e+00 2 -1000037 16 #  br(~tau_2 -> ~chi_2-  nu_tau)
      0.000000e+00 2 1000016 -37 #  br(~tau_2 -> ~nu_taul h-)
      0.000000e+00 2 1000016 -24 #  br(~tau_2 -> ~nu_taul w-)
      0.000000e+00 2 1000015 25 #  br(~tau_2 -> ~tau_1 h)
      0.000000e+00 2 1000015 35 #  br(~tau_2 -> ~tau_1 h)
      0.000000e+00 2 1000015 36 #  br(~tau_2 -> ~tau_1 a)
      0.000000e+00 2 1000015 23 #  br(~tau_2 -> ~tau_1 z)

DECAY 1000012 1.498816e-01 #  snu_el decays
      9.777008e-01 2 1000022 12 #  br(~nu_el -> ~chi_10 nu_e)
      8.115549e-03 2 1000023 12 #  br(~nu_el -> ~chi_20 nu_e)
      0.000000e+00 2 1000025 12 #  br(~nu_el -> ~chi_30 nu_e)
      0.000000e+00 2 1000035 12 #  br(~nu_el -> ~chi_40 nu_e)
      1.418369e-02 2 1000024 11 #  br(~nu_el -> ~chi_1+ e-)
      0.000000e+00 2 1000037 11 #  br(~nu_el -> ~chi_2+ e-)

DECAY 1000014 1.498816e-01 #  snu_mul decays
      9.777008e-01 2 1000022 14 #  br(~nu_mul -> ~chi_10 nu_mu)
      8.115549e-03 2 1000023 14 #  br(~nu_mul -> ~chi_20 nu_mu)
      0.000000e+00 2 1000025 14 #  br(~nu_mul -> ~chi_30 nu_mu)
      0.000000e+00 2 1000035 14 #  br(~nu_mul -> ~chi_40 nu_mu)
      1.418369e-02 2 1000024 13 #  br(~nu_mul -> ~chi_1+ mu-)
      0.000000e+00 2 1000037 13 #  br(~nu_mul -> ~chi_2+ mu-)

DECAY 1000016 1.475190e-01 #  snu_taul decays
      9.859945e-01 2 1000022 16 #  br(~nu_taul -> ~chi_10 nu_tau)
      6.251296e-03 2 1000023 16 #  br(~nu_taul -> ~chi_20 nu_tau)
      0.000000e+00 2 1000025 16 #  br(~nu_taul -> ~chi_30 nu_tau)
      0.000000e+00 2 1000035 16 #  br(~nu_taul -> ~chi_40 nu_tau)
      7.754175e-03 2 1000024 15 #  br(~nu_taul -> ~chi_1+ tau-)
      0.000000e+00 2 1000037 15 #  br(~nu_taul -> ~chi_2+ tau-)
...
DECAY 1000024 1.704145e-02 #  chargino1+ decays
      0.000000e+00 2 1000002 -1 #  br(~chi_1+ -> ~u_l   db)
      0.000000e+00 2 2000002 -1 #  br(~chi_1+ -> ~u_r   db)
      0.000000e+00 2 -1000001 2 #  br(~chi_1+ -> ~d_l*  u )
      0.000000e+00 2 -2000001 2 #  br(~chi_1+ -> ~d_r*  u )
      0.000000e+00 2 1000004 -3 #  br(~chi_1+ -> ~c_l   sb)
      0.000000e+00 2 2000004 -3 #  br(~chi_1+ -> ~c_r   sb)
      0.000000e+00 2 -1000003 4 #  br(~chi_1+ -> ~s_l*  c )
      0.000000e+00 2 -2000003 4 #  br(~chi_1+ -> ~s_r*  c )
      0.000000e+00 2 1000006 -5 #  br(~chi_1+ -> ~t_1   bb)
      0.000000e+00 2 2000006 -5 #  br(~chi_1+ -> ~t_2   bb)
      0.000000e+00 2 -1000005 6 #  br(~chi_1+ -> ~b_1*  t )
      0.000000e+00 2 -2000005 6 #  br(~chi_1+ -> ~b_2*  t )
      0.000000e+00 2 1000012 -11 #  br(~chi_1+ -> ~nu_el  e+  )
      0.000000e+00 2 1000014 -13 #  br(~chi_1+ -> ~nu_mul  mu+ )
      0.000000e+00 2 1000016 -15 #  br(~chi_1+ -> ~nu_tau1 tau+)
      ...
      7.483888e-02 2 1000022 24 #  br(~chi_1+ -> ~chi_10  w+)
      0.000000e+00 2 1000023 24 #  br(~chi_1+ -> ~chi_20  w+)
      0.000000e+00 2 1000025 24 #  br(~chi_1+ -> ~chi_30  w+)
      0.000000e+00 2 1000035 24 #  br(~chi_1+ -> ~chi_40  w+)
      0.000000e+00 2 1000022 37 #  br(~chi_1+ -> ~chi_10  h+)
      0.000000e+00 2 1000023 37 #  br(~chi_1+ -> ~chi_20  h+)
      0.000000e+00 2 1000025 37 #  br(~chi_1+ -> ~chi_30  h+)
      0.000000e+00 2 1000035 37 #  br(~chi_1+ -> ~chi_40  h+)

DECAY 1000037 2.486895e+00 #  chargino2+ decays
      0.000000e+00 2 1000002 -1 #  br(~chi_2+ -> ~u_l   db)
      0.000000e+00 2 2000002 -1 #  br(~chi_2+ -> ~u_r   db)
      0.000000e+00 2 -1000001 2 #  br(~chi_2+ -> ~d_l*  u )
      0.000000e+00 2 -2000001 2 #  br(~chi_2+ -> ~d_r*  u )
      0.000000e+00 2 1000004 -3 #  br(~chi_2+ -> ~c_l   sb)
      0.000000e+00 2 2000004 -3 #  br(~chi_2+ -> ~c_r   sb)
      0.000000e+00 2 -1000003 4 #  br(~chi_2+ -> ~s_l*  c )
      0.000000e+00 2 -2000003 4 #  br(~chi_2+ -> ~s_r*  c )
      0.000000e+00 2 1000006 -5 #  br(~chi_2+ -> ~t_1   bb)
      0.000000e+00 2 2000006 -5 #  br(~chi_2+ -> ~t_2   bb)
      0.000000e+00 2 -1000005 6 #  br(~chi_2+ -> ~b_1*  t )
      0.000000e+00 2 -2000005 6 #  br(~chi_2+ -> ~b_2*  t )
      2.009688e-02 2 1000012 -11 #  br(~chi_2+ -> ~nu_el  e+  )
      2.009688e-02 2 1000014 -13 #  br(~chi_2+ -> ~nu_mul  mu+ )
      2.745074e-02 2 1000016 -15 #  br(~chi_2+ -> ~nu_tau1 tau+)
      ...
      2.315133e-01 2 1000024 23 #  br(~chi_2+ -> ~chi_1+  z )
      6.767151e-02 2 1000022 24 #  br(~chi_2+ -> ~chi_10  w+)
      2.936548e-01 2 1000023 24 #  br(~chi_2+ -> ~chi_20  w+)
      0.000000e+00 2 1000025 24 #  br(~chi_2+ -> ~chi_30  w+)
      0.000000e+00 2 1000035 24 #  br(~chi_2+ -> ~chi_40  w+)
      1.784788e-01 2 1000024 25 #  br(~chi_2+ -> ~chi_1+  h )
      0.000000e+00 2 1000024 35 #  br(~chi_2+ -> ~chi_1+  h )
      0.000000e+00 2 1000024 36 #  br(~chi_2+ -> ~chi_1+  a )
      0.000000e+00 2 1000022 37 #  br(~chi_2+ -> ~chi_10  h+)
      0.000000e+00 2 1000023 37 #  br(~chi_2+ -> ~chi_20  h+)
      0.000000e+00 2 1000025 37 #  br(~chi_2+ -> ~chi_30  h+)
      0.000000e+00 2 1000035 37 #  br(~chi_2+ -> ~chi_40  h+)

DECAY 1000022 0.000000e+00 #  neutralino1 decays
DECAY 1000023 2.077700e-02 #  neutralino2 decays
      0.000000e+00 2 1000022 23 #  br(~chi_20 -> ~chi_10   z )
      0.000000e+00 2 1000024 -24 #  br(~chi_20 -> ~chi_1+   w-)
      0.000000e+00 2 -1000024 24 #  br(~chi_20 -> ~chi_1-   w+)
      0.000000e+00 2 1000037 -24 #  br(~chi_20 -> ~chi_2+   w-)
      0.000000e+00 2 -1000037 24 #  br(~chi_20 -> ~chi_2-   w+)
      0.000000e+00 2 1000022 25 #  br(~chi_20 -> ~chi_10   h )
      0.000000e+00 2 1000022 35 #  br(~chi_20 -> ~chi_10   h )
      0.000000e+00 2 1000022 36 #  br(~chi_20 -> ~chi_10   a )
      0.000000e+00 2 1000024 -37 #  br(~chi_20 -> ~chi_1+   h-)
      0.000000e+00 2 -1000024 37 #  br(~chi_20 -> ~chi_1-   h+)
      0.000000e+00 2 1000037 -37 #  br(~chi_20 -> ~chi_2+   h-)
      0.000000e+00 2 -1000037 37 #  br(~chi_20 -> ~chi_2-   h+)
      0.000000e+00 2 1000002 -2 #  br(~chi_20 -> ~u_l      ub)
      0.000000e+00 2 -1000002 2 #  br(~chi_20 -> ~u_l*     u )
      0.000000e+00 2 2000002 -2 #  br(~chi_20 -> ~u_r      ub)
      0.000000e+00 2 -2000002 2 #  br(~chi_20 -> ~u_r*     u )
      0.000000e+00 2 1000001 -1 #  br(~chi_20 -> ~d_l      db)
      0.000000e+00 2 -1000001 1 #  br(~chi_20 -> ~d_l*     d )
      0.000000e+00 2 2000001 -1 #  br(~chi_20 -> ~d_r      db)
      0.000000e+00 2 -2000001 1 #  br(~chi_20 -> ~d_r*     d )
      0.000000e+00 2 1000004 -4 #  br(~chi_20 -> ~c_l      cb)
      0.000000e+00 2 -1000004 4 #  br(~chi_20 -> ~c_l*     c )
      0.000000e+00 2 2000004 -4 #  br(~chi_20 -> ~c_r      cb)
      0.000000e+00 2 -2000004 4 #  br(~chi_20 -> ~c_r*     c )
      0.000000e+00 2 1000003 -3 #  br(~chi_20 -> ~s_l      sb)
      0.000000e+00 2 -1000003 3 #  br(~chi_20 -> ~s_l*     s )
      0.000000e+00 2 2000003 -3 #  br(~chi_20 -> ~s_r      sb)
      0.000000e+00 2 -2000003 3 #  br(~chi_20 -> ~s_r*     s )
      0.000000e+00 2 1000006 -6 #  br(~chi_20 -> ~t_1      tb)
      0.000000e+00 2 -1000006 6 #  br(~chi_20 -> ~t_1*     t )
      0.000000e+00 2 2000006 -6 #  br(~chi_20 -> ~t_2      tb)
      0.000000e+00 2 -2000006 6 #  br(~chi_20 -> ~t_2*     t )
      0.000000e+00 2 1000005 -5 #  br(~chi_20 -> ~b_1      bb)
      0.000000e+00 2 -1000005 5 #  br(~chi_20 -> ~b_1*     b )
      0.000000e+00 2 2000005 -5 #  br(~chi_20 -> ~b_2      bb)
      ...
      0.000000e+00 2 -2000015 15 #  br(~chi_20 -> ~tau_2+   tau-)
      0.000000e+00 2 1000012 -12 #  br(~chi_20 -> ~nu_el    nu_eb)
      0.000000e+00 2 -1000012 12 #  br(~chi_20 -> ~nu_el*   nu_e )
      0.000000e+00 2 1000014 -14 #  br(~chi_20 -> ~nu_mul   nu_mub)
      0.000000e+00 2 -1000014 14 #  br(~chi_20 -> ~nu_mul*  nu_mu )
      0.000000e+00 2 1000016 -16 #  br(~chi_20 -> ~nu_tau1  nu_taub)
      0.000000e+00 2 -1000016 16 #  br(~chi_20 -> ~nu_tau1* nu_tau )

DECAY 1000025 1.915985e+00 #  neutralino3 decays
      1.132266e-01 2 1000022 23 #  br(~chi_30 -> ~chi_10   z )
      2.119692e-01 2 1000023 23 #  br(~chi_30 -> ~chi_20   z )
      2.953298e-01 2 1000024 -24 #  br(~chi_30 -> ~chi_1+   w-)
      2.953298e-01 2 -1000024 24 #  br(~chi_30 -> ~chi_1-   w+)
      0.000000e+00 2 1000037 -24 #  br(~chi_30 -> ~chi_2+   w-)
      0.000000e+00 2 -1000037 24 #  br(~chi_30 -> ~chi_2-   w+)
      2.130765e-02 2 1000022 25 #  br(~chi_30 -> ~chi_10   h )
      0.000000e+00 2 1000022 35 #  br(~chi_30 -> ~chi_10   h )
      0.000000e+00 2 1000022 36 #  br(~chi_30 -> ~chi_10   a )
      1.245383e-02 2 1000023 25 #  br(~chi_30 -> ~chi_20   h )
      0.000000e+00 2 1000023 35 #  br(~chi_30 -> ~chi_20   h )
      0.000000e+00 2 1000023 36 #  br(~chi_30 -> ~chi_20   a )
      0.000000e+00 2 1000024 -37 #  br(~chi_30 -> ~chi_1+   h-)
      0.000000e+00 2 -1000024 37 #  br(~chi_30 -> ~chi_1-   h+)
      0.000000e+00 2 1000037 -37 #  br(~chi_30 -> ~chi_2+   h-)
      0.000000e+00 2 -1000037 37 #  br(~chi_30 -> ~chi_2-   h+)
      0.000000e+00 2 1000002 -2 #  br(~chi_30 -> ~u_l      ub)
      0.000000e+00 2 -1000002 2 #  br(~chi_30 -> ~u_l*     u )
      0.000000e+00 2 2000002 -2 #  br(~chi_30 -> ~u_r      ub)
      0.000000e+00 2 -2000002 2 #  br(~chi_30 -> ~u_r*     u )
      0.000000e+00 2 1000001 -1 #  br(~chi_30 -> ~d_l      db)
      0.000000e+00 2 -1000001 1 #  br(~chi_30 -> ~d_l*     d )
      0.000000e+00 2 2000001 -1 #  br(~chi_30 -> ~d_r      db)
      0.000000e+00 2 -2000001 1 #  br(~chi_30 -> ~d_r*     d )
      0.000000e+00 2 1000004 -4 #  br(~chi_30 -> ~c_l      cb)
      0.000000e+00 2 -1000004 4 #  br(~chi_30 -> ~c_l*     c )
      0.000000e+00 2 2000004 -4 #  br(~chi_30 -> ~c_r      cb)
      0.000000e+00 2 -2000004 4 #  br(~chi_30 -> ~c_r*     c )
      0.000000e+00 2 1000003 -3 #  br(~chi_30 -> ~s_l      sb)
      0.000000e+00 2 -1000003 3 #  br(~chi_30 -> ~s_l*     s )
      0.000000e+00 2 2000003 -3 #  br(~chi_30 -> ~s_r      sb)
      0.000000e+00 2 -2000003 3 #  br(~chi_30 -> ~s_r*     s )
      0.000000e+00 2 1000006 -6 #  br(~chi_30 -> ~t_1      tb)
      0.000000e+00 2 -1000006 6 #  br(~chi_30 -> ~t_1*     t )
      0.000000e+00 2 2000006 -6 #  br(~chi_30 -> ~t_2      tb)
      0.000000e+00 2 -2000006 6 #  br(~chi_30 -> ~t_2*     t )
      0.000000e+00 2 1000005 -5 #  br(~chi_30 -> ~b_1      bb)
      0.000000e+00 2 -1000005 5 #  br(~chi_30 -> ~b_1*     b )
      0.000000e+00 2 2000005 -5 #  br(~chi_30 -> ~b_2      bb)
      ...
      6.728146e-03 2 -2000015 15 #  br(~chi_30 -> ~tau_2+   tau-)
      3.189205e-03 2 1000012 -12 #  br(~chi_30 -> ~nu_el    nu_eb)
      3.189205e-03 2 -1000012 12 #  br(~chi_30 -> ~nu_el*   nu_e )
      3.189205e-03 2 1000014 -14 #  br(~chi_30 -> ~nu_mul   nu_mub)
      3.189205e-03 2 -1000014 14 #  br(~chi_30 -> ~nu_mul*  nu_mu )
      3.202459e-03 2 1000016 -16 #  br(~chi_30 -> ~nu_tau1  nu_taub)
      3.202459e-03 2 -1000016 16 #  br(~chi_30 -> ~nu_tau1* nu_tau )

DECAY 1000035 2.585851e+00 #  neutralino4 decays
      2.153693e-02 2 1000022 23 #  br(~chi_40 -> ~chi_10   z )
      1.855000e-02 2 1000023 23 #  br(~chi_40 -> ~chi_20   z )
      0.000000e+00 2 1000025 23 #  br(~chi_40 -> ~chi_30   z )
      2.495414e-01 2 1000024 -24 #  br(~chi_40 -> ~chi_1+   w-)
      2.495414e-01 2 -1000024 24 #  br(~chi_40 -> ~chi_1-   w+)
      0.000000e+00 2 1000037 -24 #  br(~chi_40 -> ~chi_2+   w-)
      0.000000e+00 2 -1000037 24 #  br(~chi_40 -> ~chi_2-   w+)
      6.932133e-02 2 1000022 25 #  br(~chi_40 -> ~chi_10   h )
      0.000000e+00 2 1000022 35 #  br(~chi_40 -> ~chi_10   h )
      0.000000e+00 2 1000022 36 #  br(~chi_40 -> ~chi_10   a )
      1.476023e-01 2 1000023 25 #  br(~chi_40 -> ~chi_20   h )
      0.000000e+00 2 1000023 35 #  br(~chi_40 -> ~chi_20   h )
      0.000000e+00 2 1000023 36 #  br(~chi_40 -> ~chi_20   a )
      0.000000e+00 2 1000025 25 #  br(~chi_40 -> ~chi_30   h )
      0.000000e+00 2 1000025 35 #  br(~chi_40 -> ~chi_30   h )
      0.000000e+00 2 1000025 36 #  br(~chi_40 -> ~chi_30   a )
      0.000000e+00 2 1000024 -37 #  br(~chi_40 -> ~chi_1+   h-)
      0.000000e+00 2 -1000024 37 #  br(~chi_40 -> ~chi_1-   h+)
      0.000000e+00 2 1000037 -37 #  br(~chi_40 -> ~chi_2+   h-)
      0.000000e+00 2 -1000037 37 #  br(~chi_40 -> ~chi_2-   h+)
      0.000000e+00 2 1000002 -2 #  br(~chi_40 -> ~u_l      ub)
      0.000000e+00 2 -1000002 2 #  br(~chi_40 -> ~u_l*     u )
      0.000000e+00 2 2000002 -2 #  br(~chi_40 -> ~u_r      ub)
      0.000000e+00 2 -2000002 2 #  br(~chi_40 -> ~u_r*     u )
      0.000000e+00 2 1000001 -1 #  br(~chi_40 -> ~d_l      db)
      0.000000e+00 2 -1000001 1 #  br(~chi_40 -> ~d_l*     d )
      0.000000e+00 2 2000001 -1 #  br(~chi_40 -> ~d_r      db)
      0.000000e+00 2 -2000001 1 #  br(~chi_40 -> ~d_r*     d )
      0.000000e+00 2 1000004 -4 #  br(~chi_40 -> ~c_l      cb)
      0.000000e+00 2 -1000004 4 #  br(~chi_40 -> ~c_l*     c )
      0.000000e+00 2 2000004 -4 #  br(~chi_40 -> ~c_r      cb)
      0.000000e+00 2 -2000004 4 #  br(~chi_40 -> ~c_r*     c )
      0.000000e+00 2 1000003 -3 #  br(~chi_40 -> ~s_l      sb)
      0.000000e+00 2 -1000003 3 #  br(~chi_40 -> ~s_l*     s )
      0.000000e+00 2 2000003 -3 #  br(~chi_40 -> ~s_r      sb)
      0.000000e+00 2 -2000003 3 #  br(~chi_40 -> ~s_r*     s )
      0.000000e+00 2 1000006 -6 #  br(~chi_40 -> ~t_1      tb)
      0.000000e+00 2 -1000006 6 #  br(~chi_40 -> ~t_1*     t )
      0.000000e+00 2 2000006 -6 #  br(~chi_40 -> ~t_2      tb)
      0.000000e+00 2 -2000006 6 #  br(~chi_40 -> ~t_2*     t )
      0.000000e+00 2 1000005 -5 #  br(~chi_40 -> ~b_1      bb)
      0.000000e+00 2 -1000005 5 #  br(~chi_40 -> ~b_1*     b )
      0.000000e+00 2 2000005 -5 #  br(~chi_40 -> ~b_2      bb)
      ...
      1.622898e-02 2 -2000015 15 #  br(~chi_40 -> ~tau_2+   tau-)
      2.537965e-02 2 1000012 -12 #  br(~chi_40 -> ~nu_el    nu_eb)
      2.537965e-02 2 -1000012 12 #  br(~chi_40 -> ~nu_el*   nu_e )
      2.537965e-02 2 1000014 -14 #  br(~chi_40 -> ~nu_mul   nu_mub)
      2.537965e-02 2 -1000014 14 #  br(~chi_40 -> ~nu_mul*  nu_mu )
      2.547244e-02 2 1000016 -16 #  br(~chi_40 -> ~nu_tau1  nu_taub)
