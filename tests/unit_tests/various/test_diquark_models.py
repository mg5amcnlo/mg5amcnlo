...
class TestColorAntiTripletModel(unittest.TestCase):
    """Test class for the antitriplet diquark implementation"""


    def setUp(self):
        self.base_model = import_ufo.import_model('antitriplets')
        self.full_model = model_reader.ModelReader(self.base_model)
        self.full_model.set_parameters_and_couplings()
    
    def test_uu_to_anti3_g(self):
        """Test the process u u > anti3 g against literature expression"""
    ...
    def disabled_test_gu_to_ux_anti3(self):
        """Test the process u u > anti3 g against literature expression"""
        ...
        comparison_value = gu_uxD(p, 3, self.full_model)
