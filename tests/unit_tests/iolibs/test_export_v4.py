...
CALL IOVXXX(W(1,3),W(1,7),W(1,2),GGI,AMP(3))""".split('\n')
    ...
    def test_export_color_epsilon_processes(self):
        """Test color epsilon process u u > antithree > t t
        """
        ...
        # Color antitriplet
        mypartlist.append(base_objects.Particle({'name':'anti3~',
                      'antiname':'anti3',
                      'spin':0,
                      'color':3,
                      'mass':'manti3',
                      ...
                      'is_part':True,
                      'self_antipart':False}))
        anti3bar = mypartlist[len(mypartlist) - 1]
        anti3 = copy.copy(anti3bar)
        anti3.set('is_part', False)
        ...
        myinterlist.append(base_objects.Interaction({
                      ...
                      'particles': base_objects.ParticleList(\
                                            [u, \
                                             u, \
                                             anti3bar]),
                      'color': [color.ColorString([color.Epsilon(0,1,2)])],
                      'lorentz':[''],
                      'couplings':{(0, 0):'GUA3'},
                      'orders':{'QCD':1}}))
        ...
        myinterlist.append(base_objects.Interaction({
                      ...
                      'particles': base_objects.ParticleList(\
                                            [ubar, \
                                             ubar, \
                                             anti3]),
                      'color': [color.ColorString([color.Epsilonbar(0,1,2)])],
                      'lorentz':[''],
                      'couplings':{(0, 0):'GUA3'},
                      'orders':{'QCD':1}}))
