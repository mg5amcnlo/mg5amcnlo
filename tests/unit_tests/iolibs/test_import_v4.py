...
class ProcCardV4ReaderTest(unittest.TestCase):
    ...
    def test_line_creation(self):
        ...
        solution =['# Define multiparticle labels',
                   ...
                   'generate p p > ve~ e- @1', 
                   'add process p p > z, (z > w+ w-, w- > mu- vm) @2',
                   'add process p p > t t~ $ a @3 QED=0', 
                   'add process p p > t t~ $ g / a @2 QED=0', 
                   'add process p p > z $ a / g, (z > w+ w- $ a / g, w- > mu- vm $ a / g) @4',
                   'add process p p > z z $ a / g, (z > w+ w- $ a / g, w- > mu- vm $ a / g), z > w+ w- $ a / g @4 QED=1',
