...
C     ----------
      ...
      CALL FFV1_3(W(1,1),W(1,4),GC_10,ZERO,ZERO,W(1,6))
      CALL FFV1_3(W(1,2),W(1,3),GC_10,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,6),W(1,7),W(1,5),GC_9,AMP(1))
      CALL FFV1_2(W(1,2),W(1,5),GC_10,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_10,AMP(2))
      CALL FFV1_1(W(1,3),W(1,5),GC_10,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,2),W(1,9),W(1,6),GC_10,AMP(3))
      CALL FFV1_2(W(1,1),W(1,5),GC_10,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,4),W(1,7),GC_10,AMP(4))
      CALL FFV1_1(W(1,4),W(1,5),GC_10,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,1),W(1,11),W(1,7),GC_10,AMP(5))
...
C     ----------
      IF (.NOT. CALCULATEDBORN) THEN
        ...
        CALL FFV1_2(W(1,1),W(1,2),GC_10,ZERO,ZERO,W(1,5))
C       Amplitude(s) for diagram number 1
        CALL FFV1_0(W(1,5),W(1,3),W(1,4),GC_10,AMP(1))
        CALL FFV1_3(W(1,1),W(1,3),GC_10,ZERO,ZERO,W(1,6))
C       Amplitude(s) for diagram number 2
        CALL VVV1_0(W(1,2),W(1,4),W(1,6),GC_9,AMP(2))
