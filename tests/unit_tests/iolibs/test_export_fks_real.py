...
"""
    ...
    def test_write_mirrorprocs(self):
...
""" % misc.get_pkg_info()
    ...
    def test_write_born_fks_no_ijglu(self):
...
""" % misc.get_pkg_info()
    ...
    def test_write_born_fks_ijglu(self):
        """Tests the correct writing of the born.f file, when the particle
...
"""
    ...
    def test_write_ngraphs_file(self):
...
"""
    ...
    def test_write_configs_file_noinv(self):
...
"""
    ...
    def test_write_configs_file_inv(self):
        """Tests if the configs.inc file is corretly written, 
        without the t-channel inversion.
        """
        goal = \
...
"""
    ...
    def test_write_props_file_noinv(self):
...
"""
    ...
    def test_write_props_file_inv(self):
        """Tests if the props.inc file is corretly written, 
...
"""
    ...
    def test_write_bornfromreal_file(self):
...
"""
    ...
    def test_den_factor_line_w_real(self):
    ...
    def test_den_factor_line_wo_real(self):
    ...
    def test_get_icolamp_lines(self):
