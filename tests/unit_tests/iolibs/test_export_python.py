...
"""class Matrix_0_uux_uux(object):
    ...
    def matrix(self, p, hel, model):
        ...
        w[5] = FFV2__FFV5_3(w[0],w[1],GC_35,GC_47,MZ, WZ)
        # Amplitude(s) for diagram number 2
        amp[1] = FFV2__FFV5_0(w[3],w[2],w[5],GC_35,GC_47)
        w[6] = FFV1_3(w[0],w[2],GC_10,ZERO, ZERO)
        # Amplitude(s) for diagram number 3
        amp[2] = FFV1_0(w[3],w[1],w[6],GC_10)
        w[7] = FFV2__FFV5_3(w[0],w[2],GC_35,GC_47,MZ, WZ)
        # Amplitude(s) for diagram number 4
        amp[3] = FFV2__FFV5_0(w[3],w[1],w[7],GC_35,GC_47)
