...
eWcft_UV_EW_R = CTParameter(name = 'eWcft_UV_EW_R',
                            ...
                            value = {-1:'1.34',
                                     0:'1.34'},
                            texname = r'\delta ZR_e^{EW}')

tWcft_UV_EW_L = CTParameter(name = 'tWcft_UV_EW_L',
                            type = 'complex',
                            value = {-1:'2.31',
                                     0:'2.32'},
                            texname = r'\delta ZL_t^{EW}')
