...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_2(W(1,5),W(1,2),GC_2,DCMPLX(ZERO),W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,6),W(1,1),W(1,7),GC_124,AMP(4))
