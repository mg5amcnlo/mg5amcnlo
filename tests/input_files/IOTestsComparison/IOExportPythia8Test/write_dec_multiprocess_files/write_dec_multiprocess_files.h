...
// Process: g d > z d  QCD+2*QED<=3
// *   Decay: z > d d~  QCD+2*QED<=2
// Process: g s > z s  QCD+2*QED<=3
// *   Decay: z > d d~  QCD+2*QED<=2
// Process: g d > z d  QCD+2*QED<=3
// *   Decay: z > u u~  QCD+2*QED<=2
// Process: g s > z s  QCD+2*QED<=3
// *   Decay: z > u u~  QCD+2*QED<=2
// Process: g d > z d  QCD+2*QED<=3
// *   Decay: z > s s~  QCD+2*QED<=2
// Process: g s > z s  QCD+2*QED<=3
// *   Decay: z > s s~  QCD+2*QED<=2
// Process: g u > z u  QCD+2*QED<=3
// *   Decay: z > d d~  QCD+2*QED<=2
// Process: g u > z u  QCD+2*QED<=3
// *   Decay: z > s s~  QCD+2*QED<=2
// Process: g u > z u  QCD+2*QED<=3
