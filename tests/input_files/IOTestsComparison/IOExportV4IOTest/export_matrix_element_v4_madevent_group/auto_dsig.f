...
C     Per-event MLM graph: igraphs(1) from REWGT (0 = no MLM)
      INTEGER IGRAPH1(VECSIZE_MEMMAX)
      COMMON/VEC_IGRAPH/IGRAPH1
C     
C     DATA
C     
...
C         Select a flavor combination (need to do here for right sign)
     ...
     $  IGRAPH1, ALL_OUT , SELECTED_HEL, SELECTED_COL, VECSIZE_USED)
...
C           Call UNWGT to unweight and store events
     ...
     $  IGRAPH1, OUT, SELECTED_HEL, SELECTED_COL, VECSIZE_USED)
      USE OMP_LIB
      IMPLICIT NONE
