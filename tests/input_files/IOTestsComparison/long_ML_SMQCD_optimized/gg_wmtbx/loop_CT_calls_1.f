...
C     CutTools call for loop numbers 5,20,66
      CALL ML5_0_LOOP_2(8,15,DCMPLX(ZERO),DCMPLX(MDL_MT),1,I_SO,5)
C     CutTools call for loop numbers 7,112,113,114
...
C     CutTools call for loop numbers 9,36,76
      CALL ML5_0_LOOP_3(3,4,13,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MB),2,I_SO,8)
C     CutTools call for loop numbers 10,118,119,120
      CALL ML5_0_LOOP_4(3,4,6,5,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),DCMPLX(MDL_MB),3,I_SO,9)
C     CutTools call for loop numbers 11
      CALL ML5_0_LOOP_4(3,5,4,6,DCMPLX(MDL_MB),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MT),DCMPLX(MDL_MT),3,I_SO,10)
C     CutTools call for loop numbers 12
      CALL ML5_0_LOOP_4(3,4,5,6,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MB),DCMPLX(MDL_MB),3,I_SO,11)
C     CutTools call for loop numbers 13,23,69
      CALL ML5_0_LOOP_3(3,5,15,DCMPLX(MDL_MB),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MT),2,I_SO,12)
C     CutTools call for loop numbers 14,74
      CALL ML5_0_LOOP_2(10,17,DCMPLX(ZERO),DCMPLX(MDL_MB),1,I_SO,13)
C     CutTools call for loop numbers 15,21
      CALL ML5_0_LOOP_2(9,18,DCMPLX(ZERO),DCMPLX(MDL_MT),1,I_SO,14)
C     CutTools call for loop numbers 16
      CALL ML5_0_LOOP_3(3,9,10,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MB),2,I_SO,15)
C     CutTools call for loop numbers 17,80
...
C     CutTools call for loop numbers 18
     ...
     $ ,DCMPLX(MDL_MT),DCMPLX(ZERO),3,I_SO,17)
...
C     CutTools call for loop numbers 24,92
...
C     CutTools call for loop numbers 25
     ...
     $ ,DCMPLX(ZERO),DCMPLX(MDL_MB),3,I_SO,21)
...
C     CutTools call for loop numbers 27,67
      CALL ML5_0_LOOP_2(12,21,DCMPLX(ZERO),DCMPLX(MDL_MT),1,I_SO,23)
C     CutTools call for loop numbers 28,34
      CALL ML5_0_LOOP_2(11,22,DCMPLX(ZERO),DCMPLX(MDL_MB),1,I_SO,24)
C     CutTools call for loop numbers 29
      CALL ML5_0_LOOP_3(3,12,11,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MB),2,I_SO,25)
C     CutTools call for loop numbers 30,85
...
C     CutTools call for loop numbers 31
     ...
     $ ,DCMPLX(MDL_MB),DCMPLX(ZERO),3,I_SO,27)
...
C     CutTools call for loop numbers 40,54
...
C     CutTools call for loop numbers 44
     ...
     $ ,DCMPLX(MDL_MB),DCMPLX(ZERO),3,I_SO,37)
...
C     CutTools call for loop numbers 46
     ...
     $ ,DCMPLX(MDL_MB),DCMPLX(MDL_MT),DCMPLX(ZERO),4,I_SO,39)
...
C     CutTools call for loop numbers 49
     ...
     $ ,DCMPLX(MDL_MB),DCMPLX(ZERO),3,I_SO,42)
...
C     CutTools call for loop numbers 56,57,58,61,62,63
