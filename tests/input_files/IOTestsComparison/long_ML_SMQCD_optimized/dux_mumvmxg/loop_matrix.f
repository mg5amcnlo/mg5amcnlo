...
C       CutTools call for loop numbers 2
        CALL ML5_0_LOOP_3(2,7,6,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $   ,2,I_SO,2)
C       CutTools call for loop numbers 3
        CALL ML5_0_LOOP_3(1,7,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $   ,2,I_SO,3)
...
C       CutTools call for loop numbers 5,8
        CALL ML5_0_LOOP_3(1,5,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $   ,2,I_SO,5)
