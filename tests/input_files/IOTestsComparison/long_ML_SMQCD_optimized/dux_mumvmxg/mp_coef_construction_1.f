...
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL MP_FFV2L2_1(PL(0,1),W(1,7),GC_11,ZERO,ZERO,PL(0,2),COEFS)
...
C     Coefficient construction for loop diagram with ID 4
      CALL MP_FFV1L2P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL MP_FFV2L2_1(PL(0,10),W(1,7),GC_11,ZERO,ZERO,PL(0,13),COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,13)
     $ )
      CALL MP_FFV1L2_1(PL(0,13),W(1,5),GC_5,ZERO,ZERO,PL(0,14),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      CALL MP_FFV1L1_2(PL(0,6),W(1,5),GC_5,ZERO,ZERO,PL(0,15),COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,15))
      CALL MP_FFV1L1P0_3(PL(0,15),W(1,9),GC_5,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL MP_VVV1L2P0_1(PL(0,9),W(1,5),GC_4,ZERO,ZERO,PL(0,17),COEFS)
      CALL MP_ML5_0_UPDATE_WL_0_1(WL(1,0,1,9),4,COEFS,4,4,WL(1,0,1,17))
      CALL MP_FFV1L3_1(PL(0,17),W(1,2),GC_5,ZERO,ZERO,PL(0,18),COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,18)
     $ )
      CALL MP_FFV2L2_1(PL(0,18),W(1,7),GC_11,ZERO,ZERO,PL(0,19),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL MP_FFV1L3_1(PL(0,17),W(1,9),GC_5,ZERO,ZERO,PL(0,20),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L2_1(PL(0,1),W(1,5),GC_5,ZERO,ZERO,PL(0,23),COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,23))
      CALL MP_FFV1L2P0_3(PL(0,23),W(1,10),GC_5,ZERO,ZERO,PL(0,24)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL MP_FFV1L1P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,25),COEFS)
