...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1
     $ ,11))
      CALL MP_FFV2L2_1(PL(0,11),W(1,7),GC_47,ZERO,ZERO,PL(0,12),COEFS)
      CALL MP_ML5_0_UPDATE_WL_2_1(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1
     $ ,12))
...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1
     $ ,14))
...
C     Coefficient construction for loop diagram with ID 8
     ...
     $ ,15))
      ...
      CALL MP_ML5_0_UPDATE_WL_2_1(WL(1,0,1,15),4,COEFS,4,4,WL(1,0,1
     $ ,16))
...
C     Coefficient construction for loop diagram with ID 9
     ...
     $ ,17))
      ...
      CALL MP_ML5_0_UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1
     $ ,18))
...
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL MP_ML5_0_UPDATE_WL_2_0(WL(1,0,1,19),4,COEFS,4,4,WL(1,0,1
     $ ,20))
...
C     Coefficient construction for loop diagram with ID 11
      ...
      CALL MP_ML5_0_UPDATE_WL_0_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1
     $ ,22))
...
C     Coefficient construction for loop diagram with ID 12
      ...
      CALL MP_ML5_0_UPDATE_WL_0_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1
     $ ,24))
...
C     Coefficient construction for loop diagram with ID 13
     ...
     $ ,COEFS)
      CALL MP_ML5_0_UPDATE_WL_2_0(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1
     $ ,27))
