...
C     Amplitude(s) for UVCT diagram with ID 41
      ...
      AMPL(1,81)=AMPL(1,81)*(2.0D0*UVWFCT_T_0+2.0D0*UVWFCT_G_2+2.0D0
     $ *UVWFCT_G_1)
...
C     Amplitude(s) for UVCT diagram with ID 43
      ...
      AMPL(1,83)=AMPL(1,83)*(2.0D0*UVWFCT_T_0+2.0D0*UVWFCT_G_2+2.0D0
     $ *UVWFCT_G_1)
...
C     Amplitude(s) for UVCT diagram with ID 45
      ...
      AMPL(1,85)=AMPL(1,85)*(2.0D0*UVWFCT_T_0+2.0D0*UVWFCT_G_2+2.0D0
     $ *UVWFCT_G_1)
