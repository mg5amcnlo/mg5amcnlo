...
C     ----------
      ...
      SUBROUTINE ML5_0_SMATRIX(P, FLAVOR, ANS)
C     
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.ML5_0_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=ML5_0_MATRIX(P ,NHEL(1,IHEL),JC(1),FLAVOR(1))
     ...
     $       -1.OR.ML5_0_IS_BORN_HEL_SELECTED(IHEL)) THEN
      ...
      REAL*8 FUNCTION ML5_0_MATRIX(P,NHEL,IC,FLAVOR)
      USE MODEL_OBJECT
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
...
C     ROUTINE FOR F2PY to read the benchmark point.
      ...
      CALL  ML5_0_GET_VALUE_INTERNAL(P, ALPHAS, NHEL, FLAVOR ,ANS)
      RETURN
      END
