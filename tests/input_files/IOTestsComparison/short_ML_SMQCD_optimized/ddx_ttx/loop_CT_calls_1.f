...
C     CutTools call for loop numbers 2
      CALL ML5_0_LOOP_4(1,2,4,3,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(MDL_MT
     $ ),DCMPLX(ZERO),2,I_SO,2)
C     CutTools call for loop numbers 3
      CALL ML5_0_LOOP_4(1,2,3,4,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(MDL_MT
...
C     CutTools call for loop numbers 8
      CALL ML5_0_LOOP_3(3,4,5,DCMPLX(ZERO),DCMPLX(MDL_MT),DCMPLX(MDL_MT
     $ ),2,I_SO,7)
