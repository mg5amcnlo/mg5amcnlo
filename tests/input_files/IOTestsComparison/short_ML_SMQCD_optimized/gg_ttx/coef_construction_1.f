...
C     Coefficient construction for loop diagram with ID 26
     ...
     $ ,COEFS)
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,60),1,4,1,2,1,112,H)
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,61),1,4,1,2,1,113,H)
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,62),1,4,1,2,1,114,H)
C     Coefficient construction for loop diagram with ID 27
     ...
     $ ,COEFS)
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,63),1,4,2,1,1,115,H)
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,64),1,4,2,1,1,116,H)
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,65),1,4,2,1,1,117,H)
...
C     Coefficient construction for loop diagram with ID 34
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,83),2,4,23,1,1,124,H)
C     Coefficient construction for loop diagram with ID 35
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,86),3,4,24,1,1,125,H)
C     Coefficient construction for loop diagram with ID 36
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,89),3,4,24,1,1,126,H)
C     Coefficient construction for loop diagram with ID 37
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,91),2,4,25,1,1,127,H)
C     Coefficient construction for loop diagram with ID 38
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,92),3,4,26,1,1,128,H)
C     Coefficient construction for loop diagram with ID 39
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,93),3,4,26,1,1,129,H)
