      SUBROUTINE MP_HELAS_CALLS_AMPB_1(P,NHEL,H)
C     
...
C      if true.
      ...
      CALL MP_FFV2P0_3(W(2),W(1),GC_124,CMPLX(CMASS_MDL_MW,KIND=16)
     $ ,W(5))
...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_L_VEXVEA21_0(W(2),W(1),W(6),C_UVCXSWP1EW_1EPS,AMPL(2,5))
      CALL MP_L_VEXVEA21_0(W(2),W(1),W(6),C_UVCXSWP1EW,AMPL(1,6))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL MP_FFV2_0(W(4),W(3),W(5),R2_VLW,AMPL(1,7))
C     Counter-term amplitude(s) for loop diagram number 16
      CALL MP_FFV2_0(W(2),W(1),W(6),R2_BXTW2CP,AMPL(1,8))
