...
C      if true.
      ...
      CALL MP_FFV2P0_3(W(1,2),W(1,1),GC_67,CMPLX(CMASS_MDL_MW,KIND=16)
     $ ,W(1,5))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_FFV2_0(W(1,4),W(1,3),W(1,5),GC_67,AMP(1))
...
C     Counter-term amplitude(s) for loop diagram number 35
      CALL MP_R2_GG_1_R2_GG_3_0(W(1,5),W(1,6),R2_WWUD1,R2_WWTB3,AMPL(1
     $ ,12))
