...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL L_VEXVEA21_0(W(2),W(1),W(6),C_UVCXSWP1EW_1EPS,AMPL(2,5))
      CALL L_VEXVEA21_0(W(2),W(1),W(6),C_UVCXSWP1EW,AMPL(1,6))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL FFV2_0(W(4),W(3),W(5),R2_VLW,AMPL(1,7))
C     Counter-term amplitude(s) for loop diagram number 16
      CALL FFV2_0(W(2),W(1),W(6),R2_BXTW2CP,AMPL(1,8))
