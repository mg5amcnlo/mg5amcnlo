...
integer,parameter::native_context_ids(5)=[2,2,2,2,2]
integer,parameter::native_sector_ids(5)=[1,2,3,4,5]
integer,parameter::native_provider_ids(5)=[2,2,2,2,2]
integer,parameter::context_providers(2)=[1,2]
integer,save::active_context=0,active_sector=1,native_epoch=0,active_history=0
logical,save::native_mapping=.false.
integer,save::native_order_map(2,2)=0,native_amplitude_map(2,2)=0
type(BornMetadata),target,save::contexts(2)
type(BornMetadata),pointer,save::native_metadata=>null()
type(BornResult),save::native_result
integer,parameter::history_count=11
integer,save::history_flavours(2,11)=0,history_permutations(5,11)=0
