...
C        
C     
C     Process: d~ a > ve e+ u~ [ all = QCD QED ] QCD^2<=0 QED^2<=6
C     Process: s~ a > ve e+ c~ [ all = QCD QED ] QCD^2<=0 QED^2<=6
C     
C     ****************************************************            
C         
      IMPLICIT NONE
...
C         
     ...
     $ =EE_COMP_PROD(SX1_COMPONENTS,A2_COMPONENTS)
      ...
      IPROS=IPROS+1  ! d~ a > ve e+ u~
      PD2(IPROS) = A2

      IPROS=IPROS+1  ! s~ a > ve e+ c~
      PD2(IPROS) = A2

      PD1(0) = 0D0
      IPROSS = 0

      IPROSS=IPROSS+1  ! d~ a > ve e+ u~
      PD1(IPROSS) = DX1

      IPROSS=IPROSS+1  ! s~ a > ve e+ c~
      PD1(IPROSS) = SX1
      DO I=1,IPROC
