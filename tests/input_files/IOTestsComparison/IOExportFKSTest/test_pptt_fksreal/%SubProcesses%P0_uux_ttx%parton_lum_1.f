...
C        
C     
C     Process: u u~ > t t~ g  QCD+2*QED<=3 [ real = QCD ]
C     Process: c c~ > t t~ g  QCD+2*QED<=3 [ real = QCD ]
C     Process: d d~ > t t~ g  QCD+2*QED<=3 [ real = QCD ]
C     Process: s s~ > t t~ g  QCD+2*QED<=3 [ real = QCD ]
C     
C     ****************************************************            
C         
      IMPLICIT NONE
