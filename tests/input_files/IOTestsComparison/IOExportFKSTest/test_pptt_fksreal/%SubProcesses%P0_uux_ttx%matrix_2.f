...
C     Amplitude(s) for diagram number 5
      ...
      JAMP(1) = (0.5)*AMP(1)+(0.5)*AMP(3)+(0.5*IMAG1)*AMP(5)
      JAMP(2) = (-0.16666666666666666)*AMP(1)+(-0.16666666666666666)
     $ *AMP(4)
      JAMP(3) = (-0.16666666666666666)*AMP(2)+(-0.16666666666666666)
     $ *AMP(3)
      JAMP(4) = (0.5)*AMP(2)+(0.5)*AMP(4)+(-0.5*IMAG1)*AMP(5)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
