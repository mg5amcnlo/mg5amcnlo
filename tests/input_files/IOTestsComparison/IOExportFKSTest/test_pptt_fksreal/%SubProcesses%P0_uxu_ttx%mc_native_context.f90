...
integer,parameter::native_context_ids(8)=[3,3,3,3,3,3,1,1]
integer,parameter::native_sector_ids(8)=[1,2,3,4,5,6,5,8]
integer,parameter::native_provider_ids(8)=[3,3,3,3,3,3,1,1]
