...
C     
C     Process: d~ g > t t~ d~  QCD+2*QED<=3 [ real = QCD ]
C     Process: s~ g > t t~ s~  QCD+2*QED<=3 [ real = QCD ]
C     Process: u~ g > t t~ u~  QCD+2*QED<=3 [ real = QCD ]
C     Process: c~ g > t t~ c~  QCD+2*QED<=3 [ real = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
