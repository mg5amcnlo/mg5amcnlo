...
C     JAMPs contributing to orders QCD=3 QED=0
      JAMP(1,1)=+1D0/2D0*(-AMP(1)-AMP(2)-IMAG1*AMP(4))
      JAMP(2,1)=+1D0/2D0*(+1D0/3D0*AMP(2)+1D0/3D0*AMP(3))
      JAMP(3,1)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(5))
      JAMP(4,1)=+1D0/2D0*(-AMP(3)+IMAG1*AMP(4)-AMP(5))
