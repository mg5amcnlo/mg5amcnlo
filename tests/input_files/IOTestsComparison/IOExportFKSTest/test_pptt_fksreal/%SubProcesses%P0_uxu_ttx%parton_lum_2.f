...
C        
C     
C     Process: g u > t t~ u  QCD+2*QED<=3 [ real = QCD ]
C     Process: g c > t t~ c  QCD+2*QED<=3 [ real = QCD ]
C     Process: g d > t t~ d  QCD+2*QED<=3 [ real = QCD ]
C     Process: g s > t t~ s  QCD+2*QED<=3 [ real = QCD ]
C     
C     ****************************************************            
C         
      IMPLICIT NONE
