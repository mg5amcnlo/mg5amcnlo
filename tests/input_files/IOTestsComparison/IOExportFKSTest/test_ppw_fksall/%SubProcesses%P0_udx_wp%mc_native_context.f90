...
integer,parameter::native_context_ids(4)=[2,2,2,2]
integer,parameter::native_sector_ids(4)=[1,2,3,4]
integer,parameter::native_provider_ids(4)=[2,2,2,2]
...
integer,parameter::history_count=6
integer,save::history_flavours(2,6)=0,history_permutations(4,6)=0
logical,save::history_initialized=.false.
logical,save::shared_real_active=.false.
integer,save::shared_real_epoch=0
real(8),save::shared_real_point(0:3,4)
contains
...
history_permutations(:,1)=[1,2,3,4]
history_flavours(1:2,2)=[1,2]
history_permutations(:,2)=[1,2,3,4]
history_flavours(1:2,3)=[1,2]
history_permutations(:,3)=[1,2,3,4]
history_flavours(1:2,4)=[1,2]
history_permutations(:,4)=[1,2,3,4]
history_flavours(1:2,5)=[1,2]
history_permutations(:,5)=[1,2,3,4]
history_flavours(1:2,6)=[1,2]
history_permutations(:,6)=[1,2,3,4]
history_initialized=.true.
end subroutine
subroutine mc_begin_real_point(p)
real(8),intent(in)::p(0:3,4)
shared_real_point=p
