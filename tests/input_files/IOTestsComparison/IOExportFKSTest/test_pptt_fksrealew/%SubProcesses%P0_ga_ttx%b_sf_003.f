...
C     ----------
     ...
     $   //' only with calculatedborn = true'
      ...
      ELSEIF (CALCULATEDBORN) THEN
        ...
        ENDDO
      ENDIF
C     JAMP1s contributing to orders QCD=1 QED=1
      JAMP1(1,1)=-AMP(1)-AMP(2)
C     JAMP2s contributing to orders QCD=1 QED=1
      JAMP2(1,1)=+1D0/4D0*(-3D0*AMP(1)+1D0/3D0*AMP(1)-3D0*AMP(2)+1D0
     $ /3D0*AMP(2))
      DO I = 1, NSQAMPSO
        ANS(I) = 0D0
      ENDDO
