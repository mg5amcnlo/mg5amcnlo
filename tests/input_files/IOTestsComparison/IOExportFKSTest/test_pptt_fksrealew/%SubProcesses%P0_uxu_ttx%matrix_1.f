...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_2(W(4),W(5),GC_2,MDL_MT,MDL_WT,W(7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(7),W(3),W(6),GC_11,AMP(2))
      CALL FFV1_1(W(1),W(5),GC_2,ZERO,ZERO,W(7))
      CALL FFV1P0_3(W(4),W(3),GC_11,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(2),W(7),W(6),GC_11,AMP(3))
      CALL FFV1_2(W(2),W(5),GC_2,ZERO,ZERO,W(7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(7),W(1),W(6),GC_11,AMP(4))
