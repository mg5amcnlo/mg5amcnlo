...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_2,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_5_3(W(1,2),W(1,5),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,12))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,6),W(1,7),GC_2,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,2),W(1,6),W(1,8),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,2),W(1,6),W(1,9),-GC_50,GC_58,AMP(12))
