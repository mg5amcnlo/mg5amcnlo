...
C     JAMPs contributing to orders QCD=3 QED=0
      JAMP(1,1)=+1D0/2D0*(-AMP(2)-AMP(5)+IMAG1*AMP(13))
      JAMP(2,1)=+1D0/2D0*(+1D0/3D0*AMP(5)+1D0/3D0*AMP(8))
      JAMP(3,1)=+1D0/2D0*(+1D0/3D0*AMP(2)+1D0/3D0*AMP(11))
      JAMP(4,1)=+1D0/2D0*(-AMP(8)-AMP(11)-IMAG1*AMP(13))
C     JAMPs contributing to orders QCD=1 QED=2
      JAMP(1,2)=0D0
      JAMP(2,2)=-AMP(4)-AMP(6)-AMP(7)-AMP(9)
      JAMP(3,2)=-AMP(1)-AMP(3)-AMP(10)-AMP(12)
      JAMP(4,2)=0D0
