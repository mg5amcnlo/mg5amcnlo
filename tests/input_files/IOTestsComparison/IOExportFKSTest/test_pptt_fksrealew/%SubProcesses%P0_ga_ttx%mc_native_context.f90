...
integer,parameter::native_context_ids(11)=[4,4,4,4,4,4,4,2,3,6,7]
integer,parameter::native_sector_ids(11)=[1,2,3,4,5,6,7,11,11,11,11]
integer,parameter::native_provider_ids(11)=[4,4,4,4,4,4,4,2,3,6,7]
