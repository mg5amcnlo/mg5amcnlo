...
C     
      ...
      LOGICAL FORCE_IJGLU_ZERO
      COMMON /TO_FORCE_IJGLU/ FORCE_IJGLU_ZERO
      INTEGER IDEN_VALUES(7)
      DATA IDEN_VALUES /32, 32, 32, 32, 32, 32, 32/
      INTEGER NFKSPROCESS
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV1_1(W(3),W(1),GC_2,MDL_MT,MDL_WT,W(5))
C           Amplitude(s) for diagram number 1
            CALL FFV1_0(W(4),W(5),W(2),GC_11,AMP(1))
            CALL FFV1_2(W(4),W(1),GC_2,MDL_MT,MDL_WT,W(5))
C           Amplitude(s) for diagram number 2
            CALL FFV1_0(W(5),W(3),W(2),GC_11,AMP(2))
            DO I=1,NGRAPHS
