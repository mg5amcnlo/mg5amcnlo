...
C       Loop diagram number 3 (might be others, just an example)
        DO I=1,4
          ...
          CALL FFV2L_1(WL(3),W(WE(2),H),LC(2),ML(4),ZERO,WL(4))
...
C       Loop diagram number 5 (might be others, just an example)
        DO I=1,4
          ...
          CALL FFV2L_2(WL(3),W(WE(2),H),LC(2),ML(4),ZERO,WL(4))
...
C       Loop diagram number 6 (might be others, just an example)
        DO I=1,4
          ...
          CALL FFV2L_1(WL(5),W(WE(4),H),LC(4),ML(6),ZERO,WL(6))
          BUFF(I)=WL(6)%W(I)
        ENDDO
        CALL CLOSE_4(BUFF(1),RES)
      ELSEIF (ID.EQ.5) THEN
C       Loop diagram number 7 (might be others, just an example)
        DO I=1,4
          ...
          CALL FFV1LP0_3(W(WE(1),H),WL(2),LC(1),ML(3),ZERO,WL(3))
          CALL FFV1L_1(W(WE(2),H),WL(3),LC(2),ML(4),ZERO,WL(4))
          CALL FFV2L_1(WL(4),W(WE(3),H),LC(3),ML(5),ZERO,WL(5))
          CALL FFV1L_1(WL(5),W(WE(4),H),LC(4),ML(6),ZERO,WL(6))
          BUFF(I)=WL(6)%W(I)
        ENDDO
        CALL CLOSE_4(BUFF(1),RES)
      ELSEIF (ID.EQ.6) THEN
...
C       Loop diagram number 3 (might be others, just an example)
        DO I=1,4
          ...
          CALL MP_FFV2L_1(WL(3),W(WE(2),H),LC(2),ML(4),ZERO,WL(4))
...
C       Loop diagram number 5 (might be others, just an example)
        DO I=1,4
          ...
          CALL MP_FFV2L_2(WL(3),W(WE(2),H),LC(2),ML(4),ZERO,WL(4))
...
C       Loop diagram number 6 (might be others, just an example)
        DO I=1,4
          ...
          CALL MP_FFV2L_1(WL(5),W(WE(4),H),LC(4),ML(6),ZERO,WL(6))
          BUFF(I)=WL(6)%W(I)
        ENDDO
        CALL MP_CLOSE_4(BUFF(1),RES)
      ELSEIF (ID.EQ.5) THEN
C       Loop diagram number 7 (might be others, just an example)
        DO I=1,4
          ...
          CALL MP_FFV1LP0_3(W(WE(1),H),WL(2),LC(1),ML(3),ZERO,WL(3))
          CALL MP_FFV1L_1(W(WE(2),H),WL(3),LC(2),ML(4),ZERO,WL(4))
          CALL MP_FFV2L_1(WL(4),W(WE(3),H),LC(3),ML(5),ZERO,WL(5))
          CALL MP_FFV1L_1(WL(5),W(WE(4),H),LC(4),ML(6),ZERO,WL(6))
          BUFF(I)=WL(6)%W(I)
        ENDDO
        CALL MP_CLOSE_4(BUFF(1),RES)
      ELSEIF (ID.EQ.6) THEN
