...
C         Amplitude(s) for UVCT diagram with ID 136
          ...
          AMPL(1,238)=AMPL(1,238)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 138
          ...
          AMPL(1,240)=AMPL(1,240)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 140
          ...
          AMPL(1,242)=AMPL(1,242)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 142
          ...
          AMPL(1,244)=AMPL(1,244)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 144
     ...
     $     )
          AMPL(1,246)=AMPL(1,246)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 146
          ...
          AMPL(1,248)=AMPL(1,248)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 148
          ...
          AMPL(1,250)=AMPL(1,250)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
...
C         Amplitude(s) for UVCT diagram with ID 150
          ...
          AMPL(1,252)=AMPL(1,252)*(1.0D0*UVWFCT_B_0+2.0D0*UVWFCT_G_2
     $     +2.0D0*UVWFCT_G_1+1.0D0*UVWFCT_T_0)
