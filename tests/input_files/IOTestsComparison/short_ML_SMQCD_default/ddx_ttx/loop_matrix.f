...
C            optimized output)
            ...
            GOTO 300
          ENDIF
          CALL IXXXXX(P(0,1),ZERO,NHEL(1),+1, FLAVOR(1),W(1,H))
          CALL OXXXXX(P(0,2),ZERO,NHEL(2),-1, FLAVOR(2),W(2,H))
          CALL OXXXXX(P(0,3),MDL_MT,NHEL(3),+1, FLAVOR(3),W(3,H))
          CALL IXXXXX(P(0,4),MDL_MT,NHEL(4),-1, FLAVOR(4),W(4,H))
          CALL FFV1P0_3(W(1,H),W(2,H),GC_5,ZERO,ZERO,W(5,H))
C         Amplitude(s) for born diagram with ID 1
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMP(1,H))
          CALL FFV1P0_3(W(4,H),W(3,H),GC_5,ZERO,ZERO,W(6,H))
C         Counter-term amplitude(s) for loop diagram number 2
          CALL R2_GG_1_R2_GG_2_0(W(5,H),W(6,H),R2_GGG_1,R2_GGG_2
     $     ,AMPL(1,1))
C         Counter-term amplitude(s) for loop diagram number 3
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),R2_GQQ,AMPL(1,2))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,3))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,4))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,5))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,6))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,7))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB_1EPS,AMPL(2,8))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQG_1EPS,AMPL(2,9))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQB,AMPL(1,10))
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),UV_GQQT,AMPL(1,11))
C         Counter-term amplitude(s) for loop diagram number 5
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),R2_GQQ,AMPL(1,12))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,13))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,14))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,15))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,16))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,17))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,18))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQG_1EPS,AMPL(2,19))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB,AMPL(1,20))
          CALL FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQT,AMPL(1,21))
C         Counter-term amplitude(s) for loop diagram number 10
          CALL R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,22))
          CALL R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,23))
          CALL R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,24))
          CALL R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,25))
C         Counter-term amplitude(s) for loop diagram number 11
          CALL R2_GG_1_R2_GG_3_0(W(5,H),W(6,H),R2_GGQ,R2_GGB,AMPL(1,26)
     $     )
C         Counter-term amplitude(s) for loop diagram number 12
          CALL R2_GG_1_R2_GG_3_0(W(5,H),W(6,H),R2_GGQ,R2_GGT,AMPL(1,27)
     $     )
C         Amplitude(s) for UVCT diagram with ID 13
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMPL(2,28))
          AMPL(2,28)=AMPL(2,28)*(2.0D0*UVWFCT_B_0_1EPS)
C         Amplitude(s) for UVCT diagram with ID 14
          CALL FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMPL(1,29))
...
C     Loop amplitude for loop diagram with ID 6
     ...
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(ZERO)
     $ ,CMPLX(MP__ZERO,KIND=16),GC_5,MP__GC_5,GC_5,MP__GC_5,GC_4
     $ ,MP__GC_4,2,1,1,34,AMPL(1,34),S(34))
C     Loop amplitude for loop diagram with ID 7
      CALL ML5_0_LOOP_4_4(6,1,2,4,3,DCMPLX(ZERO),CMPLX(MP__ZERO
...
C     Loop amplitude for loop diagram with ID 8
      CALL ML5_0_LOOP_4_4(7,1,2,3,4,DCMPLX(ZERO),CMPLX(MP__ZERO
     $ ,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(MDL_MT)
     $ ,CMPLX(MP__MDL_MT,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
     $ ,GC_5,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,2,1,1
     $ ,36,AMPL(1,36),S(36))
C     Loop amplitude for loop diagram with ID 9
     ...
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),GC_4,MP__GC_4,GC_4
     $ ,MP__GC_4,2,1,1,37,AMPL(1,37),S(37))
C     Loop amplitude for loop diagram with ID 10
     ...
     $ ,MP__GC_5,2,1,4,38,AMPL(1,38),S(38))
C     Loop amplitude for loop diagram with ID 11
      CALL ML5_0_LOOP_2_2(9,5,6,DCMPLX(MDL_MB),CMPLX(MP__MDL_MB
     $ ,KIND=16),DCMPLX(MDL_MB),CMPLX(MP__MDL_MB,KIND=16),GC_5
     $ ,MP__GC_5,GC_5,MP__GC_5,2,1,1,39,AMPL(1,39),S(39))
C     Loop amplitude for loop diagram with ID 12
      CALL ML5_0_LOOP_2_2(9,5,6,DCMPLX(MDL_MT),CMPLX(MP__MDL_MT
     $ ,KIND=16),DCMPLX(MDL_MT),CMPLX(MP__MDL_MT,KIND=16),GC_5
     $ ,MP__GC_5,GC_5,MP__GC_5,2,1,1,40,AMPL(1,40),S(40))
