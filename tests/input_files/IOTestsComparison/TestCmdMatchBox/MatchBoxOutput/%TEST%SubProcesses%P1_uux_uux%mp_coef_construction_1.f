...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL MP_MG5_1_UPDATE_WL_0_1(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1
     $ ,12))
      CALL MP_FFV1L1_2(PL(0,12),W(1,6),GC_5,ZERO,ZERO,PL(0,13),COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,12),4,COEFS,4,4,WL(1,0,1
     $ ,13))
...
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL MP_MG5_1_UPDATE_WL_1_0(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1
     $ ,15))
      CALL MP_VVV1L2P0_1(PL(0,15),W(1,6),GC_4,ZERO,ZERO,PL(0,16),COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,15),4,COEFS,4,4,WL(1,0,1
     $ ,16))
...
C     Coefficient construction for loop diagram with ID 9
      ...
      CALL MP_MG5_1_UPDATE_WL_0_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1
     $ ,18))
      CALL MP_FFV1L2_1(PL(0,18),W(1,8),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,18),4,COEFS,4,4,WL(1,0,1
     $ ,19))
...
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL MP_MG5_1_UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1
     $ ,21))
      CALL MP_VVV1L2P0_1(PL(0,21),W(1,8),GC_4,ZERO,ZERO,PL(0,22),COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1
     $ ,22))
...
C     Coefficient construction for loop diagram with ID 11
     ...
     $ ,23))
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1
     $ ,24))
      CALL MP_FFV1L1P0_3(PL(0,24),W(1,3),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL MP_MG5_1_UPDATE_WL_2_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1
     $ ,25))
...
C     Coefficient construction for loop diagram with ID 12
     ...
     $ ,26))
      ...
      CALL MP_MG5_1_UPDATE_WL_2_0(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1
     $ ,27))
...
C     Coefficient construction for loop diagram with ID 14
     ...
     $ ,29))
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,29),4,COEFS,4,4,WL(1,0,1
     $ ,30))
...
C     Coefficient construction for loop diagram with ID 15
      ...
      CALL MP_MG5_1_UPDATE_WL_1_0(WL(1,0,1,29),4,COEFS,4,4,WL(1,0,1
     $ ,31))
      CALL MP_FFV1L3_1(PL(0,31),W(1,3),GC_5,ZERO,ZERO,PL(0,32),COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,31),4,COEFS,4,4,WL(1,0,1
     $ ,32))
...
C     Coefficient construction for loop diagram with ID 16
     ...
     $ ,33))
      ...
      CALL MP_MG5_1_UPDATE_WL_2_0(WL(1,0,1,33),4,COEFS,4,4,WL(1,0,1
     $ ,34))
...
C     Coefficient construction for loop diagram with ID 17
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,35),4,COEFS,4,4,WL(1,0,1
     $ ,36))
...
C     Coefficient construction for loop diagram with ID 18
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,37),4,COEFS,4,4,WL(1,0,1
     $ ,38))
...
C     Coefficient construction for loop diagram with ID 19
     ...
     $ ,COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,39),4,COEFS,4,4,WL(1,0,1
     $ ,40))
...
C     Coefficient construction for loop diagram with ID 20
     ...
     $ ,COEFS)
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,41),4,COEFS,4,4,WL(1,0,1
     $ ,42))
...
C     Coefficient construction for loop diagram with ID 21
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,43),4,COEFS,4,4,WL(1,0,1
     $ ,44))
...
C     Coefficient construction for loop diagram with ID 22
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,45),4,COEFS,4,4,WL(1,0,1
     $ ,46))
...
C     Coefficient construction for loop diagram with ID 23
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,47),1,COEFS,1,1,WL(1,0,1
     $ ,48))
...
C     Coefficient construction for loop diagram with ID 24
      ...
      CALL MP_MG5_1_UPDATE_WL_1_1(WL(1,0,1,49),1,COEFS,1,1,WL(1,0,1
     $ ,50))
