      SUBROUTINE P1_CTLOOP(NLOOPLINE,PL,M2L,RANK,RES,STABLE)
C     
...
C     CONVERT THE MOMENTA FLOWING IN THE LOOP LINES TO CT CONVENTIONS
      ...
      CALL CTSXCUT(CTMODE,LSCALE,MU_R,NLOOPLINE,P1_LOOPNUM,P1_MPLOOPNUM
     $ ,RANK,PCT,M2LCT,RES,ACC,R1,STABLE)
...
C     CALL CTSINIT(THRS,LOOPLIB)
      ...
      SUBROUTINE P1_LOOP_4( LID, W1, W2, W3, W4, M1, M2, M3, M4,  RANK
     $ , RES, STABLE, LOOPNUM)
...
C     ----------
     ...
     $ ) THEN
        ...
        DO I=0,3
          ...
          ENDDO
        ENDDO
        CALL P1_CTLOOP(NLOOPLINE,PL,M2L,RANK,RES,STABLE)
      ELSE
        RES(1)=0.0D0
        RES(2)=0.0D0
        RES(3)=0.0D0
      ...
      SUBROUTINE P1_LOOP_3( LID, W1, W2, W3, M1, M2, M3,  RANK, RES
     $ , STABLE, LOOPNUM)
...
C     ----------
     ...
     $ ) THEN
      ...
      SUBROUTINE P1_LOOP_2( LID, W1, W2, M1, M2,  RANK, RES, STABLE
     $ , LOOPNUM)
