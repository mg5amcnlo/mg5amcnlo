...
C     ===========================================
      ...
      SUBROUTINE MG5_1_SAMURAI_LOOP(NLOOPLINE,PL,M2L,RANK,RES,STABLE)
C     
C     Module used
C     
      USE MSAMURAI
...
C     Hook for numerator function for Samurai
      COMPLEX*16 MG5_1_SAMURAI_LOOPNUM
      EXTERNAL MG5_1_SAMURAI_LOOPNUM
C     
C     GLOBAL VARIABLES
C     
      INCLUDE 'coupl.inc'
...
C     Optionally one can set the kinematic matrix fo samurai
      CALL MG5_1_SET_SAMURAI_S_MAT(NLOOPLINE,P_TMP,M2L)

      CALL SAMURAI(MG5_1_SAMURAI_LOOPNUM,SAM_RES,R1,P_SAM,M2L_SAM
...
C     =====================================================
      FUNCTION MG5_1_SAMURAI_LOOPNUM(ICUT_DUMMY,Q_IN,MU2_DUMMY)
      IMPLICIT NONE
C     
C     ARGUMENTS 
C     
      ...
      Q(2)=Q_IN(2)
      Q(3)=Q_IN(3)
      CALL MG5_1_LOOPNUM(Q,RES)

      MG5_1_SAMURAI_LOOPNUM = RES

      END


      SUBROUTINE MG5_1_SET_SAMURAI_S_MAT(NLOOPLINE,P_LOOP_IN,M2L)
C     
C     Module used
C     
...
C     
      DO I=1,NLOOPLINE
        ...
        ENDDO
      ENDDO
      CALL MG5_1_BUILD_KINEMATIC_MATRIX(NLOOPLINE,P_LOOP,M2L,S_MAT_OUT)
...
C         Samurai is used
          CALL MG5_1_SAMURAI_LOOP(NLOOPLINE,PL,M2L,RANK,LOOPRES(1
