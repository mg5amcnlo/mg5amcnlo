...
C     and
C     Process: b~ b > z a [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Helas calls and color basis for the Sudakov amplitude
      ...
      CALL FFV2_3_1(W(1),W(3),GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(2),W(5),W(4),GC_1,AMP2(1))
      CALL FFV1_1(W(1),W(4),GC_1,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(2),W(5),W(3),GC_68,GC_76,AMP2(2))
C     JAMPs contributing to orders QCD=0 QED=2
