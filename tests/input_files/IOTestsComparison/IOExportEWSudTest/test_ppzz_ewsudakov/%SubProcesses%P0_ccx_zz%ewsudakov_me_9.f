...
C     and
C     Process: c c~ > w- w+ [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Helas calls and color basis for the Sudakov amplitude
      ...
      CALL FFV1P0_3(W(1),W(2),GC_2,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(5),W(3),W(4),GC_4,AMP2(1))
      CALL FFV2_5P0_3(W(1),W(2),GC_69,GC_76,MDL_MZ,MDL_WZ,W(5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(3),W(4),W(5),GC_71,AMP2(2))
      CALL FFV2_2(W(1),W(4),GC_124,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(5),W(2),W(3),GC_124,AMP2(3))
C     JAMPs contributing to orders QCD=0 QED=2
