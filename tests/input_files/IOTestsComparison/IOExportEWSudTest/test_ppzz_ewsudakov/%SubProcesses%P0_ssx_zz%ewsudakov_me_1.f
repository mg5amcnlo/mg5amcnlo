...
C     and
C     Process: s s~ > a z [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Helas calls and color basis for the Sudakov amplitude
      ...
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV1_2(W(1,1),W(1,3),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,4),GC_68,GC_76,AMP2(1))
      CALL FFV2_3_2(W(1,1),W(1,4),GC_68,GC_76,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,2),W(1,3),GC_1,AMP2(2))
C     JAMPs contributing to orders QCD=0 QED=2
