...
C     and
C     Process: b~ t > z w+ [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     
      ...
      PARAMETER ( NGRAPHS1=2, NGRAPHS2=4)
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(2),W(5),W(4),GC_68,GC_76,AMP1(1))
      CALL FFV2_3_1(W(1),W(4),GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(2),W(5),W(3),GC_68,GC_76,AMP1(2))
...
C     Reshuffle the momenta here
      P_SAVE(:,:) = P(:,:)
      PASS_RESHUFFLE = .TRUE.
      CALL RESHUFFLE_MOMENTA(P,P_RESH,(/2,4/),(/5,23/),(/6,24/)
     $ ,PASS_RESHUFFLE)
      P(:,:)=P_RESH(:,:)
...
C     Helas calls and color basis for the Sudakov amplitude
      CALL OXXXXX(P(0,1),ZERO,NHEL(1),-1, FLAVOR(1),W(1))
      CALL IXXXXX(P(0,2),MDL_MT,NHEL(2),+1, FLAVOR(2),W(2))
      CALL VXXXXX(P(0,3),MDL_MZ,NHEL(3),+1,W(3))
      CALL VXXXXX(P(0,4),MDL_MW,NHEL(4),+1,W(4))
      CALL FFV2P0_3(W(2),W(1),GC_124,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(5),W(4),W(3),GC_71,AMP2(1))
      CALL FFS3_3(W(2),W(1),GC_30,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(4),W(3),W(5),GC_84,AMP2(2))
      CALL FFV2_3_1(W(1),W(3),GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(2),W(5),W(4),GC_124,AMP2(3))
      CALL FFV2_1(W(1),W(4),GC_124,MDL_MT,MDL_WT,W(5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(2),W(5),W(3),GC_69,GC_76,AMP2(4))
C     JAMPs contributing to orders QCD=0 QED=2
      JAMP2(1,1) = (-1.000000000000000D+00)*AMP2(1)+(
     $ -1.000000000000000D+00)*AMP2(2)+(-1.000000000000000D+00)*AMP2(3)
     $ +(-1.000000000000000D+00)*AMP2(4)
