...
C       the SSC terms (charged)
     ...
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        ...
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(1,3,PDGLIST,-3,24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_5(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/-3,4,23,24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(1,4,PDGLIST,-3,24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_6(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/-4,3,-24,23/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(2,3,PDGLIST,3,-24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_7(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/-4,3,23,-24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(2,4,PDGLIST,3,-24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_8(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/-4,4,24,-24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
