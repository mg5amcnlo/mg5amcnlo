...
C       the SSC terms (charged)
        ...
        PDGLIST_OTH = (/6,-6,23,23/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(1,2,PDGLIST,6,-6,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_4(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/6,-5,24,23/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(1,3,PDGLIST,6,24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_5(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/6,-5,23,24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(1,4,PDGLIST,6,24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_6(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/5,-6,-24,23/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(2,3,PDGLIST,-6,-24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_7(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/5,-6,23,-24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
     $   +AMP_SPLIT_EWSUD(:)*GET_SSC_C(2,4,PDGLIST,-6,-24,NHEL(1,IHEL)
     $   ,IFLIST,INVARIANTS)*COMP_IDFAC
        CALL EWSDK_ME_8(P,NHEL(1,IHEL),ANS_SUMMED)
        PDGLIST_OTH = (/5,-5,24,-24/)
        AMP_SPLIT_EWSUD_SSC(:) = AMP_SPLIT_EWSUD_SSC(:)
