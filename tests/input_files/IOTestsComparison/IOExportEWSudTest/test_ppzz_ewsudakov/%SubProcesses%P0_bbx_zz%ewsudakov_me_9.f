...
C     and
C     Process: b b~ > w- w+ [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Helas calls and color basis for the base amplitude
      ...
      CALL FFV2_3_2(W(1,1),W(1,3),GC_68,GC_76,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,4),GC_68,GC_76,AMP1(1))
      CALL FFV2_3_2(W(1,1),W(1,4),GC_68,GC_76,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,3),GC_68,GC_76,AMP1(2))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3P0_3(W(1,1),W(1,2),GC_68,GC_76,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,3),W(1,4),W(1,5),-GC_70,AMP2(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_124,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_124,AMP2(3))
C     JAMPs contributing to orders QCD=0 QED=2
