...
c for the uncertainty estimate
      ...
      do i=1,1
       l=(i-1)*26
        ...
        call HwU_book(l+ 2,'w+ pt     ',20,500d0,2500.d0)
        call HwU_book(l+ 3,'w+ log pt',20,log10(500d0),log10(2500.d0))
        call HwU_book(l+ 4,'w+ y      ', 20,-9.d0,9.d0)
        call HwU_book(l+ 5,'w+ eta    ', 20,-9.d0,9.d0)
        call HwU_book(l+ 6,'z pt     ',20,500d0,2500.d0)
        call HwU_book(l+ 7,'z log pt',20,log10(500d0),log10(2500.d0))
        call HwU_book(l+ 8,'z y      ', 20,-9.d0,9.d0)
        call HwU_book(l+ 9,'z eta    ', 20,-9.d0,9.d0)
        call HwU_book(l+ 10,'V1 pt     ',20,500d0,2500.d0)
        call HwU_book(l+ 11,'V1 log pt',20,log10(500d0),log10(2500.d0))
        call HwU_book(l+ 12,'V2 pt     ',20,500d0,2500.d0)
        call HwU_book(l+ 13,'V2 log pt',20,log10(500d0),log10(2500.d0))
        call HwU_book(l+ 14,'m w+z       ', 20,1000d0,4000.d0)
        call HwU_book(l+ 15,'m w+z log ',20,log10(1000d0),log10(4000.d0))
        ...
        call HwU_book(l+ 19,'pt w+ +j      ', 20,300d0,2500.d0)
        call HwU_book(l+ 20,'pt w+ +j log ',20,log10(300d0),log10(2500.d0))
        call HwU_book(l+ 21,'inv w+ +j     ', 20,20d0,4000.d0)
        call HwU_book(l+ 22,'inv w+ +j log ',20,log10(20d0),log10(4000.d0))
        call HwU_book(l+ 23,'pt z +j      ', 20,300d0,2500.d0)
        call HwU_book(l+ 24,'pt z +j log',20,log10(300d0),log10(2500.d0))
...
C---CLUSTER THE EVENT
      ...
      var=1.0
      if (pass_jets) then
      if ((ptz.gt.600.d0).and.(ptwp.gt.600.d0).and.(m_wpz.gt.1200.d0)) then
