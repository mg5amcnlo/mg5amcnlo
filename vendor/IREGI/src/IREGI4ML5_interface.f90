...
SUBROUTINE IMLOOP(IMODE,NLOOPLINE,NLOOPCOEFS,RANK,PDEN,M2L,MUR,TIRCOEFS,STABLE)
  USE funlib
  USE ti_reduce
  USE global
  IMPLICIT NONE
  INTEGER,INTENT(IN)::NLOOPLINE,RANK,NLOOPCOEFS
  ...
  CALL tensor_integral_reduce(IMODE,NLOOPLINE,RANK,nlenrank,&
       PL,M2LR,MUR,TCOEFS(0:nlenrank-1,1:4),TSTABLE)
  STABLE=TSTABLE
