      ...
      t=ra*r**(1d0/(pa+1))
      z=t*(1d0-x)+x
      g=a*dexp(p*(1d0-x/z))*dexp(q*(x/z)**(-1.5d0))*isr_tilde(z,beta)
      g=g*z**(-1d0/3d0)
...
c     In Gmu scheme
      ...
      data a11/0.7434d0/,a01/0.04563/,a10/0.04568/,a00/0.003537/
      data p1/-0.6016d0/,q1/-7.179d-3/,p2/-0.6089d0/,q2/-7.135d-3/
      data p3/-0.5629d0/,q3/-7.464d-3/,p4/-0.5743d0/,q4/-7.259d-3/
