...
c
      integer i,j,id,inst,inxm,ipart,itype,i1,i2,ipmap(100),iitype
     $     ,iipart,iinst,iinxm
      integer ifakegrid
...
c
      ...
      write (*,*) 'enter itype, ipart and inxm'
      read (*,*) iitype,iipart,iinxm
      ...
      write (cdum3,*) iinxm
c$$$      write (cdum4,*) iinst
c$$$      filelog='sudakov_'//trim(adjustl(cdum1))//'_'
c$$$     $     //trim(adjustl(cdum2))//'_'//trim(adjustl(cdum3))//'_'
c$$$     $     //trim(adjustl(cdum4))//'.log'
c$$$      fileerr='sudakov_'//trim(adjustl(cdum1))//'_'
c$$$     $     //trim(adjustl(cdum2))//'_'//trim(adjustl(cdum3))//'_'
c$$$     $     //trim(adjustl(cdum4))//'.err'
      filelog='sudakov_'//trim(adjustl(cdum1))//'_'
     $     //trim(adjustl(cdum2))//'_'//trim(adjustl(cdum3))
     $     //'.log'
      fileerr='sudakov_'//trim(adjustl(cdum1))//'_'
     $     //trim(adjustl(cdum2))//'_'//trim(adjustl(cdum3))
     $     //'.err'
