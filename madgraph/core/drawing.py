...
class FeynmanLine:
    ...
    def __str__(self):
        return f'FeynmanLine(({self.begin.pos_x},{self.begin.pos_y}), ({self.end.pos_x},{self.end.pos_y}), id={self.id}, number={self.number})'
        ...
        for i, line in enumerate(self.lineList):
            for j in range(i + 1, len(self.lineList)):
                ...
                if line.begin == line2.end or line.begin == line2.begin:
                    ...
                    logger.info(f'intersection for {i} {j}')
                    logger.info(f'line {i} ({line.begin.pos_x},{line.begin.pos_y}),({line.end.pos_x},{line.end.pos_y})')
                    logger.info(f'line {j} ({line2.begin.pos_x},{line2.begin.pos_y}),({line2.end.pos_x},{line2.end.pos_y})')
