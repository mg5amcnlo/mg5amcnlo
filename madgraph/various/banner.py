...
""", 
    ...
    def default_setup(self):
        ...
        self.add_param("cut_decays", False, cut=[','])
        ...
        # DRJJ
        self.add_param("drjj", 0.4, cut=['j','j'])
        self.add_param("drbb", 0.0, cut=['b','b'])
        self.add_param("drll", 0.4, cut=['l','l'])
        self.add_param("draa", 0.4, cut=['a','a'])
        self.add_param("drbj", 0.0, cut=['b','j'])
        self.add_param("draj", 0.4, cut=['a','j'])
        self.add_param("drjl", 0.4, cut=['j','l'])
        self.add_param("drab", 0.0, cut=['a','b'])
        self.add_param("drbl", 0.0, cut=['b','l'])
        self.add_param("dral", 0.4, cut=['a','l'])
        self.add_param("drjjmax", -1.0, cut=['j','j'])
        self.add_param("drbbmax", -1.0, cut=['b','b'])
        self.add_param("drllmax", -1.0, cut=['l','l'])
        self.add_param("draamax", -1.0, cut=['a','a'])
        self.add_param("drbjmax", -1.0, cut=['b','j'])
        self.add_param("drajmax", -1.0, cut=['a','j'])
        self.add_param("drjlmax", -1.0, cut=['j','l'])
        self.add_param("drabmax", -1.0, cut=['a','b'])
        self.add_param("drblmax", -1.0, cut=['b','l'])
        self.add_param("dralmax", -1.0, cut=['a','l'])
        # invariant mass
        self.add_param("mmjj", 0.0, cut=['j','j'])
        self.add_param("mmbb", 0.0, cut=['b','b'])
        self.add_param("mmaa", 0.0, cut=['a','a'])
        self.add_param("mmll", 0.0, cut=['l','l'])
        self.add_param("mmjjmax", -1.0, cut=['j','j'])
        self.add_param("mmbbmax", -1.0, cut=['b','b'])                
        self.add_param("mmaamax", -1.0, cut=['a','a'])
        self.add_param("mmllmax", -1.0, cut=['l','l'])
        self.add_param("mmnl", 0.0, cut=['L', 'L'])
        self.add_param("mmnlmax", -1.0, cut=['L','L'])
        #minimum/max pt for sum of leptons
        self.add_param("ptllmin", 0.0, cut=['l','l'])
        self.add_param("ptllmax", -1.0, cut=['l','l'])
        self.add_param("xptj", 0.0, cut=['j','j'])
        self.add_param("xptb", 0.0, cut=['b','b'])
        self.add_param("xpta", 0.0, cut=['a','a']) 
        self.add_param("xptl", 0.0, cut=['l','l'])
        # ordered pt jet 
        self.add_param("ptj1min", 0.0, cut=['j','j'])
        self.add_param("ptj1max", -1.0, cut=['j','j'])
        self.add_param("ptj2min", 0.0, cut=['j','j'])
        self.add_param("ptj2max", -1.0, cut=['j','j'])
        self.add_param("ptj3min", 0.0, cut=['j','j','j'])
        self.add_param("ptj3max", -1.0, cut=['j','j','j'])
        self.add_param("ptj4min", 0.0, cut=['j']*4)
        self.add_param("ptj4max", -1.0, cut=['j']*4)                
        self.add_param("cutuse", 0, cut=['j','j'])
        # ordered pt lepton
        ...
        self.add_param("xqcut", 0.0, cut=['j'])
