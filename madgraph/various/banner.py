...
""",
    ...
    def default_setup(self):
        ...
        self.add_param('tmin_for_channel', -0.2, hidden=True, comment='limit the non-singular reach of --some-- channel of integration related to T-channel diagram')
        ...
        self.add_param('single_diagram_enhancement_strategy', 2, allowed=[1,2], fortran_name="sde_strat", hidden=True, comment="decide how Multi-channel should behaves \"1\" means full single diagram enhanced (hep-ph/0208156), \"2\" use the product of the denominator")
