...
# Temporary, for testing purposes
            if True:
                ...
                shutil.copy(pjoin(self.mgme_dir,'TEST2/OLP_virtuals','OLE_order.olc'),
                   pjoin(virtual_path,'OLE_order.olc'))
                os.makedirs(pjoin(virtual_path,'Virtuals','lib'))
                shutil.copy(pjoin(self.mgme_dir,'GoSam_DY/SubProcesses/Virtual/olp_module.mod'),
                   pjoin(virtual_path,'Virtuals','olp_module.mod'))
                shutil.copy(pjoin(self.mgme_dir,'GoSam_DY/SubProcesses/Virtual/lib/libgolem_olp.so'),
                   pjoin(virtual_path,'Virtuals','lib','libgolem_olp.so'))
                retcode=0
