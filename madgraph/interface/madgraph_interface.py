...
class MadGraphCmd(HelpToCmd, CheckValidForCmd, CompleteForCmd, CmdExtended):
    ...
    _v4_export_formats = ['madevent', 'standalone', 'standalone_msP','standalone_msF', 'matrix'] 
    ...
    def setup(self):
        ...
        self._v4_export_formats = ['madevent', 'standalone','standalone_msP','standalone_msF', 'matrix'] 
...
#                    filetext = urllib.urlopen('http://madgraph.phys.ucl.ac.be/patch_test/build%s.patch' %(i+1))
    ...
    def do_output(self, line):
        ...
        if self._export_format in ['madevent', 'standalone','standalone_msP','standalone_msF', 'matrix']:
            self._curr_exporter = export_v4.ExportV4Factory(self, noclean)
        elif self._export_format == 'standalone_cpp':
            export_cpp.setup_cpp_standalone_dir(self._export_dir, self._curr_model)
        if self._export_format not in \
                ['madevent', 'standalone', 'standalone_cpp', 'standalone_msP', 'standalone_msF'] and \
    ...
    def export(self, nojpeg = False, main_file_name = "", args=[]):
        ...
        def generate_matrix_elements(self):
            ...
            if self._export_format in [ 'standalone_msP', 'standalone_msF' ]:
                to_distinguish = []
                for part in self._curr_model.get('particles'):
        ...
        if self._export_format in ['standalone_cpp', 'madevent', 'standalone', 'standalone_msP', 'standalone_msF']:
        ...
        if self._export_format in ['standalone', 'standalone_msP', 'standalone_msF']:
    ...
    def finalize(self, nojpeg, online = False):
        ...
        if self._export_format in ['madevent', 'standalone', 'standalone_msP','standalone_msF', 'NLO']:
