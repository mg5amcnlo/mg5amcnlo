...
class CmdExtended(cmd.Cmd):
    ...
    def __init__(self, *arg, **opt):
        ...
        "************************************************************\n" + \
        "*                                                          *\n" + \
        "*      W E L C O M E  to  M A D G R A P H  5  @ N L O      *\n" + \
        "*                                                          *\n" + \
        "*                                                          *\n" + \
        "*                 *                       *                *\n" + \
        "*                   *        * *        *                  *\n" + \
...
class MadGraphCmd(CmdExtended, HelpToCmd):
    ...
    def __init__(self, mgme_dir = '', *completekey, **stdin):
        ...
        self._options['group_subprocesses'] = False
        self._options['collect_mirror_processes'] = False
    ...
    def do_add(self, line):
        ...
        if args[0] == 'process':            
            ...
            # Generate processes
            collect_mirror_procs = self._options['collect_mirror_processes']
            ignore_six_quark_processes = \
