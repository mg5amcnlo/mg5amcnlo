...
void add_instructions(py::classh<FunctionBuilder>& fb) {
    ...
    fb.def("t_inv_min_max_cut", &FunctionBuilder::t_inv_min_max_cut, py::arg("pa"), py::arg("pb"), py::arg("m1"), py::arg("m2"), py::arg("t_min_cut"), py::arg("t_max_cut"));
    fb.def("t_inv_value_and_min_max_cut", &FunctionBuilder::t_inv_value_and_min_max_cut, py::arg("pa"), py::arg("pb"), py::arg("p1"), py::arg("p2"), py::arg("t_min_cut"), py::arg("t_max_cut"));
    ...
    fb.def("s23_min_max_cut", &FunctionBuilder::s23_min_max_cut, py::arg("pa"), py::arg("pb"), py::arg("p3"), py::arg("t1_abs"), py::arg("m1"), py::arg("m2"), py::arg("s23_min_cut"), py::arg("s23_max_cut"));
    fb.def("s23_value_and_min_max_cut", &FunctionBuilder::s23_value_and_min_max_cut, py::arg("pa"), py::arg("pb"), py::arg("p3"), py::arg("t1_abs"), py::arg("p1"), py::arg("p2"), py::arg("s23_min_cut"), py::arg("s23_max_cut"));
