...
def fixed_input_points(rng, request):
    ...
    r1 = rng.random(N)
    r2 = rng.random(N)
    p12, p3, det_22 = map_22.map_forward([r1, r2, m12, m3], [pA, pB, ZEROS])
...
def test_momentum_conservation(input_points):
    ...
    conditions = [input_points.pa, input_points.pb, input_points.p3, ZEROS, ZEROS]
...
def test_phase_space_compare(rng, input_points):
    ...
    conditions = [input_points.pa, input_points.pb, input_points.p3, ZEROS, ZEROS]
    conditions22 = [input_points.pa, input_points.pb - input_points.p3, ZEROS]
