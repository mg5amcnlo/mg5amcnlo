...
class MadSpinInterface(extended_cmd.Cmd):
    ...
    def run_onshell(self, line, density_method=False):
        ...
        to_decay = collections.defaultdict(int)
        # Spyros: dictionary with particle properties
        decay_dict = {}
    ...
    def get_maxwgt_for_onshell(self, orig_lhe, evt_decayfile, decay_dict, inter_prod_dict=None):
...
#        misc.sprint(all_maxwgt)
    ...
    def get_onshell_evt_and_wgt(self, production, decays, decay_dict, inter_prod_dict=None):
	...
	# Spyros: get helicity of production event
        ...
        #print("production_hel = {production_hel}")
        ...
        if pdir in self.all_f2py:
            ...
            for p in all_p:
                ...
                if event[0].color1 == 599 and event.aqcd==0:
                    ...
                    #print(f"Spyros calculate ME fixed_hel = {self.all_f2py[pdir](p, event.aqcd, helicity)} , all_hel = {self.all_f2py[pdir](p, event.aqcd, 0)}")
