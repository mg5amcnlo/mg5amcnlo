...
C     
C     Process: g u~ > e+ e- g g u~ WEIGHTED<=7 @1
C     Process: g u~ > mu+ mu- g g u~ WEIGHTED<=7 @1
C     Process: g c~ > e+ e- g g c~ WEIGHTED<=7 @1
C     Process: g c~ > mu+ mu- g g c~ WEIGHTED<=7 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,3) .OR. NTRY(3).LE.MAXTRIES.OR.(ISUM_HEL.NE.0))
     $      THEN
            T=MATRIX3(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(3).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,3) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,3)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 3',TS(I)
     $           *NCOMB/ANS,' in event ',NTRY(3)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(3).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX3(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,9))
      CALL VVV1P0_1(W(1,8),W(1,6),GC_10(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_1(W(1,2),W(1,9),GC_2,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,11),W(1,10),GC_11(IVEC),AMP(1))
      CALL FFV1_2(W(1,7),W(1,9),GC_2,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,12),W(1,2),W(1,10),GC_11(IVEC),AMP(2))
      CALL FFV1_1(W(1,2),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,13),W(1,6),GC_11(IVEC),AMP(3))
      CALL FFV1_2(W(1,7),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,14),W(1,11),W(1,6),GC_11(IVEC),AMP(4))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,15)
     $ )
      CALL FFV2_5_1(W(1,2),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,7),W(1,4),W(1,10),GC_11(IVEC),AMP(5))
      CALL FFV2_5_2(W(1,7),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,2),W(1,10),GC_11(IVEC),AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,13),W(1,6),GC_11(IVEC),AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,14),W(1,4),W(1,6),GC_11(IVEC),AMP(8))
      CALL FFV1_1(W(1,2),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_1(W(1,10),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,16),W(1,9),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,14),W(1,10),W(1,9),GC_2,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,7),W(1,16),W(1,15),-GC_50,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,14),W(1,10),W(1,15),-GC_50,GC_58,AMP(12))
      CALL FFV1_2(W(1,7),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
      CALL FFV1_2(W(1,14),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,2),W(1,9),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,14),W(1,13),W(1,9),GC_2,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,15),-GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,14),W(1,13),W(1,15),-GC_50,GC_58,AMP(16))
      CALL VVV1P0_1(W(1,1),W(1,6),GC_10(IVEC),ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
      CALL FFV1_1(W(1,16),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,7),W(1,8),W(1,9),GC_2,AMP(17))
      CALL FFV1_2(W(1,7),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,17),W(1,16),W(1,9),GC_2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,7),W(1,8),W(1,15),-GC_50,GC_58,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,17),W(1,16),W(1,15),-GC_50,GC_58,AMP(20))
      CALL FFV1_2(W(1,7),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1_2(W(1,8),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,18),W(1,2),W(1,9),GC_2,AMP(21))
      CALL FFV1_1(W(1,2),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,8),W(1,19),W(1,9),GC_2,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,18),W(1,2),W(1,15),-GC_50,GC_58,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,8),W(1,19),W(1,15),-GC_50,GC_58,AMP(24))
      CALL VVV1P0_1(W(1,13),W(1,5),GC_10(IVEC),ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,7),W(1,11),W(1,18),GC_11(IVEC),AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,12),W(1,2),W(1,18),GC_11(IVEC),AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,12),W(1,19),W(1,5),GC_11(IVEC),AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,17),W(1,11),W(1,5),GC_11(IVEC),AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,7),W(1,4),W(1,18),GC_11(IVEC),AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,3),W(1,2),W(1,18),GC_11(IVEC),AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,3),W(1,19),W(1,5),GC_11(IVEC),AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,17),W(1,4),W(1,5),GC_11(IVEC),AMP(32))
      CALL FFV1_1(W(1,2),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
      CALL VVV1P0_1(W(1,5),W(1,6),GC_10(IVEC),ZERO, FK_ZERO,W(1,19))
      CALL FFV1_1(W(1,17),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,7),W(1,18),W(1,9),GC_2,AMP(33))
      CALL FFV1_1(W(1,17),W(1,9),GC_2,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,7),W(1,13),W(1,19),GC_11(IVEC),AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,7),W(1,18),W(1,15),-GC_50,GC_58,AMP(35))
      CALL FFV2_5_1(W(1,17),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,7),W(1,18),W(1,19),GC_11(IVEC),AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,8),W(1,13),W(1,6),GC_11(IVEC),AMP(37))
      CALL FFV1_1(W(1,17),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,8),W(1,20),W(1,9),GC_2,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,8),W(1,18),W(1,6),GC_11(IVEC),AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_5_0(W(1,8),W(1,20),W(1,15),-GC_50,GC_58,AMP(40))
      CALL FFV1_1(W(1,17),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,12),W(1,21),W(1,6),GC_11(IVEC),AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,12),W(1,20),W(1,5),GC_11(IVEC),AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,3),W(1,21),W(1,6),GC_11(IVEC),AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,3),W(1,20),W(1,5),GC_11(IVEC),AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,14),W(1,21),W(1,9),GC_2,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,14),W(1,13),W(1,5),GC_11(IVEC),AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_5_0(W(1,14),W(1,21),W(1,15),-GC_50,GC_58,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,14),W(1,18),W(1,5),GC_11(IVEC),AMP(48))
      CALL FFV1_2(W(1,7),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,18))
      CALL FFV1_2(W(1,18),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,21),W(1,2),W(1,9),GC_2,AMP(49))
      CALL FFV1_2(W(1,18),W(1,9),GC_2,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,13),W(1,2),W(1,19),GC_11(IVEC),AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_5_0(W(1,21),W(1,2),W(1,15),-GC_50,GC_58,AMP(51))
      CALL FFV2_5_2(W(1,18),W(1,15),-GC_50,GC_58,ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,21),W(1,2),W(1,19),GC_11(IVEC),AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,13),W(1,16),W(1,6),GC_11(IVEC),AMP(53))
      CALL FFV1_2(W(1,18),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,20),W(1,16),W(1,9),GC_2,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,21),W(1,16),W(1,6),GC_11(IVEC),AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV2_5_0(W(1,20),W(1,16),W(1,15),-GC_50,GC_58,AMP(56))
      CALL FFV1_2(W(1,18),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,17),W(1,11),W(1,6),GC_11(IVEC),AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,20),W(1,11),W(1,5),GC_11(IVEC),AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,17),W(1,4),W(1,6),GC_11(IVEC),AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,20),W(1,4),W(1,5),GC_11(IVEC),AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,17),W(1,10),W(1,9),GC_2,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,13),W(1,10),W(1,5),GC_11(IVEC),AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV2_5_0(W(1,17),W(1,10),W(1,15),-GC_50,GC_58,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,21),W(1,10),W(1,5),GC_11(IVEC),AMP(64))
      CALL VVV1P0_1(W(1,1),W(1,19),GC_10(IVEC),ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,7),W(1,11),W(1,21),GC_11(IVEC),AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,12),W(1,2),W(1,21),GC_11(IVEC),AMP(66))
      CALL FFV1_1(W(1,2),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,12),W(1,17),W(1,1),GC_11(IVEC),AMP(67))
      CALL FFV1_2(W(1,7),W(1,19),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 68
      CALL FFV1_0(W(1,13),W(1,11),W(1,1),GC_11(IVEC),AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV1_0(W(1,7),W(1,4),W(1,21),GC_11(IVEC),AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,3),W(1,2),W(1,21),GC_11(IVEC),AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,3),W(1,17),W(1,1),GC_11(IVEC),AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,13),W(1,4),W(1,1),GC_11(IVEC),AMP(72))
      CALL FFV1_1(W(1,16),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,12),W(1,13),W(1,6),GC_11(IVEC),AMP(73))
      CALL FFV1_1(W(1,16),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,12),W(1,17),W(1,1),GC_11(IVEC),AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV1_0(W(1,3),W(1,13),W(1,6),GC_11(IVEC),AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,3),W(1,17),W(1,1),GC_11(IVEC),AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,14),W(1,13),W(1,9),GC_2,AMP(77))
      CALL FFV1_2(W(1,14),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,17),W(1,16),W(1,9),GC_2,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_5_0(W(1,14),W(1,13),W(1,15),-GC_50,GC_58,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_5_0(W(1,17),W(1,16),W(1,15),-GC_50,GC_58,AMP(80))
      CALL FFV1_2(W(1,8),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,16),W(1,11),W(1,6),GC_11(IVEC),AMP(81))
      CALL FFV1_2(W(1,8),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,13),W(1,11),W(1,1),GC_11(IVEC),AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,16),W(1,4),W(1,6),GC_11(IVEC),AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,13),W(1,4),W(1,1),GC_11(IVEC),AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,16),W(1,10),W(1,9),GC_2,AMP(85))
      CALL FFV1_1(W(1,10),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,8),W(1,13),W(1,9),GC_2,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV2_5_0(W(1,16),W(1,10),W(1,15),-GC_50,GC_58,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV2_5_0(W(1,8),W(1,13),W(1,15),-GC_50,GC_58,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV1_0(W(1,12),W(1,13),W(1,5),GC_11(IVEC),AMP(89))
      CALL FFV1_1(W(1,10),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 90
      CALL FFV1_0(W(1,12),W(1,8),W(1,1),GC_11(IVEC),AMP(90))
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,3),W(1,13),W(1,5),GC_11(IVEC),AMP(91))
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,3),W(1,8),W(1,1),GC_11(IVEC),AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,17),W(1,11),W(1,5),GC_11(IVEC),AMP(93))
      CALL FFV1_2(W(1,14),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,8),W(1,11),W(1,1),GC_11(IVEC),AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,17),W(1,4),W(1,5),GC_11(IVEC),AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,8),W(1,4),W(1,1),GC_11(IVEC),AMP(96))
     ...
     $ ,W(1,17))
      CALL FFV1_1(W(1,2),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,6))
      CALL FFV1_1(W(1,2),W(1,4),GC_11(IVEC),ZERO, FK_ZERO,W(1,5))
      CALL FFV1_1(W(1,2),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 97
      ...
      CALL FFV1_2(W(1,7),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,11))
      CALL FFV1_2(W(1,7),W(1,4),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1_2(W(1,7),W(1,17),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 98
      CALL FFV1_0(W(1,11),W(1,2),W(1,9),GC_2,AMP(100))
      CALL FFV1_0(W(1,8),W(1,2),W(1,9),GC_2,AMP(101))
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_2,AMP(102))
C     Amplitude(s) for diagram number 99
      CALL FFV2_5_0(W(1,7),W(1,6),W(1,15),-GC_50,GC_58,AMP(103))
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,15),-GC_50,GC_58,AMP(104))
      CALL FFV2_5_0(W(1,7),W(1,1),W(1,15),-GC_50,GC_58,AMP(105))
C     Amplitude(s) for diagram number 100
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,15),-GC_50,GC_58,AMP(106))
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,15),-GC_50,GC_58,AMP(107))
      CALL FFV2_5_0(W(1,4),W(1,2),W(1,15),-GC_50,GC_58,AMP(108))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(8) = AMP(69) +  AMP(70)  ! used 4 times
      TMP_JAMP(7) = AMP(65) +  AMP(66)  ! used 4 times
      TMP_JAMP(6) = AMP(5) +  AMP(6)  ! used 4 times
      TMP_JAMP(5) = AMP(1) +  AMP(2)  ! used 4 times
      TMP_JAMP(4) = AMP(104) +  AMP(107)  ! used 4 times
      TMP_JAMP(3) = AMP(98) +  AMP(101)  ! used 4 times
      TMP_JAMP(2) = AMP(29) +  AMP(30)  ! used 4 times
      TMP_JAMP(1) = AMP(25) +  AMP(26)  ! used 4 times
      ...
      TMP_JAMP(39) = AMP(67) +  AMP(71)  ! used 2 times
      TMP_JAMP(38) = AMP(51) +  AMP(52)  ! used 2 times
      TMP_JAMP(37) = AMP(49) +  AMP(50)  ! used 2 times
      TMP_JAMP(36) = AMP(11) +  AMP(12)  ! used 2 times
      TMP_JAMP(35) = AMP(9) +  AMP(10)  ! used 2 times
      TMP_JAMP(34) = AMP(4) +  AMP(8)  ! used 2 times
      TMP_JAMP(33) = AMP(27) +  AMP(31)  ! used 2 times
      TMP_JAMP(32) = AMP(23) +  AMP(24)  ! used 2 times
      TMP_JAMP(31) = AMP(21) +  AMP(22)  ! used 2 times
      TMP_JAMP(30) = AMP(28) +  AMP(32)  ! used 2 times
      TMP_JAMP(29) = AMP(19) +  AMP(20)  ! used 2 times
      TMP_JAMP(28) = AMP(17) +  AMP(18)  ! used 2 times
      TMP_JAMP(27) = AMP(15) +  AMP(16)  ! used 2 times
      TMP_JAMP(26) = AMP(13) +  AMP(14)  ! used 2 times
      TMP_JAMP(25) = AMP(3) +  AMP(7)  ! used 2 times
      TMP_JAMP(24) = AMP(68) +  AMP(72)  ! used 2 times
      TMP_JAMP(23) = AMP(35) +  AMP(36)  ! used 2 times
      TMP_JAMP(22) = AMP(33) +  AMP(34)  ! used 2 times
      ...
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(41)+(
     $ -1.000000000000000D+00)*AMP(43)+(-1.000000000000000D+00)*AMP(45)
     $ +(-1.000000000000000D+00)*AMP(46)+(-1.000000000000000D+00)
     $ *AMP(47)+(-1.000000000000000D+00)*AMP(48)+(-1.000000000000000D
     $ +00)*AMP(94)+(-1.000000000000000D+00)*AMP(96)+(
     $ -1.000000000000000D+00)*TMP_JAMP(42)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(49)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(50)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(37)+(
     $ -1.000000000000000D+00)*AMP(38)+(-1.000000000000000D+00)*AMP(39)
     $ +(-1.000000000000000D+00)*AMP(40)+(-1.000000000000000D+00)
     $ *AMP(42)+(-1.000000000000000D+00)*AMP(44)+(-1.000000000000000D
     $ +00)*AMP(82)+(-1.000000000000000D+00)*AMP(84)+(
     $ -1.000000000000000D+00)*TMP_JAMP(40)+((0.000000000000000D+00,
     $ -1.000000000000000D+00))*TMP_JAMP(49)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(52)
      JAMP(3,1) = (-1.000000000000000D+00)*AMP(73)+(
     ...
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(51)
      JAMP(4,1) = (-1.000000000000000D+00)*AMP(53)+(
     ...
     $ ,1.000000000000000D+00))*TMP_JAMP(54)
      JAMP(5,1) = (-1.000000000000000D+00)*AMP(81)+(
     $ -1.000000000000000D+00)*AMP(83)+(-1.000000000000000D+00)*AMP(85)
     $ +(-1.000000000000000D+00)*AMP(86)+(-1.000000000000000D+00)
     $ *AMP(87)+(-1.000000000000000D+00)*AMP(88)+(-1.000000000000000D
     ...
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(53)
      JAMP(6,1) = (-1.000000000000000D+00)*AMP(57)+(
     $ -1.000000000000000D+00)*AMP(59)+(-1.000000000000000D+00)*AMP(61)
     $ +(-1.000000000000000D+00)*AMP(62)+(-1.000000000000000D+00)
     $ *AMP(63)+(-1.000000000000000D+00)*AMP(64)+(-1.000000000000000D
     $ +00)*AMP(90)+(-1.000000000000000D+00)*AMP(92)+(
     $ -1.000000000000000D+00)*TMP_JAMP(42)+((0.000000000000000D+00,
