...
C     
C     Process: g u > e+ e- u c c~ WEIGHTED<=7 @1
C     Process: g u > mu+ mu- u c c~ WEIGHTED<=7 @1
C     Process: g c > e+ e- c u u~ WEIGHTED<=7 @1
C     Process: g c > mu+ mu- c u u~ WEIGHTED<=7 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE   
     ...
     $     //' zero but not the total matrix-element'
      ...
      call select_color(rcol, jamp2, iconfig,5,  icol)
