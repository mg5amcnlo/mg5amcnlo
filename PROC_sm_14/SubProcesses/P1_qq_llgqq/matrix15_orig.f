      SUBROUTINE SMATRIX15(P, RHEL, RCOL, CHANNEL, IVEC, ANS, IHEL,
     $  ICOL)
C     
...
C     
C     Process: d d~ > e+ e- g u u~ WEIGHTED<=7 @1
C     Process: d d~ > e+ e- g c c~ WEIGHTED<=7 @1
C     Process: d d~ > mu+ mu- g u u~ WEIGHTED<=7 @1
C     Process: d d~ > mu+ mu- g c c~ WEIGHTED<=7 @1
C     Process: s s~ > e+ e- g u u~ WEIGHTED<=7 @1
C     Process: s s~ > e+ e- g c c~ WEIGHTED<=7 @1
C     Process: s s~ > mu+ mu- g u u~ WEIGHTED<=7 @1
C     Process: s s~ > mu+ mu- g c c~ WEIGHTED<=7 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,15) .OR. NTRY(15)
     $     .LE.MAXTRIES.OR.(ISUM_HEL.NE.0)) THEN
            T=MATRIX15(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(15).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,15) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,15)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 15'
     $           ,TS(I)*NCOMB/ANS,' in event ',NTRY(15)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(15).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      CALL SELECT_COLOR(RCOL, JAMP2, ICONFIG,15,  ICOL)

      END


      REAL*8 FUNCTION MATRIX15(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
     ...
     $ )
      CALL FFV2_3_1(W(1,2),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,1),W(1,4),W(1,10),GC_11(IVEC),AMP(3))
      CALL FFV2_3_2(W(1,1),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,2),W(1,10),GC_11(IVEC),AMP(4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,8),W(1,9),GC_2,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,14),W(1,6),W(1,10),GC_11(IVEC),AMP(5))
      CALL FFV1_2(W(1,8),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,6),W(1,9),GC_2,AMP(6))
      CALL FFV2_5_2(W(1,8),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,15),W(1,6),W(1,10),GC_11(IVEC),AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,14),W(1,6),W(1,13),-GC_50,GC_58,AMP(8))
      CALL FFV1_1(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
      CALL FFV1P0_3(W(1,7),W(1,14),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,1),W(1,11),W(1,15),GC_11(IVEC),AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,2),W(1,15),GC_11(IVEC),AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,1),W(1,4),W(1,15),GC_11(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,3),W(1,2),W(1,15),GC_11(IVEC),AMP(12))
      CALL FFV1_1(W(1,14),W(1,9),GC_2,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,15),W(1,10),GC_11(IVEC),AMP(13))
      CALL FFV1_1(W(1,14),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,15),W(1,9),GC_2,AMP(14))
      CALL FFV2_5_1(W(1,14),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,8),W(1,10),GC_11(IVEC),AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,7),W(1,15),W(1,13),-GC_50,GC_58,AMP(16))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
      CALL FFV1P0_3(W(1,7),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1_1(W(1,15),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,14),W(1,9),GC_1,AMP(17))
      CALL FFV1_1(W(1,15),W(1,9),GC_1,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,1),W(1,16),W(1,8),GC_11(IVEC),AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,1),W(1,14),W(1,13),GC_50,GC_58,AMP(19))
      CALL FFV2_3_1(W(1,15),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,1),W(1,14),W(1,8),GC_11(IVEC),AMP(20))
      CALL FFV1P0_3(W(1,1),W(1,15),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
      CALL FFV1_2(W(1,7),W(1,9),GC_2,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,15),W(1,6),W(1,14),GC_11(IVEC),AMP(21))
      CALL FFV1_1(W(1,6),W(1,9),GC_2,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,16),W(1,14),GC_11(IVEC),AMP(22))
      CALL FFV2_5_2(W(1,7),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,17),W(1,6),W(1,14),GC_11(IVEC),AMP(23))
      CALL FFV2_5_1(W(1,6),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,7),W(1,18),W(1,14),GC_11(IVEC),AMP(24))
      CALL FFV1_2(W(1,1),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
      CALL FFV1_2(W(1,14),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,19),W(1,2),W(1,9),GC_1,AMP(25))
      CALL FFV1_2(W(1,14),W(1,9),GC_1,ZERO, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,20),W(1,2),W(1,8),GC_11(IVEC),AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,19),W(1,2),W(1,13),GC_50,GC_58,AMP(27))
      CALL FFV2_3_2(W(1,14),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,19),W(1,2),W(1,8),GC_11(IVEC),AMP(28))
      CALL FFV1P0_3(W(1,14),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,15),W(1,6),W(1,19),GC_11(IVEC),AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,16),W(1,19),GC_11(IVEC),AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,17),W(1,6),W(1,19),GC_11(IVEC),AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,7),W(1,18),W(1,19),GC_11(IVEC),AMP(32))
      CALL VVV1P0_1(W(1,5),W(1,8),GC_10(IVEC),ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,1),W(1,11),W(1,19),GC_11(IVEC),AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,12),W(1,2),W(1,19),GC_11(IVEC),AMP(34))
      CALL FFV1_1(W(1,2),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,12),W(1,14),W(1,5),GC_11(IVEC),AMP(35))
      CALL FFV1_2(W(1,1),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,12),W(1,11),W(1,5),GC_11(IVEC),AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,1),W(1,4),W(1,19),GC_11(IVEC),AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,3),W(1,2),W(1,19),GC_11(IVEC),AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,3),W(1,14),W(1,5),GC_11(IVEC),AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,12),W(1,4),W(1,5),GC_11(IVEC),AMP(40))
      CALL VVV1P0_1(W(1,5),W(1,10),GC_10(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,15),W(1,6),W(1,12),GC_11(IVEC),AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,7),W(1,16),W(1,12),GC_11(IVEC),AMP(42))
      CALL FFV1_1(W(1,6),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,15),W(1,4),W(1,5),GC_11(IVEC),AMP(43))
      CALL FFV1_2(W(1,7),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,15),W(1,16),W(1,5),GC_11(IVEC),AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,17),W(1,6),W(1,12),GC_11(IVEC),AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,7),W(1,18),W(1,12),GC_11(IVEC),AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,17),W(1,4),W(1,5),GC_11(IVEC),AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,15),W(1,18),W(1,5),GC_11(IVEC),AMP(48))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(24) = AMP(45) +  AMP(46)  ! used 2 times
      TMP_JAMP(23) = AMP(43) +  AMP(47)  ! used 2 times
      TMP_JAMP(22) = AMP(41) +  AMP(42)  ! used 2 times
      TMP_JAMP(21) = AMP(37) +  AMP(38)  ! used 2 times
      TMP_JAMP(20) = AMP(36) +  AMP(40)  ! used 2 times
      TMP_JAMP(19) = AMP(33) +  AMP(34)  ! used 2 times
      TMP_JAMP(18) = AMP(23) +  AMP(24)  ! used 2 times
      TMP_JAMP(17) = AMP(21) +  AMP(22)  ! used 2 times
      TMP_JAMP(16) = AMP(19) +  AMP(20)  ! used 2 times
      TMP_JAMP(15) = AMP(17) +  AMP(18)  ! used 2 times
      ...
      TMP_JAMP(10) = AMP(35) +  AMP(39)  ! used 2 times
      TMP_JAMP(9) = AMP(31) +  AMP(32)  ! used 2 times
      TMP_JAMP(8) = AMP(29) +  AMP(30)  ! used 2 times
      TMP_JAMP(7) = AMP(27) +  AMP(28)  ! used 2 times
      TMP_JAMP(6) = AMP(25) +  AMP(26)  ! used 2 times
      TMP_JAMP(5) = AMP(44) +  AMP(48)  ! used 2 times
      TMP_JAMP(4) = AMP(15) +  AMP(16)  ! used 2 times
      TMP_JAMP(3) = AMP(13) +  AMP(14)  ! used 2 times
      TMP_JAMP(2) = AMP(11) +  AMP(12)  ! used 2 times
      ...
      JAMP(1,1) = (1.666666666666667D-01)*TMP_JAMP(40)
     $ +(1.666666666666667D-01)*TMP_JAMP(42)
      JAMP(2,1) = ((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(39)+(-5.000000000000000D-01)*TMP_JAMP(40)+(
     $ -5.000000000000000D-01)*TMP_JAMP(41)
      JAMP(3,1) = (1.666666666666667D-01)*TMP_JAMP(41)
     $ +(1.666666666666667D-01)*TMP_JAMP(43)
      JAMP(4,1) = ((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(39)+(-5.000000000000000D-01)*TMP_JAMP(42)+(
     $ -5.000000000000000D-01)*TMP_JAMP(43)
