...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,14) .OR. NTRY(14)
     $     .LE.MAXTRIES.OR.(ISUM_HEL.NE.0)) THEN
            T=MATRIX14(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(14).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,14) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,14)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 14'
     $           ,TS(I)*NCOMB/ANS,' in event ',NTRY(14)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(14).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX14(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,6),W(1,15),GC_11(IVEC),AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,1),W(1,4),W(1,15),GC_11(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,3),W(1,6),W(1,15),GC_11(IVEC),AMP(12))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_1(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,15),W(1,2),W(1,14),GC_11(IVEC),AMP(21))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,17),W(1,2),W(1,14),GC_11(IVEC),AMP(23))
      CALL FFV2_5_1(W(1,2),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,12),W(1,6),W(1,19),GC_11(IVEC),AMP(34))
      CALL FFV1_1(W(1,6),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,3),W(1,6),W(1,19),GC_11(IVEC),AMP(38))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,15),W(1,2),W(1,12),GC_11(IVEC),AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,7),W(1,16),W(1,12),GC_11(IVEC),AMP(42))
      CALL FFV1_1(W(1,2),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,17),W(1,2),W(1,12),GC_11(IVEC),AMP(45))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(24) = AMP(44) +  AMP(48)  ! used 2 times
      TMP_JAMP(23) = AMP(43) +  AMP(47)  ! used 2 times
      TMP_JAMP(22) = AMP(15) +  AMP(16)  ! used 2 times
      TMP_JAMP(21) = AMP(13) +  AMP(14)  ! used 2 times
      TMP_JAMP(20) = AMP(11) +  AMP(12)  ! used 2 times
      TMP_JAMP(19) = AMP(9) +  AMP(10)  ! used 2 times
      TMP_JAMP(18) = AMP(7) +  AMP(8)  ! used 2 times
      TMP_JAMP(17) = AMP(5) +  AMP(6)  ! used 2 times
      TMP_JAMP(16) = AMP(3) +  AMP(4)  ! used 2 times
      TMP_JAMP(15) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(14) = AMP(45) +  AMP(46)  ! used 2 times
      TMP_JAMP(13) = AMP(41) +  AMP(42)  ! used 2 times
      TMP_JAMP(12) = AMP(37) +  AMP(38)  ! used 2 times
      TMP_JAMP(11) = AMP(35) +  AMP(39)  ! used 2 times
      ...
      TMP_JAMP(5) = AMP(36) +  AMP(40)  ! used 2 times
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(42)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(40)+(
