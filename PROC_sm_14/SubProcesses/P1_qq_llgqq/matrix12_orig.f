...
C      where in initialization mode as well for the helicity.
     ...
     $  THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,12) .OR. NTRY(12)
     $     .LE.MAXTRIES.OR.(ISUM_HEL.NE.0)) THEN
            T=MATRIX12(P ,NHEL(1,I),JC(1),I,AMP2, JAMP2, IVEC)
     ...
     $       .EQ.0.AND.ALLOW_HELICITY_GRID_ENTRIES) THEN
          ...
          ENDIF
        ENDDO
        IF(NTRY(12).EQ.(MAXTRIES+1).AND.DS_GET_DIM_STATUS('Helicity')
     $   .NE.-1) THEN
...
C            update.
     ...
     $              'IMIRROR', IMIRROR
                ENDIF
              ELSE IF (.NOT.GOODHEL(I,12) .AND. (DABS(TS(I)).GT.ANS
     $         *LIMHEL/NCOMB)) THEN
                GOODHEL(I,12)=.TRUE.
                NGOOD = NGOOD +1
                PRINT *,'Added good helicity ',I, 'for process 12'
     $           ,TS(I)*NCOMB/ANS,' in event ',NTRY(12)
              ENDIF
            ENDDO
          ENDIF
          IF(NTRY(12).EQ.MAXTRIES)THEN
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX12(P,NHEL,IC, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.7.1, 2026-04-10
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,4),W(1,10),GC_11(IVEC),AMP(3))
      CALL FFV2_3_2(W(1,7),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,2),W(1,10),GC_11(IVEC),AMP(4))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,11),W(1,15),GC_11(IVEC),AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,2),W(1,15),GC_11(IVEC),AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,4),W(1,15),GC_11(IVEC),AMP(11))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,7),W(1,14),W(1,9),GC_1,AMP(17))
      CALL FFV1_1(W(1,15),W(1,9),GC_1,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,7),W(1,16),W(1,8),GC_11(IVEC),AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,7),W(1,14),W(1,13),GC_50,GC_58,AMP(19))
      CALL FFV2_3_1(W(1,15),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,14),W(1,8),GC_11(IVEC),AMP(20))
      CALL FFV1P0_3(W(1,7),W(1,15),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_2(W(1,7),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,7),W(1,11),W(1,19),GC_11(IVEC),AMP(33))
