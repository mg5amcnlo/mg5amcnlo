...
C     
     ...
     $ * W3))
      V3(3)= DENOM*(-4D0 * CI)*(OM3*-1D0/4D0 * P3(0)*(TMP27+4D0*(TMP37)
     $ )+(+1D0/4D0*(F2(5)*F1(3)+F2(6)*F1(4))+F2(3)*F1(5)+F2(4)*F1(6)))
      V3(4)= DENOM*(-4D0 * CI)*(OM3*-1D0/4D0 * P3(1)*(TMP27+4D0*(TMP37)
     $ )+(-1D0/4D0*(F2(6)*F1(3)+F2(5)*F1(4))+F2(4)*F1(5)+F2(3)*F1(6)))
      V3(5)= DENOM*4D0 * CI*(OM3*1D0/4D0 * P3(2)*(TMP27+4D0*(TMP37))+(
     $ +1D0/4D0 * CI*(F2(6)*F1(3))-1D0/4D0 * CI*(F2(5)*F1(4))-CI*(F2(4)
     $ *F1(5))+CI*(F2(3)*F1(6))))
      V3(6)= DENOM*4D0 * CI*(OM3*1D0/4D0 * P3(3)*(TMP27+4D0*(TMP37))+(
